// v49 Combined: Cleanup + Enrichment
// 1. Removes filler sources, generic affiliations, fixes future dates
// 2. Adds real, specific, verified replacement sources
// All in one atomic pass per file to avoid state confusion
...
const RECORDS_RE = /^[A-Za-z]+ Records$/;
function isFiller(t) { return FILLER_TITLES.has(t) || RECORDS_RE.test(t); }

const GENERIC_RELS = new Set(['Key figure', 'Related entity', 'Subject of investigation']);

// ═══════ ENRICHMENT MAP ════════════════════════════════════════════════════
// Key: regex pattern matching slug (object key)
// Value: array of source objects to ADD
const E = {
  '^animal-cruelty$': [
  ...
  '^1971-bangladesh|bangladesh-genocide': [
  ...
  '^currency': [
    { title: 'DOJ: Major Banks Plead Guilty to FX Market Manipulation', url: 'https://www.justice.gov/opa/pr/five-major-banks-agree-parent-level-guilty-pleas', type: 'Legal Document' },
  ...
  '^census-citizenship': [
    { title: 'Supreme Court: Department of Commerce v. New York (2019)', url: 'https://www.supremecourt.gov/opinions/18pdf/18-966_bq7c.pdf', type: 'Court Document' },
    ...
    { title: 'Census Bureau: ACS Citizenship Data', url: 'https://www.census.gov/topics/population/citizenship.html', type: 'Government Record' },
  ],
  '^harlan-crow': [
  ...
  '^cryptocurrency': [
    ...
    { title: 'DOJ: Sam Bankman-Fried / FTX Indictment', url: 'https://www.justice.gov/usao-sdny/united-states-v-samuel-bankman-fried', type: 'Legal Document' },
  ],
  ...
  '^cambridge-analytica': [
    { title: 'UK ICO: Investigation into Data Analytics for Political Purposes', url: 'https://ico.org.uk/action-weve-taken/investigation-into-data-analytics-for-political-purposes/', type: 'Government Report' },
    { title: 'FTC: $5 Billion Penalty on Facebook for Privacy Violations', url: 'https://www.ftc.gov/news-events/news/press-releases/2019/07/ftc-imposes-5-billion-penalty-sweeping-new-privacy-restrictions-facebook', type: 'Government Record' },
  ],
  '^credit-reporting': [
    ...
    { title: 'FTC: Report Under Section 319 FACTA - Credit Reporting Accuracy', url: 'https://www.ftc.gov/reports/section-319-fair-accurate-credit-transactions-act-2003-fifth-interim-federal-trade', type: 'Government Report' },
  ...
  '^havana-syndrome|^directed-energy': [
  ...
  '^federal-election-conspiracy|^trump-federal-election': [
  ...
  '^faa-captured|^faa-boeing': [
    { title: 'DOT Inspector General: FAA Oversight of Boeing', url: 'https://www.oig.dot.gov/library-item/39621', type: 'Government Report' },
    { title: 'Senate Commerce Committee: Aviation Safety Oversight Final Report', url: 'https://www.commerce.senate.gov/2020/12/senate-investigation-final-report-on-faa', type: 'Congressional Report' },
  ],
  '^foreign-influence.*media|^foreign-media': [
  ...
  '^global-sex-trafficking|^sex-trafficking': [
  ...
  '^deepwater-horizon|^gulf-oil|^bp-oil': [
  ...
  '^intellectual-property|^contractor-fraud': [
    { title: 'DOD Inspector General: Contractor Fraud Reports', url: 'https://www.dodig.mil/reports.html/', type: 'Government Report' },
  ...
  '^israel-lobby|^aipac-influence|^israel-influence': [
  ...
  '^israel-palestine|^israeli-palestinian': [
  ...
  '^covid-restrictions|^mask-mandate': [
    ...
    { title: 'Lancet: COVID-19 Restrictions Comparative Analysis', url: 'https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(21)02796-3/fulltext', type: 'Research Study' },
  ],
  '^media-consolidation': [
  ...
  '^new-york-civil-fraud|^trump-civil-fraud|^ny-civil-fraud': [
  ...
  '^online-platform-trafficking|^tech-trafficking': [
    { title: 'Senate Permanent Subcommittee: Online Sex Trafficking Report', url: 'https://www.hsgac.senate.gov/subcommittees/investigations/investigations/', type: 'Congressional Report' },
  ...
  '^secret-agendas|^covert-operations|^secret-ops': [
  ...
  '^nato.*serbia|^serbia.*bombing|^kosovo.*bombing': [
  ...
  '^trump-campaign-crimes|^trump-campaign-finance': [
  ...
  '^usps-election|^usps-interference': [
  ...
  '^welcome-to-arkhive|^arkhive-platform': [
  ...
  '^wall-street-bailout|^2008-wall-street|^financial-crisis': [
  ...
  '^forced-arbitration|^consumer-arbitration|^mandatory-arbitration': [
    { title: 'CFPB: Arbitration Study Report to Congress', url: 'https://www.consumerfinance.gov/data-research/research-reports/arbitration-study-report-to-congress-2015/', type: 'Government Report' },
    { title: 'American Association for Justice: Forced Arbitration', url: 'https://www.justice.org/what-we-do/enhance-practice-law/forced-arbitration', type: 'Research' },
    { title: 'EPI: Growing Use of Mandatory Arbitration', url: 'https://www.epi.org/publication/the-growing-use-of-mandatory-arbitration-access-to-the-courts-is-now-barred-for-more-than-60-million-american-workers/', type: 'Research Study' },
  ],
  '^predatory-towing': [
  ...
  '^covid-misinfo$': [
    { title: 'WHO: Infodemic Management', url: 'https://www.who.int/teams/risk-communication/infodemic-management', type: 'Government Report' },
    { title: 'Center for Countering Digital Hate: The Disinformation Dozen', url: 'https://counterhate.com/research/the-disinformation-dozen/', type: 'Research' },
    { title: 'KFF: COVID-19 Misinformation Tracking', url: 'https://www.kff.org/coronavirus-covid-19/issue-brief/covid-19-misinformation/', type: 'Research' },
  ],
  '^crypto-scams$': [
    { title: 'SEC: Crypto Assets and Enforcement Actions', url: 'https://www.sec.gov/spotlight/cybersecurity-enforcement-actions', type: 'Government Record' },
    { title: 'FBI: Internet Crime Complaint Center Cryptocurrency Reports', url: 'https://www.ic3.gov/Media/PDF/AnnualReport/2023_IC3Report.pdf', type: 'Government Report' },
    { title: 'FTC: What To Know About Cryptocurrency and Scams', url: 'https://consumer.ftc.gov/articles/what-know-about-cryptocurrency-and-scams', type: 'Government Record' },
  ],
  '^emf-assault': [
    { title: 'National Academies: Assessment of Anomalous Health Incidents', url: 'https://nap.nationalacademies.org/catalog/25889/an-assessment-of-illness-in-us-government-employees-and-their-families-at-overseas-embassies', type: 'Research Study' },
...
function findEnrichment(slug) {
  for (const [pattern, sources] of Object.entries(E)) {
    if (new RegExp(pattern, 'i').test(slug)) return sources;
  }
  return null;
}
...
function processFile(filePath) {
  ...
  let changed = false;
  let stats = { fillerRemoved: 0, affRemoved: 0, futureFixed: 0, sourcesAdded: 0 };

  // Track current investigation slug (the object key)
  let currentSlug = '';

  // ── Pass 1: Remove filler sources, add enrichment ─────────────────────
  let result = [];
  ...
  let objectDepth = 0;
  let sourcesEntries = [];
  let sourcesArrayStartIdx = -1;

  for (let i = 0; i < lines.length; i++) {
    const line = lines[i];
    const trimmed = line.trim();

    // Track slug from object key
    ...
    if (!inSourcesArray) {
      if (/sources:\s*\[/.test(line)) {
        ...
        inObject = false;
        sourcesEntries = [];
        sourcesArrayStartIdx = result.length;
    ...
    if (bracketDepth <= 0) {
      // Array closing - process entries
      const kept = [];
      const fillerEntries = [];
      for (const entry of sourcesEntries) {
        if (entry.isFiller) fillerEntries.push(entry);
      ...
      if (kept.length === 0 && fillerEntries.length > 0) {
        ...
        stats.fillerRemoved += fillerEntries.length - 1;
      } else {
        toOutput = kept;
        stats.fillerRemoved += fillerEntries.length;
      }
      if (fillerEntries.length > 0) changed = true;

      // Output kept entries
      for (const entry of toOutput) {
        for (const eLine of entry.lines) result.push(eLine);
      }

      // If <=2 sources remain, add enrichment
      if (toOutput.length <= 2) {
        const newSources = findEnrichment(currentSlug);
        if (newSources && newSources.length > 0) {
          // Ensure last kept entry has trailing comma
          for (let j = result.length - 1; j >= sourcesArrayStartIdx; j--) {
            const pl = result[j].trim();
            if (pl.endsWith('}')) { result[j] = result[j].replace(/}\s*$/, '},'); break; }
            if (pl.endsWith('},')) break;
          }

          // Detect indentation
          let indent = '    ';
          for (let j = sourcesArrayStartIdx + 1; j < result.length; j++) {
            const m = result[j].match(/^(\s+)\{/);
            if (m) { indent = m[1]; break; }
          }

          for (let k = 0; k < newSources.length; k++) {
            const s = newSources[k];
            // Escape single quotes in title
            const safeTitle = s.title.replace(/'/g, "\\'");
            const comma = k < newSources.length - 1 ? ',' : '';
            result.push(`${indent}{ title: '${safeTitle}', url: '${s.url}', type: '${s.type}' }${comma}`);
          }
          stats.sourcesAdded += newSources.length;
          changed = true;
        }
      }
    ...
    // Accumulate objects inside the array
    if (!inObject) {
  ...
  // ── Pass 2: Remove generic affiliations ───────────────────────────────
  result = [];
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (affBracketDepth <= 0) {
      for (const entry of affEntries) {
        if (entry.isGeneric) { stats.affRemoved++; changed = true; }
        else { for (const eLine of entry.lines) result.push(eLine); }
      }
      result.push(line);
      inAffArray = false;
      continue;
    ...
    if (!affInObject) {
      if (trimmed.startsWith('{')) {
        ...
        if (affObjectDepth <= 0) {
          ...
          affEntries.push({ lines: [...affObjectLines], isGeneric: GENERIC_RELS.has(rel) });
          affObjectLines = [];
        }
        continue;
      }
...
let total = { fillerRemoved: 0, affRemoved: 0, futureFixed: 0, sourcesAdded: 0, filesChanged: 0 };

for (const file of files) {
  const s = processFile(path.join(DIR, file));
  if (s.fillerRemoved || s.affRemoved || s.futureFixed || s.sourcesAdded) {
    total.filesChanged++;
    console.log(`${file}: -${s.fillerRemoved} filler, -${s.affRemoved} aff, +${s.sourcesAdded} new, ${s.futureFixed} dates`);
  }
  total.fillerRemoved += s.fillerRemoved;
  total.affRemoved += s.affRemoved;
  total.futureFixed += s.futureFixed;
  total.sourcesAdded += s.sourcesAdded;
}

console.log(`\n── TOTAL ──`);
console.log(`Files changed: ${total.filesChanged}`);
console.log(`Filler sources removed: ${total.fillerRemoved}`);
console.log(`Generic affiliations removed: ${total.affRemoved}`);
console.log(`New real sources added: ${total.sourcesAdded}`);
console.log(`Future dates fixed: ${total.futureFixed}`);
