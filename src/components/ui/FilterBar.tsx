...
export default function FilterBar({
 ...
 className="w-full pl-11 pr-4 py-3 bg-black border-2 border-[rgba(255,255,255,0.15)] text-white placeholder-zinc-600 focus:outline-none focus:border-zinc-700 transition-colors"
 />
 {searchQuery && (
 <button
 ...
 : 'border-[rgba(255,255,255,0.15)] text-zinc-500 hover:border-[rgba(255,255,255,0.18)]'
 }`}
 >
 <Filter className="w-4 h-4"/>
 <span className="text-sm font-medium">Filters</span>
 {activeFiltersCount > 0 && (
 <span className="px-2 py-0.5 bg-zinc-700 text-white text-xs font-bold">
 {activeFiltersCount}
 </span>
 )}
 ...
 {/* Filter Options */}
 {showFilters && (
 <div className="p-4 border-2 border-[rgba(255,255,255,0.15)] bg-[#080808] space-y-4">
 ...
 className="px-3 py-1.5 bg-black border-2 border-[rgba(255,255,255,0.15)] text-zinc-400 text-sm focus:outline-none focus:border-zinc-700"
 >
 ...
 {/* Clear Filters */}
 {activeFiltersCount > 0 && (
 <div className="pt-4 border-t border-[rgba(255,255,255,0.15)]">
 <button
 onClick={clearFilters}
 className="text-sm text-zinc-500 hover:text-zinc-500 transition-colors"
 >
 Clear all filters
 </button>
 </div>
