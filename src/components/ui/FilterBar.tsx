...
export default function FilterBar({
 ...
 className="w-full pl-11 pr-4 py-3 bg-black border-2 border-[rgba(60,160,255,0.12)] text-white placeholder-zinc-600 focus:outline-none focus:border-blood-700 transition-colors"
 />
 {searchQuery && (
 <button
 ...
 : 'border-[rgba(60,160,255,0.12)] text-zinc-500 hover:border-[rgba(60,160,255,0.18)]'
 }`}
 >
 ...
 {/* Filter Options */}
 {showFilters && (
 <div className="p-4 border-2 border-[rgba(60,160,255,0.12)] bg-[rgba(0,15,40,0.50)] space-y-4">
 ...
 className="px-3 py-1.5 bg-black border-2 border-[rgba(60,160,255,0.12)] text-zinc-400 text-sm focus:outline-none focus:border-blood-700"
 >
 ...
 {/* Clear Filters */}
 {activeFiltersCount > 0 && (
 <div className="pt-4 border-t border-[rgba(60,160,255,0.12)]">
 <button
