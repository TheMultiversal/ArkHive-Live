...
export default function SearchFilter({
 ...
 className="w-full pl-12 pr-4 py-3 bg-[rgba(0,20,55,0.40)] border border-[rgba(60,160,255,0.12)] text-white placeholder-zinc-600 focus:outline-none focus:border-blood-700 transition-colors"
 />
 {searchQuery && (
 <button
 ...
 :"bg-[rgba(0,20,55,0.40)] border-[rgba(60,160,255,0.12)] text-zinc-400 hover:text-white"
 }`}
 >
 ...
 className="w-full px-4 py-2.5 bg-[rgba(0,20,55,0.50)] border border-[rgba(60,160,255,0.12)] text-white text-sm focus:outline-none focus:border-blood-700"
 >
 ...
 {/* Severity */}
 <div>
 <label className="block text-xs text-zinc-500 mb-2">Severity</label>
 <select
 ...
 {/* Date Range */}
 <div>
 <label className="block text-xs text-zinc-500 mb-2">Time Period</label>
 <select
