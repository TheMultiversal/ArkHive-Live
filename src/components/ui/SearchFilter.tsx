...
export default function SearchFilter({
 ...
 className="w-full pl-12 pr-4 py-3 bg-zinc-900/50 border border-zinc-800 text-white placeholder-zinc-600 focus:outline-none focus:border-blood-700 transition-colors"
 />
 {searchQuery && (
 <button
 ...
 className="w-full px-4 py-2.5 bg-zinc-900 border border-zinc-800 text-white text-sm focus:outline-none focus:border-blood-700"
 >
