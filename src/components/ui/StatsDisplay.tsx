    ...
    <div className="flex flex-wrap gap-2">
     {QUICK_NAV.map((item) => (
      <motion.button
       ...
       className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono border border-zinc-800 bg-black/40 text-zinc-400 hover:text-white hover:border-zinc-700/60 hover:bg-zinc-800/80 active:scale-[0.97] transition-all duration-150 cursor-pointer select-none"
     ...
     {TOPICS.map((topic, i) => (
      <motion.button
       ...
       className={`
        ...
        bg-black/30 border border-[rgba(255,255,255,0.08)]
        hover:bg-zinc-800/80 hover:border-zinc-800
        hover:shadow-[0_0_10px_rgba(150, 150, 150,0.08)]
        active:scale-[0.98]
