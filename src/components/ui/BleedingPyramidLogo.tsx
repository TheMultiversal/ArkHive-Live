...
export default function BleedingPyramidLogo({ 
 ...
 <feFlood floodColor="#8f0000"floodOpacity="0.4"/>
 <feComposite in2="blur"operator="in"/>
 <feMerge>
 <feMergeNode />
 <feMergeNode in="SourceGraphic"/>
 ...
 {/* Rays from eye */}
 <g stroke="#8f0000"strokeWidth="0.5"opacity="0.4">
 {[...Array(8)].map((_, i) => {
 ...
 textShadow: '0 0 10px rgba(143, 0, 0, 0.8), 0 2px 4px rgba(0,0,0,0.5)',
 }}
 initial={{ 
 y: 0, 
 opacity: 0,
 ...
 animate={{ opacity: 1 }}
 style={{
 background: 'radial-gradient(circle, rgba(143, 0, 0, 0.2) 0%, transparent 70%)',
 }}
 />
 )}
 </div>
