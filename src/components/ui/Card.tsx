...
const variantClasses: Record<CardVariant, string> = {
 default: 'bg-[#000a1c] border border-[rgba(80,180,255,0.15)]',
 elevated: 'bg-[#000a1c] border border-[rgba(80,180,255,0.15)] shadow-lg shadow-black/20',
 outlined: 'bg-transparent border-2 border-[rgba(60,160,255,0.18)]',
 glass: 'glass-card',
 interactive: 'bg-[#000a1c] border border-[rgba(80,180,255,0.15)] hover:border-blood-700 hover:bg-zinc-900/70 transition-all cursor-pointer',
};
