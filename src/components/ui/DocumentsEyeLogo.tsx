...
export default function DocumentsEyeLogo({ size ="md", className =""}: DocumentsEyeLogoProps) {
 ...
 <circle cx="55"cy="75"r="6"fill="#2563eb"opacity="0.4"/>
 <circle cx="35"cy="82"r="4"fill="#1d4ed8"opacity="0.3"/>
 <ellipse cx="50"cy="85"rx="8"ry="3"fill="#1e40af"opacity="0.3"/>
 </g>
 </g>
 ...
 {/* Blood vessels */}
 <g opacity="0.6">
 <path d="M35 48 Q42 49, 45 50"stroke="#2563eb"strokeWidth="0.6"fill="none"/>
 <path d="M34 52 Q40 51, 44 50"stroke="#1d4ed8"strokeWidth="0.5"fill="none"/>
 <path d="M65 48 Q58 49, 55 50"stroke="#2563eb"strokeWidth="0.6"fill="none"/>
 <path d="M66 52 Q60 51, 56 50"stroke="#1d4ed8"strokeWidth="0.5"fill="none"/>
 </g>
 ...
 <rect x="20"y="12"width="45"height="12"fill="none"stroke="#2563eb"strokeWidth="1.5"rx="1"/>
 <text x="42.5"y="21"textAnchor="middle"fill="#2563eb"fontSize="6"fontFamily="monospace"fontWeight="bold">CLASSIFIED</text>
 </g>
