...
export default function Pagination({
 ...
 className="p-2 border border-[rgba(255, 80, 80,0.15)] text-zinc-500 hover:border-blood-700 hover:text-blood-600 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
 ...
 : 'border-[rgba(255, 80, 80,0.15)] text-zinc-500 hover:border-blood-800 hover:text-blood-600'
 }`}
