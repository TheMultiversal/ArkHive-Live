...
export default function Pagination({
 ...
 className="p-2 border border-[rgba(80,180,255,0.15)] text-zinc-500 hover:border-blood-700 hover:text-blood-600 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
 ...
 currentPage === page
 ? 'border-blood-700 bg-blood-950 text-blood-500'
 : 'border-[rgba(80,180,255,0.15)] text-zinc-500 hover:border-blood-800 hover:text-blood-600'
 }`}
