...
export default function Pagination({
 ...
 className="p-2 border border-[rgba(255,255,255,0.15)] text-zinc-500 hover:border-zinc-700 hover:text-zinc-500 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
 ...
 : 'border-[rgba(255,255,255,0.15)] text-zinc-500 hover:border-zinc-800 hover:text-zinc-500'
 }`}
