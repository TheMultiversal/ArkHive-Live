...
export default function InvertedPyramidEyeLogo({ size ="md", className =""}: InvertedPyramidEyeLogoProps) {
 ...
 style={{
 background: `radial-gradient(circle, rgba(160, 160, 160, ${glowIntensity * 0.4}) 0%, transparent 70%)`,
 }}
 />
 ...
 style={{
 background: `linear-gradient(to top, rgba(160, 160, 160, ${0.1 + Math.sin(pulsePhase * 0.03 + i) * 0.1}), transparent)`,
 ...
 style={{
 background: `linear-gradient(135deg, rgba(160, 160, 160, ${glowIntensity}) 0%, rgba(60, 60, 60, 0.3) 50%, rgba(160, 160, 160, ${glowIntensity}) 100%)`,
 padding: '2px',
 }}
 />

 {/* Inner background */}
 <div className="absolute inset-[2px] bg-gradient-to-br from-dark-950 via-black to-dark-900 overflow-hidden">
 ...
 style={{ filter: `drop-shadow(0 0 ${8 + glowIntensity * 10}px rgba(160, 160, 160, ${glowIntensity}))` }}
 >
 <defs>
 {/* Gradients */}
 ...
 <stop offset="50%"stopColor="#6b6b6b"stopOpacity="0.5"/>
 ...
 <animate attributeName="stop-color"values="#6b6b6b;#e85454;#6b6b6b"dur="2s"repeatCount="indefinite"/>
 </stop>
 ...
 {/* Brick/stone lines */}
 <g stroke="#000a1f"strokeWidth="0.3"opacity="0.5">
 ...
 <line x1="50"y1="46"x2="35"y2="75"stroke="#6b6b6b"strokeWidth="0.5"/>
 <line x1="50"y1="46"x2="50"y2="80"stroke="#6b6b6b"strokeWidth="0.5"/>
 <line x1="50"y1="46"x2="65"y2="75"stroke="#6b6b6b"strokeWidth="0.5"/>
 </g>

 {/* Mystical symbols at corners (small) */}
 <g fill="#6b6b6b"opacity="0.4"fontSize="5"fontFamily="serif">
 <text x="8"y="25"transform="rotate(-15, 8, 25)">â—Š</text>
 <text x="88"y="25"transform="rotate(15, 88, 25)">â—Š</text>
 <text x="48"y="95">â–½</text>
 </g>
