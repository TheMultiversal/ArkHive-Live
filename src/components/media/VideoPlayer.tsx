...
export default function VideoPlayer({
 ...
 {showSubtitles && (
 <div className="absolute bottom-full right-0 mb-2 bg-[rgba(0,10,28,0.85)] border border-[rgba(80,180,255,0.15)] p-2 min-w-[150px]">
 <button
 onClick={() => {
 ...
 {showSettings && (
 <div className="absolute bottom-full right-0 mb-2 bg-[rgba(0,10,28,0.85)] border border-[rgba(80,180,255,0.15)] p-2 min-w-[180px]">
 {/* Quality */}
