...
function GalleryItem({ image, showTitle, onClick }: GalleryItemProps) {
 ...
 className="relative group cursor-pointer overflow-hidden bg-[rgba(0,30,80,0.40)]"
 onClick={onClick}
 >
 {/* Loading placeholder */}
 {!loaded && !error && (
 <div className="aspect-square flex items-center justify-center bg-[rgba(0,30,80,0.40)]">
 <motion.div
 animate={{ rotate: 360 }}
 ...
 {/* Error state */}
 {error && (
 <div className="aspect-square flex items-center justify-center bg-[rgba(0,30,80,0.40)] text-zinc-500">
...
function CarouselGallery({ images, onSelect, showTitles }: CarouselGalleryProps) {
 ...
 {/* Main Image */}
 <div
 className="relative aspect-video bg-[rgba(0,20,55,0.50)] cursor-pointer"
 ...
 className="absolute left-2 top-1/2 -translate-y-1/2 p-2 bg-black/50 text-white hover:bg-[rgba(0,15,40,0.55)] transition-colors"
 >
 ...
 className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-black/50 text-white hover:bg-[rgba(0,15,40,0.55)] transition-colors"
 >
...
function Lightbox({ images, currentIndex, onClose, onNavigate }: LightboxProps) {
 ...
 className="absolute left-4 p-3 bg-black/50 text-white hover:bg-[rgba(0,15,40,0.55)] transition-colors z-10"
 >
 ...
 className="absolute right-4 p-3 bg-black/50 text-white hover:bg-[rgba(0,15,40,0.55)] transition-colors z-10"
 >
