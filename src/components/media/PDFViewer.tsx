...
export default function PDFViewer({
 ...
 ref={containerRef}
 className={cn(
 'flex flex-col bg-[#000a1c] border border-[rgba(80,180,255,0.15)]',
 ...
 className="border-b border-[rgba(80,180,255,0.15)] bg-zinc-800"
 >
 ...
 {/* Loading state */}
 {loading && (
 <div className="absolute inset-0 flex items-center justify-center bg-[#000a1c]">
 ...
 className="px-4 py-2 bg-[#000c20] text-white hover:bg-zinc-700 transition-colors"
 >
 Try again
 </button>
 </div>
 ...
 {numPages && numPages > 1 && (
 <div className="border-t border-[rgba(80,180,255,0.15)] bg-[#000c20] p-2">
