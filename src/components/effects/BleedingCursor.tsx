...
export default function TargetingCursor() {
 ...
 {/* Crosshairs */}
 <g stroke="#2563eb"strokeWidth="1.5"opacity="0.9">
 {/* Top */}
 ...
 {/* Corner brackets */}
 <g stroke="#60a5fa"strokeWidth="2"fill="none"opacity={isHovering ? 1 : 0.6} style={{ transition: 'opacity 0.15s' }}>
 ...
 >
 <circle cx="50"cy="50"r="35"fill="none"stroke="#60a5fa"strokeWidth="2"/>
 <text x="50"y="98"textAnchor="middle"fill="#60a5fa"fontSize="8"fontFamily="monospace">LOCKED</text>
 </motion.g>
 )}
 </svg>
 </motion.div>
