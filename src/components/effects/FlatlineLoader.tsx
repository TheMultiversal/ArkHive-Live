...
export default function FlatlineLoader({ 
 ...
 <stop offset="20%"stopColor={phase === 'flatline' ? '#dc2626' : '#d64545'} />
 <stop offset="80%"stopColor={phase === 'flatline' ? '#dc2626' : '#d64545'} />
 <stop offset="100%"stopColor="transparent"/>
 </linearGradient>
 <filter id="ecgGlow">
 <feGaussianBlur stdDeviation="2"result="blur"/>
 <feFlood floodColor={phase === 'flatline' ? '#dc2626' : '#d64545'} floodOpacity="0.8"/>
 ...
 <g opacity="0.1">
 {[...Array(6)].map((_, i) => (
 <line key={`h${i}`} x1="0"y1={i * 20} x2="300"y2={i * 20} stroke="#d64545"strokeWidth="0.5"/>
 ))}
 {[...Array(16)].map((_, i) => (
 <line key={`v${i}`} x1={i * 20} y1="0"x2={i * 20} y2="100"stroke="#d64545"strokeWidth="0.5"/>
 ))}
 </g>
