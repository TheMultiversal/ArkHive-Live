...
export default function CrystalGridBackground() {
 ...
 <feFlood floodColor="#162f5e"floodOpacity={glowIntensity} />
 ...
 <stop offset="0%"stopColor="#162f5e"stopOpacity={glowIntensity} />
 <stop offset="50%"stopColor="#162f5e"stopOpacity={glowIntensity * 0.3} />
 ...
 style={{
 boxShadow: '0 0 20px rgba(22, 47, 94, 0.3)',
 }}
 />
 </motion.div>
 ))}
