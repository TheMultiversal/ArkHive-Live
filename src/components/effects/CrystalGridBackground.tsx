...
export default function CrystalGridBackground() {
 ...
 <feFlood floodColor="#003d8f"floodOpacity={glowIntensity} />
 ...
 <stop offset="0%"stopColor="#003d8f"stopOpacity={glowIntensity} />
 <stop offset="50%"stopColor="#003d8f"stopOpacity={glowIntensity * 0.3} />
 ...
 style={{
 boxShadow: '0 0 20px rgba(0, 61, 143, 0.3)',
 }}
 />
 </motion.div>
 ))}
 ...
 style={{ boxShadow: '0 0 10px #003d8f' }}
 />
 <motion.div
