...
export default function HeartbeatBackground() {
 ...
 translateX: '-50%',
 translateY: '-50%',
 background: `radial-gradient(circle, rgba(37, 99, 235, ${0.15 + mouseSpeed * 0.08}) 0%, transparent 70%)`,
 }}
 />

 <svg className="absolute inset-0 w-full h-full"style={{ filter: 'drop-shadow(0 0 8px rgba(37, 99, 235, 0.5))' }}>
 <defs>
 ...
 <motion.rect x={0} y={0} width={3} height={dimensions.height} fill="rgba(37, 99, 235, 0.4)"animate={{ x: [0, dimensions.width] }} transition={{ duration: 5, repeat: Infinity, ease:"linear"}} />
 </svg>
