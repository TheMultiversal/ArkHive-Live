...
export default function HeartbeatBackground() {
 ...
 style={{
 backgroundImage: `linear-gradient(rgba(22, 47, 94, 0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(22, 47, 94, 0.3) 1px, transparent 1px)`,
 ...
 translateX: '-50%',
 translateY: '-50%',
 background: `radial-gradient(circle, rgba(22, 47, 94, ${0.15 + mouseSpeed * 0.08}) 0%, transparent 70%)`,
 }}
 />

 <svg className="absolute inset-0 w-full h-full"style={{ filter: 'drop-shadow(0 0 8px rgba(22, 47, 94, 0.5))' }}>
 <defs>
 <linearGradient id="ecgGrad"x1="0%"y1="0%"x2="100%"y2="0%">
 <stop offset="0%"stopColor="transparent"/>
 <stop offset="5%"stopColor="#162f5e"/>
 <stop offset="95%"stopColor="#162f5e"/>
 ...
 <motion.rect x={0} y={0} width={3} height={dimensions.height} fill="rgba(22, 47, 94, 0.4)"animate={{ x: [0, dimensions.width] }} transition={{ duration: 5, repeat: Infinity, ease:"linear"}} />
 </svg>
