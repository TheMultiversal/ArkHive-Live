...
export function NotificationBadge({
 ...
 className={cn(
 'absolute flex items-center justify-center px-1 bg-blood-600 text-white font-bold ',
 sizeClasses[size],
 className
 )}
 >
...
export function StandaloneBadge({
 ...
 success: 'bg-blood-500/20 text-blood-400',
 warning: 'bg-zinc-400/20 text-zinc-300',
 error: 'bg-blood-500/20 text-blood-400',
 info: 'bg-blood-500/20 text-blood-400',
 };
