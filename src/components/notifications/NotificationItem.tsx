...
const colorMap: Record<NotificationType, string> = {
 info: 'text-blood-500 bg-blood-500/10',
 success: 'text-blood-500 bg-blood-500/10',
 warning: 'text-zinc-400 bg-zinc-400/10',
 error: 'text-blood-500 bg-blood-500/10',
 investigation: 'text-blood-500 bg-blood-500/10',
 entity: 'text-blood-500 bg-blood-500/10',
 document: 'text-blood-700 bg-blood-700/10',
...
export function NotificationItem({
 ...
 {/* Unread indicator */}
 {!notification.read && (
 <div className="absolute left-1 top-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-blood-500"/>
 )}
 ...
 className="p-1.5 text-zinc-500 hover:text-blood-500 hover:bg-zinc-700 transition-colors"
 title="Mark as read"
 >
