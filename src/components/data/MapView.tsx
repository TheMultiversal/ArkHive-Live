...
export default function MapView({
 ...
 ref={containerRef}
 className={cn(
 'relative bg-[#0a0a0a] border border-[rgba(255,255,255,0.15)] overflow-hidden',
 className
 )}
 >
 {/* Map Container */}
 ...
 exit={{ opacity: 0, y: 5 }}
 className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] whitespace-nowrap z-10"
 >
 ...
 <div className="flex items-center gap-2 bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] px-3 py-2">
 ...
 className="p-2 bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] text-zinc-400 hover:text-white disabled:opacity-50 transition-colors"
 >
 <ZoomIn className="w-4 h-4"/>
 </button>
 <div className="px-2 py-1 bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] text-xs text-center text-zinc-400">
 {zoom}x
 </div>
 <button
 ...
 {/* Marker count */}
 <div className="absolute bottom-4 right-4 px-2 py-1 bg-zinc-800/80 border border-[rgba(255,255,255,0.18)] text-xs text-zinc-400">
 ...
 exit={{ opacity: 0, x: 20 }}
 className="absolute top-4 right-16 w-64 bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] shadow-lg"
 >
 <div className="flex items-start justify-between p-3 border-b border-[rgba(255,255,255,0.18)]">
 <div>
 ...
 <div className="p-3 border-b border-[rgba(255,255,255,0.18)]">
 ...
 <div className="absolute bottom-12 left-4 bg-zinc-800/80 border border-[rgba(255,255,255,0.18)] p-2">
