...
export default function TagsLoading() {
 ...
 <div className="h-10 w-32 bg-[rgba(0,20,55,0.50)] animate-pulse mx-auto mb-4"/>
 ...
 <div className="mb-12">
 <div className="h-6 w-32 bg-[rgba(0,30,80,0.40)] animate-pulse mb-6"/>
 ...
 {/* All tags */}
 <div>
 <div className="h-6 w-24 bg-[rgba(0,30,80,0.40)] animate-pulse mb-6"/>
 ...
 {/* Trending */}
 <div className="mt-12">
 <div className="h-6 w-28 bg-[rgba(0,30,80,0.40)] animate-pulse mb-6"/>
 ...
 <div className="h-5 w-24 bg-[rgba(0,30,80,0.40)] animate-pulse mb-1"/>
