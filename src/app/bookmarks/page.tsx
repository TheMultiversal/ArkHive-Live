...
const mockFolders: BookmarkFolder[] = [
 ...
 { id: 'fol_2', name: 'Research', color: '#d64545', count: 8 },
...
const mockBookmarks: BookmarkItem[] = [
 ...
 url: '/investigations/nsa-mass-surveillance',
 folder: 'Priority',
 ...
 id: 'bm_6',
 type: 'workspace',
 title: 'Pharmaceutical Price Fixing',
...
function BookmarkCard({ 
 ...
 bookmark.starred ? 'text-zinc-400' : 'text-zinc-600 hover:text-zinc-400'
 }`}
 >
 ...
 {bookmark.starred && <Star className="w-4 h-4 text-zinc-400 fill-current"/>}
 </div>
 ...
 className="p-1 text-zinc-600 hover:text-blood-400 transition-colors"
 >
