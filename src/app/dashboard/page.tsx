...
export default function DashboardPage() {
 ...
 stat.color === 'blue' ? 'bg-blood-500/20' :
 stat.color === 'purple' ? 'bg-blood-500/20' :
 'bg-blood-500/20'
 }`}>
 <stat.icon className={`w-5 h-5 ${
 stat.color === 'blood' ? 'text-blood-500' :
 stat.color === 'blue' ? 'text-blood-500' :
 stat.color === 'purple' ? 'text-blood-500' :
 'text-blood-500'
 }`} />
 </div>
 <span className="flex items-center gap-1 text-blood-400 text-sm">
