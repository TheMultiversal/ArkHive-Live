...
export default function ProfilePage() {
 ...
 animate={{ opacity: 1, y: 0 }}
 exit={{ opacity: 0, y: -20 }}
 className="fixed top-24 right-4 bg-blood-900/90 border border-blood-700 p-4 flex items-center gap-3 z-50"
 >
 <CheckCircle className="w-5 h-5 text-blood-400"/>
 <span className="text-blood-300">Settings saved successfully</span>
 </motion.div>
 )}
 ...
 <span className="px-3 py-1 bg-blood-500/20 text-blood-400 text-sm">
 Enabled
 </span>
 </div>
 ...
 {/* Danger Zone */}
 <div className="bg-blood-900/20 border border-blood-800/50 p-6">
 <h3 className="text-lg font-semibold text-blood-400 mb-4 flex items-center gap-2">
 ...
 <button className="flex items-center gap-2 bg-blood-600/20 hover:bg-blood-600/30 border border-blood-600 text-blood-400 px-4 py-2 transition-colors">
