    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 text-xs text-zinc-500">
          <span className="bg-[#0a0a0a] border border-[rgba(255,255,255,0.15)] px-3 py-1">
      ...
      <motion.div
        ...
        className="bg-zinc-900 border border-zinc-600/50 p-4 mb-8"
      >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 bg-[#0a0a0a] border border-[rgba(255,255,255,0.15)] text-zinc-400 hover:text-white transition-colors"
            >
          ...
          <div className="flex">
            <button
              ...
              className={`p-2.5 border transition-colors ${
                viewMode === 'list'
                  ? 'bg-zinc-900 border-zinc-600 text-zinc-400'
                  : 'bg-[#0a0a0a] border-[rgba(255,255,255,0.15)] text-zinc-400'
              }`}
            >
        ...
        <AnimatePresence>
          {showFilters && (
            ...
            >
              <div className="bg-[#0a0a0a] border border-[rgba(255,255,255,0.15)] p-4 flex flex-wrap gap-6">
                <div>
                  <label className="block text-sm text-zinc-400 mb-2">Category</label>
                  <select
                    value={selectedCategory}
                    onChange={(e) => { setSelectedCategory(e.target.value); setVisibleCount(ITEMS_PER_PAGE); }}
                    className="bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] text-white px-3 py-2 focus:border-zinc-600 focus:outline-none"
                  >
                    {categories.map(cat => (
                ...
                <div>
                  ...
                  <select
                    ...
                    className="bg-[#0d0d0d] border border-[rgba(255,255,255,0.18)] text-white px-3 py-2 focus:border-zinc-600 focus:outline-none max-w-[280px]"
                  >
          ...
          {visibleDocs.map((doc, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#0a0a0a] border border-[rgba(255,255,255,0.15)] p-4 hover:border-[rgba(255,255,255,0.18)] transition-colors group"
              >
                <div className="flex items-start gap-4">
                  <div className="bg-[#0d0d0d] p-3 shrink-0">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {doc.classification === 'public' ? (
                          ...
                          <Lock className={`w-4 h-4 ${
                            doc.classification === 'sensitive' ? 'text-zinc-300' : 'text-zinc-400'
                          }`} />
                        )}
                  ...
                  <a
                    ...
                    className="flex items-center gap-1.5 px-3 py-2 bg-zinc-900 text-zinc-400 hover:bg-zinc-800/80 transition-colors text-sm shrink-0"
                  >
          ...
          {visibleDocs.map((doc, index) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href={`/investigations/${doc.investigationSlug}`}
                  className="text-zinc-300 hover:text-white text-xs transition-colors line-clamp-1 block mb-3"
                >
                  {doc.investigation}
                </Link>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-2 bg-zinc-900 text-zinc-400 hover:bg-zinc-800/80 text-sm transition-colors flex items-center justify-center gap-2"
                >
                  <ExternalLink className="w-4 h-4" />
                  View Source
                </a>
      ...
      {hasMore && (
        <div className="mt-8 text-center">
          <button
            ...
            className="px-6 py-3 bg-[#0a0a0a] border border-[rgba(255,255,255,0.15)] text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors"
          >
