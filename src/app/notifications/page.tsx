...
const mockNotifications: NotificationItem[] = [
  ...
  },
  {
    ...
    message: 'Operation Blackwater has been elevated to critical severity level.',
    read: false,
    timestamp: new Date(Date.now() - 1000 * 60 * 60),
    actionUrl: '/investigations/operation-blackwater',
  },
  {
    id: 'notif_3',
    type: 'comment',
    title: 'New Comment',
    message: 'Sarah Miller commented on Shadow Protocol: "Found new connections..."',
    read: false,
    timestamp: new Date(Date.now() - 1000 * 60 * 60 * 3),
    actionUrl: '/investigations/shadow-protocol',
  },
  {
    id: 'notif_4',
    type: 'team',
