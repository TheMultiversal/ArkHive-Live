...
export default function AboutLoading() {
 ...
 <div className="h-12 w-48 bg-[rgba(0,20,55,0.50)] animate-pulse mx-auto mb-4"/>
 ...
 className="mb-12"
 >
 <div className="h-8 w-48 bg-[rgba(0,30,80,0.40)] animate-pulse mb-6"/>
 ...
 <div className="h-4 w-24 bg-[rgba(0,30,80,0.40)] animate-pulse mx-auto"/>
 </motion.div>
 ))}
 </div>
 </div>
