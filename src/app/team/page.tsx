...
const roleColors: Record<TeamMember['role'], string> = {
 owner: 'bg-zinc-400 text-black',
 admin: 'bg-blood-500 text-white',
 investigator: 'bg-blood-500 text-white',
 analyst: 'bg-blood-500 text-white',
...
function TeamMemberCard({ member }: { member: TeamMember }) {
 ...
 <div className="text-center">
 <FileText className="w-4 h-4 text-blood-400 mx-auto mb-1"/>
 <p className="text-white font-semibold text-sm">{member.stats.documents}</p>
 <p className="text-zinc-500 text-xs">Docs</p>
 </div>
 <div className="text-center">
 <MessageSquare className="w-4 h-4 text-zinc-300 mx-auto mb-1"/>
...
export default function TeamPage() {
 ...
 { label: 'Online Now', value: activeCount, icon: <CheckCircle className="w-5 h-5 text-blood-500"/> },
 { label: 'Away', value: awayCount, icon: <Clock className="w-5 h-5 text-zinc-400"/> },
 { label: 'Pending Invites', value: 3, icon: <Mail className="w-5 h-5 text-blood-500"/> },
 ].map((stat, i) => (
 ...
 <Mail className="w-5 h-5 text-blood-500"/>
 Pending Invitations
 </h2>
 ...
 <button className="px-3 py-1 text-sm text-blood-400 hover:text-blood-400 transition-colors">
 Revoke
 </button>
 </div>
 </div>
