...
export default function FAQLoading() {
 ...
 <div className="h-10 w-80 bg-[#0a0a0a] animate-pulse mx-auto mb-4"/>
 ...
 <div className="h-5 w-3/4 bg-[#0d0d0d] animate-pulse"/>
 </div>
 ...
 >
 <div className="h-6 w-64 bg-[#0d0d0d] animate-pulse mx-auto mb-4"/>
