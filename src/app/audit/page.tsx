...
const getActionColor = (action: AuditLogEntry['action']) => {
 const colors = {
 create: 'text-blood-500 bg-blood-500/10',
 read: 'text-blood-500 bg-blood-500/10',
 update: 'text-zinc-400 bg-zinc-400/10',
 delete: 'text-blood-500 bg-blood-500/10',
 login: 'text-blood-500 bg-blood-500/10',
 logout: 'text-zinc-500 bg-zinc-500/10',
 export: 'text-blood-500 bg-blood-500/10',
 share: 'text-blood-500 bg-blood-500/10',
 permission: 'text-blood-700 bg-blood-700/10',
 };
...
export default function AuditPage() {
 ...
 { label: 'Failed Actions', value: '23', icon: <AlertTriangle className="w-5 h-5 text-blood-500"/> },
 { label: 'High Risk Events', value: '156', icon: <Shield className="w-5 h-5 text-blood-700"/> },
 { label: 'Active Users', value: '47', icon: <User className="w-5 h-5 text-blood-500"/> },
 ].map((stat, i) => (
