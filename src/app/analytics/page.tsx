...
const severityData: ChartData[] = [
 ...
 { label: 'Low', value: 62, color: '#c23030' },
];
...
const entityTypeData: ChartData[] = [
 { label: 'Corporations', value: 45, color: '#d64545' },
 { label: 'Agencies', value: 28, color: '#8b5cf6' },
 { label: 'Individuals', value: 18, color: '#71717a' },
...
function MetricCardComponent({ metric }: { metric: MetricCard }) {
 ...
 <span className="text-blood-500 text-sm">+{metric.change}%</span>
 </>
 )}
 {isNegative && (
 <>
...
export default function AnalyticsPage() {
 ...
 item.type === 'entity' ? 'bg-zinc-400' :
 item.type === 'document' ? 'bg-blood-500' :
 item.type === 'connection' ? 'bg-blood-500' :
 'bg-blood-600'
 }`} />
