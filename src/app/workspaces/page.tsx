...
export default function WorkspacesPage() {
 ...
 className="flex items-center gap-2 px-3 py-2 bg-zinc-800 text-zinc-400/80 rounded text-[11px] font-medium hover:bg-zinc-800 transition-colors"
 >
 ...
 <Link
 href="/workspaces/create"
 className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-800 text-zinc-400/70 rounded text-xs font-medium hover:bg-zinc-800 transition-colors"
 >
 <Plus className="w-3.5 h-3.5"/>
 Create Workspace
 </Link>
