...
export default function WorkspacesPage() {
 ...
 className="flex items-center gap-2 px-3 py-2 bg-zinc-800 text-zinc-400/80 text-[11px] font-medium hover:bg-zinc-800 transition-colors"
 >
 ...
 <div className="p-3 bg-[#0a0a0a] border border-white/[0.04]">
 <div className="text-lg font-medium text-zinc-400/70 mb-0.5">{stats.active}</div>
 ...
 className="w-full pl-9 pr-4 py-2 bg-[#0a0a0a] border border-white/[0.06] text-xs text-white/70 placeholder-white/25 focus:outline-none focus:border-white/[0.1] transition-colors"
 />
 </div>
 ...
 className="px-2 py-1 bg-transparent border border-white/[0.06] text-[10px] text-white/40 focus:outline-none cursor-pointer"
 >
 ...
 <Link
 href="/workspaces/create"
 className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-800 text-zinc-400/70 text-xs font-medium hover:bg-zinc-800 transition-colors"
 >
 <Plus className="w-3.5 h-3.5"/>
 Create Workspace
 </Link>
