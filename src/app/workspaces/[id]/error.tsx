...
import { Users, RefreshCw, ArrowLeft, Lock } from 'lucide-react';
      ...
      <div className="max-w-lg mx-auto px-4 text-center">
        <div className="border-2 border-blood-800/60 bg-black/80 p-8">
          <div className="w-20 h-20 mx-auto mb-6 border-2 border-blood-700 bg-blood-950/30 flex items-center justify-center">
            <Lock className="w-10 h-10 text-blood-600" />
          </div>
          ...
          <p className="text-zinc-400 mb-6 text-sm leading-relaxed">
            Unable to access the requested workspace. 
            You may not have permission, or the workspace may have been archived.
          </p>
