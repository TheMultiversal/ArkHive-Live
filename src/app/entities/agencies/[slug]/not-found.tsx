...
import { Landmark, AlertTriangle, ArrowLeft, Home } from "lucide-react";
      ...
      <div className="max-w-lg mx-auto px-4 text-center">
        <div className="border-2 border-blood-800/60 bg-black/80 p-12">
          ...
          <p className="text-zinc-400 mb-8 leading-relaxed">
            This agency record has been <span className="text-blood-600 font-bold">redacted</span>, 
            is under investigation, or does not exist in our database.
          </p>
        ...
        <div className="mt-8 text-xs text-zinc-700 uppercase tracking-widest">
          Error Code: AGENCY_RECORD_CLASSIFIED
        </div>
      </div>
    </div>
  );
