...
export default function EntitiesError({ error, reset }: ErrorProps) {
  useEffect(() => {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-zinc-400 mb-8">
          Unable to retrieve entity information. Our database of corporations, agencies, 
          and individuals may be temporarily unavailable.
        </p>
