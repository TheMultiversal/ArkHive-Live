...
const corporationData: Record<string, {
 ...
 'amerisourcebergen': {
 name: 'AmerisourceBergen (now Cencora)',
 industry: 'Pharmaceutical Distribution',
 headquarters: 'Conshohocken, Pennsylvania',
 founded: '2001 (merger of AmeriSource and Bergen Brunswig)',
 riskLevel: 'high' as const,
 description: 'AmerisourceBergen, rebranded as Cencora in 2023, is one of the "Big Three"pharmaceutical distributors blamed for fueling the opioid epidemic. The company distributed billions of oxycodone and hydrocodone pills to pharmacies despite glaring red flags and suspicious order patterns. AmerisourceBergen agreed to pay $6.4 billion as part of a landmark opioid settlement with state and local governments across the United States.',
 employees: '44,000+',
 revenue: '$262 billion (2023)',
 marketCap: '$45+ billion',
 ceo: 'Robert P. Mauch',
 website: 'https://www.cencora.com',
 controversies: [
 'OPIOID CRISIS: Distributed billions of opioid pills despite suspicious order indicators',
 'SETTLEMENT: $6.4 billion opioid settlement with state and local governments',
 'FAILURE TO REPORT: Failed to flag suspicious pharmacy orders as required by DEA',
 'PROFIT OVER SAFETY: Prioritized revenue from opioid distribution over public health',
 'DEA VIOLATIONS: Repeated violations of controlled substance monitoring obligations',
 'LOBBYING: Spent millions lobbying against opioid regulation and oversight',
 ],
 subsidiaries: [
 ...
 relatedInvestigations: [
 { title: 'The Opioid Crisis', slug: 'opioid-crisis', severity: 'critical' },
 ],
 keyFigures: [
 { name: 'Robert P. Mauch', role: 'CEO (Cencora)' },
 { name: 'Steven H. Collis', role: 'Former CEO (2011-2023)' },
 ],
 legalHistory: [
 '2017: $16 million DEA settlement for distribution violations',
 '2022: $6.4 billion national opioid settlement agreement',
 '2023: Rebranded to Cencora amid ongoing opioid litigation',
 ],
 },
 'cardinal-health': {
 ...
 founded: '1971',
 riskLevel: 'high' as const,
 description: 'Cardinal Health is one of the "Big Three"pharmaceutical distributors that fueled the opioid epidemic by shipping massive quantities of opioid painkillers without adequate controls. The company failed to flag suspicious orders of controlled substances to the DEA and is part of a $21 billion opioid settlement alongside McKesson and AmerisourceBergen.',
 employees: '48,000+',
 revenue: '$205 billion (2023)',
 marketCap: '$27+ billion',
 ceo: 'Jason Hollar',
 website: 'https://www.cardinalhealth.com',
 controversies: [
 'OPIOID CRISIS: Failed to flag suspicious orders of controlled substances to the DEA',
 'SETTLEMENT: Part of $21 billion opioid settlement with state and local governments',
 'DISTRIBUTION: Shipped millions of opioid doses to small-town pharmacies far exceeding local demand',
 'DEA SANCTIONS: Distribution centers suspended by DEA for compliance failures',
 'PROFIT MOTIVE: Continued high-volume opioid distribution despite internal warnings',
 'OVERSIGHT FAILURES: Inadequate anti-diversion programs for years',
 'LOBBYING: Lobbied against stricter opioid distribution regulations',
 ],
 subsidiaries: [
 'Cardinal Health Pharmaceutical Distribution',
 'Cordis (medical devices)',
 ...
 keyFigures: [
 { name: 'Jason Hollar', role: 'CEO' },
 { name: 'George Barrett', role: 'Former CEO (2009-2018)' },
 ],
 legalHistory: [
 '2008: $34 million DEA fine for distribution violations',
 '2016: $44 million Justice Department settlement',
 '2022: $6.6 billion share of national opioid settlement',
 ],
 },
 'equifax': {
 name: 'Equifax Inc.',
 ...
 founded: '1899',
 riskLevel: 'high' as const,
 description: 'Equifax is one of the three major consumer credit reporting agencies in the United States. In 2017, the company suffered one of the largest data breaches in history, exposing the personal information of 147 million Americans including Social Security numbers, birth dates, and addresses. Executives sold stock before the breach was publicly disclosed, and the company faced a $700 million FTC settlement.',
 employees: '14,000+',
 ...
 controversies: [
 'DATA BREACH: 2017 breach exposed personal data of 147 million Americans',
 'INSIDER TRADING: Executives sold $1.8 million in stock before breach disclosure',
 'NEGLIGENCE: Failed to patch known Apache Struts vulnerability for months',
 'SETTLEMENT: $700 million FTC settlement for data breach failures',
 'SECURITY FAILURES: Used "admin" as username and password for internal portal',
 'DELAYED DISCLOSURE: Waited six weeks to inform the public of the breach',
 'CONSUMER HARM: Millions of identity theft cases linked to breach data',
 ],
 subsidiaries: [
 ...
 relatedInvestigations: [
 { title: 'Corporate Surveillance State', slug: 'corporate-surveillance', severity: 'high' },
 ],
 keyFigures: [
 { name: 'Mark Begor', role: 'CEO (since 2018)' },
 { name: 'Richard Smith', role: 'Former CEO (resigned after breach)' },
 { name: 'Jun Ying', role: 'Former CIO (convicted of insider trading)' },
 ],
 legalHistory: [
 '2017: Massive data breach disclosed affecting 147 million people',
 '2019: $700 million FTC settlement',
 '2020: Four Chinese military hackers indicted for breach',
 '2020: Former CIO Jun Ying sentenced for insider trading',
 ],
 },
 'general-dynamics': {
 ...
 founded: '1952',
 riskLevel: 'medium' as const,
 description: 'General Dynamics is one of the largest defense contractors in the world, manufacturing nuclear submarines, M1 Abrams tanks, Gulfstream jets, and IT systems for the military and intelligence community. The company has billions in government contracts and exemplifies the revolving door between the Pentagon and the defense industry.',
 employees: '106,000+',
 revenue: '$42 billion (2023)',
 marketCap: '$75+ billion',
 ceo: 'Phebe Novakovic',
 website: 'https://www.gd.com',
 controversies: [
 'REVOLVING DOOR: Executives regularly move between Pentagon and company leadership',
 'COST OVERRUNS: Billions in cost overruns on major defense programs',
 'WEAPONS SALES: Major arms supplier to Saudi Arabia and other authoritarian regimes',
 'LOBBYING: Spends $10+ million annually lobbying for defense spending increases',
 'SURVEILLANCE: GDIT subsidiary provides mass surveillance tools to intelligence agencies',
 'NUCLEAR WEAPONS: Builds Trident submarine-launched ballistic missile systems',
 ],
 subsidiaries: [
 ...
 keyFigures: [
 { name: 'Phebe Novakovic', role: 'CEO and Chairman' },
 { name: 'Jason Aiken', role: 'CFO' },
 ],
 legalHistory: [
 '2009: $4 million settlement for overcharging the Army',
 '2015: Paid $7.5 million for subcontractor fraud claims',
 'Multiple False Claims Act settlements with DOJ',
 ],
 lobbyingSpend: '$12+ million annually',
 governmentContracts: '$25+ billion in active government contracts',
 },
 'hsbc': {
 ...
 founded: '1865',
 riskLevel: 'high' as const,
 description: 'HSBC is one of the largest banking and financial services organizations in the world. The bank paid a record $1.9 billion fine in 2012 for laundering hundreds of millions of dollars for Mexican drug cartels and processing transactions for sanctioned nations including Iran, Libya, and Sudan. Despite the severity of the crimes, no executives were criminally prosecuted under a deferred prosecution agreement.',
 employees: '220,000+',
 revenue: '$66 billion (2023)',
 marketCap: '$155+ billion',
 ceo: 'Noel Quinn (until 2024), Georges Elhedery',
 website: 'https://www.hsbc.com',
 controversies: [
 'MONEY LAUNDERING: Laundered $881 million for Mexican and Colombian drug cartels',
 'SANCTIONS VIOLATIONS: Processed transactions for Iran, Libya, Sudan, and Burma',
 'RECORD FINE: $1.9 billion penalty, largest bank fine at the time',
 'NO PROSECUTION: Deferred prosecution agreement meant no executives jailed',
 'TAX EVASION: Swiss subsidiary helped clients hide $100+ billion from tax authorities',
 'SWISS LEAKS: 2015 leak revealed massive tax evasion facilitation',
 'COMPLIANCE FAILURES: Systematically failed anti-money-laundering controls for years',
 ],
 subsidiaries: [
 'HSBC Bank USA',
 ...
 keyFigures: [
 { name: 'Georges Elhedery', role: 'Group CEO (since 2024)' },
 { name: 'Stuart Gulliver', role: 'Former CEO (during Swiss Leaks scandal)' },
 ],
 legalHistory: [
 '2012: $1.9 billion fine for drug cartel money laundering',
 '2012: Deferred prosecution agreement with DOJ (5 years)',
 '2015: Swiss Leaks tax evasion scandal exposed',
 '2018: Deferred prosecution agreement expired without charges',
 ],
 },
 'johnson-and-johnson': {
 ...
 founded: '1886',
 riskLevel: 'high' as const,
 description: 'Johnson & Johnson is a multinational pharmaceutical and consumer goods corporation. Despite its family-friendly brand image, the company faces tens of billions in liability for its role in the opioid crisis through marketing fentanyl patches and for selling talc-based baby powder linked to cancer. J&J attempted a controversial "Texas Two-Step"bankruptcy maneuver to limit talc liabilities.',
 employees: '131,900+',
 ...
 controversies: [
 'TALC CANCER: $8.9 billion settlement for talc/baby powder cancer lawsuits',
 'OPIOID CRISIS: Marketed Duragesic fentanyl patches and grew opium poppies in Tasmania',
 'BANKRUPTCY MANEUVER:"Texas Two-Step"bankruptcy strategy to avoid talc liabilities',
 'ASBESTOS IN TALC: Internal documents showed company knew of asbestos contamination',
 'OPIOID SETTLEMENT: $5 billion opioid settlement with state and local governments',
 'PRODUCT RECALLS: Multiple recalls of hip implants, contact lenses, and medications',
 'DECEPTIVE MARKETING: Marketed opioids to elderly patients and downplayed addiction risks',
 ],
 subsidiaries: [
 'Janssen Pharmaceuticals',
 'Kenvue (consumer health spin-off)',
 'Ethicon (surgical)',
 ...
 keyFigures: [
 { name: 'Joaquin Duato', role: 'CEO and Chairman' },
 { name: 'Alex Gorsky', role: 'Former CEO (2012-2022)' },
 ],
 legalHistory: [
 '2019: $572 million Oklahoma opioid verdict',
 '2020: $100 million opioid settlement with New York',
 '2022: $8.9 billion talc/baby powder settlement proposed',
 '2023: Texas Two-Step bankruptcy dismissed by courts',
 '2024: $700 million talc settlement with 42 states',
 ],
 },
 'juul-labs': {
 name: 'JUUL Labs, Inc.',
 industry: 'E-cigarettes / Tobacco',
 headquarters: 'Washington, D.C.',
 founded: '2017 (spun off from Pax Labs)',
 riskLevel: 'high' as const,
 description: 'JUUL Labs is an electronic cigarette company that became the dominant e-cigarette brand by marketing sleek, high-nicotine vaping devices that appealed to teenagers. The company triggered a youth vaping epidemic, with millions of minors becoming addicted to nicotine through JUUL products. Altria (Philip Morris parent company) took a 35% stake in JUUL for $12.8 billion.',
 employees: '1,000+',
 revenue: '$1.3 billion (estimated, pre-decline)',
 ceo: 'Scott Dunlap (interim)',
 ...
 'ALTRIA DEAL: 35% stake purchased by Altria (Marlboro maker) for $12.8 billion',
 ],
 subsidiaries: [
 'JUUL Labs International',
 'JUUL Labs Canada',
 ],
 relatedInvestigations: [],
 keyFigures: [
 { name: 'James Monsees', role: 'Co-founder' },
 { name: 'Adam Bowen', role: 'Co-founder' },
 { name: 'Kevin Burns', role: 'Former CEO' },
 ],
 legalHistory: [
 '2020: Criminal probe by FTC into marketing practices',
 '2022: $438.5 million multistate attorney general settlement',
 '2022: FDA marketing denial order issued',
 '2023: $462 million settlement with six states and D.C.',
 ],
 },
 'mckesson': {
 ...
 founded: '1833',
 riskLevel: 'high' as const,
 description: 'McKesson is the largest pharmaceutical distributor in the United States and a Fortune 8 company. As a member of the "Big Three"opioid distributors, McKesson shipped massive quantities of opioid painkillers across the country while failing to report suspicious orders as required by law. The company is part of a $21 billion opioid settlement with state and local governments.',
 employees: '51,000+',
 revenue: '$309 billion (2023)',
 marketCap: '$72+ billion',
 ceo: 'Brian Tyler',
 website: 'https://www.mckesson.com',
 controversies: [
 'OPIOID CRISIS: Distributed billions of opioid pills while ignoring suspicious order indicators',
 'SETTLEMENT: $7.9 billion share of $21 billion national opioid settlement',
 'DEA VIOLATIONS: Repeatedly failed to report suspicious orders to the DEA',
 'PROFIT MOTIVE: Revenue from controlled substance distribution drove growth',
 'COMPLIANCE FAILURES: Antiquated monitoring systems inadequate for detecting suspicious orders',
 'EXECUTIVE PAY: CEO compensation exceeded $20 million during peak of opioid crisis',
 'LOBBYING: Spent millions lobbying against stricter distribution oversight',
 ],
 subsidiaries: [
 ...
 keyFigures: [
 { name: 'Brian Tyler', role: 'CEO' },
 { name: 'John Hammergren', role: 'Former CEO (2001-2019)' },
 ],
 legalHistory: [
 '2008: $13.25 million DEA settlement',
 '2017: $150 million DEA fine for controlled substance violations',
 '2022: $7.9 billion national opioid settlement share',
 ],
 },
 'procter-gamble': {
 ...
 founded: '1837',
 riskLevel: 'medium' as const,
 description: 'Procter & Gamble is the world\'s largest consumer goods company, producing household brands like Tide, Pampers, and Gillette. Despite its mainstream appeal, P&G has faced significant criticism for environmental destruction through palm oil sourcing, gender discrimination lawsuits, and aggressive pricing practices.',
 employees: '107,000+',
 ...
 controversies: [
 'DEFORESTATION: Linked to rainforest destruction for palm oil sourcing in Southeast Asia',
 'ENVIRONMENTAL: Major plastic pollution contributor through single-use product packaging',
 'DISCRIMINATION: Gender and race discrimination lawsuits from employees',
 'PRICE GOUGING: Accused of coordinated price increases during inflation periods',
 'GREENWASHING: Marketing sustainability claims contradicted by supply chain practices',
 'ANIMAL TESTING: Continued animal testing for product development despite alternatives',
 ],
 subsidiaries: [
 'Gillette',
 ...
 relatedInvestigations: [],
 keyFigures: [
 { name: 'Jon Moeller', role: 'CEO and Chairman' },
 { name: 'David Taylor', role: 'Former CEO (2015-2021)' },
 ],
 legalHistory: [
 '2016: $750 million price-fixing settlement (European Commission)',
 '2017: Gender discrimination class action filed',
 'Multiple environmental violation fines across manufacturing facilities',
 ],
 },
 'saudi-aramco': {
 ...
 founded: '1933',
 riskLevel: 'high' as const,
 description: 'Saudi Aramco is the world\'s most profitable company and the largest oil producer, state-owned by the Kingdom of Saudi Arabia. The company is the single largest contributor to global carbon emissions in history. Aramco\'s influence extends into U.S. politics through the Saudi sovereign wealth fund, which invested $2 billion in Jared Kushner\'s private equity firm shortly after he left the White House.',
 employees: '70,000+',
 revenue: '$535 billion (2022)',
 marketCap: '$2+ trillion',
 ceo: 'Amin H. Nasser',
 website: 'https://www.aramco.com',
 controversies: [
 'CLIMATE DESTRUCTION: Largest single corporate contributor to global carbon emissions',
 'EMISSIONS COVER-UP: Knew about climate change for decades while funding disinformation',
 'KUSHNER CONNECTION: Saudi sovereign fund invested $2 billion in Kushner firm after White House',
 'HUMAN RIGHTS: Operations in Saudi Arabia under regime with severe human rights abuses',
 'JOURNALIST MURDER: Saudi state (Aramco owner) ordered murder of Jamal Khashoggi',
 'IPO MANIPULATION: Pressured Saudi citizens and institutions to inflate IPO demand',
 'LOBBYING: Funds extensive lobbying against climate legislation worldwide',
 ],
 subsidiaries: [
 'Saudi Aramco Total Refining (SATORP)',
 'Motiva Enterprises (U.S.)',
 'S-Oil (South Korea)',
 'SABIC (Saudi Basic Industries)',
 ],
 relatedInvestigations: [
 { title: 'Kushner-Saudi Deal', slug: 'kushner-saudi-deal', severity: 'critical' },
 { title: 'Climate Disinformation', slug: 'climate-disinformation', severity: 'high' },
 ],
 keyFigures: [
 { name: 'Amin H. Nasser', role: 'President and CEO' },
 { name: 'Yasir Al-Rumayyan', role: 'Chairman' },
 { name: 'Mohammed bin Salman', role: 'Saudi Crown Prince (de facto owner)' },
 ],
 legalHistory: [
 '2019: IPO raised $25.6 billion amid controversy',
 '2020: Oil price war crashed global energy markets',
 'Multiple climate litigation cases filed in U.S. and European courts',
 ],
 },
 'unitedhealth-group': {
 ...
 founded: '1977',
 riskLevel: 'high' as const,
 description: 'UnitedHealth Group is the largest health insurance company in the United States and one of the largest corporations by revenue. Through its Optum subsidiary, UnitedHealth has vertically integrated across insurance, pharmacy benefits, and healthcare delivery, raising antitrust concerns. The company faces DOJ investigation and widespread criticism for systematic claim denials and algorithmic coverage decisions that prioritize profits over patient care.',
 employees: '400,000+',
 revenue: '$372 billion (2023)',
 marketCap: '$450+ billion',
 ceo: 'Andrew Witty',
 website: 'https://www.unitedhealthgroup.com',
 controversies: [
 'CLAIM DENIALS: Systematic denial of medical claims using AI/algorithmic decision-making',
 'ANTITRUST: DOJ antitrust investigation into vertical integration practices',
 'OPTUM INTEGRATION: Vertical integration of insurance, pharmacy, and care raises monopoly concerns',
 'EXECUTIVE PAY: CEO compensation exceeds $20 million while denying patient claims',
 'PRIOR AUTHORIZATION: Excessive prior authorization requirements delaying critical care',
 'DATA BREACH: 2024 Change Healthcare cyberattack exposed data of 100+ million people',
 'LOBBYING: Largest health sector lobbying spender at $10+ million annually',
 ],
 subsidiaries: [
 'Optum Health',
 ...
 { name: 'Stephen Hemsley', role: 'Former CEO and Board Member' },
 ],
 legalHistory: [
 '2023: DOJ antitrust investigation opened',
 '2024: Change Healthcare breach, largest healthcare data breach in U.S. history',
 '2024: Multiple state investigations into claim denial practices',
 'Multiple class action lawsuits over coverage denials',
 ],
 },
 'walmart': {
 name: 'Walmart Inc.',
 ...
 founded: '1962',
 riskLevel: 'high' as const,
 description: 'Walmart is the world\'s largest company by revenue and the largest private employer. The retail giant agreed to pay $3.1 billion to settle opioid crisis lawsuits over its pharmacy operations. Walmart has a long history of labor violations, anti-union practices, poverty-level wages, and destroying local businesses, all while the Walton family has accumulated over $200 billion in wealth.',
 employees: '2,100,000+',
 revenue: '$648 billion (2024)',
 marketCap: '$550+ billion',
 ceo: 'Doug McMillon',
 website: 'https://www.walmart.com',
 controversies: [
 'OPIOID CRISIS: $3.1 billion settlement for pharmacy role in opioid epidemic',
 'POVERTY WAGES: Employees rely on food stamps and Medicaid while Walton family worth $200B+',
 'ANTI-UNION: Aggressive union busting including closing stores that unionize',
 'LABOR VIOLATIONS: Wage theft, forced overtime, and child labor violations',
 'DISCRIMINATION: Major gender discrimination class action (Dukes v. Walmart)',
 'COMMUNITY DESTRUCTION: Drives local businesses to closure upon entering markets',
 'SUPPLY CHAIN: Suppliers in developing nations face exploitative conditions',
 ],
 subsidiaries: [
 'Sam\'s Club',
 'Walmart International',
 'Flipkart (India)',
 'Walmart Health (closed 2024)',
 ],
 relatedInvestigations: [
 { title: 'The Opioid Crisis', slug: 'opioid-crisis', severity: 'critical' },
 ],
 keyFigures: [
 { name: 'Doug McMillon', role: 'CEO and President' },
 { name: 'Rob Walton', role: 'Former Chairman, Walton family heir' },
 { name: 'Alice Walton', role: 'Walton family heir, richest woman in the world' },
 ],
 legalHistory: [
 '2011: Supreme Court ruled against class action in Dukes v. Walmart',
 '2019: $282 million FCPA settlement for bribery in Mexico, Brazil, India, China',
 '2022: $3.1 billion opioid settlement with state and local governments',
 'Hundreds of wage theft and labor violation settlements nationwide',
 ],
 },
 '3m-company': {
 name: '3M Company',
 ...
 founded: '1902',
 riskLevel: 'high' as const,
 description: '3M Company (formerly Minnesota Mining and Manufacturing) is one of the largest producers of PFAS"forever chemicals"alongside DuPont. The company knowingly manufactured and disposed of PFAS compounds that contaminated water supplies nationwide, affecting millions of Americans. Internal documents revealed 3M was aware of health risks for decades but concealed the information. The company agreed to multi-billion dollar settlements to address the crisis.',
 employees: '92,000+',
 revenue: '$34 billion',
 ceo: 'William Brown',
 website: 'https://www.3m.com',
 controversies: [
 'PFAS"forever chemical"manufacturing and nationwide water contamination',
 'Internal knowledge of PFAS health risks concealed for decades',
 'Multi-billion dollar settlement agreements ($10.3B for public water systems)',
 'Environmental contamination of groundwater and drinking water',
 'Military earplug defect lawsuits ($6B settlement)',
 'Dumping PFAS waste near communities',
 'Lobbying against PFAS regulation',
 ],
 subsidiaries: [
 '3M Health Care (spun off as Solventum)', '3M Industrial', '3M Consumer',
 ],
 relatedInvestigations: [
 { title: 'Water Contamination Nationwide', slug: 'water-contamination-nationwide', severity: 'critical' },
 ],
 keyFigures: [
 { name: 'William Brown', role: 'CEO (2024-present)' },
 { name: 'Mike Roman', role: 'Former CEO (2018-2024)' },
 ],
 legalHistory: [
 '2023: $10.3 billion settlement for PFAS contamination of public water systems',
 '2023: $6 billion settlement for military earplug defects',
 'Ongoing state and federal lawsuits over PFAS contamination',
 'Multiple EPA enforcement actions for environmental violations',
 ],
 },
 'arthur-andersen': {
 ...
 founded: '1913 (dissolved 2002)',
 riskLevel: 'critical' as const,
 description: 'Arthur Andersen was one of the "Big Five"accounting firms and served as Enron\'s auditor. The firm was convicted of obstruction of justice for shredding tons of Enron-related documents after the SEC opened its investigation. Although the Supreme Court later overturned the conviction, the firm had already collapsed, surrendering its CPA licenses and losing virtually all clients. The Enron scandal and Andersen\'s role led directly to the Sarbanes-Oxley Act.',
 employees: '85,000 (at peak before dissolution)',
 revenue: 'N/A (dissolved)',
 ceo: 'Joseph Berardino (final CEO)',
 controversies: [
 'Enron audit failures, approved fraudulent financial statements for years',
 'OBSTRUCTION: Mass shredding of Enron documents after SEC investigation began',
 'Criminal conviction for obstruction of justice (2002)',
 'Collapse of firm - 85,000 employees lost jobs',
 'Supreme Court overturned conviction (2005) but firm already destroyed',
 'Pattern of audit failures: Waste Management, WorldCom, Sunbeam',
 'Led to passage of Sarbanes-Oxley Act',
 ],
 subsidiaries: [
 ...
 keyFigures: [
 { name: 'Joseph Berardino', role: 'Final CEO' },
 { name: 'David Duncan', role: 'Lead Enron auditor, ordered shredding' },
 { name: 'Nancy Temple', role: 'In-house counsel, directed document destruction policy' },
 ],
 legalHistory: [
 '2002: Convicted of obstruction of justice for shredding Enron documents',
 '2002: Surrendered CPA licenses, effectively dissolved',
 '2005: Supreme Court unanimously overturned conviction (Arthur Andersen LLP v. United States)',
 'Multiple civil settlements from Enron-related lawsuits',
 ],
 },
 'dominion-voting': {
 name: 'Dominion Voting Systems',
 ...
 founded: '2002',
 riskLevel: 'low' as const,
 description: 'Dominion Voting Systems is a voting technology company that became the target of baseless conspiracy theories after the 2020 presidential election. Fox News and other right-wing media outlets falsely claimed Dominion machines were used to steal the election. Dominion sued Fox News for defamation and won a record $787.5 million settlement. Dominion was the VICTIM of disinformation, not a perpetrator, included here as a referenced entity.',
 employees: '300+',
 revenue: 'Not publicly disclosed',
 ceo: 'John Poulos',
 website: 'https://www.dominionvoting.com',
 controversies: [
 'TARGET of baseless election fraud conspiracy theories after 2020 election',
 '$787.5 million defamation settlement from Fox News (2023)',
 'Ongoing $1.6 billion defamation lawsuit against Newsmax',
 'Lawsuits against Sidney Powell, Rudy Giuliani, Mike Lindell, and others',
 'NOTE: Dominion was the VICTIM of propaganda, not a perpetrator',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Fox News Propaganda', slug: 'fox-news-propaganda', severity: 'critical' },
 { title: 'Election Denial', slug: 'election-denial', severity: 'critical' },
 ],
 keyFigures: [
 { name: 'John Poulos', role: 'CEO and Co-founder' },
 ],
 legalHistory: [
 '2023: $787.5 million settlement from Fox News defamation case',
 '2023: Sidney Powell settled defamation case (undisclosed amount)',
 'Ongoing: $1.6 billion lawsuit against Newsmax',
 'Ongoing: Lawsuits against Rudy Giuliani, Mike Lindell, Patrick Byrne',
 ],
 financialNotes: 'Dominion is a legitimate election technology company whose equipment has been repeatedly audited and verified. The company was vindicated through the legal process.',
 },
 'harris-corporation': {
 name: 'Harris Corporation (now L3Harris Technologies)',
 ticker: 'LHX',
 industry: 'Defense / Surveillance Technology',
 headquarters: 'Melbourne, Florida',
 founded: '1895 (merged into L3Harris 2019)',
 riskLevel: 'high' as const,
 description: 'Harris Corporation (now L3Harris Technologies after its 2019 merger with L3 Technologies) is the manufacturer of the StingRay cell-site simulator, a controversial surveillance device used by law enforcement agencies to intercept cell phone communications. Harris requires law enforcement agencies to sign strict non-disclosure agreements, effectively hiding the technology\'s use from courts and the public. The devices enable warrantless mass surveillance.',
 employees: '47,000+ (as L3Harris)',
 revenue: '$18 billion+ (as L3Harris)',
 marketCap: '$42+ billion',
 ceo: 'Christopher Kubasik (L3Harris CEO)',
 website: 'https://www.l3harris.com',
 controversies: [
 'Manufacturing StingRay cell-site simulators for mass surveillance',
 'Requiring law enforcement to sign non-disclosure agreements hiding device use',
 'Enabling warrantless surveillance of cell phone communications',
 'Devices intercept data from ALL phones in range, not just targets',
 'Cases dismissed rather than reveal StingRay use due to NDAs',
 'Lobbying against transparency and oversight of surveillance tech',
 'Selling surveillance technology to authoritarian governments',
 ],
 subsidiaries: [
 'L3Harris Technologies', 'Harris Defense', 'Harris Surveillance Solutions',
 ],
 relatedInvestigations: [
 { title: 'StingRay Surveillance', slug: 'stingray-surveillance', severity: 'high' },
 ],
 keyFigures: [
 { name: 'Christopher Kubasik', role: 'CEO, L3Harris Technologies' },
 { name: 'William Brown', role: 'Former CEO, Harris Corporation' },
 ],
 lobbyingSpend: '$5+ million annually',
 governmentContracts: '$8+ billion annually (L3Harris)',
 },
 'raytheon': {
 name: 'Raytheon Company (now RTX Corporation)',
 industry: 'Defense / Aerospace',
 headquarters: 'Arlington, Virginia (formerly Waltham, Massachusetts)',
 founded: '1922 (merged into RTX 2020)',
 riskLevel: 'critical' as const,
 description: 'Raytheon Company was a major American defense contractor that manufactured precision-guided munitions used extensively in the Saudi-led coalition\'s bombing campaign in Yemen. Raytheon-made bombs were identified at the sites of strikes that killed civilians, including children. The company aggressively lobbied for continued arms sales to Saudi Arabia despite evidence of war crimes. Raytheon merged with United Technologies in 2020 to form RTX Corporation.',
 employees: '185,000+ (as RTX)',
 revenue: '$67 billion+ (as RTX)',
 marketCap: '$145+ billion (as RTX)',
 ceo: 'Chris Calio (RTX CEO)',
 website: 'https://www.rtx.com',
 controversies: [
 'Precision-guided munitions used in Saudi bombing of Yemen civilians',
 'Raytheon-made bombs identified at sites of school bus attacks and weddings',
 'Aggressive lobbying for continued Saudi Arabia arms sales',
 'Profiting from Yemen humanitarian crisis, worst in the world',
 'Revolving door between Raytheon executives and Pentagon officials',
 'Former Raytheon lobbyist Mark Esper served as Secretary of Defense',
 'Billions in arms sales to repressive regimes',
 'War profiteering allegations across multiple conflicts',
 ],
 subsidiaries: [
 'Raytheon Missiles & Defense', 'Raytheon Intelligence & Space',
 ],
 relatedInvestigations: [
 { title: 'Yemen War', slug: 'yemen-war', severity: 'critical' },
 { title: 'Military Industrial Complex', slug: 'military-industrial-complex', severity: 'high' },
 { title: 'Saudi Arms Sales', slug: 'saudi-arms-sales', severity: 'critical' },
 ],
 keyFigures: [
 { name: 'Chris Calio', role: 'CEO, RTX Corporation' },
 { name: 'Mark Esper', role: 'Former Raytheon lobbyist, became Secretary of Defense', href: '/entities/individuals/mark-esper' },
 { name: 'Thomas Kennedy', role: 'Former Raytheon CEO' },
 ],
 legalHistory: [
 '2020: Merged with United Technologies to form RTX Corporation',
 '2022: $950 million settlement for defective pricing on defense contracts',
 'Multiple investigations into foreign arms sales practices',
 'Ongoing scrutiny over weapons used in Yemen civilian casualties',
 ],
 lobbyingSpend: '$11+ million annually',
 governmentContracts: '$20+ billion annually',
 ...
 riskLevel: 'medium',
 description: 'Elite Manhattan private prep school where Jeffrey Epstein was hired as a math and physics teacher at age 20 in 1973 despite lacking a college degree. He was hired by headmaster Donald Barr, whose son William Barr later became Attorney General overseeing the prison where Epstein died.',
 founded: '1919',
 headquarters: 'New York City, NY',
 employees: '350+',
 revenue: '$60M+',
 ceo: 'Jim Best (Head of School)',
 controversies: [
 'Hired unqualified 20-year-old Epstein',
 'Donald Barr connection to future AG William Barr',
 'Epstein reportedly fired for inappropriate behavior with students',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 ...
 keyFigures: [
 { name: 'Donald Barr', role: 'Headmaster (1964-1974)', href: '/entities/individuals/donald-barr' },
 ],
 },
 'harvard-university': {
 ...
 riskLevel: 'high',
 description: 'Received $9M+ in donations from Jeffrey Epstein. Epstein maintained an office in Harvard\'s Department of Evolutionary Biology after his 2008 conviction. Martin Nowak ran an Epstein-funded program. Professor Alan Dershowitz represented Epstein legally. Larry Summers met with Epstein during his Harvard presidency.',
 founded: '1636',
 headquarters: 'Cambridge, MA',
 employees: '20,000+',
 revenue: '$5.8B',
 ceo: 'Alan Garber (President)',
 controversies: [
 'Accepted $9M+ from Epstein',
 'Epstein maintained campus office post-conviction',
 'Nowak\'s Epstein-funded program',
 'Failed to sever ties after conviction',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 keyFigures: [
 { name: 'Larry Summers', role: 'Former President', href: '/entities/individuals/larry-summers' },
 { name: 'Martin Nowak', role: 'PED Director', href: '/entities/individuals/martin-nowak' },
 ],
 },
 'mit': {
 ...
 industry: 'Higher Education',
 riskLevel: 'high',
 description: 'MIT Media Lab under Joi Ito accepted and concealed funding from Epstein after his conviction. Ito referred to Epstein internally as "Voldemort."Marvin Minsky, MIT AI pioneer, was named in victim depositions. MIT accepted the funding knowingly.',
 founded: '1861',
 headquarters: 'Cambridge, MA',
 employees: '13,000+',
 revenue: '$3.8B',
 ceo: 'Sally Kornbluth (President)',
 controversies: [
 'Hidden Epstein funding at Media Lab',
 'Marvin Minsky named in victim depositions',
 'Institutional concealment of donor identity',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 keyFigures: [
 { name: 'Joi Ito', role: 'Former Media Lab Director', href: '/entities/individuals/joi-ito' },
 { name: 'Marvin Minsky', role: 'AI Lab Co-Founder (Deceased)', href: '/entities/individuals/marvin-minsky' },
 ],
 },
 'ohio-state': {
 ...
 industry: 'Higher Education',
 riskLevel: 'medium',
 description: 'Les Wexner, Epstein\'s primary financial backer, was the largest individual donor to Ohio State. The Wexner Foundation and Wexner Center for the Arts gave Wexner enormous institutional influence.',
 founded: '1870',
 headquarters: 'Columbus, OH',
 employees: '50,000+',
 revenue: '$8.6B',
 ceo: 'Walter Carter Jr. (President)',
 controversies: [
 'Wexner\'s largest donor status and Epstein ties',
 'Wexner Foundation influence',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 keyFigures: [
 { name: 'Les Wexner', role: 'Largest Donor', href: '/entities/individuals/les-wexner' },
 ],
 },
 'mc2': {
 name: 'MC2 Model Management',
 industry: 'Modeling Agency',
 riskLevel: 'critical',
 description: 'Jean-Luc Brunel\'s modeling agency funded by Epstein that served as a trafficking pipeline. Brought young models (some underage) from South America, Eastern Europe, and France to the US on work visas arranged by Epstein\'s attorneys. MC2 was a key front for the trafficking operation.',
 founded: '2005',
 headquarters: 'Miami, FL / New York City',
 employees: '20+',
 revenue: 'Unknown',
 ceo: 'Jean-Luc Brunel (Deceased)',
 controversies: [
 'Key trafficking front operation',
 'Recruited underage models internationally',
 'Work visa fraud for trafficking victims',
 'Funded directly by Epstein',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 riskLevel: 'medium',
 description: 'Prestigious arts camp for young people in Michigan that received donations from Epstein. A lodge was named after him before being renamed. The camp provided Epstein access to young aspiring artists and performers.',
 founded: '1928',
 headquarters: 'Interlochen, MI',
 employees: '500+',
 revenue: '$50M+',
 ceo: 'Trey Devey (President)',
 controversies: [
 'Accepted Epstein donations',
 'Named lodge after him',
 'Provided access to young performers',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 industry: 'Investment Banking',
 riskLevel: 'medium',
 description: 'Major investment bank where Epstein worked as an options trader from 1976 to 1981. Rose to limited partner despite lacking a college degree. Made the connections that launched his independent financial career. Bear Stearns collapsed in 2008 financial crisis.',
 founded: '1923',
 headquarters: 'New York City (Historical)',
 employees: '0 (Acquired by JPMorgan 2008)',
 revenue: 'N/A (Defunct)',
 ceo: 'N/A (Defunct)',
 controversies: [
 'Hired unqualified Epstein',
 'SEC investigation while Epstein was there',
 'Collapsed in 2008 financial crisis',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 riskLevel: 'high',
 description: 'Shell company established by Epstein in the US Virgin Islands to gain tax advantages and reduced regulatory oversight for his financial operations.',
 founded: '1995',
 headquarters: 'US Virgin Islands',
 employees: 'Unknown',
 revenue: 'Unknown',
 ceo: 'Jeffrey Epstein (Deceased)',
 controversies: [
 'Tax avoidance scheme',
 'Reduced regulatory oversight',
 'Part of complex shell company network',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 industry: 'Financial Services',
 riskLevel: 'high',
 description: 'USVI-based entity in Epstein\'s financial web. Received significant tax benefits. USVI AG later sued estate alleging benefits were obtained through fraud.',
 founded: '1990s',
 headquarters: 'US Virgin Islands',
 employees: 'Unknown',
 revenue: 'Unknown',
 ceo: 'Jeffrey Epstein (Deceased)',
 controversies: [
 'Tax benefits obtained through alleged fraud',
 'Part of Epstein shell company network',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 industry: 'Holding Company',
 riskLevel: 'medium',
 description: 'LLC controlled by Ghislaine Maxwell used to purchase the Bradford, New Hampshire property where she was eventually arrested by the FBI in July 2020.',
 founded: '2019',
 headquarters: 'Bradford, NH',
 employees: '0',
 revenue: 'N/A',
 ceo: 'Ghislaine Maxwell',
 controversies: [
 'Used to conceal Maxwell\'s location',
 'Part of Maxwell\'s asset concealment efforts',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 keyFigures: [
 { name: 'Ghislaine Maxwell', role: 'Controller', href: '/entities/individuals/ghislaine-maxwell' },
 ],
 },
 'apollo-global': {
 ...
 industry: 'Private Equity',
 riskLevel: 'high',
 description: 'One of the world\'s largest alternative asset managers. CEO Leon Black paid Epstein $158M in"advisory fees"between 2012-2017 after his sex offender conviction. Black stepped down as CEO in 2021.',
 founded: '1990',
 ...
 ceo: 'Marc Rowan',
 controversies: [
 'CEO paid $158M to convicted sex offender',
 'Questions about leverage Epstein had over Black',
 'Black stepped down amid scrutiny',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 keyFigures: [
 { name: 'Leon Black', role: 'Former CEO', href: '/entities/individuals/leon-black' },
 ],
 },
 'towers-financial': {
 name: 'Towers Financial Corporation',
 industry: 'Financial Services (Ponzi Scheme)',
 riskLevel: 'critical',
 description: 'Steven Hoffenberg\'s $475M Ponzi scheme where Epstein served as a consultant. Hoffenberg claimed Epstein was an equal partner in the fraud. The company collapsed in 1993. Critical origin story for Epstein\'s mysterious wealth.',
 founded: '1983',
 headquarters: 'New York City',
 employees: '0 (Defunct)',
 revenue: 'N/A (Fraud)',
 ceo: 'Steven Hoffenberg (Deceased)',
 controversies: [
 '$475M Ponzi scheme',
 'Epstein allegedly was equal partner',
 ...
 keyFigures: [
 { name: 'Steven Hoffenberg', role: 'CEO (Deceased)', href: '/entities/individuals/steven-hoffenberg' },
 ],
 },
 ...
 riskLevel: 'low',
 description: 'Epstein served on the Mind, Brain, and Behavior advisory committee at Rockefeller University, using the position for scientific credibility.',
 founded: '1901',
 headquarters: 'New York City',
 employees: '3,200+',
 revenue: '$350M',
 ceo: 'Richard Lifton (President)',
 controversies: [
 'Epstein served on advisory committee',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 industry: 'Modeling Agency',
 riskLevel: 'high',
 description: 'French modeling agency connected to Jean-Luc Brunel\'s trafficking network. Supplied models for events that served as cover for recruiting victims from France and Europe.',
 founded: '1970s',
 ...
 ceo: 'Unknown',
 controversies: [
 'Connected to Brunel trafficking pipeline',
 'Supplied models used as recruitment cover',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
 ...
 keyFigures: [
 { name: 'Jean-Luc Brunel', role: 'Connected Agent (Deceased)', href: '/entities/individuals/jean-luc-brunel' },
 ],
 },
 'columbus-nova': {
 name: 'Columbus Nova',
 ...
 riskLevel: 'medium',
 description: 'Investment firm connected to Russian oligarch Viktor Vekselberg. Financial connections between Epstein\'s network and Russian money raise questions about intelligence interests.',
 founded: '2000',
 headquarters: 'New York City',
 employees: '50+',
 revenue: 'Unknown',
 ceo: 'Andrew Intrater',
 controversies: [
 'Links to Russian oligarch Vekselberg',
 'Epstein network financial connections',
 'Vekselberg sanctioned by US government',
 ],
 subsidiaries: [],
 relatedInvestigations: [
 { title: 'Epstein Network Complicity', slug: 'epstein-network', severity: 'critical' },
...
export default function CorporationContent() {
 ...
 useEffect(() => {
 if (slugParam) setSlug(slugParam as string);
 }, [slugParam]);
