...
export default function EntitiesPage() {
 ...
 className="group block border-2 border-[rgba(80,180,255,0.15)] bg-[#000819] p-8 hover:border-blood-700 transition-all duration-300"
 >
 ...
 {/* Info Section - Sharp */}
 <div className="border-2 border-[rgba(80,180,255,0.15)] bg-[#000819] p-8 lg:p-12">
 ...
 <div className="p-5 border border-[rgba(80,180,255,0.15)] bg-zinc-900">
