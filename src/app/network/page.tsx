      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-red-500/[0.06] border border-red-500/20 flex items-center justify-center" style={{ borderRadius: 12 }}>
        ...
        <div className="mt-12">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-red-500/[0.06] border border-red-500/20 flex items-center justify-center" style={{ borderRadius: 12 }}>
