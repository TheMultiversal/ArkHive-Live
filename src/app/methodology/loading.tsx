...
export default function MethodologyLoading() {
 ...
 <div className="h-12 w-64 bg-[#000a1c] animate-pulse mx-auto mb-4"/>
 <div className="h-6 w-96 bg-zinc-900 animate-pulse mx-auto"/>
 </div>

 {/* Principles grid */}
 <div className="mb-16">
 <div className="h-8 w-48 bg-[#000c20] animate-pulse mb-8"/>
 ...
 <div className="h-6 w-32 bg-[#000c20] animate-pulse mb-3"/>
 ...
 {/* Evidence types */}
 <div className="mb-16">
 <div className="h-8 w-40 bg-[#000c20] animate-pulse mb-8"/>
 ...
 <div className="h-5 w-40 bg-[#000c20] animate-pulse mb-2"/>
 ...
 {/* Process steps */}
 <div>
 <div className="h-8 w-32 bg-[#000c20] animate-pulse mb-8"/>
 ...
 <div className="flex-1">
 <div className="h-6 w-48 bg-[#000c20] animate-pulse mb-2"/>
 <div className="h-4 w-full bg-zinc-900 animate-pulse"/>
 </div>
 </motion.div>
 ))}
