...
export default function MethodologyLoading() {
 ...
 <div className="h-12 w-64 bg-[rgba(0,10,28,0.85)] animate-pulse mx-auto mb-4"/>
 <div className="h-6 w-96 bg-zinc-900/60 animate-pulse mx-auto"/>
 </div>

 {/* Principles grid */}
 <div className="mb-16">
 <div className="h-8 w-48 bg-[rgba(0,12,32,0.85)] animate-pulse mb-8"/>
 ...
 <div className="h-6 w-32 bg-[rgba(0,12,32,0.85)] animate-pulse mb-3"/>
 ...
 {/* Evidence types */}
 <div className="mb-16">
 <div className="h-8 w-40 bg-[rgba(0,12,32,0.85)] animate-pulse mb-8"/>
 ...
 <div className="h-5 w-40 bg-[rgba(0,12,32,0.85)] animate-pulse mb-2"/>
 ...
 {/* Process steps */}
 <div>
 <div className="h-8 w-32 bg-[rgba(0,12,32,0.85)] animate-pulse mb-8"/>
 ...
 <div className="flex-1">
 <div className="h-6 w-48 bg-[rgba(0,12,32,0.85)] animate-pulse mb-2"/>
 <div className="h-4 w-full bg-zinc-900/60 animate-pulse"/>
 </div>
 </motion.div>
 ))}
