...
export default function SearchPage() {
 ...
 className="w-full pl-12 pr-12 py-4 bg-[#000a1c] border border-[rgba(80,180,255,0.15)] text-white text-lg placeholder-zinc-500 focus:outline-none focus:border-blood-500 transition-colors"
 autoFocus
 />
 {query && (
 <button
 ...
 : 'bg-[#000a1c] text-zinc-400 hover:text-white hover:bg-[#000c20]'
 )}
 >
 ...
 showFilters
 ? 'bg-blood-600 text-white'
 : 'bg-[#000a1c] text-zinc-400 hover:text-white'
 )}
 >
 ...
 className="px-4 py-2 bg-[#000a1c] border border-[rgba(80,180,255,0.15)] text-zinc-300 text-sm focus:outline-none focus:border-blood-500"
 >
 ...
 viewMode === 'list' ? 'bg-[#000c20] text-white' : 'text-zinc-500 hover:text-white'
 )}
 >
 ...
 className={cn(
 'p-2 transition-colors',
 viewMode === 'grid' ? 'bg-[#000c20] text-white' : 'text-zinc-500 hover:text-white'
 )}
 >
 ...
 className="bg-[#000a1c] border border-[rgba(80,180,255,0.15)] p-6 mb-6"
 >
 ...
 className="flex-1 px-3 py-2 bg-[#000c20] border border-[rgba(60,160,255,0.18)] text-white text-sm"
 />
 <input
 type="date"
 value={dateRange.to}
 ...
 <button
 key={sev}
 className="px-3 py-1 text-xs bg-[#000c20] text-zinc-300 hover:bg-zinc-700 capitalize"
 >
 {sev}
 </button>
 ))}
...
function SearchResultCard({ 
 ...
 href={getLink()}
 className={cn(
 'block bg-[#000a1c] border border-[rgba(80,180,255,0.15)] p-4 hover:border-blood-500/50 transition-colors group',
 viewMode === 'list' && 'flex gap-4'
 )}
 >
 <div className={cn(
 'flex items-center justify-center bg-[#000c20] text-zinc-400 group-hover:text-blood-500 transition-colors',
 ...
 <span className="text-xs px-2 py-0.5 bg-[#000c20] text-zinc-400 capitalize">
 {result.type}
 </span>
 {result.severity && (
 <span className={cn(
