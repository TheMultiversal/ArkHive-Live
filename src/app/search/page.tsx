...
export default function SearchPage() {
 ...
 className="w-full pl-12 pr-12 py-4 bg-[rgba(0,10,28,0.85)] border border-[rgba(80,180,255,0.15)] text-white text-lg placeholder-zinc-500 focus:outline-none focus:border-blood-500 transition-colors"
 autoFocus
 />
 {query && (
 <button
 ...
 : 'bg-[rgba(0,10,28,0.85)] text-zinc-400 hover:text-white hover:bg-[rgba(0,12,32,0.85)]'
 )}
 >
 ...
 className="px-4 py-2 bg-[rgba(0,10,28,0.85)] border border-[rgba(80,180,255,0.15)] text-zinc-300 text-sm focus:outline-none focus:border-blood-500"
 >
 ...
 <div className="flex border border-[rgba(80,180,255,0.15)]">
 <button
 onClick={() => setViewMode('list')}
 className={cn(
 'p-2 transition-colors',
 viewMode === 'list' ? 'bg-[rgba(0,12,32,0.85)] text-white' : 'text-zinc-500 hover:text-white'
 )}
 >
 ...
 className={cn(
 'p-2 transition-colors',
 viewMode === 'grid' ? 'bg-[rgba(0,12,32,0.85)] text-white' : 'text-zinc-500 hover:text-white'
 )}
 >
 ...
 className="bg-[rgba(0,10,28,0.85)] border border-[rgba(80,180,255,0.15)] p-6 mb-6"
 >
 ...
 className="flex-1 px-3 py-2 bg-[rgba(0,12,32,0.85)] border border-[rgba(60,160,255,0.18)] text-white text-sm"
 />
 <input
 type="date"
 value={dateRange.to}
 ...
 <button
 key={sev}
 className="px-3 py-1 text-xs bg-[rgba(0,12,32,0.85)] text-zinc-300 hover:bg-zinc-700 capitalize"
 >
 {sev}
 </button>
 ))}
...
function SearchResultCard({ 
 ...
 href={getLink()}
 className={cn(
 'block bg-[rgba(0,10,28,0.82)] border border-[rgba(80,180,255,0.15)] p-4 hover:border-blood-500/50 transition-colors group',
 viewMode === 'list' && 'flex gap-4'
 )}
 >
 <div className={cn(
 'flex items-center justify-center bg-[rgba(0,12,32,0.85)] text-zinc-400 group-hover:text-blood-500 transition-colors',
 ...
 <span className="text-xs px-2 py-0.5 bg-[rgba(0,12,32,0.85)] text-zinc-400 capitalize">
 {result.type}
 </span>
 {result.severity && (
 <span className={cn(
