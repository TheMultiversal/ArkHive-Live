...
export default function TimelinePage() {
 ...
 {/* Header */}
 <div className="py-12">
 <div className="border-2 border-blood-800/50 bg-[rgba(0,15,40,0.50)] p-8 text-center">
 ...
 {/* Timeline Line */}
 <div className="absolute left-8 top-0 bottom-0 w-[2px] bg-[rgba(0,30,80,0.40)]"/>
 ...
 {/* Card */}
 <div className="border border-[rgba(60,160,255,0.12)] bg-[rgba(0,20,55,0.40)] p-5 hover:border-blood-500/50 hover:bg-zinc-900/80 transition-all">
 ...
 {event.tags.map(tag => (
 <span key={tag} className="text-xs px-2 py-1 bg-[rgba(0,30,80,0.40)] text-zinc-500">
 {tag}
 </span>
 ))}
 </div>
