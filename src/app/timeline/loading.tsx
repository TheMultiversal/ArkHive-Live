...
export default function TimelineLoading() {
 ...
 <div className="h-10 w-64 bg-[rgba(0,20,55,0.50)] animate-pulse mx-auto mb-4"/>
 ...
 {/* Vertical line */}
 <div className="absolute left-1/2 transform -translate-x-1/2 w-px h-full bg-[rgba(0,30,80,0.40)]"/>
 ...
 <div className="h-6 w-full bg-[rgba(0,30,80,0.40)] animate-pulse mb-3"/>
