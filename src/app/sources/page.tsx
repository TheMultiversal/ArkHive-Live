...
export default function SourcesPage() {
 ...
 className="bg-[#000a1c] border border-[rgba(80,180,255,0.15)] p-4 mb-8"
 >
 ...
 <span
 key={cat}
 className="px-2 py-0.5 bg-[#000c20] text-zinc-400 text-xs"
 >
 {cat}
 </span>
 ))}
 ...
 <div className="bg-zinc-900 border border-[rgba(60,160,255,0.08)] p-5">
