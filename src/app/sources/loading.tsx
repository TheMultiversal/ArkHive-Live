...
export default function SourcesLoading() {
 ...
 <div className="h-10 w-48 bg-zinc-900 animate-pulse"/>
 ...
 {[...Array(5)].map((_, i) => (
 <div key={i} className="w-10 h-10 bg-zinc-900 animate-pulse"/>
 ))}
 </div>
 </div>
 </div>
