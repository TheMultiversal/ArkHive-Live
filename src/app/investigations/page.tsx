...
export default function InvestigationsPage() {
 ...
 :"bg-black/40 border-[rgba(255, 60, 60,0.08)] text-zinc-500 hover:text-zinc-300 hover:border-[rgba(255, 60, 60,0.18)]"
 }`}
 >
 ...
 className="w-full pl-11 pr-10 py-2.5 bg-[#190800] border border-[rgba(255, 80, 80,0.15)] text-white text-sm placeholder-zinc-600 focus:outline-none focus:border-blood-700 transition-colors"
 />
 {searchQuery && (
 <button
 ...
 className="px-4 py-2.5 bg-[#190800] border border-[rgba(255, 80, 80,0.15)] text-zinc-300 text-sm focus:outline-none focus:border-blood-700"
 >
 ...
 {/* ── RESULTS BAR ──────────────────────────────────────── */}
 <div className="flex flex-wrap items-center justify-between gap-4 mb-6 border border-[rgba(255, 60, 60,0.08)] bg-black/40 px-4 py-3">
 ...
 className="p-2 border border-[rgba(255, 80, 80,0.15)] text-zinc-400 hover:text-white hover:border-zinc-600 disabled:opacity-30 disabled:pointer-events-none transition-colors"
 >
 ...
 currentPage === item
 ?"bg-blood-900 border-blood-700 text-blood-400"
 :"border-[rgba(255, 80, 80,0.15)] text-zinc-500 hover:text-white hover:border-zinc-600"
 }`}
 >
 {item}
 </button>
