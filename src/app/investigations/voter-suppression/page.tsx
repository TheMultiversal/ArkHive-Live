...
export default function VoterSuppressionPage() {
 ...
 <div key={index} className="flex items-start gap-4 p-3 bg-[rgba(0,20,55,0.40)] border border-[rgba(60,160,255,0.12)]">
 ...
 <div key={index} className="text-center p-4 bg-[rgba(0,20,55,0.40)] border border-[rgba(60,160,255,0.12)]">
