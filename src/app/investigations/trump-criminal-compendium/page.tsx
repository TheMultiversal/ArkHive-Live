...
const categoryConfig: Record<string, { icon: React.ElementType; color: string }> = {
 'Crimes Against Humanity': { icon: Skull, color: 'text-zinc-300 border-zinc-800 bg-zinc-900' },
 'Human Trafficking': { icon: Users, color: 'text-zinc-300 border-zinc-800 bg-zinc-900' },
 'Financial Crimes': { icon: DollarSign, color: 'text-zinc-300 border-zinc-800 bg-zinc-900' },
 'Election Crimes': { icon: Vote, color: 'text-zinc-300 border-zinc-800 bg-zinc-900' },
 'National Security': { icon: Shield, color: 'text-zinc-300 border-zinc-800 bg-zinc-900' },
 'Environmental Crimes': { icon: Flame, color: 'text-zinc-600 border-zinc-800 bg-zinc-900' },
 'Organized Crime': { icon: Building2, color: 'text-zinc-400 border-zinc-700 bg-zinc-900' },
 'Conspiracy': { icon: Globe, color: 'text-zinc-300 border-zinc-800 bg-zinc-900' },
};
...
const severityColors = {
 ...
 high: 'bg-zinc-900 text-zinc-300 border-zinc-800',
 medium: 'bg-zinc-800 text-zinc-300 border-zinc-800',
...
export default function TrumpCriminalCompendiumPage() {
 ...
 <ChevronRight className="w-4 h-4"/>
 <span className="text-zinc-300">{investigationData.category}</span>
 </nav>
 ...
 <span className="px-3 py-1.5 bg-[#0a0a0a] text-zinc-400 text-xs font-medium border border-[rgba(255,255,255,0.15)]">
 ...
 className="lg:hidden flex items-center gap-2 px-4 py-2 bg-zinc-700 hover:bg-zinc-700 text-white text-sm transition-colors"
 >
 ...
 {/* Warning Notice */}
 <div className="bg-zinc-900 border-2 border-zinc-800 p-4 mb-8 flex items-start gap-3">
 <AlertTriangle className="w-6 h-6 text-zinc-300 flex-shrink-0 mt-0.5"/>
 <div>
 <p className="text-zinc-400 font-bold uppercase tracking-wider text-sm">Evidentiary Documentation</p>
 ...
 <code key={i} className="text-xs bg-[#0a0a0a] text-zinc-500 px-2 py-1 font-mono">
 {statute}
 </code>
 ))}
 ...
 <code key={i} className="text-xs bg-zinc-900 text-zinc-400 border border-zinc-700/50 px-2 py-1 font-mono">
 {statute}
 </code>
 ))}
 </div>
 ...
 <span className="w-1 h-1 bg-zinc-600 mt-1.5 flex-shrink-0"/>
 {item}
 </li>
 ))}
 </ul>
 ...
 className="px-3 py-1.5 bg-[#0a0a0a] hover:bg-[#0d0d0d] text-zinc-400 text-sm border border-[rgba(255,255,255,0.15)] hover:border-zinc-700 transition-colors"
 >
 {tag}
 </Link>
 ))}
 ...
 <Link
 href="/entities/individuals/donald-trump"
 className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-700 hover:bg-zinc-700 text-white font-medium transition-colors"
 >
