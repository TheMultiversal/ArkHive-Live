...
export default function FakeElectorsPage() {
 ...
 <div key={idx} className={`p-4 border ${state.prosecuted ? 'border-blood-500/30 bg-blood-950/20' : 'border-[rgba(60,160,255,0.12)] bg-zinc-900/20'}`}>
 ...
 <div className="p-3 bg-[rgba(0,20,55,0.40)] border-l-2 border-blood-500">
