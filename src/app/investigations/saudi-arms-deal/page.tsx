...
const severityColors = {
 ...
 medium: 'text-zinc-400 bg-[rgba(0,20,55,0.40)] border-zinc-400/30',
...
export default function SaudiArmsDealPage() {
 ...
 <div className="bg-[rgba(0,20,55,0.40)] p-4 border border-[rgba(60,160,255,0.12)]">
 ...
 <span className="text-xs bg-[rgba(0,30,80,0.40)] text-zinc-400 px-2 py-1">{figure.status}</span>
 </div>
 ...
 className="flex items-center justify-between p-3 bg-[rgba(0,20,55,0.40)] hover:bg-[rgba(0,30,80,0.30)] transition-colors border border-[rgba(60,160,255,0.12)]"
 >
 <div>
