...
export default function EmolumentsPage() {
 ...
 <div key={idx} className="border border-[rgba(60,160,255,0.12)] bg-black/50 p-4">
 ...
 <div key={idx} className="flex justify-between items-start border border-[rgba(60,160,255,0.18)] bg-[rgba(0,20,55,0.40)] p-3">
 ...
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="border-2 border-[rgba(60,160,255,0.12)] bg-[rgba(0,15,40,0.50)] p-6 mb-8 border-l-4 border-blood-600">
