...
const investigation = {
  ...
  sources: [
    { title: 'House Oversight Foreign Payments Report', url: 'https://web.archive.org/web/2024/https://oversight.house.gov/wp-content/uploads/2022/01/Trump-Hotel-Report-January-2022.pdf', date: '2022' },
    { title: 'CREW Emoluments Tracking', url: 'https://web.archive.org/web/2024/https://www.citizensforethics.org/reports-investigations/crew-reports/president-trump-accepted-663-payments-foreign-governments/', date: '2020' },
    { title: 'GSA Lease Agreement', url: 'https://web.archive.org/web/2024/https://www.gsa.gov/real-estate/gsa-properties/gsa-properties-faq/old-post-office-building-washington-dc', date: '2013' },
    { title: 'DC & Maryland Lawsuit', url: 'https://web.archive.org/web/2024/https://oag.dc.gov/blog/district-columbia-and-maryland-file-lawsuit-against-president-trump', date: '2017' },
