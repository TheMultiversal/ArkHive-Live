...
export default function PardonsPage() {
 ...
 <Shield className="w-6 h-6 text-blood-700 mx-auto mb-2"/>
 <p className="text-xl font-black text-blood-700">{investigationData.pardonStats.russiaProbe}</p>
 <p className="text-xs text-zinc-400">Russia Probe</p>
 </div>
 <div className="glass-card p-4 text-center border-l-4 border-blood-800">
 <Calendar className="w-6 h-6 text-blood-700 mx-auto mb-2"/>
 <p className="text-xl font-black text-blood-700">{investigationData.pardonStats.finalMonth}</p>
 ...
 <p className="text-sm text-blood-600"><strong>Controversy:</strong> {pardon.controversy}</p>
 </div>
 ))}
 </div>
 </motion.section>
