...
export default function LafayetteSquarePage() {
 ...
 <div key={idx} className="p-4 bg-zinc-900/50 border border-zinc-400/30">
 ...
 <div className="p-3 bg-zinc-900/20 border border-zinc-400/30">
 ...
 <p className="text-xs text-blood-500">Criticism</p>
