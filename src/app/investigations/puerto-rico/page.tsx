...
export default function PuertoRicoPage() {
 ...
 <p className="text-4xl font-black text-zinc-300">{investigation.deaths.official}</p>
 </div>
 <div className="text-center p-4 border border-[rgba(255,255,255,0.15)] bg-[#0a0a0a]">
 ...
 <div className="text-center p-4 border border-zinc-700 bg-zinc-900">
 <p className="text-xs text-zinc-500">Study Estimates</p>
 <p className="text-2xl font-black text-zinc-400">{investigation.deaths.studyRange}</p>
 </div>
 <div className="text-center p-4 border border-zinc-800 bg-zinc-900">
 <p className="text-xs text-zinc-500">Trump Claimed</p>
 <p className="text-sm font-bold text-zinc-400">{investigation.deaths.trumpClaim}</p>
 </div>
 </div>
 </motion.div>
 ...
 <div key={idx} className={`p-4 border ${item.location.includes('Puerto Rico') ? 'border-zinc-600/50 bg-zinc-900' : 'border-zinc-800 bg-zinc-900'}`}>
 <p className="font-bold glass-text">{item.location}</p>
 <div className="mt-2 space-y-1">
 <p className="text-xs text-zinc-400">Visit: <span className={item.location.includes('Puerto Rico') ? 'text-zinc-400' : 'text-zinc-400'}>{item.timing}</span></p>
 <p className="text-xs text-zinc-400">Aid: <span className={item.location.includes('Puerto Rico') ? 'text-zinc-400' : 'text-zinc-400'}>{item.aid}</span></p>
 <p className="text-xs text-zinc-400">Deaths: <span className={item.location.includes('Puerto Rico') ? 'text-zinc-300 text-lg font-bold' : 'text-zinc-300'}>{item.deaths}</span></p>
 </div>
 </div>
 ))}
 </div>
 ...
 <p className="text-xs text-zinc-300 font-mono mb-1">{item.date}</p>
 ...
 <p className="font-bold text-zinc-400">{item.issue}</p>
 </div>
 ...
 <p className="text-xs text-zinc-300">Trump&apos;s Response</p>
 ...
 <p className="text-4xl font-black text-zinc-300">{investigation.aidBlocked.amount}</p>
