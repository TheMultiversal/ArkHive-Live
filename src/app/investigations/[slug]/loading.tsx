...
export default function InvestigationLoading() {
 ...
 <div className="border-2 border-blood-800/40 bg-[rgba(0,8,25,0.85)] p-6 lg:p-8 animate-pulse">
 ...
 <div className="h-8 bg-[rgba(0,12,32,0.80)] rounded w-3/4"/>
 ...
 <div className="h-6 bg-[rgba(0,12,32,0.80)] rounded w-1/4 mb-4"/>
 ...
 <div className="h-5 bg-[rgba(0,12,32,0.80)] rounded w-1/3 mb-3"/>
 <div className="space-y-2">
 {[...Array(4)].map((_, i) => (
