...
import { FileX, AlertTriangle, ArrowLeft, Home } from "lucide-react";
      ...
      <div className="max-w-lg mx-auto px-4 text-center">
        <div className="border-2 border-blood-800/60 bg-black/80 p-12">
          ...
          <div className="w-24 h-24 mx-auto mb-8 border-2 border-blood-700 bg-blood-950/30 flex items-center justify-center">
            <FileX className="w-12 h-12 text-blood-600" />
          </div>
          ...
          <p className="text-zinc-400 mb-8 leading-relaxed">
            This investigation has been <span className="text-blood-600 font-bold">classified</span>, 
            archived, or does not exist in our database.
          </p>
        ...
        <div className="mt-8 text-xs text-zinc-700 uppercase tracking-widest">
          Error Code: INVESTIGATION_CLASSIFIED
        </div>
      </div>
    </div>
  );
