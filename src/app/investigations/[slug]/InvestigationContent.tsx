                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 border text-sm transition-colors ${
                    saved
                      ...
                      : 'bg-[#1c0a00] hover:bg-[#200c00] border-[rgba(255, 80, 80,0.15)] text-white'
                  }`}
                >
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {investigationData.tags.map((tag) => (
                  <Link key={tag} href={`/investigations?tag=${encodeURIComponent(tag)}`} className="px-3 py-1.5 bg-[#1c0a00] hover:bg-[#200c00] text-zinc-400 text-sm transition-colors">
                    {tag}
                  </Link>
                ))}
              </div>
            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-3">
                {investigationData.sources.map((source, index) => (
                  <a key={index} href={source.url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-3 bg-[#1c0a00] hover:bg-[#1c0a00] transition-colors group">
