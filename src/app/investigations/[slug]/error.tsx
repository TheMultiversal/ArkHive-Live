...
import { FileX, RefreshCw, Home, ArrowLeft } from 'lucide-react';
...
export default function InvestigationError({ error, reset }: ErrorProps) {
  useEffect(() => {
      ...
      <div className="max-w-lg mx-auto px-4 text-center">
        <div className="border-2 border-blood-800/60 bg-black/80 p-8">
          ...
          <h1 className="text-xl font-black text-white uppercase tracking-wider mb-3">
            INVESTIGATION INACCESSIBLE
          </h1>

          <p className="text-zinc-400 mb-6 text-sm leading-relaxed">
            Unable to retrieve the requested investigation data. 
            The files may be classified, corrupted, or under review.
          </p>
