...
const investigation = {
 ...
 { name: 'Bill Barr', role: 'Attorney General \u2014 Expanded federal private prison use; former board member of entities with private prison investments', href: '/entities/individuals/william-barr', status: 'Left Office' },
