...
export default function IranContraPage() {
 ...
 <blockquote className="p-4 bg-[#000a1c] border-l-4 border-blood-600 text-sm text-zinc-300 italic mb-4">
 ...
 {/* ICJ Ruling */}
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="border-2 border-blood-800/60 bg-blood-950 p-6 mb-8">
 <h2 className="text-xl font-bold glass-text uppercase tracking-wider mb-4 flex items-center gap-2">
 ...
 <div key={idx} className="p-4 bg-blood-950 border border-blood-800">
