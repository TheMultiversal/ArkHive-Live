...
export default function FamilySeparationPage() {
 ...
 <Baby className="w-5 h-5 text-blood-500"/>
 Human Cost
 </h2>
 <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
 <div className="border border-blood-800/50 bg-black/50 p-4 text-center">
 <p className="text-3xl font-bold text-blood-500">{investigation.statistics.childrenSeparated}</p>
 <p className="text-sm text-zinc-400">Children Separated</p>
 </div>
 <div className="border border-blood-800/50 bg-black/50 p-4 text-center">
 <p className="text-3xl font-bold text-blood-500">{investigation.statistics.stillSeparated}</p>
 <p className="text-sm text-zinc-400">Still Not Reunited</p>
 </div>
 <div className="border border-blood-800/50 bg-black/50 p-4 text-center">
 <p className="text-3xl font-bold text-blood-500">{investigation.statistics.deathsInCustody}</p>
 <p className="text-sm text-zinc-400">Deaths in Custody</p>
 </div>
 </div>
 <div className="mt-4 grid grid-cols-2 gap-4">
 <div className="border border-[rgba(60,160,255,0.18)] bg-black/50 p-3">
 ...
 <div className="border border-[rgba(80,180,255,0.15)] bg-black/50 p-4">
 ...
 <p className="text-sm text-blood-400 mt-2">{investigation.sessionsQuote.context}</p>
 </div>
 </motion.div>
 ...
 <div key={idx} className="border border-blood-800/50 bg-black/50 p-4">
 ...
 <div key={idx} className="flex items-start gap-2 text-zinc-300 border border-[rgba(60,160,255,0.18)] bg-[rgba(0,10,28,0.82)] p-3">
 ...
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }} className="border-2 border-[rgba(80,180,255,0.15)] bg-[rgba(0,8,25,0.85)] p-6 mb-8">
