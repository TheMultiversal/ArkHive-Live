...
const investigation = {
  ...
  sources: [
    ...
    { title: 'Deutsche Bank $670M Russia Fine', url: 'https://www.justice.gov/opa/pr/deutsche-bank-agrees-pay-over-41-million-resolve-foreign-corrupt-practices-act', date: '2017' }, // TODO: dead link — no archive found (check scripts/404-replacements.json)
