...
export default function WatergatePage() {
 ...
 <div key={idx} className="p-2 bg-[rgba(0,20,55,0.40)] border border-[rgba(60,160,255,0.12)] text-sm text-zinc-300">{b}</div>
 ))}
 </div>
 </motion.div>
 ...
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }} className="border-2 border-blood-800/60 bg-blood-950/20 p-6 mb-8">
 <h2 className="text-xl font-bold glass-text uppercase tracking-wider mb-4 flex items-center gap-2">
 ...
 <div key={idx} className="p-2 bg-blood-950/30 border border-blood-500/30 text-sm text-zinc-300">
 <span className="text-blood-500 mr-2">→</span>{c}
 </div>
 ))}
 </div>
 </motion.div>
