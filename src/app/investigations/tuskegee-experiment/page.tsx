...
export default function TuskegeeExperimentPage() {
 ...
 {/* Penicillin Betrayal */}
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="border-2 border-blood-800/60 bg-blood-950 p-6 mb-8">
 ...
 <div className="text-center p-4 border border-blood-800 bg-blood-950"><p className="text-lg font-black text-blood-500">Cure Available: {investigation.penicillinBetrayal.yearAvailable}</p></div>
 <div className="text-center p-4 border border-blood-800 bg-blood-950"><p className="text-lg font-black text-blood-500">{investigation.penicillinBetrayal.yearsWithheld}</p></div>
 <div className="text-center p-4 border border-blood-800 bg-blood-950"><p className="text-lg font-black text-blood-500">{investigation.penicillinBetrayal.additionalDead}</p></div>
 </div>
