...
export default function TuskegeeExperimentPage() {
 ...
 <h2 className="text-xl font-bold glass-text uppercase tracking-wider mb-4 flex items-center gap-2"><Heart className="w-5 h-5 text-blood-500"/>Scale of Atrocity</h2>
 ...
 {/* Penicillin Betrayal */}
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="border-2 border-blood-800/60 bg-blood-950/20 p-6 mb-8">
 <h2 className="text-xl font-bold glass-text uppercase tracking-wider mb-4 flex items-center gap-2">
 <Syringe className="w-5 h-5 text-blood-500"/>
 The Penicillin Betrayal: 25 Years of Preventable Death
 </h2>
 <div className="grid md:grid-cols-3 gap-4 mb-4">
 <div className="text-center p-4 border border-blood-500/30 bg-blood-950/30"><p className="text-lg font-black text-blood-500">Cure Available: {investigation.penicillinBetrayal.yearAvailable}</p></div>
 <div className="text-center p-4 border border-blood-500/30 bg-blood-950/30"><p className="text-lg font-black text-blood-500">{investigation.penicillinBetrayal.yearsWithheld}</p></div>
 <div className="text-center p-4 border border-blood-500/30 bg-blood-950/30"><p className="text-lg font-black text-blood-500">{investigation.penicillinBetrayal.additionalDead}</p></div>
 </div>
 ...
 <span className="text-xs px-2 py-1 bg-[rgba(0,30,80,0.40)] text-zinc-400 border border-[rgba(60,160,255,0.18)] whitespace-nowrap ml-2">{figure.status}</span>
 </div>
 ))}
 </div>
 </motion.div>
 ...
 {/* Charges */}
 <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="glass-card p-6 border-l-4 border-blood-600">
 <h2 className="text-xl font-bold glass-text uppercase tracking-wider mb-4 flex items-center gap-2"><AlertTriangle className="w-5 h-5 text-blood-500"/>Applicable Charges & Statutes</h2>
 ...
 <h3 className="text-lg font-bold glass-text uppercase tracking-wider mb-4 flex items-center gap-2"><FileText className="w-4 h-4 text-blood-500"/>Sources</h3>
 <div className="space-y-2">
 {investigation.sources.map((source, idx) => (
 <a key={idx} href={source.url} target="_blank"rel="noopener noreferrer"className="flex items-start gap-2 p-2 text-sm text-zinc-400 hover:text-blood-400 hover:bg-[rgba(0,20,55,0.40)] transition-colors">
