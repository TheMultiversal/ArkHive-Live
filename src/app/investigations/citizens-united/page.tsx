...
const investigation = {
  ...
  charges: [
    ...
    { statute: '52 U.S.C. § 30118 — Corporate Contribution Ban (Partially Invalidated)', description: 'Century-old prohibition on corporate election spending struck down by Citizens United', count: 'Billions in corporate and dark money spending since 2010' },
    ...
    { statute: '26 U.S.C. § 501(c)(4) — Social Welfare Organizations', description: 'Tax-exempt organizations used primarily for political spending rather than social welfare', count: 'Billions funneled through "social welfare" organizations whose primary activity is political spending' },
    ...
    { statute: '18 U.S.C. § 1346 — Honest Services Fraud', description: 'Officials influenced by dark money spending fail to provide honest services to constituents', count: 'Study: 91% of the time, the candidate with the most money wins their Congressional race' },
  ],
  coverup: [
