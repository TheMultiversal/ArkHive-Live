...
export default function TrumpOrgFraudPage() {
 ...
 <div className="border border-zinc-700/50 bg-black p-4 col-span-2 md:col-span-1">
 <p className="text-3xl font-bold text-zinc-400">{investigation.civilCase.verdict.totalJudgment}</p>
 <p className="text-sm text-zinc-400">Total Judgment</p>
 </div>
 <div className="border border-[rgba(255,255,255,0.18)] bg-black p-4">
 <p className="text-xl font-bold text-zinc-300">{investigation.civilCase.verdict.trumpPenalty}</p>
 <p className="text-sm text-zinc-400">Donald Trump</p>
 </div>
 <div className="border border-[rgba(255,255,255,0.18)] bg-black p-4">
 <p className="text-xl font-bold text-zinc-300">{investigation.civilCase.verdict.donJrPenalty}</p>
 <p className="text-sm text-zinc-400">Donald Trump Jr.</p>
 </div>
 <div className="border border-[rgba(255,255,255,0.18)] bg-black p-4">
 <p className="text-xl font-bold text-zinc-300">{investigation.civilCase.verdict.ericPenalty}</p>
 <p className="text-sm text-zinc-400">Eric Trump</p>
 </div>
 <div className="border border-[rgba(255,255,255,0.18)] bg-black p-4">
 <p className="text-xl font-bold text-zinc-300">{investigation.civilCase.verdict.weisselburgPenalty}</p>
 ...
 <span className="text-zinc-300">ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â </span>
 {p}
 </div>
 ))}
 </div>
 ...
 <div>
 <p className="text-zinc-400 font-bold">Claimed</p>
 <p className="text-zinc-300">{fraud.claimed}</p>
 </div>
 <div>
 <p className="text-zinc-400 font-bold">Reality</p>
 ...
 <div className="border border-zinc-700/50 bg-zinc-900 p-4 mb-4">
 <div className="flex justify-between items-center mb-2">
 <span className="text-2xl font-bold text-zinc-400">GUILTY - ALL 17 COUNTS</span>
 ...
 <span className="text-zinc-300">{bank.loan}</span>
 </div>
