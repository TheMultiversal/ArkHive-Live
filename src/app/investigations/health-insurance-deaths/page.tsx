...
const investigation = {
 ...
 keyFigures: [
 { name: 'Andrew Witty', role: 'CEO of UnitedHealth Group, the largest health insurance company in the world with $371.6B in revenue (2023). UnitedHealth\'s subsidiary Optum employs more physicians than any other entity in the U.S., creating a vertical monopoly over both insurance and care delivery.', href: '/entities/individuals/andrew-witty', status: 'Current CEO, UnitedHealth' },
 { name: 'David Cordani', role: 'CEO of Cigna Group (2009-2023). Under his leadership, Cigna expanded its denial rates and prior authorization requirements while posting record profits. Cigna\'s algorithm-based claim denial system rejected hundreds of thousands of claims in bulk without medical review.', href: '/entities/individuals/david-cordani', status: 'Former CEO, Cigna' },
 { name: 'Martin Shkreli', role: '"Pharma Bro."As CEO of Turing Pharmaceuticals, raised the price of Daraprim, a life-saving anti-parasitic drug, from $13.50 to $750 per pill overnight (a 5,455% increase). Became the public face of pharmaceutical price gouging.', href: '/entities/individuals/martin-shkreli', status: 'Convicted, Released 2023' },
 { name: 'Heather Bresch', role: 'CEO of Mylan (2012-2020). Presided over the EpiPen price increase from $100 to $608 - a 500%+ increase for a life-saving allergy medication that costs approximately $1 to manufacture. Simultaneously lobbied to make EpiPens mandatory in schools.', href: '/entities/individuals/heather-bresch', status: 'Former CEO, Mylan' },
 { name: 'Albert Bourla', role: 'CEO of Pfizer. Quadrupled the price of the COVID-19 vaccine from $19.50 to $110-$130 per dose after the pandemic, a product developed with $2.5B in taxpayer funding. Pfizer\'s revenue reached $100.3B in 2022.', href: '/entities/individuals/albert-bourla', status: 'Current CEO, Pfizer' },
 { name: 'Rick Scott', role: 'Former CEO of Columbia/HCA, the largest for-profit hospital chain. Under his leadership, HCA committed the largest Medicare fraud in history, settling for $1.7B. Scott was never charged personally. Later became Governor of Florida and U.S. Senator.', href: '/entities/individuals/rick-scott', status: 'U.S. Senator (R-FL)' },
 { name: 'Mitch McConnell', role: 'Senate Minority/Majority Leader. Has received over $4 million in healthcare industry campaign contributions. Led opposition to the Affordable Care Act and every subsequent reform effort, including drug price negotiation.', href: '/entities/individuals/mitch-mcconnell', status: 'U.S. Senator (R-KY)' },
 { name: 'Joe Manchin', role: 'U.S. Senator (D-WV). His daughter Heather Bresch was the Mylan CEO who raised EpiPen prices 500%+. Manchin blocked the Build Back Better Act\'s drug pricing provisions and opposed Medicare expansion, protecting the industry that enriched his family.', href: '/entities/individuals/joe-manchin', status: 'Former U.S. Senator' },
 { name: 'Donald Trump', role: 'Promised to replace the ACA with"something terrific"and to lower drug prices. Instead, his administration expanded short-term junk insurance plans, attempted to eliminate ACA protections, and abandoned drug pricing reforms after industry lobbying.', href: '/entities/individuals/donald-trump', status: 'Current President' },
 { name: 'Richard Sackler', role: 'Former Chairman of Purdue Pharma. Oversaw the aggressive marketing of OxyContin that fueled the opioid crisis, killing over 500,000 Americans. The Sackler family extracted $10.7B from Purdue while the company pled guilty to criminal charges.', href: '/entities/individuals/richard-sackler', status: 'Sackler Family Settlement' },
 { name: 'John Kapoor', role: 'Founder and former Chairman of Insys Therapeutics. Convicted of racketeering for bribing doctors to prescribe a powerful fentanyl spray to patients who did not need it, including cancer patients, contributing to the opioid epidemic.', href: '/entities/individuals/john-kapoor', status: 'Convicted - 66 months' },
 { name: 'Alex Gorsky', role: 'Former CEO of Johnson & Johnson (2012-2022). J&J knew for decades that its talc-based baby powder contained asbestos and caused cancer. The company used a "Texas two-step"bankruptcy maneuver to limit victim payouts to $8.9 billion.', href: '/entities/individuals/alex-gorsky', status: 'Former CEO, J&J' },
 { name: 'Stephen Hemsley', role: 'Former CEO of UnitedHealth Group (2006-2017). Oversaw UnitedHealth\'s transformation into a healthcare monopoly acquiring physician practices, pharmacy benefit managers, and data analytics firms while tightening claim denials. Compensation exceeded $300M during tenure.', href: '/entities/individuals/stephen-hemsley', status: 'Executive Chairman' },
 { name: 'Karen Lynch', role: 'CEO of CVS Health (which acquired Aetna). CVS/Aetna controls insurance, pharmacy benefits, and retail pharmacy, a vertical monopoly that profits at every stage of healthcare delivery while patients pay ever-increasing out-of-pocket costs.', href: '/entities/individuals/karen-lynch', status: 'Former CEO, CVS Health' },
 ],
 timeline: [
 ...
 legalOutcomes: [
 { defendant: 'Columbia/HCA (Rick Scott, CEO)', charge: 'Largest Medicare fraud in history, systematic overbilling, kickbacks, and false claims', outcome: '$1.7B settlement. Rick Scott personally took the Fifth 75 times. Never charged. Became Governor and Senator.' },
 { defendant: 'Purdue Pharma / Sackler Family', charge: 'Fraudulent marketing of OxyContin, fueling opioid epidemic that killed 500,000+ Americans', outcome: 'Purdue pled guilty to criminal charges twice. Sacklers paid $6B but received personal immunity. No family member imprisoned.' },
 { defendant: 'Insys Therapeutics / John Kapoor', charge: 'RICO, bribing doctors to prescribe fentanyl spray to patients who did not need it', outcome: 'Kapoor convicted, sentenced to 66 months. Company filed for bankruptcy after $225M settlement.' },
 { defendant: 'Johnson & Johnson', charge: 'Concealing asbestos contamination in talc products for decades, causing cancer', outcome: '$8.9B proposed settlement using "Texas two-step"bankruptcy maneuver to limit payouts. No executive charged.' },
 { defendant: 'Martin Shkreli / Turing Pharmaceuticals', charge: 'Price gouging of life-saving medication (Daraprim: $13.50 to $750)', outcome: 'Convicted of securities fraud (separate matter). Barred from pharmaceutical industry. Drug pricing remains legal.' },
 { defendant: 'Mylan / Heather Bresch', charge: 'EpiPen price gouging (500%+ increase) and Medicaid rebate fraud', outcome: '$465M DOJ settlement for misclassifying EpiPen to underpay Medicaid rebates. No personal charges against Bresch.' },
 { defendant: 'Cigna', charge: 'Algorithm-based claim denials without medical review, rejecting 60,000 claims per day', outcome: 'Class action lawsuits pending. No executive charged. Practice continues industry-wide.' },
 { defendant: 'UnitedHealth Group', charge: 'Monopolistic practices, systematic claim denials, and vertical integration eliminating competition', outcome: 'DOJ antitrust investigation ongoing. No charges to date. Company continues acquiring competitors.' },
 ],
 charges: [
 { statute: '18 U.S.C. § 1347 - Healthcare Fraud', description: 'Insurance companies systematically deny legitimate claims, delay prior authorizations, and use algorithmic denial systems designed to avoid paying for covered medical care, constituting a scheme to defraud policyholders of benefits they have paid for.', count: 'Hundreds of millions of claims denied annually across the industry' },
 { statute: '18 U.S.C. § 1962 - RICO (Racketeer Influenced and Corrupt Organizations)', description: 'The health insurance industry operates as a coordinated enterprise engaging in a pattern of fraud, bribery (lobbying), and obstruction to maintain a system that extracts maximum revenue while minimizing care delivery, resulting in preventable deaths.', count: 'Industry-wide pattern spanning decades' },
 { statute: '18 U.S.C. § 1112 - Involuntary Manslaughter', description: 'Claim denials and prior authorization delays that result in patient deaths constitute involuntary manslaughter when insurance companies know that denial of timely care creates a substantial risk of death.', count: 'Estimated 68,000+ deaths annually attributable to lack of insurance; additional thousands from claim denials' },
 { statute: '15 U.S.C. § 2 - Sherman Act (Monopolization)', description: 'Health insurance companies have engaged in systematic acquisition of competitors, physician practices, pharmacy benefit managers, and healthcare delivery systems to create vertical monopolies that eliminate competition and consumer choice.', count: 'UnitedHealth, CVS/Aetna, and Cigna control over 50% of the commercial insurance market' },
 { statute: '18 U.S.C. § 201 - Bribery of Public Officials', description: 'The health insurance and pharmaceutical industries have spent over $700M lobbying Congress since 1998, purchasing legislative outcomes including the Medicare Part D prohibition on drug price negotiation and the defeat of the public option.', count: '$700M+ in documented lobbying expenditures; millions more in campaign contributions' },
 { statute: '42 U.S.C. § 300gg, ACA Violations', description: 'Insurance companies have systematically violated ACA requirements including essential health benefits mandates, mental health parity requirements, and prohibitions on rescission through creative reinterpretation and inadequate enforcement.', count: 'Thousands of documented violations across the industry' },
 { statute: '18 U.S.C. § 1341/1343 - Mail/Wire Fraud', description: 'Insurance companies make material misrepresentations about coverage, benefits, and provider networks to sell policies, then systematically deny claims for care that policyholders reasonably believed was covered.', count: 'Millions of policyholders sold coverage that does not perform as represented' },
 { statute: '18 U.S.C. § 1951 - Hobbs Act (Extortion)', description: 'The system of employer-sponsored insurance (where loss of employment means loss of healthcare) functions as economic coercion, trapping workers in jobs under threat of losing access to life-sustaining medical treatment.', count: 'An estimated 157 million Americans dependent on employer-sponsored insurance' },
 { statute: '15 U.S.C. § 13 - Robinson-Patman Act (Price Discrimination)', description: 'Pharmaceutical companies charge American consumers 2-3 times what they charge patients in other countries for identical medications, constituting price discrimination enabled by the lobbied prohibition on Medicare negotiation and drug importation.', count: 'Americans pay the highest drug prices in the world, an estimated $1,500/person/year vs. $749 in comparable nations' },
 ],
 coverup: [
 ...
 sources: [
 { title: 'The Lancet: Health Insurance and Mortality in US Adults (68,000 Annual Deaths)', url: 'https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(19)33019-3/fulltext', date: 'February 15, 2020' },
 { title: 'American Journal of Public Health: Medical Bankruptcy and the Economy', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2556047/', date: '2009' },
 { title: 'ProPublica: How Cigna Saves Millions by Having Its Doctors Reject Claims Without Reading Them', url: 'https://www.propublica.org/article/cigna-pxdx-medical-health-insurance-rejection-claims', date: 'March 25, 2023' },
 { title: 'Kaiser Family Foundation: Health Insurance Coverage of the Total Population', url: 'https://www.kff.org/other/state-indicator/total-population/', date: '2024' },
 { title: 'Commonwealth Fund: U.S. Health System Ranks Last Among 11 Countries', url: 'https://www.commonwealthfund.org/publications/fund-reports/2024/sep/mirror-mirror-2024', date: 'September 2024' },
 { title: 'OpenSecrets: Health Sector Lobbying Profile', url: 'https://www.opensecrets.org/federal-lobbying/sectors/summary?cycle=2023&id=H', date: '2023' },
 { title: 'AMA: 2023 Prior Authorization Physician Survey, Harms and Delays', url: 'https://www.ama-assn.org/system/files/prior-authorization-survey.pdf', date: '2023' },
 { title: 'T1International: Insulin Rationing in the United States', url: 'https://www.t1international.com/insulin-and-supply-survey/', date: '2020' },
 { title: 'Wendell Potter,"Deadly Spin: An Insurance Company Insider Speaks Out"', url: 'https://www.simonandschuster.com/books/Deadly-Spin/Wendell-Potter/9781608192816', date: '2010' },
 { title: 'New York Times: A Hospital Charged $18,000 for a Cough. This Is Our Healthcare System.', url: 'https://www.nytimes.com/interactive/2019/09/26/health/hospitals-emergency-room-cost.html', date: 'September 26, 2019' },
 ],
};

export default function HealthInsuranceDeathsPage() {
 return (
