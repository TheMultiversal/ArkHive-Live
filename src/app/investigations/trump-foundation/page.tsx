...
export default function TrumpFoundationPage() {
 ...
 <div key={item.violation} className="border border-[rgba(60,160,255,0.12)]">
 <button
 ...
 <div key={i} className="flex items-center justify-between p-2 bg-[rgba(0,20,55,0.40)] mb-1">
