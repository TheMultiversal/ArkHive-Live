...
export default function TrumpFoundationPage() {
 ...
 <Heart className="w-6 h-6 text-zinc-400 mx-auto mb-2"/>
 <p className="text-xl font-black text-zinc-400">{investigationData.fraudStats.portraitPurchases}</p>
 ...
 <div key={item.violation} className="border border-[rgba(80,180,255,0.15)]">
 <button
 ...
 <div key={i} className="flex items-center justify-between p-2 bg-[rgba(0,10,28,0.82)] mb-1">
