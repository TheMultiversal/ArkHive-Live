...
const investigationData = {
  ...
  sources: [
    ...
    { title: 'Purdue Pharma Settlement', url: 'https://web.archive.org/web/2024/https://www.justice.gov/opa/pr/opioid-manufacturer-purdue-pharma-pleads-guilty-federal-criminal-charges', type: 'DOJ Press Release' },
