...
export default function UkraineExtortionPage() {
 ...
 <div className="border border-zinc-700/50 bg-black p-4 mb-4">
 <p className="text-2xl text-zinc-400 italic">&quot;{investigation.thePerfectCall.keyQuote}&quot;</p>
 <p className="text-xs text-zinc-500 mt-2">- Donald Trump to Volodymyr Zelensky</p>
 </div>
 <div>
 <h3 className="glass-text font-bold mb-2">Trump&apos;s Demands:</h3>
 ...
 <p className="text-xs text-zinc-400 mt-1">{person.status}</p>
 </div>
 ))}
 </div>
 </motion.div>
 ...
 <div key={idx} className="border border-[rgba(255,255,255,0.18)] bg-[#0a0a0a] p-4">
 <h3 className="font-bold text-zinc-300 mb-2">{test.witness}</h3>
 ...
 <span className="text-zinc-300">House: {charge.houseVote}</span>
 </div>
 <p className="text-zinc-400">{charge.description}</p>
 </div>
 ))}
 </div>
 <div className="mt-4 border border-[rgba(255,255,255,0.15)] bg-zinc-900 p-4">
