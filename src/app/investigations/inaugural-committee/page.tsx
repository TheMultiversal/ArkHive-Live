...
export default function InauguralCommitteePage() {
 ...
 <div className="text-center p-4 border border-[rgba(60,160,255,0.12)]">
 ...
 <div key={idx} className={`p-4 border ${item.category === 'Unknown/Unaccounted' ? 'border-blood-500/50 bg-blood-950/20' : 'border-[rgba(60,160,255,0.12)] bg-[rgba(0,20,55,0.40)]'}`}>
 ...
 <div className="p-4 bg-[rgba(0,20,55,0.40)] border border-blood-500/30">
 ...
 <span className="text-blood-500 font-bold">{donor.amount}</span>
 </div>
 ...
 <p className="text-4xl font-black text-blood-500">{investigation.dcSettlement.amount}</p>
