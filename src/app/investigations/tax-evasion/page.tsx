...
const investigationData = {
  ...
  sources: [
    ...
    { title: 'Congressional Committee Tax Release', url: 'https://web.archive.org/web/*/https://waysandmeans.house.gov/trump-tax-returns/', type: 'Government Document' }, // TODO: dead link — no archive found (check scripts/404-replacements.json)
