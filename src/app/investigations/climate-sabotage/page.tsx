...
export default function ClimateSabotagePage() {
 ...
 <blockquote key={i} className="text-zinc-400 italic text-sm border-l-2 border-[rgba(60,160,255,0.18)] pl-3 mb-2">
 {quote}
 </blockquote>
 ))}
 </motion.section>
 ...
 <div key={category.category} className="border border-[rgba(80,180,255,0.15)]">
 <button
