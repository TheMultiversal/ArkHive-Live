...
export default function RussianInterferencePage() {
 ...
 key={idx}
 href={attendee.href}
 className="border border-[rgba(255, 60, 60,0.18)] bg-[#1c0a00] p-3 hover:border-blood-600 transition-colors group"
 >
 ...
 <div key={idx} className="border border-[rgba(255, 60, 60,0.18)] bg-[#1c0a00] p-3">
