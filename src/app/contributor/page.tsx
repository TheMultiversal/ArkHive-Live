          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full px-4 py-3 border border-red-900/50 hover:border-red-700 text-red-400 hover:text-red-300 text-xs uppercase tracking-wider transition-colors flex items-center justify-center gap-2"
              >
      ...
      <div className="max-w-lg mx-auto px-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="p-3 border border-red-900/50 bg-red-950/30">
                <p className="text-sm text-red-400">{error}</p>
              </div>
            )}
            {success && (
              <div className="p-3 border border-green-900/50 bg-green-950/30">
