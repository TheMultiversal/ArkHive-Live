...
export default function ContributorAuthPage() {
 ...
 <div className="flex items-center gap-2 px-3 py-1.5 border border-zinc-700 bg-zinc-900">
 ...
 className="glass-card p-5 flex items-center gap-4 group hover:border-blood-700 transition-colors"
 >
 <div className="p-3 bg-zinc-800 group-hover:bg-zinc-700 transition-colors">
 ...
 <div className="p-1.5 bg-zinc-800 mt-0.5">
 ...
 className="w-full px-4 py-3 border border-zinc-800 hover:border-zinc-600 text-zinc-400 hover:text-white text-sm uppercase tracking-wider transition-colors flex items-center justify-center gap-2"
 >
