 ...
 { id: '2', name: 'SEC', type: 'agency', relationship: 'Securities regulation and financial crime enforcement', href: '/entities/agencies/sec' },
  ...
  'wall-street-capture-of-sec': {
   ...
   timeline: [
     ...
     { date: '2008', event: 'THE 2008 CRISIS AND NON-PROSECUTION: The 2008 financial crisis; caused by systematic fraud in mortgage origination, securitization, and credit ratings; resulted in $17.5 trillion in household wealt...', type: 'political' },
  ...
  'wrongful-convictions-systemic-crisis': {
   ...
   timeline: [
     ...
     { date: '2009', event: 'A landmark 2009 National Academy of Sciences report found that most forensic disciplines; including bite mark analysis, hair microscopy, firearm tool mark analysis, and arson investigation; lack sc...', type: 'default' },
  ...
  'water-treatment-chemical-health-effects': {
   ...
   timeline: [
     ...
     { date: '2024', event: 'The EPA finalized a revised Lead and Copper Rule Improvements (LCRI) in 2024 requiring all lead service lines be replaced within 10 years; but the estimated cost is $45-60 billion and funding remai...', type: 'political' },
