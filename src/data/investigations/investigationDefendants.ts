...
const investigationDefendants: Record<string, Defendant[]> = {
  '1mdb-scandal': [
    ...
    { name: 'Najib Razak', role: 'Former Prime Minister of Malaysia', status: 'convicted', charges: ['Abuse of power', 'Money laundering', 'Criminal breach of trust'], sentence: '12 years imprisonment', fine: '$50 million', convictionDate: '2020-07-28', notes: 'Convicted on all 7 charges; sentence upheld by Federal Court 2022' },
  ...
  'financial-crisis-accountability-failure': [
    { name: 'Countrywide Financial / Angelo Mozilo', role: 'CEO of largest subprime lender', status: 'settled', fine: '$67.5 million', notes: 'SEC civil settlement 2010; no criminal charges despite massive fraud' },
  ...
  '2020-election-overturn': [
    { name: 'Donald Trump', role: 'Principal instigator of election overturn scheme', status: 'indicted', charges: ['Conspiracy to defraud the United States', 'Conspiracy to obstruct an official proceeding', 'Obstruction of an official proceeding', 'Conspiracy against rights'], indictmentDate: '2023-08-01', notes: 'Federal indictment by Special Counsel Jack Smith; case dropped after 2024 election' },
    { name: 'Rudy Giuliani', role: 'Personal attorney promoting false election claims', status: 'indicted', charges: ['RICO conspiracy', 'False statements'], notes: 'Indicted in Georgia RICO case; disbarred in NY and DC; $148M defamation judgment' },
    { name: 'John Eastman', role: 'Author of plan to have VP overturn election', status: 'indicted', charges: ['RICO conspiracy', 'Conspiracy to commit forgery'], notes: 'Indicted in Georgia; disbarred in California 2024' },
    ...
    { name: 'Mark Meadows', role: 'White House Chief of Staff coordinating overturn efforts', status: 'indicted', charges: ['RICO conspiracy', 'Solicitation of violation of oath by public officer'], notes: 'Indicted in Georgia RICO case' },
  ...
  '2016-election': [
    ...
    { name: 'Paul Manafort', role: 'Trump campaign chairman with Russian ties', status: 'convicted', charges: ['Tax fraud', 'Bank fraud', 'Foreign lobbying violations'], sentence: '7.5 years', convictionDate: '2018-08-21', pardonDate: '2020-12-23', pardonedBy: 'Donald Trump', notes: 'Convicted at trial; later pardoned' },
    { name: 'Michael Flynn', role: 'National Security Advisor who lied about Russian contacts', status: 'convicted', charges: ['Making false statements to FBI'], convictionDate: '2017-12-01', pardonDate: '2020-11-25', pardonedBy: 'Donald Trump', notes: 'Pled guilty; later pardoned before sentencing' },
    { name: 'Roger Stone', role: 'Political operative - WikiLeaks coordination', status: 'convicted', charges: ['Obstruction', 'Witness tampering', 'False statements'], sentence: '40 months', convictionDate: '2019-11-15', pardonDate: '2020-12-23', pardonedBy: 'Donald Trump' },
    { name: 'Rick Gates', role: 'Deputy campaign chairman', status: 'convicted', charges: ['Conspiracy against the United States', 'False statements'], convictionDate: '2018-02-23', sentence: '45 days jail + probation', notes: 'Cooperating witness' },
  ],
  'access-hollywood': [
    { name: 'Donald Trump', role: 'Subject of tape describing sexual assault', status: 'pending', notes: 'No criminal charges from tape itself; connected to hush money payments that led to conviction' },
  ...
  'blackwater-massacre': [
    ...
    { name: 'Erik Prince', role: 'Blackwater founder and CEO', status: 'pending', notes: 'Never charged; company rebranded to Academi; congressional investigations ongoing' },
  ],
  'boeing-safety-crisis': [
    ...
    { name: 'Dennis Muilenburg', role: 'CEO during 737 MAX crashes', status: 'pending', notes: 'Fired December 2019; never criminally charged' },
  ...
  'central-park-five': [
    ...
    { name: 'Linda Fairstein', role: 'Head of Manhattan DA Sex Crimes Unit', status: 'pending', notes: 'Led prosecution of innocent teenagers; faced no criminal accountability' },
  ...
  'catholic-church-abuse': [
    { name: 'Cardinal Bernard Law', role: 'Archbishop of Boston who covered up abuse', status: 'pending', notes: 'Resigned 2002; never criminally charged; reassigned to Rome by Vatican' },
  ...
  'hush-money': [
    { name: 'Donald Trump', role: 'Directed hush money payments and falsified business records', status: 'convicted', charges: ['34 counts of falsifying business records in the first degree'], convictionDate: '2024-05-30', notes: 'First former US president convicted of felony crimes; sentenced to unconditional discharge January 2025' },
    { name: 'Michael Cohen', role: 'Personal attorney who made hush money payment', status: 'convicted', charges: ['Campaign finance violations', 'Tax evasion', 'False statements'], sentence: '3 years', convictionDate: '2018-08-21', notes: 'Key prosecution witness in Trump trial' },
  ...
  'trump-org-fraud': [
    { name: 'Donald Trump', role: 'Principal who inflated asset values to obtain loans', status: 'convicted', fine: '$354.9 million', notes: 'Civil fraud judgment by Judge Engoron (Feb 2024); barred from running NY business for 3 years; appealing' },
    { name: 'Donald Trump Jr.', role: 'Executive who signed fraudulent financial statements', status: 'convicted', fine: '$4 million', notes: 'Civil fraud judgment; joint and several liability' },
    { name: 'Eric Trump', role: 'Executive involved in asset inflation scheme', status: 'convicted', fine: '$4 million', notes: 'Civil fraud judgment; joint and several liability' },
  ...
  'cia-torture': [
    ...
    { name: 'Bruce Jessen', role: 'Psychologist who co-designed torture program', status: 'pending', notes: 'Contracted by CIA alongside Mitchell; their firm paid $81 million' },
    { name: 'Gina Haspel', role: 'CIA officer who oversaw black site; later CIA Director', status: 'pending', notes: 'Ran Thailand black site; promoted to CIA Director 2018; never charged' },
  ...
  'covid-misinfo': [
    { name: 'Alex Jones', role: 'Promoted conspiracy theories and dangerous treatments', status: 'convicted', fine: '$1.5 billion', notes: 'Defamation judgment in Sandy Hook case; separately spread COVID misinformation' },
  ...
  'enron-fraud': [
    { name: 'Jeffrey Skilling', role: 'CEO who orchestrated accounting fraud', status: 'convicted', charges: ['Conspiracy', 'Securities fraud', 'Insider trading'], sentence: '24 years (reduced to 14)', convictionDate: '2006-05-25', releaseDate: '2019-02-21' },
    { name: 'Kenneth Lay', role: 'Founder and Chairman', status: 'convicted', charges: ['Conspiracy', 'Securities fraud', 'Wire fraud', 'Bank fraud'], convictionDate: '2006-05-25', notes: 'Conviction vacated after death in July 2006' },
  ...
  'wells-fargo-fraud': [
    ...
    { name: 'John Stumpf', role: 'CEO during fake account scandal', status: 'settled', fine: '$17.5 million', notes: 'OCC personal fine; barred from banking industry; resigned 2016' },
  ...
  'arms-trafficking': [
    { name: 'Oliver North', role: 'NSC staff who facilitated arms-for-hostages deal', status: 'convicted', charges: ['Aiding and abetting obstruction of Congress', 'Destroying documents', 'Accepting illegal gratuity'], convictionDate: '1989-05-04', notes: 'Convictions overturned on appeal due to immunized testimony' },
    { name: 'John Poindexter', role: 'National Security Advisor', status: 'convicted', charges: ['Conspiracy', 'Obstruction of Congress', 'False statements'], convictionDate: '1990-04-07', notes: 'Convictions overturned on appeal' },
    { name: 'Caspar Weinberger', role: 'Secretary of Defense who concealed information', status: 'indicted', charges: ['Perjury', 'Obstruction'], pardonDate: '1992-12-24', pardonedBy: 'George H.W. Bush', notes: 'Pardoned before trial by President Bush' },
    { name: 'Elliott Abrams', role: 'Assistant Secretary of State who lied to Congress', status: 'convicted', charges: ['Withholding information from Congress'], convictionDate: '1991-10-07', pardonDate: '1992-12-24', pardonedBy: 'George H.W. Bush' },
  ],
  'boeing-criminal-enterprise': [
    ...
    { name: 'Dennis Muilenburg', role: 'CEO who prioritized production over safety', status: 'pending', notes: 'Fired December 2019; testified to Congress; never charged' },
  ],
  'banking-corruption': [
  ...
  'botham-jean-murder': [
    { name: 'Amber Guyger', role: 'Off-duty Dallas officer who shot unarmed man in his apartment', status: 'convicted', charges: ['Murder'], sentence: '10 years', convictionDate: '2019-10-01', notes: 'Claimed she mistook his apartment for her own' },
  ],
  'build-the-wall-fraud': [
    { name: 'Steve Bannon', role: 'Co-conspirator in We Build the Wall fraud', status: 'indicted', charges: ['Money laundering', 'Conspiracy to commit wire fraud'], pardonDate: '2021-01-20', pardonedBy: 'Donald Trump', notes: 'Federal charges; pardoned by Trump; convicted separately of contempt of Congress' },
  ...
  'comey-firing': [
    { name: 'Donald Trump', role: 'Fired FBI Director investigating Russian interference', status: 'pending', notes: 'Mueller found substantial evidence of obstruction but did not indict per DOJ policy' },
  ],
  'coffee-county': [
  ...
  'crow-network': [
    { name: 'Clarence Thomas', role: 'Supreme Court Justice who failed to disclose gifts', status: 'pending', notes: 'ProPublica revealed undisclosed luxury travel, yacht trips, and real estate transactions from Harlan Crow' },
  ...
  'scotus-corruption': [
    { name: 'Clarence Thomas', role: 'Failed to disclose luxury gifts and travel', status: 'pending', notes: 'Undisclosed gifts from Harlan Crow; RV from Anthony Welters; Ginni Thomas Jan 6 involvement' },
    { name: 'Samuel Alito', role: 'Failed to disclose luxury fishing trip', status: 'pending', notes: 'Undisclosed Alaska fishing trip with Paul Singer; refused to recuse from Singer cases' },
  ],
  'pandemic-profiteering-covid-corruption': [
    { name: 'Richard Burr', role: 'Senator who sold stocks after classified COVID briefing', status: 'pending', notes: 'DOJ investigation closed without charges 2021; SEC investigation also dropped' },
    { name: 'Kelly Loeffler', role: 'Senator who traded stocks after classified COVID briefing', status: 'pending', notes: 'DOJ cleared of wrongdoing; trades conducted by third-party managers' },
  ],
  'campaign-finance': [
  ...
  'columbia-hca-fraud': [
    ...
    { name: 'Rick Scott', role: 'CEO during fraud; later Governor and Senator', status: 'pending', notes: 'Resigned as CEO; invoked Fifth Amendment 75 times; never charged; elected Governor of Florida twice' },
  ],
  'bill-cosby-sexual-assault': [
    { name: 'Bill Cosby', role: 'Serial sexual assault over decades', status: 'released', charges: ['Three counts of aggravated indecent assault'], sentence: '3-10 years', convictionDate: '2018-04-26', releaseDate: '2021-06-30', notes: 'PA Supreme Court overturned conviction on due process grounds (prior DA non-prosecution agreement)' },
  ],
  ...
  'aig-bailout-scandal': [
    ...
    { name: 'Hank Greenberg', role: 'Former CEO accused of accounting fraud', status: 'settled', fine: '$15 million', notes: 'SEC civil settlement 2017; fought charges for over a decade' },
  ],
  'crypto-exchange-fraud-ecosystem': [
    { name: 'Sam Bankman-Fried', role: 'Founder of FTX who stole billions in customer funds', status: 'convicted', charges: ['Wire fraud', 'Conspiracy to commit money laundering', 'Campaign finance violations'], sentence: '25 years', convictionDate: '2024-03-28', notes: 'Convicted on all counts; FTX collapsed November 2022 with $8B+ missing' },
    ...
    { name: 'Changpeng Zhao', role: 'Binance CEO who violated money laundering laws', status: 'convicted', charges: ['Violating Bank Secrecy Act'], sentence: '4 months', fine: '$50 million personal + $4.3B corporate', convictionDate: '2024-04-30' },
    { name: 'Do Kwon', role: 'Terraform Labs founder - Luna/Terra collapse', status: 'charged', charges: ['Securities fraud', 'Wire fraud', 'Commodities fraud'], notes: 'Extradited to US from Montenegro 2024; $40B collapse of Terra/Luna' },
    { name: 'Alex Mashinsky', role: 'Celsius Network CEO who defrauded depositors', status: 'charged', charges: ['Securities fraud', 'Commodities fraud', 'Wire fraud'], notes: 'Arrested July 2023; Celsius filed bankruptcy with $4.7B hole' },
  ],
  'child-exploitation': [
    { name: 'Jeffrey Epstein', role: 'Financier who ran child sex trafficking network', status: 'charged', charges: ['Sex trafficking of minors', 'Conspiracy to commit sex trafficking'], notes: 'Died in custody August 2019 before trial; first plea deal (2008) widely condemned as corrupt' },
    { name: 'Ghislaine Maxwell', role: 'Recruited and groomed victims for Epstein', status: 'convicted', charges: ['Sex trafficking of a minor', 'Conspiracy', 'Transporting a minor for illegal sexual activity'], sentence: '20 years', convictionDate: '2021-12-29' },
  ],
  'aids-crisis': [
  ...
  'civil-rights': [
    { name: 'J. Edgar Hoover', role: 'FBI Director who ran COINTELPRO against civil rights movement', status: 'pending', notes: 'Died 1972; COINTELPRO revelations came through Church Committee 1975' },
    { name: 'Bull Connor', role: 'Birmingham Commissioner who ordered violence against protesters', status: 'pending', notes: 'Used fire hoses and police dogs on children; catalyzed Civil Rights Act passage' },
    { name: 'Byron De La Beckwith', role: 'Assassin of Medgar Evers', status: 'convicted', charges: ['Murder'], sentence: 'Life', convictionDate: '1994-02-05', notes: 'Two mistrials in 1964 with all-white juries; finally convicted 30 years later' },
  ],
  ...
  'white-supremacist-violence': [
    ...
    { name: 'James Fields Jr.', role: 'Charlottesville car attack that killed Heather Heyer', status: 'convicted', charges: ['29 federal hate crime charges', 'First-degree murder (state)'], sentence: 'Life + 419 years (federal) + Life (state)', convictionDate: '2019-06-28' },
  ],
  'my-lai-massacre': [
    { name: 'William Calley', role: 'Platoon leader who ordered massacre of civilians', status: 'convicted', charges: ['Murder of 22 Vietnamese civilians'], sentence: 'Life (reduced to 3.5 years house arrest)', convictionDate: '1971-03-29', notes: 'Only person convicted despite 26 soldiers charged; Nixon intervened to reduce sentence' },
    { name: 'Ernest Medina', role: 'Company commander who may have ordered massacre', status: 'acquitted', notes: 'Acquitted at court-martial September 1971' },
  ...
  'tuskegee-experiment': [
    ...
    { name: 'John Cutler', role: 'PHS researcher who also ran Guatemala experiments', status: 'pending', notes: 'Conducted nonconsensual STD experiments in Guatemala; died 2003 without accountability' },
  ...
  'russian-interference': [
    ...
    { name: 'Maria Butina', role: 'Russian agent who infiltrated NRA and GOP', status: 'convicted', charges: ['Conspiracy to act as unregistered foreign agent'], sentence: '18 months', convictionDate: '2018-12-13' },
  ],
  'libor-scandal': [
  ...
  'cambridge-analytica-global-operations': [
    ...
    { name: 'Alexander Nix', role: 'CEO of Cambridge Analytica', status: 'pending', notes: 'Suspended then fired; testified to UK Parliament; no criminal charges' },
  ...
  'bribery-corruption': [
    { name: 'Bob Menendez', role: 'Senator convicted of corruption', status: 'convicted', charges: ['Bribery', 'Acting as foreign agent', 'Extortion'], convictionDate: '2024-07-16', notes: 'Found gold bars and cash in home; acted as agent for Egypt' },
    { name: 'Rod Blagojevich', role: 'Illinois Governor who tried to sell Senate seat', status: 'convicted', charges: ['Corruption', 'Attempting to sell Senate seat'], sentence: '14 years', convictionDate: '2011-06-27', pardonDate: '2020-02-18', pardonedBy: 'Donald Trump', notes: 'Commuted by Trump after serving 8 years' },
  ],
};
