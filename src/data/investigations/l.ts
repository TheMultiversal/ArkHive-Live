...
const investigations_l: Record<string, InvestigationData> = {
 ...
 timeline: [
   ...
   { date: '7:06 PM', event: 'Trump poses with Bible in front of St. John\\' },
 ...
 defendants: [
   ...
   { name: 'Federal Officers (multiple agencies)', role: 'Assault on clergy and media at St. John\\', status: 'charged', notes: 'No officers disciplined despite documented attacks on press and religious figures' },
 ],
  },
  'laos-secret-bombing': {
 ...
 date: '1982-01-01',
 lastUpdated: '2026-03-28',
 summary: 'Leonard Leo, co-chairman of the Federalist Society, has orchestrated the most successful judicial capture operation in American history. Through a web of dark money organizations funded by anonymous billionaire donors, Leo engineered the appointments of at least six conservative Supreme Court justices and reshaped the entire federal judiciary. In 2022, it was revealed that electronics magnate Barre Seid donated $1.6 billion to Leo\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Leonard Leo\\', url: 'https://www.politico.com/news/magazine/2022/08/22/leonard-leo-dark-money-00053117', type: 'Article' },
   { title: 'The Man Behind the Supreme Court\\', url: 'https://www.washingtonpost.com/politics/leonard-leo-supreme-court/2019/05/25/', type: 'Article' },
   ...
   { title: 'The Federalist Society\\', url: 'https://www.brookings.edu/articles/the-federalist-societys-influence-on-federal-judges/', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'barre-seid', name: 'Barre Seid', type: 'individual', relationship: 'Electronics magnate who donated $1.6 billion to Leo\\', href: '/entities/individuals/barre-seid' },
   { id: 'clarence-thomas', name: 'Clarence Thomas', type: 'individual', relationship: 'Supreme Court Justice with extensive undisclosed ties to Leo\\', href: '/entities/individuals/clarence-thomas' },
   { id: 'harlan-crow', name: 'Harlan Crow', type: 'individual', relationship: 'Billionaire donor who lavished gifts on Justice Thomas while funding Leo\\', href: '/entities/individuals/harlan-crow' },
   { id: 'don-mcgahn', name: 'Don McGahn', type: 'individual', relationship: 'Trump White House Counsel who implemented Leo\\', href: '/entities/individuals/don-mcgahn' },
   { id: 'mitch-mcconnell', name: 'Mitch McConnell', type: 'individual', relationship: 'Senate leader who blocked Merrick Garland and fast-tracked Leo\\', href: '/entities/individuals/mitch-mcconnell' },
   ...
   { id: 'neil-gorsuch', name: 'Neil Gorsuch', type: 'individual', relationship: 'Supreme Court Justice nominated from Leo\\', href: '/entities/individuals/neil-gorsuch' },
   { id: 'amy-coney-barrett', name: 'Amy Coney Barrett', type: 'individual', relationship: 'Supreme Court Justice, fast-tracked nomination managed by Leo\\', href: '/entities/individuals/amy-coney-barrett' },
   ...
   { id: 'ginni-thomas', name: 'Ginni Thomas', type: 'individual', relationship: 'Conservative activist, wife of Clarence Thomas, connected to Leo\\', href: '/entities/individuals/ginni-thomas' },
 ],
 timeline: [
   ...
   { date: '2016', event: 'McConnell blocks Merrick Garland nomination for 293 days, holding seat open for Leo\\' },
   { date: '2017', event: 'Neil Gorsuch confirmed to stolen Supreme Court seat; Leo\\' },
   { date: '2018', event: 'Leo takes formal leave from Federalist Society to manage Brett Kavanaugh confirmation campaign' },
   { date: '2018', event: 'Leo\\' },
   { date: '2020', event: 'Amy Coney Barrett rushed to confirmation in 30 days before election; Leo\\' },
   { date: '2021', event: 'Supreme Court\\' },
   { date: '2022', event: 'Dobbs v. Jackson overturns Roe v. Wade, the culmination of Leo\\' },
   { date: '2022', event: 'Barre Seid\\' },
   { date: '2023', event: 'ProPublica reveals extensive undisclosed gifts to Clarence Thomas from Harlan Crow and others in Leo\\' },
 ...
 statutes: [
   ...
   { code: '28 U.S.C. § 455', description: 'Failure to recuse, justices with financial ties to Leo\\' },
 ],
 defendants: [
   ...
   { name: 'CRC Advisors (Leo\\', role: 'Self-dealing from nonprofit funds', status: 'charged', notes: 'Under investigation; Leo\\' },
 ],
  },
  'libya-intervention': {
 title: 'Libya Intervention: From Regime Change to Failed State',
 subtitle: 'NATO bombing destroyed Africa\\',
 severity: 'critical',
 category: 'Military & Foreign Policy',
 date: '2011-01-01',
 lastUpdated: '2026-03-28',
 summary: 'In 2011, the United States and NATO allies launched a military intervention in Libya under the guise of"humanitarian protection,"transforming a UN-authorized no-fly zone into a full-scale regime change operation. The bombing campaign destroyed Libya\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Obama Says Libya Was His \\', url: 'https://www.bbc.com/news/world-us-canada-36013703', type: 'Article' },
   ...
   { title: 'Washington Post, Scramble for Libya\\', url: 'https://www.washingtonpost.com/world/national-security/libyas-weapons-flooding-out/', type: 'Article' },
 ],
 affiliations: [
 ...
 timeline: [
   ...
   { date: 'April 2011', event: 'NATO begins targeting Gaddafi\\' },
   { date: 'June 2011', event: 'Obama administration argues bombing doesn\\' },
 ...
 defendants: [
   ...
   { name: 'United States', role: 'Violation of War Powers Resolution, continued bombing beyond 60-day limit without Congressional authorization', status: 'charged', notes: 'Obama administration argued bombing wasn\\' },
