...
const investigations_l: Record<string, InvestigationData> = {
 ...
 { id: '1', name: 'EPA', type: 'agency', relationship: 'Phased out leaded gasoline between 1975-1996; now oversees Lead and Copper Rule for drinking water but enforcement remains inadequate', href: '/entities/agencies/epa' },
   ...
   timeline: [
     ...
     { date: '1955', event: 'Internal LIA documents (discovered during litigation) show that the industry knew as early as 1955 that no level of lead exposure was safe for children; yet the industry continued to sell lead pain...', type: 'default' },
 ...
 { id: '2', name: 'Sinclair Broadcast Group', type: 'corporation', relationship: 'Owns 185 TV stations; imposes centralized conservative editorial content on local broadcasts', href: '/entities/corporations/sinclair' },
   ...
   timeline: [
     ...
     { date: '2018', event: 'In 2018, the Posts own editorial board published an unprecedented plea: "As vultures circle, The Denver Post must be saved." Gannett (the largest newspaper chain, with over 200 dailies) has followe...', type: 'default' },
     { date: '2018', event: 'A 2018 study published in the Journal of Financial Economics found that municipal borrowing costs increased by 5-11 basis points after newspaper closures; representing millions in additional taxpay...', type: 'financial' },
 ...
 { id: '2', name: 'DHS', type: 'agency', relationship: 'Monitors social media of visa applicants, travelers, immigrants, and protesters; produced intelligence reports on journalists during 2020 protests', href: '/entities/agencies/dhs' },
   ...
   timeline: [
     ...
     { date: '2020', event: 'Following the Black Lives Matter protests of 2020, the FBI and DHS monitored protesters social media posts in real time; the Washington Post reported that DHS compiled "intelligence reports" on jou...', type: 'default' },
 ...
 { id: '1', name: 'FMCSA', type: 'agency', relationship: 'Approximately 1,000 investigators covering 500,000+ carriers and 3.5 million drivers; unable to adequately enforce hours-of-service or safety regulations', href: '/entities/agencies/fmcsa' },
  ...
  'lobotomy-epidemic-united-states': {
   ...
   timeline: [
     ...
     { date: '1947', event: 'The legal and ethical standards violated include: the Hippocratic Oath (primum non nocere); the Nuremberg Code (1947), Principle 1 (requiring voluntary, informed consent for medical procedures); ba...', type: 'default' },
     ...
     { date: '1982', event: 'Romeo (1982), recognizing that institutionalized persons have a liberty interest in freedom from unreasonable bodily restraint and harm); and emerging international human rights norms articulated i...', type: 'default' },
   ],
  },
};
