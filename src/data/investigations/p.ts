...
const investigations_p: Record<string, InvestigationData> = {
 ...
 sources: [
   ...
   { title: 'Panama Papers: How the World\\', url: 'https://www.theguardian.com/news/2016/apr/03/what-you-need-to-know-about-the-panama-papers', type: 'Article' },
 ...
 affiliations: [
   { id: 'j-rgen-mossack', name: 'Jürgen Mossack', type: 'individual', relationship: 'Co-founder of Mossack Fonseca; created the law firm that became the world\\', href: '/entities/individuals/jurgen-mossack' },
   { id: 'ram-n-fonseca', name: 'Ramón Fonseca', type: 'individual', relationship: 'Co-founder of Mossack Fonseca and adviser to Panama\\', href: '/entities/individuals/ramon-fonseca' },
   ...
   { id: 'nawaz-sharif', name: 'Nawaz Sharif', type: 'individual', relationship: 'Prime Minister of Pakistan; disqualified from office after papers revealed his family\\', href: '/entities/individuals/nawaz-sharif' },
   { id: 'xi-jinping-family', name: 'Xi Jinping (Family)', type: 'individual', relationship: 'Relatives of China\\', href: '/entities/individuals/xi-jinping' },
   ...
   { id: 'daphne-caruana-galizia', name: 'Daphne Caruana Galizia', type: 'individual', relationship: 'Maltese journalist who investigated Panama Papers connections to Malta\\', href: '/entities/individuals/daphne-caruana-galizia' },
 ],
 timeline: [
   { date: '1977', event: 'Jürgen Mossack founds his law firm in Panama City; Ramón Fonseca joins later to form Mossack Fonseca' },
   { date: '1980s-2010s', event: 'Mossack Fonseca grows to become the world\\' },
   ...
   { date: '2016-05', event: 'UK PM David Cameron admits he profited from his father\\' },
   ...
   { date: '2017-03', event: 'Pakistan\\' },
   { date: '2017-07', event: 'Nawaz Sharif disqualified from office by Pakistan\\' },
   { date: '2017-10-16', event: 'Daphne Caruana Galizia, who investigated Malta\\' },
 ...
 statutes: [
   ...
   { code: 'Pakistan Anti-Corruption Laws', description: 'PM Sharif\\' },
 ...
 sources: [
   ...
   { title: 'ProPublica:"The FBI\\', url: 'https://www.propublica.org/series/the-fbis-manufactured-war-on-terror', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'robert-mueller', name: 'Robert Mueller', type: 'individual', relationship: 'FBI Director, Oversaw FBI\\', href: '/entities/individuals/robert-mueller' },
 ...
 timeline: [
   ...
   { date: '2005-12', event: 'New York Times reveals Bush\\' },
   ...
   { date: '2013-06-06', event: 'Snowden reveals bulk phone metadata collection under Section 215; every American\\' },
   ...
   { date: '2017', event: 'Section 702 of FISA reauthorized with minimal reforms; FBI continues"backdoor searches"of Americans\\' },
   ...
   { date: '2023', event: 'Section 702 reauthorized again; FISA court reveals FBI conducted 278,000 warrantless searches of Americans\\' },
 ],
 statutes: [
 ...
 sources: [
   ...
   { title: 'Alec Smith: The Face of America\\', url: 'https://www.washingtonpost.com/local/he-lost-his-insurance-and-danger-losing-everything/2019/08/02/', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'alec-smith', name: 'Alec Smith', type: 'individual', relationship: '26-year-old diabetic who died rationing insulin he couldn\\', href: '/entities/individuals/alec-smith' },
 ...
 timeline: [
   ...
   { date: 'September 2015', event: 'Martin Shkreli\\' },
   ...
   { date: '2017', event: 'Alec Smith, 26, dies after rationing insulin he could not afford after aging off his parents\\' },
 ...
 date: '1967-01-01',
 lastUpdated: '2026-03-28',
 summary: 'Since 1997, the Department of Defense\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Marshall Project, How the 1033 Program Equipped America\\', url: 'https://www.themarshallproject.org/2014/12/03/the-pentagon-finally-details-its-weapons-for-cops-giveaway', type: 'Article' },
   ...
   { title: 'Washington Post, Police Shootings Database', url: 'https://www.washingtonpost.com/graphics/investigations/police-shootings-database/', type: 'Article' },
   { title: 'Lowery, Wesley, They Can\\', url: 'https://www.hachettebookgroup.com/titles/wesley-lowery/they-cant-kill-us-all/9780316312479/', type: 'Article' },
 ],
 affiliations: [
   ...
   { id: 'donald-trump', name: 'Donald Trump', type: 'individual', relationship: 'President who reversed Obama\\', href: '/entities/individuals/donald-trump' },
 ...
 timeline: [
   ...
   { date: '2017-AUG', event: 'Trump signs Executive Order 13809 reversing Obama\\' },
 ...
 date: '2008-01-01',
 lastUpdated: '2026-03-28',
 summary: 'Starting in the early 2010s, police departments across the United States adopted"predictive policing"software that claimed to use data science to forecast where crimes would occur. In reality, these systems, including PredPol (now Geolitica), HunchLab, and Palantir\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Weapons of Math Destruction, Cathy O\\', url: 'https://www.penguinrandomhouse.com/books/241363/weapons-of-math-destruction-by-cathy-oneil/', type: 'Article' },
   { title: 'Race After Technology, Ruha Benjamin', url: 'https://www.ruhabenjamin.com/race-after-technology', type: 'Article' },
   { title: 'The Verge, Palantir\\', url: 'https://www.theverge.com/2018/2/27/17054740/palantir-predictive-policing-tool-new-orleans-nopd', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'cathy-o', name: 'Cathy O\\', type: 'individual', relationship: 'Mathematician who exposed predictive policing in "Weapons of Math Destruction"', href: '/entities/individuals/cathy-oneil' },
 ...
 timeline: [
   { date: '2008', event: 'IBM develops predictive policing concept for Memphis PD\\' },
   ...
   { date: '2014', event: 'Chicago PD creates "Strategic Subject List"(heat list) scoring individuals\\' },
   ...
   { date: '2016', event: 'ProPublica\\' },
   { date: '2017', event: 'The Verge reveals Palantir\\' },
 ...
 sources: [
   ...
   { title: 'The New York Times -"Inside the Heritage Foundation\\', url: 'https://www.nytimes.com/2024/01/21/magazine/heritage-foundation-project-2025.html', type: 'Article' },
   { title: 'ProPublica -"Inside Project 2025\\', url: 'https://www.propublica.org/article/inside-project-2025-secret-training-videos', type: 'Article' },
   { title: 'The Guardian -"Kevin Roberts: \\', url: 'https://www.theguardian.com/us-news/article/2024/jul/04/project-2025-heritage-foundation-kevin-roberts', type: 'Article' },
 ...
 affiliations: [
   { id: 'kevin-roberts', name: 'Kevin Roberts', type: 'individual', relationship: 'Heritage Foundation President and Project 2025 mastermind. Declared the project a"second American Revolution "that" will remain bloodless if the left allows it to be"- an open threat of political viol', href: '/entities/individuals/kevin-roberts' },
   { id: 'leonard-leo', name: 'Leonard Leo', type: 'individual', relationship: 'Federalist Society co-chairman and dark money kingpin who controls a $1.6 billion political network. Architect of the Supreme Court supermajority. Connected to Project 2025 through overlapping donor n', href: '/entities/individuals/leonard-leo' },
   { id: 'russell-vought', name: 'Russell Vought', type: 'individual', relationship: 'Former OMB Director and author of Project 2025\\', href: '/entities/individuals/russell-vought' },
   { id: 'stephen-miller', name: 'Stephen Miller', type: 'individual', relationship: 'Former Senior Advisor and founder of America First Legal. Author of the mass deportation and immigration crackdown components. Architect of family separation policy. Connected to white nationalist net', href: '/entities/individuals/stephen-miller' },
   ...
   { id: 'john-mcentee', name: 'John McEntee', type: 'individual', relationship: 'Former Director of the Presidential Personnel Office who led Trump-era loyalty purges. Now leads Project 2025\\', href: '/entities/individuals/john-mcentee' },
 ...
 timeline: [
   ...
   { date: '2022-06-24', event: 'Supreme Court overturns Roe v. Wade in Dobbs v. Jackson, a preview of Project 2025\\' },
   ...
   { date: '2023-09-15', event: 'Analysis reveals 140+ former Trump administration officials contributed to Project 2025; despite Trump\\' },
   { date: '2023-11-13', event: 'Trump announces plan to reinstate Schedule F on Day One, proposing to reclassify up to 50,000 federal employees as at-will and fireable, the cornerstone of Project 2025\\' },
   ...
   { date: '2024-07-04', event: 'Kevin Roberts declares on Steve Bannon\\' },
 ...
 statutes: [
   ...
   { code: '18 U.S.C. § 371: Conspiracy to Defraud the United States', description: 'Coordinated effort to interfere with the lawful functions of federal agencies through deceptive means, including Trump\\' },
 ...
 subtitle: 'How the Sackler Family Engineered America\\',
 severity: 'critical',
 ...
 sources: [
   ...
   { title: 'Art of the Steal: Sackler Family\\', url: 'https://www.forbes.com/sites/nathanvardi/2017/10/16/the-oxycontin-clan-the-14-billion-newcomer-to-forbes-2015-list-of-richest-u-s-families/', type: 'Article' },
 ],
 affiliations: [
   { id: 'arthur-m-sackler', name: 'Arthur M. Sackler', type: 'individual', relationship: 'Patriarch who pioneered pharmaceutical marketing techniques; laid groundwork for Purdue\\', href: '/entities/individuals/arthur-sackler' },
   ...
   { id: 'curtis-wright', name: 'Curtis Wright', type: 'individual', relationship: 'FDA examiner who approved OxyContin\\', href: '/entities/individuals/curtis-wright' },
 ...
 statutes: [
   ...
   { code: '18 U.S.C. § 371: Conspiracy to Defraud the United States', description: 'Systematic scheme to impede the DEA\\' },
   ...
   { code: '18 U.S.C. § 1341: Mail Fraud', description: 'Misleading materials sent to doctors and patients about OxyContin\\' },
