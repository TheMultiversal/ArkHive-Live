...
const investigations_p: Record<string, InvestigationData> = {
 ...
 defendants: [
  ...
  'payroll-tax-fraud-industry-analysis': {
    ...
    subtitle: 'The systematic theft of $20-40 billion annually from federal and state governments through worker misclassification, off-the-books labor, and shell company payroll schemes that exploit millions of workers while honest businesses are driven out of competition.',
    severity: 'high' as const,
    category: 'Financial Crime',
    date: 'January 1, 2000',
    lastUpdated: 'March 14, 2023',
    summary: 'Payroll tax fraud, encompassing worker misclassification as independent contractors, off-the-books cash payments, and shell company payroll schemes, costs federal and state governments an estimated $20-40 billion annually in lost revenue. The construction, trucking, janitorial, and home care industries are the worst offenders. Workers harmed by misclassification lose access to unemployment insurance, workers\' compensation, Social Security contributions, and labor law protections. Despite the enormous scale, IRS enforcement has been gutted by decades of budget cuts, conducting only 6,000 employment tax examinations annually across millions of employers.',
    content: [
      'The most pervasive form of payroll tax fraud is worker misclassification, in which employers designate employees as independent contractors to avoid paying Social Security taxes (6.2%), Medicare taxes (1.45%), federal and state unemployment taxes, and workers\' compensation premiums. The IRS estimates that misclassification alone costs the federal Treasury $12-15 billion annually. The Department of Labor and state agencies estimate the total cost, including lost state taxes and insurance premiums, at $20-40 billion. The National Employment Law Project found that 10-30% of employers misclassify at least some workers, with the construction industry worst offender at misclassification rates reaching 40% in states like Texas, Florida, and New York. The economic incentive is straightforward: an employer who misclassifies workers saves 20-40% on labor costs compared to competitors who follow the law, creating an irresistible race to the bottom.',
      'The construction industry exemplifies how payroll fraud distorts entire economic sectors. A 2020 study by the Institute for Construction Economic Research found that fraudulent construction firms gain a 20-30% cost advantage over legitimate competitors by avoiding payroll taxes, workers\' compensation insurance, and employee benefits. This advantage is decisive in competitive bidding, meaning that honest contractors systematically lose work to cheaters. The result is a vicious cycle: as more firms engage in fraud to remain competitive, the baseline of compliance drops, legitimate firms exit or capitulate, and the industry standard becomes non-compliance. In New York City, the Fiscal Policy Institute estimated that construction industry payroll fraud costs the state $500 million annually in lost tax revenue, while 50,000 construction workers are denied proper wages and protections.',
      'Off-the-books labor constitutes the most exploitative form of payroll fraud. In the underground economy, employers pay workers entirely in cash with no tax reporting, withholding, or documentation. This practice is concentrated in construction, restaurants, agriculture, domestic work, car washes, and the gig economy. The IRS estimated the underground economy at approximately $2 trillion, or roughly 8-9% of GDP by some measures. The workers, predominantly immigrants, undocumented individuals, and other marginalized populations, have no legal protections, no recourse for wage theft, and no safety net if injured or killed on the job. When an off-the-books construction worker falls from scaffolding and breaks his back, he has no workers\' compensation, no disability insurance, no legal standing to sue, and often faces threats of deportation if he contacts authorities. The employer faces virtually no consequence.',
      'Sophisticated payroll fraud operations use networks of shell companies through a scheme known as payroll pyramiding. The typical operation involves creating a series of LLCs that serve as employer of record, collecting payroll taxes withheld from workers\' paychecks but never remitting them to the IRS or state tax authorities. When the IRS identifies the delinquent entity, the operators dissolve it and create a new one, transferring the workforce seamlessly. By the time the government catches up, the responsible entity no longer exists and its operators have moved to a new shell. The IRS Criminal Investigation division has identified payroll pyramiding as a growing national problem, particularly in the staffing and construction industries. A single operation in New Jersey was found to have cycled through 47 shell companies over eight years, defrauding the IRS of over $28 million in employment taxes.',
      'The trucking industry faces parallel dynamics with the exploitation of so-called owner-operators. Major trucking companies and freight brokers classify drivers as independent contractors despite controlling virtually every aspect of their work, from routes and schedules to the trucks they drive (often leased from the company at inflated rates). The California Labor Commissioner found that one of the largest port trucking companies in the state misclassified all 800 of its drivers, owing over $6.9 million in back wages and penalties for a single company. The Supreme Court of California\'s 2018 Dynamex decision established the ABC test for independent contractor status, leading to the passage of Assembly Bill 5 (AB5) in 2019. The trucking and gig economy industries responded with Proposition 22, a $200 million ballot initiative that exempted app-based drivers from employee classification, demonstrating the political power of companies built on misclassification.',
      'Home care and janitorial services represent some of the most vulnerable workforces affected by payroll fraud. These industries, often staffed by immigrant women with limited English proficiency, have extremely high misclassification rates. The Economic Policy Institute found that home care workers are misclassified at rates exceeding 30%, stripping them of minimum wage and overtime protections, workers\' compensation, and access to unemployment benefits. When COVID-19 struck, many of these misclassified home care workers continued providing essential services without personal protective equipment, health insurance, or sick leave. The Government Accountability Office documented that domestic workers in private homes are among the least protected workers in the American economy, often excluded from basic labor laws that have covered other workers since the New Deal.',
      'Federal enforcement of payroll tax compliance has been systematically weakened for decades. The IRS conducts approximately 6,000 employment tax examinations annually, a number that has declined sharply since the 1990s even as the number of employers has grown. With roughly 10 million employer tax identification numbers on file, the audit rate for employment taxes is approximately 0.06%, meaning an employer could expect to be examined once every 1,700 years at current rates. The IRS Criminal Investigation division, which handles the most egregious cases, has seen its workforce cut from over 3,000 agents in the 1990s to fewer than 2,000 today. State labor departments are similarly under-resourced, with most states dedicating fewer than 20 investigators to wage and hour enforcement across their entire economies.',
      'The penalties for payroll fraud, when violations are actually discovered and prosecuted, are typically far less than the savings from non-compliance. Civil penalties for failure to deposit employment taxes are 2-15% of the underpayment. Even the Trust Fund Recovery Penalty, which allows the IRS to hold responsible individuals personally liable for willful failure to remit withheld taxes, is limited to 100% of the unpaid amount, with no additional punitive component. Criminal prosecution under 26 U.S.C. 7202 carries a maximum five-year sentence but is rarely pursued. In practice, most payroll fraud is resolved through negotiated installment agreements that allow the violator to continue operating while making partial payments, often at less than the full amount owed. The rational economic calculation for many employers is clear: the expected cost of non-compliance (probability of detection times penalty) is far lower than the certain cost of compliance.',
      'Worker misclassification creates cascading harms throughout the social safety net. When workers are classified as independent contractors rather than employees, they do not have Social Security and Medicare contributions made on their behalf, reducing their lifetime benefits. They are excluded from unemployment insurance, leaving them without income during layoffs. They have no access to workers\' compensation when injured on the job, shifting medical costs to Medicaid and emergency rooms, which are ultimately borne by taxpayers. They cannot access employer-provided health insurance under the Affordable Care Act employer mandate. The Department of Labor estimated that misclassified workers lose an average of $3,710 per year in employment benefits and protections, amounting to tens of billions in aggregate losses to the American workforce.',
      'Several states have established joint enforcement task forces that demonstrate both the scale of the problem and the effectiveness of targeted enforcement. New York\'s Joint Enforcement Task Force on Employee Misclassification, operating from 2007 to 2013, identified over $500 million in unreported wages, assessed $13 million in penalties, and discovered 170,000 instances of employee misclassification. Massachusetts\' Joint Task Force on the Underground Economy recovered over $20 million in penalties and restitution. California\'s Employment Development Department conducted payroll tax audits that identified $7 billion in unreported taxable wages in a single year. These state-level efforts, while successful, represent only a fraction of enforcement capability needed relative to the scale of the fraud.',
      'The intersection of payroll fraud and immigration enforcement creates a particularly toxic dynamic. Employers who hire undocumented workers off the books use the threat of deportation to suppress wage complaints, safety concerns, and organizing efforts. When workers do file complaints with state labor agencies, employers have been documented retaliating by calling Immigration and Customs Enforcement. The Obama administration established guidelines prioritizing workplace enforcement against employers rather than workers, but these protections were reversed under the Trump administration. The result is that the most exploited workers in the economy are precisely those least able to seek legal recourse, creating a system that effectively subsidizes lawbreaking employers with a captive, silenced workforce.',
      'The IRS Voluntary Classification Settlement Program, established in 2011, was intended to encourage employers to prospectively reclassify misclassified workers by offering reduced penalties for past violations. Under the program, employers pay a nominal amount equal to approximately 1% of wages paid to reclassified workers for the prior year, with no interest or penalties and no audits of prior years. While the program has been used by thousands of employers, critics argue it rewards bad behavior by offering a sweetheart deal to companies that knowingly violated the law, while honest employers who classified workers correctly all along receive no benefit. The program also has no mechanism to identify or compel participation by the worst offenders.',
      'The gig economy has industrialized worker misclassification on an unprecedented scale. Companies like Uber, Lyft, DoorDash, and Instacart have built multi-billion-dollar businesses on the classification of millions of workers as independent contractors, despite controlling fundamental aspects of their work through algorithms, pricing, and performance monitoring. A 2020 study found that if gig workers at major platforms were classified as employees, the companies would owe approximately $413 million annually in unemployment insurance contributions in California alone. The companies have spent hundreds of millions on lobbying and ballot initiatives to maintain their classification model, including $200 million on California\'s Proposition 22 and similar efforts in Massachusetts and other states.',
      'Payroll fraud intersects with other forms of financial crime in ways that increase total harm. Employers who misclassify workers or pay off the books also routinely commit wage theft by paying less than minimum wage, denying overtime, and stealing tips. The Economic Policy Institute estimated that wage theft costs American workers $15 billion annually, more than all property crimes combined. Many of the same employers also violate workplace safety requirements, and OSHA data shows that misclassified construction workers experience higher rates of workplace injury and death because independent contractors are excluded from many OSHA protections and their injuries are not recorded in employer safety statistics.',
      'The federal government\'s own procurement practices contribute to the problem. Despite Executive Orders requiring federal contractors to comply with labor laws, enforcement is minimal. A 2010 Senate report found that the 50 largest wage and hour violators in the United States held nearly $18 billion in federal contracts. The government effectively subsidizes payroll fraud by awarding contracts to the lowest bidders, who achieve their cost advantages through worker exploitation. The Fair Pay and Safe Workplaces Executive Order, signed by President Obama in 2014 to require disclosure of labor violations in federal contracting, was rescinded by President Trump in 2017 before it could be fully implemented.',
      'The scale of payroll tax fraud makes it not merely a compliance problem but a fundamental threat to the social contract. Social Security and Medicare depend on employer and employee payroll tax contributions. When $20-40 billion annually is stolen from these systems, it accelerates the insolvency of programs that hundreds of millions of Americans depend on for retirement security and healthcare. Workers whose employers cheat the system accumulate fewer Social Security credits, receiving lower benefits in retirement through no fault of their own. The systemic underfunding of enforcement, combined with penalties that make fraud economically rational, represents a deliberate policy choice to prioritize employer convenience over worker protection, public revenue, and the integrity of the social safety net.'
    ],
    tags: ['Payroll Fraud', 'Worker Misclassification', 'Tax Evasion', 'Underground Economy', 'Construction Industry', 'Labor Exploitation', 'Gig Economy', 'Shell Companies', 'IRS Enforcement', 'Workers Compensation', 'Immigration Exploitation', 'Social Security'],
    sources: [
      { title: 'IRS Criminal Investigation Division: Employment Tax Fraud', url: 'https://www.irs.gov/compliance/criminal-investigation', type: 'Government' },
      { title: 'National Employment Law Project: Worker Misclassification', url: 'https://www.nelp.org', type: 'Research' },
      { title: 'Treasury Inspector General for Tax Administration: Employment Tax Gap', url: 'https://www.treasury.gov/tigta', type: 'Government' },
      { title: 'Economic Policy Institute: Wage Theft and Misclassification Studies', url: 'https://www.epi.org', type: 'Research' },
      { title: 'Government Accountability Office: Employment Tax Enforcement', url: 'https://www.gao.gov', type: 'Government' },
      { title: 'Institute for Construction Economic Research', url: 'https://iceres.org', type: 'Research' },
      { title: 'New York Joint Enforcement Task Force on Employee Misclassification', url: 'https://www.labor.ny.gov', type: 'Government' },
      { title: 'California Employment Development Department Audit Reports', url: 'https://edd.ca.gov', type: 'Government' },
      { title: 'Department of Labor Wage and Hour Division Reports', url: 'https://www.dol.gov/agencies/whd', type: 'Government' },
      { title: 'Fiscal Policy Institute: Construction Industry Fraud Analysis', url: 'https://fiscalpolicy.org', type: 'Research' }
    ],
    affiliations: [
      { id: '1', name: 'IRS', type: 'agency', relationship: 'Primary enforcement agency with capacity gutted by decades of budget cuts; conducts only 6,000 employment tax exams annually across 10 million employers', href: '/entities/agencies/irs' },
      { id: '2', name: 'Department of Labor', type: 'agency', relationship: 'Wage and Hour Division investigates misclassification; issued ABC test guidance under Biden; enforcement reversed under Trump', href: '/entities/agencies/dol' },
      { id: '3', name: 'Uber Technologies', type: 'corporation', relationship: 'Built multi-billion-dollar business on classification of millions of drivers as independent contractors; spent $200M+ on Proposition 22', href: '/entities/corporations/uber' },
      { id: '4', name: 'Lyft Inc.', type: 'corporation', relationship: 'Co-funded Proposition 22 campaign; business model depends on driver misclassification', href: '/entities/corporations/lyft' },
      { id: '5', name: 'DoorDash Inc.', type: 'corporation', relationship: 'Major Proposition 22 funder; classifies all delivery workers as independent contractors', href: '/entities/corporations/doordash' },
      { id: '6', name: 'National Employment Law Project', type: 'organization', relationship: 'Documented misclassification rates of 10-30% across industries; advocates for worker protections', href: '/entities/organizations/nelp' },
      { id: '7', name: 'U.S. Congress', type: 'agency', relationship: 'Authorized IRS budget cuts reducing enforcement capacity; failed to close misclassification loopholes; rescinded contractor disclosure requirements', href: '/entities/agencies/congress' },
      { id: '8', name: 'Social Security Administration', type: 'agency', relationship: 'Trust funds losing billions annually from unpaid payroll taxes; misclassified workers accumulate fewer retirement credits', href: '/entities/agencies/ssa' },
      { id: '9', name: 'OSHA', type: 'agency', relationship: 'Misclassified workers excluded from many workplace safety protections; independent contractor injuries not recorded in employer statistics', href: '/entities/agencies/osha' },
      { id: '10', name: 'ICE / Immigration and Customs Enforcement', type: 'agency', relationship: 'Weaponized by employers against workers who file labor complaints; immigration enforcement used to suppress wage theft reports', href: '/entities/agencies/ice' }
    ],
   eventOriginDate: '2000-01-01',
   lastActivityDate: '2023-03-14',
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1978', event: 'IRS issues Revenue Ruling 87-41 establishing 20-factor test for worker classification, creating framework that employers systematically exploit', type: 'legal' },
     { date: '2000', event: 'GAO reports construction industry misclassification rates reaching 25-40% in multiple states with minimal enforcement response', type: 'default' },
     { date: '2007', event: 'New York establishes Joint Enforcement Task Force on Employee Misclassification, identifying $500 million in unreported wages over six years', type: 'critical' },
     { date: '2010', event: 'Senate report finds 50 largest wage and hour violators hold $18 billion in federal contracts, showing government subsidizes labor fraud', type: 'political' },
     { date: '2011', event: 'IRS launches Voluntary Classification Settlement Program offering reduced penalties for employers who reclassify workers prospectively', type: 'legal' },
     { date: '2012', event: 'IRS Criminal Investigation workforce falls below 2,500 agents, continuing decades-long decline from peak of over 3,000 in the 1990s', type: 'financial' },
     { date: '2014-07-31', event: 'President Obama signs Fair Pay and Safe Workplaces Executive Order requiring federal contractor disclosure of labor violations', type: 'legal' },
     { date: '2017-03-27', event: 'President Trump rescinds Fair Pay and Safe Workplaces EO before full implementation, eliminating contractor labor violation disclosure', type: 'political' },
     { date: '2018-04-30', event: 'California Supreme Court issues Dynamex decision establishing ABC test for independent contractor classification', type: 'legal' },
     { date: '2019-09-18', event: 'California passes Assembly Bill 5 (AB5) codifying ABC test; gig companies immediately challenge in court and at ballot box', type: 'legal' },
     { date: '2020', event: 'Institute for Construction Economic Research documents 20-30% cost advantage for fraudulent firms, systemically driving honest competitors out', type: 'critical' },
     { date: '2020-11-03', event: 'Proposition 22 passes in California with $200 million in gig company spending, exempting app-based drivers from employee classification', type: 'political' },
     { date: '2021-08-20', event: 'Alameda County Superior Court rules Proposition 22 unconstitutional; appeals court later reverses, restoring gig company exemption', type: 'legal' },
     { date: '2022', event: 'IRS employment tax audit rate falls to approximately 0.06%, meaning an employer could expect examination once every 1,700 years', type: 'critical' },
     { date: '2023-01-10', event: 'Department of Labor proposes new rule narrowing independent contractor definition under FLSA; faces industry legal challenges', type: 'legal' },
     { date: '2023-03-14', event: 'California EDD payroll tax audits identify $7 billion in unreported taxable wages in a single year, demonstrating massive scope of fraud', type: 'financial' }
   ],
    defendants: [
      { name: 'Construction Industry Fraudulent Employers', role: 'Systematic misclassification of construction workers as independent contractors to avoid 20-40% in payroll taxes, insurance, and benefits', status: 'pending' as const, notes: 'Misclassification rates reach 40% in some states; honest employers driven out of business by competitors who cheat; $500M+ in unreported wages identified in New York alone' },
      { name: 'Gig Economy Platforms (Uber, Lyft, DoorDash)', role: 'Built multi-billion-dollar businesses on classification of millions of workers as independent contractors while controlling fundamental aspects of their work', status: 'pending' as const, notes: 'Spent $200M+ on Proposition 22 to override AB5; estimated $413M annually in avoided unemployment insurance in California alone' },
      { name: 'Payroll Pyramiding Operations', role: 'Created networks of shell companies to collect payroll taxes from workers\' paychecks while failing to remit to IRS; dissolved entities when detected', status: 'charged' as const, charges: ['26 U.S.C. 7202 - Willful failure to collect or pay over tax', '18 U.S.C. 371 - Conspiracy to defraud the United States'], notes: 'Single NJ operation cycled through 47 shell companies over 8 years, defrauding IRS of $28 million' },
      { name: 'Off-the-Books Employers', role: 'Pay workers entirely in cash with no tax reporting, withholding, or documentation, concentrated in construction, restaurants, agriculture, and domestic work', status: 'pending' as const, notes: 'Underground economy estimated at $2 trillion; workers have no legal protections, recourse for injury, or safety net; deportation threats suppress complaints' }
    ],
    moneyTrail: [
      { date: '2023', from: 'Fraudulent employers', to: 'Avoided payroll taxes', amount: '$20-40B annually', purpose: 'Total estimated annual cost to federal and state governments from worker misclassification, off-the-books labor, and payroll pyramiding', documented: true },
      { date: '2023', from: 'IRS', to: 'Lost revenue from misclassification alone', amount: '$12-15B annually', purpose: 'IRS estimate of federal revenue losses specifically from worker misclassification as independent contractors', documented: true },
      { date: '2020', from: 'Gig platforms', to: 'Proposition 22 campaign', amount: '$200M+', purpose: 'Corporate spending to override California AB5 worker classification law through ballot initiative', documented: true },
      { date: '2013', from: 'New York employers', to: 'Unreported wages identified', amount: '$500M+', purpose: 'Unreported wages discovered by NY Joint Enforcement Task Force on Employee Misclassification over six years of operation', documented: true },
      { date: '2023', from: 'California employers', to: 'Unreported taxable wages', amount: '$7B', purpose: 'Unreported taxable wages identified by California EDD payroll tax audits in a single year', documented: true },
      { date: '2023', from: 'Misclassified workers', to: 'Lost benefits and protections', amount: '$3,710 per worker annually', purpose: 'DOL estimate of average annual loss per misclassified worker in employment benefits and protections', documented: true }
    ],
    statutes: [
      { code: '26 U.S.C. 7202', description: 'Willful failure to collect or pay over tax - criminal penalty for payroll tax fraud' },
      { code: '26 U.S.C. 3102', description: 'FICA tax withholding requirements for employers' },
      { code: '26 U.S.C. 3301', description: 'Federal Unemployment Tax Act (FUTA) employer obligations' },
      { code: '29 U.S.C. 201', description: 'Fair Labor Standards Act - minimum wage, overtime, and classification provisions' },
      { code: '26 U.S.C. 6672', description: 'Trust Fund Recovery Penalty for willful failure to remit withheld employment taxes' },
      { code: 'Cal. Lab. Code 2750.3', description: 'California AB5 codifying ABC test for independent contractor classification' },
      { code: '26 U.S.C. 7201', description: 'Attempt to evade or defeat tax - felony provision applicable to employment tax fraud' },
      { code: '18 U.S.C. 371', description: 'Conspiracy to defraud the United States - used in payroll pyramiding prosecutions' }
    ],
    whereIsTheMoneyNow: [
      { name: 'Fraudulent Employer Profits', relationship: 'Employers pocketing 20-40% cost savings from avoiding payroll taxes, insurance, and benefits', transferMethod: 'Direct cost savings from non-compliance accumulated as profit or used to underbid legitimate competitors', estimatedValue: '$20-40 billion annually across all industries', legalEntities: ['Construction contractors', 'Staffing companies', 'Restaurant chains', 'Agricultural operations', 'Janitorial services'], recoveryMechanisms: ['IRS enforcement actions', 'State joint task force audits', 'Trust Fund Recovery Penalty assessments', 'Criminal prosecution under 26 U.S.C. 7202'] },
      { name: 'Gig Economy Platform Valuations', relationship: 'Multi-billion-dollar companies built on avoided labor costs from worker misclassification', transferMethod: 'Classification of millions of workers as independent contractors avoiding payroll taxes, unemployment insurance, workers\' compensation, and benefits', estimatedValue: '$413M+ annually in California alone in avoided unemployment insurance', legalEntities: ['Uber Technologies', 'Lyft Inc.', 'DoorDash Inc.', 'Instacart'], recoveryMechanisms: ['State reclassification litigation', 'Federal FLSA enforcement', 'DOL independent contractor rule', 'State ballot initiative reversal'] },
      { name: 'Depleted Social Insurance Trust Funds', relationship: 'Social Security and Medicare trust funds losing billions in unpaid contributions', transferMethod: 'Employer failure to withhold and remit FICA taxes reduces trust fund contributions; misclassified workers accumulate fewer credits', estimatedValue: 'Tens of billions in cumulative losses to Social Security and Medicare trust funds', legalEntities: ['Social Security Trust Fund', 'Medicare Hospital Insurance Trust Fund'], recoveryMechanisms: ['Expanded IRS enforcement', 'Mandatory worker classification reporting', 'Increased penalties for willful non-compliance'] }
    ],
    scrubbedFromInternet: [
      { title: 'IRS Employment Tax Audit Capacity Data', type: 'buried' as const, description: 'Detailed annual data on IRS employment tax examination rates, staffing levels, and enforcement outcomes that would reveal the full scope of enforcement collapse', originalSource: 'IRS Data Book and internal staffing reports', removedBy: 'Not formally suppressed but not compiled in accessible format', recoveryStatus: 'partial' as const },
      { title: 'Federal Contractor Labor Violation Disclosures', type: 'destroyed' as const, description: 'Requirements for federal contractors to disclose labor law violations, established by Obama EO in 2014, rescinded by Trump in 2017 before data could be collected', originalSource: 'Fair Pay and Safe Workplaces Executive Order', removedBy: 'Trump administration Executive Order revocation', recoveryStatus: 'lost' as const },
      { title: 'State Misclassification Investigation Results', type: 'buried' as const, description: 'Comprehensive state-by-state data on misclassification rates, enforcement actions, and recovered wages that would enable national comparison of enforcement effectiveness', originalSource: 'State labor departments and joint task forces', removedBy: 'Fragmented across 50 state agencies with no federal compilation', recoveryStatus: 'partial' as const },
      { title: 'Gig Company Internal Classification Analysis', type: 'sealed' as const, description: 'Internal legal and financial analyses by Uber, Lyft, and DoorDash regarding the costs and risks of worker misclassification, including projected liability exposure', originalSource: 'Corporate legal departments', removedBy: 'Attorney-client privilege and trade secret designations', recoveryStatus: 'lost' as const },
      { title: 'Payroll Pyramiding Network Maps', type: 'classified' as const, description: 'IRS Criminal Investigation mapping of shell company networks used in payroll pyramiding schemes across multiple states', originalSource: 'IRS CI investigation files', removedBy: 'Ongoing investigation secrecy', recoveryStatus: 'partial' as const }
    ],
  },
