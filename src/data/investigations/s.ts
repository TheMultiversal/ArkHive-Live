...
const investigations_s: Record<string, InvestigationData> = {
 ...
 { id: '2', name: 'Google', type: 'corporation', relationship: 'YouTube recommendation engine', href: '/entities/corporations/google' },
  ...
  'school-to-prison-pipeline': {
    ...
    subtitle: 'Criminalizing Childhood Through Zero-Tolerance Discipline',
    severity: 'critical' as const,
    category: 'Criminal Justice & Education',
    date: '2024-03-20',
    lastUpdated: '2025-01-30',
    summary: 'Zero-tolerance discipline policies funnel students, disproportionately Black and disabled children, from classrooms into the juvenile and criminal justice systems. School-based arrests, suspensions, and expulsions for minor infractions create permanent records that dramatically increase the likelihood of incarceration.',
    content: [
      'The school-to-prison pipeline describes a national pattern in which punitive school discipline policies push students out of educational settings and into contact with the criminal justice system. More than 250,000 students were referred to law enforcement from schools in a single recent academic year, with offenses as minor as dress code violations, talking back to teachers, or bringing toy weapons to class. Once a student enters the juvenile justice system, the probability of future incarceration increases dramatically.',
      'Racial disparities in school discipline are staggering and well-documented. Black students are suspended at 3.5 times the rate of white students nationally, and in some districts the ratio exceeds 10 to 1. Black girls are suspended at six times the rate of white girls. Students with disabilities are twice as likely to be suspended as their nondisabled peers. These patterns persist even when controlling for income, behavior type, and school characteristics, pointing to systemic bias rather than differences in student conduct.',
      'The presence of school resource officers, now stationed in more than half of American public schools, has transformed routine disciplinary matters into criminal incidents. Behaviors previously handled by teachers or counselors, such as verbal outbursts and scuffles between adolescents, now result in arrests and criminal charges. A 2023 analysis found that schools with SROs had 3.5 times more arrests than comparable schools without police presence, with no measurable improvement in school safety outcomes.',
      'Long-term consequences extend far beyond the initial punishment. Students who are suspended even once are twice as likely to drop out of high school. Juvenile records, though theoretically sealed, frequently surface in background checks and can block access to higher education, military service, and employment. Multiple studies demonstrate that school exclusion is the single strongest predictor of future incarceration, stronger than poverty, family structure, or neighborhood crime rates.',
      'Federal guidance issued under the Obama administration urged schools to reduce exclusionary discipline and address racial disparities. The Trump administration rescinded that guidance in 2018, calling it federal overreach. Meanwhile, cities including Los Angeles, Denver, and Chicago have moved to limit or eliminate school-based arrests and replace punitive discipline with restorative justice programs. Early results show reductions in suspensions of 30% to 50% without increases in school violence, suggesting that the pipeline can be dismantled when the political will exists.',
    ],
    tags: ['school discipline', 'zero tolerance', 'juvenile justice', 'racial disparity', 'school resource officers', 'restorative justice', 'education'],
    sources: [
      'https://www.aclu.org/issues/juvenile-justice/school-prison-pipeline',
      'https://ocrdata.ed.gov/',
      'https://www.sentencingproject.org/publications/shadow-report-school-prison-pipeline/',
    ],
    affiliations: [
      { id: '1', name: 'DOE', type: 'agency', relationship: 'Office for Civil Rights collects discipline data revealing racial disparities; Obama-era guidance rescinded under Trump; Biden DOE restored partial guidance but without enforcement teeth', href: '/entities/agencies/doe' },
      { id: '2', name: 'DOJ', type: 'agency', relationship: 'Obama DOJ investigated discriminatory discipline in school districts including Ferguson-Florissant; Trump DOJ pulled back from consent decrees; Civil Rights Division role scaled back', href: '/entities/agencies/doj' },
    ],
   eventOriginDate: '2018-01-01',
