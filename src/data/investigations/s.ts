...
const investigations_s: Record<string, InvestigationData> = {
 ...
 sources: [
 { title: 'Greenberg Plea Agreement', url: 'https://www.justice.gov/usao-mdfl', type: 'Court Records' },
 ...
 timeline: [
   ...
   { date: 'November 2019', event: 'IG report finds Pompeo\\' },
 ...
 statutes: [
   ...
   { code: '18 U.S.C. § 208', description: 'Conflicts of interest, Kushner\\' },
 ...
 timeline: [
   ...
   { date: 'Nov 2018', event: 'Trump:"Maybe he did, maybe he didn\\' },
 ...
 statutes: [
   ...
   { code: '50 U.S.C. § 3024 (Intelligence Authorization)', description: 'Withholding mandatory intelligence briefing to Congress regarding foreign leader\\' },
   { code: '18 U.S.C. § 371', description: 'Conspiracy to defraud the United States by providing cover for a foreign government\\' },
 ...
 defendants: [
   ...
   { name: 'Kushner (Affinity Partners)', role: 'Potential conflict of interest, receiving $2 billion Saudi investment after leaving government', status: 'charged', notes: 'Congressional investigation launched; ethics officials noted the investment overrode objections from PIF\\' },
 ...
 sources: [
   ...
   { title: 'GAO, Financial Audit: Resolution Trust Corporation\\', url: 'https://www.gao.gov/products/aimd-96-123', type: 'Article' },
   ...
   { title: 'Inside Job: The Looting of America\\', url: 'https://www.penguinrandomhouse.com/books/163461/inside-job-by-stephen-pizzo/', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'john-glenn', name: 'John Glenn', type: 'individual', relationship: 'U.S. Senator (D-OH); one of the Keating Five accused of intervening with regulators on Keating\\', href: '/entities/individuals/john-glenn' },
   ...
   { id: 'dennis-deconcini', name: 'Dennis DeConcini', type: 'individual', relationship: 'U.S. Senator (D-AZ); one of the Keating Five who met with regulators at Keating\\', href: '/entities/individuals/dennis-deconcini' },
 ...
 sources: [
   ...
   { title: 'New York Times, Sinclair\\', url: 'https://www.nytimes.com/2017/05/12/business/media/sinclair-broadcast-komo-702.html', type: 'Article' },
   ...
   { title: 'Columbia Journalism Review, Sinclair\\', url: 'https://www.cjr.org/special_report/sinclair-broadcast-locals.php/', type: 'Article' },
   { title: 'Washington Post, Inside Sinclair\\', url: 'https://www.washingtonpost.com/lifestyle/style/under-new-ownership-a-major-shift-at-wjla-and-news-channel-8/2014/09/02/', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'ajit-pai', name: 'Ajit Pai', type: 'individual', relationship: 'FCC Chairman who relaxed ownership rules benefiting Sinclair\\', href: '/entities/individuals/ajit-pai' },
   { id: 'donald-trump', name: 'Donald Trump', type: 'individual', relationship: 'President who publicly praised Sinclair\\', href: '/entities/individuals/donald-trump' },
   ...
   { id: 'john-oliver', name: 'John Oliver', type: 'individual', relationship: 'Comedian whose "Last Week Tonight"segment brought Sinclair\\', href: '/entities/individuals/john-oliver' },
 ],
 timeline: [
   ...
   { date: 'April 2017', event: 'FCC Chairman Ajit Pai relaxes UHF discount rule, directly enabling Sinclair\\' },
   ...
   { date: 'July 2018', event: 'FCC designates Sinclair\\' },
 ...
 statutes: [
   ...
   { code: 'FCC License Condition, Localism', description: 'Stations are licensed to serve local communities\\' },
 ],
 defendants: [
   ...
   { name: 'FCC', role: 'Chairman Pai relaxed ownership rules specifically to benefit Sinclair\\', status: 'charged', notes: 'Investigation found Pai had improper contacts with Sinclair; no consequences for Pai' },
 ...
 sources: [
   ...
   { title: 'Trump\\', url: 'https://www.washingtonpost.com/news/government/wp/2016/12/02/trump-financial-connections-to-dakota-access-pipeline/', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'chase-iron-eyes', name: 'Chase Iron Eyes', type: 'individual', relationship: 'Attorney and activist who was arrested at Standing Rock; later ran for Congress; Lakota People\\', href: '/entities/individuals/chase-iron-eyes' },
 ...
 timeline: [
   ...
   { date: 'September 2016', event: 'Morton County Sheriff\\' },
 ...
 statutes: [
   ...
   { code: 'National Historic Preservation Act § 106', description: 'Failure to properly consult with tribes about pipeline\\' },
 ...
 sources: [
   ...
   { title: 'Wall Street Journal, Americans\\', url: 'https://web.archive.org/web/2024/https://www.wsj.com/articles/americans-cellphones-targeted-in-secret-u-s-spy-program-1415917533', type: 'Article' },
 ...
 timeline: [
   ...
   { date: 'Early 2000s', event: 'FBI begins deploying Stingrays domestically; technology\\' },
 ...
 timeline: [
   ...
   { date: '1908', event: 'Springfield, Illinois race riot, white mob attacks Black residents near Abraham Lincoln\\' },
 ...
 tags: ['government-corruption', 'corruption', 'justice'],
 sources: [
   ...
   { title: 'ProPublica -"Harlan Crow Bought Property From Clarence Thomas. Thomas Didn\\', url: 'https://www.propublica.org/article/clarence-thomas-harlan-crow-real-estate-scotus', type: 'Article' },
   ...
   { title: 'The New York Times -"Another Provocative Flag Was Flown at Justice Alito\\', url: 'https://www.nytimes.com/2024/05/16/us/justice-alito-flag-beach-house.html', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'samuel-alito', name: 'Samuel Alito', type: 'individual', relationship: 'Associate Justice who accepted undisclosed luxury Alaska fishing trip from Paul Singer, failed to recuse from Singer\\', href: '/entities/individuals/samuel-alito' },
   ...
   { id: 'brett-kavanaugh', name: 'Brett Kavanaugh', type: 'individual', relationship: 'Associate Justice whose $92,000+ in debts were mysteriously paid off before confirmation; nominated after Leonard Leo\\', href: '/entities/individuals/brett-kavanaugh' },
   { id: 'amy-coney-barrett', name: 'Amy Coney Barrett', type: 'individual', relationship: 'Associate Justice confirmed in rushed process 8 days before 2020 election after Leo\\', href: '/entities/individuals/amy-coney-barrett' },
   { id: 'barre-seid', name: 'Barre Seid', type: 'individual', relationship: 'Electronics magnate who donated $1.6 billion (the largest known dark money gift in U.S. history) to Leonard Leo\\', href: '/entities/individuals/barre-seid' },
 ...
 timeline: [
   ...
   { date: '1991-12-01', event: 'Thomas begins relationship with Harlan Crow; Crow\\' },
   ...
   { date: '2009-01-01', event: 'Harlan Crow purchases the house where Thomas\\' },
   ...
   { date: '2014-01-01', event: 'Harlan Crow pays $267,230 in private school tuition for Thomas\\' },
   ...
   { date: '2021-01-06', event: 'Capitol insurrection occurs; Thomas is the lone dissent against releasing White House documents to January 6 Committee, his wife\\' },
   { date: '2022-06-24', event: 'Dobbs v. Jackson overturns Roe v. Wade, the culmination of Leonard Leo\\' },
   { date: '2023-01-23', event: 'Alito\\' },
   ...
   { date: '2023-04-13', event: 'ProPublica reveals Harlan Crow purchased Thomas\\' },
   { date: '2023-06-20', event: 'ProPublica reveals Justice Samuel Alito\\' },
   ...
   { date: '2024-05-16', event: 'NYT reports "Appeal to Heaven"flag (associated with Christian nationalist movement and January 6) was flown at Alito\\' },
 ...
 statutes: [
   ...
   { code: '28 U.S.C. § 455: Disqualification of Justice or Judge', description: 'Mandatory recusal when impartiality might reasonably be questioned, Thomas on January 6 cases involving wife\\' },
   ...
   { code: '26 U.S.C. § 6033: Tax-Exempt Organization Reporting', description: 'Leonard Leo\\' },
 ...
 defendants: [
   ...
   { name: 'Samuel Alito', role: 'Failure to disclose luxury fishing trip from litigant Paul Singer; failure to recuse from Singer\\', status: 'charged', notes: 'No consequences; Alito refused to recuse and published op-ed attacking ProPublica' },
