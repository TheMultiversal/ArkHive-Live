...
const investigations_s: Record<string, InvestigationData> = {
 ...
 defendants: [
  ...
  'social-credit-system-western-adoption': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2014', event: 'China announces Social Credit System rollout; Western equivalents already operate through FICO scores, data brokers, and predictive policing algorithms', type: 'default' },
  ...
  'social-media-radicalization-pipeline': {
    ...
    subtitle: 'How platform algorithms systematically funnel users from mainstream content toward extremist material through engagement-optimized recommendation systems',
    severity: 'high',
    category: 'Media & Technology',
    date: 'March 15, 2019',
    lastUpdated: 'December 10, 2024',
    summary: 'Social media platforms\' recommendation algorithms create radicalization pipelines by optimizing for engagement, which disproportionately favors outrage, conspiracy, and extremist content. Internal research at Meta and YouTube has documented that algorithmic recommendations drive users toward increasingly extreme content, contributing to real-world violence from Christchurch to the U.S. Capitol.',
    content: [
      'YouTube\'s recommendation algorithm has been documented as a primary radicalization vector. A 2019 study by researchers at the Federal University of Minas Gerais found that YouTube\'s "Up Next" recommendations consistently directed users from mainstream political content toward increasingly extreme channels. Former YouTube engineer Guillaume Chaslot built software showing the algorithm systematically promoted conspiracy theories and extremist content because such content generated higher engagement metrics. YouTube\'s own internal research, disclosed by whistleblowers, found that 70% of time spent on the platform was driven by algorithmic recommendations.',
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2018', event: 'Facebook implements "Meaningful Social Interactions" algorithm change that inadvertently amplifies outrage and misinformation content', type: 'critical' },
