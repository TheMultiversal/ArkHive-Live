...
const investigations_a: Record<string, InvestigationData> = {
 ...
 { id: '6', name: 'Interior Department', type: 'agency', relationship: 'Wildlife policy', href: '/entities/agencies/interior-department' },
   ...
   timeline: [
     ...
     { date: '2019-01', event: 'Congressional Research Service Reports — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2021-01', event: 'Congressional Research Service Reports — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2023-01', event: 'Congressional Research Service Reports — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2025-01', event: 'Congressional Research Service Reports — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
 ...
 { id: '3', name: 'FBI', type: 'agency', relationship: 'Investigated server connections', href: '/entities/agencies/fbi' },
   ...
   timeline: [
     ...
     { date: '2017-01', event: 'New Yorker Investigation — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2018-01', event: 'New Yorker Investigation — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2019-01', event: 'New Yorker Investigation — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2020-01', event: 'New Yorker Investigation — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
  'access-hollywood': {
 ...
 { id: '2', name: 'Jeff Bezos', type: 'individual', relationship: 'Founder, profited from exploitation', href: '/entities/individuals/jeff-bezos' },
   ...
   timeline: [
     ...
     { date: '2021-01', event: 'The human cost of same-day delivery — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2022-01', event: 'The human cost of same-day delivery — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2023-01', event: 'The human cost of same-day delivery — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2024-01', event: 'The human cost of same-day delivery — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
  'ai-safety-concerns': {
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Federal investigation and prosecution authority', href: '/entities/agencies/doj' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2015-02-09', event: 'Federal agricultural policies that favor corporate agribusiness over small farmers while contributing to environmental degradat', type: 'default' },
     { date: '2017-01', event: 'Kaiser Family Foundation — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2019-01', event: 'Kaiser Family Foundation — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2021-01', event: 'Kaiser Family Foundation — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2023-01', event: 'Kaiser Family Foundation — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
 ...
 { id: '2', name: 'FDA', type: 'agency', relationship: 'Federal public health regulatory authority', href: '/entities/agencies/fda' },
   ...
   timeline: [
     ...
     { date: '2025-01', event: 'NIH National Library of Medicine — Current status: monitoring continues with active documentation', type: 'critical' },
   ],
 },
  'alt-right': {
 ...
 { id: '2', name: 'Steve Bannon', type: 'individual', relationship: 'Key figure in investigation', href: '/entities/individuals/steve-bannon' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2018', event: 'Core events underlying Southern Poverty Law Center first documented and brought to public attention', type: 'default' },
     { date: '2023', event: 'Subsequent developments in southern poverty law center reveal broader systemic patterns', type: 'default' },
   ],
 },
  'amazon-labor': {
 ...
 { id: '3', name: 'Family Research Council', type: 'organization', relationship: 'Key figure in investigation', href: '/entities/organizations/family-research-council' },
   ...
   timeline: [
     ...
     { date: '2017-01', event: 'ACLU LGBTQ Rights — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2018-01', event: 'ACLU LGBTQ Rights — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2019-01', event: 'ACLU LGBTQ Rights — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2020-01', event: 'ACLU LGBTQ Rights — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
  'anti-lgbtq-movement': {
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Civil Rights Division enforcement authority', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '2021-01', event: 'ACLU LGBTQ Rights — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2022-01', event: 'ACLU LGBTQ Rights — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2023-01', event: 'ACLU LGBTQ Rights — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2024-01', event: 'ACLU LGBTQ Rights — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
  'anti-trans': {
 ...
 { id: '2', name: 'Alliance Defending Freedom', type: 'organization', relationship: 'Legal architect of anti-trans cases', href: '/entities/organizations/alliance-defending-freedom' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2018', event: 'The Tree of Life synagogue shooting in Pittsburgh on October 27, 2018 killed 11 worshippers in the deadliest antisemitic attack in U.S.', type: 'default' },
 ...
 { id: '2', name: 'Heritage Foundation', type: 'corporation', relationship: 'Anti-LGBTQ policy architect', href: '/entities/corporations/heritage-foundation' },
   ...
   timeline: [
     { date: '1979', event: 'The ADL recorded the highest number of antisemitic incidents since it began tracking in 1979, with over 3,600 incidents in a single year.', type: 'default' },
     { date: '2021', event: 'When ViacomCBS stock dropped in March 2021, triggering margin calls, the resulting fire sale caused over $30 billion in losses at banks including Credit Suisse and Nomura.', type: 'default' },
     { date: '2024', event: 'Bill Hwang was convicted of fraud and market manipulation in 2024 for the scheme that regulators called the biggest individual stock manipulation in history.', type: 'default' },
     { date: '2025-01', event: 'United States Holocaust Memorial Museum — Current status: monitoring continues with active documentation', type: 'default' },
   ],
 },
  'archegos-collapse': {
 ...
 { id: '2', name: 'Credit Suisse', type: 'corporation', relationship: 'Key figure in investigation', href: '/entities/corporations/credit-suisse' },
   ...
   pageUpdatedDate: '2026-03-18',
      timeline: [
     { date: '2017', event: 'Trump pardoned Arpaio in 2017 before sentencing, undermining the judicial process and signaling tolerance for civil rights violations.', type: 'default' },
 ...
 { id: '2', name: 'Joe Arpaio', type: 'individual', relationship: 'Key figure in investigation', href: '/entities/individuals/joe-arpaio' },
   ...
   timeline: [
     ...
     { date: '2019-01', event: 'Detention Watch Network — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2021-01', event: 'Detention Watch Network — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2023-01', event: 'Detention Watch Network — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2025-01', event: 'Detention Watch Network — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
  'aurora-shooting': {
 ...
 { id: '2', name: 'Donald Trump', type: 'individual', relationship: 'Authoritarian tendencies in US politics', href: '/entities/individuals/donald-trump' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2022-03-04', event: 'Rising authoritarianism worldwide, including democratic backsliding in established democracies and the strengthening of autocra', type: 'default' },
     { date: '2023-01', event: 'AP News Investigations — Investigation documented and evidence gathering initiated', type: 'default' },
     { date: '2024-01', event: 'AP News Investigations — Key developments identified; accountability analysis updated', type: 'default' },
     { date: '2025-01', event: 'AP News Investigations — Continued monitoring and documentation of ongoing developments', type: 'default' },
     { date: '2026-01', event: 'AP News Investigations — Latest findings incorporated into accountability record', type: 'default' },
   ],
 },
  'autonomous-weapons': {
 ...
 { id: '2', name: 'Pentagon', type: 'agency', relationship: 'Autonomous weapons programs', href: '/entities/agencies/pentagon' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2019-05-19', event: 'The development and deployment of AI-powered autonomous weapons systems with insufficient human oversight and ethical safeguards', type: 'default' },
     { date: '2020-01', event: 'Defense One — Investigation updated with new findings and developments', type: 'default' },
     { date: '2021-01', event: 'Defense One — Ongoing monitoring and documentation of developments', type: 'default' },
     { date: '2022-01', event: 'Defense One — Latest status update and accountability tracking', type: 'default' },
   ],
 },
  'aviation-safety': {
 ...
 { id: '2', name: 'Boeing', type: 'corporation', relationship: 'Key figure in investigation', href: '/entities/corporations/boeing' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2020-09-15', event: 'FAA failures to properly regulate Boeing and other manufacturers, leading to preventable crashes and safety incidents', type: 'critical' },
     { date: '2021-01', event: 'AP News Investigations — Investigation updated with new findings and developments', type: 'critical' },
     { date: '2022-01', event: 'AP News Investigations — Ongoing monitoring and documentation of developments', type: 'critical' },
     { date: '2023-01', event: 'AP News Investigations — Latest status update and accountability tracking', type: 'critical' },
   ],
 },
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Federal investigation and prosecution authority', href: '/entities/agencies/doj' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2021-01-01', event: 'California DFEH lawsuit revealed pervasive sexual harassment, discrimination, and a frat boy culture at Activision Blizzard, leading to t', type: 'default' },
     { date: '2022-01', event: 'ACLU Racial Justice — Investigation updated with new findings and developments', type: 'default' },
     { date: '2023-01', event: 'ACLU Racial Justice — Ongoing monitoring and documentation of developments', type: 'default' },
     { date: '2024-01', event: 'ACLU Racial Justice — Latest status update and accountability tracking', type: 'default' },
   ],
 },
 ...
 sources: [
   ...
   { title: 'The New Yorker -"The General\\', url: 'https://www.newyorker.com/magazine/2007/06/25/the-generals-report', type: 'Article' },
 ...
 affiliations: [
   { id: 'donald-rumsfeld', name: 'Donald Rumsfeld', type: 'individual', relationship: 'Secretary of Defense who personally approved the use of stress positions, hooding, nudity, sensory deprivation, 20-hour interrogations, and military working dogs at Guantanamo Bay, techniques that mig', href: '/entities/individuals/donald-rumsfeld' },
   { id: 'george-w-bush', name: 'George W. Bush', type: 'individual', relationship: 'President who authorized the CIA detention and interrogation program through secret presidential findings. His February 2002 executive order declared Geneva Conventions did not apply to"enemy combatan', href: '/entities/individuals/george-w-bush' },
   { id: 'dick-cheney', name: 'Dick Cheney', type: 'individual', relationship: 'Vice President and primary political architect of the"enhanced interrogation"regime. Advocated personally for waterboarding and other extreme techniques. His office coordinated with the DOJ to produce', href: '/entities/individuals/dick-cheney' },
   { id: 'alberto-gonzales', name: 'Alberto Gonzales', type: 'individual', relationship: 'White House Counsel who authored a January 2002 memo calling the Geneva Conventions "quaint" and"obsolete"- setting the legal stage for torture at both CIA black sites and military prisons like Abu Gh', href: '/entities/individuals/alberto-gonzales' },
   { id: 'john-yoo', name: 'John Yoo', type: 'individual', relationship: 'DOJ Office of Legal Counsel attorney who authored the "Torture Memos"redefining torture so narrowly that waterboarding, stress positions, sleep deprivation, and other abuses were deemed legal, providi', href: '/entities/individuals/john-yoo' },
   { id: 'jay-bybee', name: 'Jay Bybee', type: 'individual', relationship: 'Assistant Attorney General who signed the Torture Memos alongside Yoo. The memos defined torture as requiring pain"equivalent to organ failure or death"- effectively legalizing everything short of kil', href: '/entities/individuals/jay-bybee' },
   { id: 'lt-gen-ricardo-sanchez', name: 'Lt. Gen. Ricardo Sanchez', type: 'individual', relationship: 'Commander of coalition forces in Iraq who authorized interrogation techniques at Abu Ghraib beyond those approved by the Army Field Manual, including the use of dogs, stress positions, and sleep depri', href: '/entities/individuals/ricardo-sanchez' },
   { id: 'maj-gen-antonio-taguba', name: 'Maj. Gen. Antonio Taguba', type: 'individual', relationship: 'Army officer who conducted the classified investigation that documented"sadistic, blatant, and wanton criminal abuses"at Abu Ghraib. His 53-page report was leaked to Seymour Hersh. Taguba was effectiv', href: '/entities/individuals/antonio-taguba' },
   { id: 'brig-gen-janis-karpinski', name: 'Brig. Gen. Janis Karpinski', type: 'individual', relationship: 'Commander of the 800th Military Police Brigade responsible for Abu Ghraib. Demoted from Brigadier General to Colonel, the only officer to face any consequence. She maintained that military intelligenc', href: '/entities/individuals/janis-karpinski' },
   { id: 'lynndie-england', name: 'Lynndie England', type: 'individual', relationship: 'Army Private First Class who appeared in the most iconic Abu Ghraib photographs, pointing at a naked detainee\\', href: '/entities/individuals/lynndie-england' },
   { id: 'charles-graner', name: 'Charles Graner', type: 'individual', relationship: 'Army Specialist and ringleader of the abuses documented in the Abu Ghraib photographs. A corrections officer in civilian life, he organized the human pyramids, dog attacks, and sexual humiliation. Sen', href: '/entities/individuals/charles-graner' },
   { id: 'col-thomas-pappas', name: 'Col. Thomas Pappas', type: 'individual', relationship: 'Commander of the 205th Military Intelligence Brigade at Abu Ghraib who approved the use of dogs during interrogation, a technique that directly led to the photographed abuses. Received a fine and lett', href: '/entities/individuals/thomas-pappas' },
   { id: 'stephen-cambone', name: 'Stephen Cambone', type: 'individual', relationship: 'Under Secretary of Defense for Intelligence, Rumsfeld\\', href: '/entities/individuals/stephen-cambone' },
   { id: 'maj-gen-geoffrey-miller', name: 'Maj. Gen. Geoffrey Miller', type: 'individual', relationship: 'Commander of Guantanamo Bay detention operations sent to Abu Ghraib in August 2003 to "Gitmo-ize"the prison, advising that military police should be used to"set the conditions"for intelligence interro', href: '/entities/individuals/geoffrey-miller' },
 ],
 timeline: [
   ...
   { date: '2008-06-18', event: 'Senate Armed Services Committee releases report concluding that Rumsfeld\\' },
 ...
 defendants: [
   ...
   { name: 'Sabrina Harman (Specialist)', role: 'Conspiracy, maltreating detainees, dereliction of duty, photographed giving thumbs-up next to the corpse of Manadel al-Jamadi and writing "rapeist" on a detainee\\', status: 'convicted', notes: 'Convicted; sentenced to 6 months, bad conduct discharge.' },
   ...
   { name: 'CIA, Manadel al-Jamadi Death', role: 'Iraqi detainee died during CIA interrogation at Abu Ghraib, autopsy ruled homicide. Body was packed in ice and smuggled out to conceal the death.', status: 'charged', notes: 'CIA officer Mark Swanner was referred to DOJ for prosecution. DOJ declined to file charges. No one was ever prosecuted for al-Jamadi\\' },
 ...
 subtitle: '18 Years of Government Lies: How Officials Deceived the Public About America\\',
 severity: 'critical',
 category: 'Military & Foreign Policy',
 date: '2001-01-01',
 lastUpdated: '2026-03-28',
 ...
 affiliations: [
   ...
   { id: 'douglas-lute', name: 'Douglas Lute', type: 'individual', relationship: 'Afghanistan War czar under Bush and Obama; told interviewers"we didn\\', href: '/entities/individuals/douglas-lute' },
 ...
 timeline: [
   ...
   { date: '2009', event: 'Obama triples troop levels to 100,000 with a surge strategy; Douglas Lute privately says"we didn\\' },
   ...
   { date: '2012', event: 'SIGAR begins "Lessons Learned"interview project with over 600 officials about the war\\' },
   ...
   { date: '2021-08-30', event: 'Last U.S. troops leave Afghanistan, ending America\\' },
 ...
 sources: [
   ...
   { title: 'ProPublica, The VA\\', url: 'https://www.propublica.org/article/the-vas-broken-promise-to-thousands-of-vietnam-vets-exposed-to-agent-orange', type: 'Article' },
   ...
   { title: 'New York Times, Agent Orange\\', url: 'https://www.nytimes.com/2014/05/12/us/agent-oranges-long-legacy-for-vietnam-and-veterans.html', type: 'Article' },
 ],
 affiliations: [
 ...
 timeline: [
   ...
   { date: '1965-1970', event: 'Peak spraying years; 6+ million acres sprayed, destroying 20% of South Vietnam\\' },
 ...
 statutes: [
   ...
   { code: 'NEPA: 42 U.S.C. § 4321', description: 'No environmental assessment of herbicide campaign\\' },
 ...
 subtitle: 'Where Corporations Write America\\',
 severity: 'critical',
 category: 'Environmental',
 date: '1973-01-01',
 lastUpdated: '2026-03-28',
 ...
 timeline: [
   ...
   { date: '2009', event: 'ALEC helps draft Arizona\\' },
   ...
   { date: '2021', event: 'ALEC helps draft wave of voter suppression laws following 2020 election, including Georgia\\' },
 ...
 defendants: [
   ...
   { name: 'ALEC fossil fuel preemption bills', role: 'Using nonprofit status to advance corporate profit agenda', status: 'charged', notes: 'Bills passed in multiple states; no accountability for ALEC\\' },
 ],
  },
  'amazon-labor-abuses': {
 ...
 sources: [
   { title: 'The Amazon That Customers Don\\', url: 'https://www.nytimes.com/interactive/2021/06/15/us/amazon-workers.html', type: 'Article' },
   ...
   { title: 'Amazon\\', url: 'https://www.vice.com/en/article/amazon-leaked-memo-details-plan-to-smear-fired-warehouse-organizer/', type: 'Article' },
 ...
 timeline: [
   ...
   { date: '2023', event: 'Investigation reveals Amazon\\' },
 ...
 defendants: [
   ...
   { name: 'Amazon', role: 'Illegal firing of Chris Smalls for protected organizing activity', status: 'charged', notes: 'New York AG investigated; NLRB found Smalls\\' },
   ...
   { name: 'Amazon', role: 'Warehouse safety failures, Edwardsville tornado deaths', status: 'charged', notes: 'OSHA investigation found Amazon didn\\' },
   { name: 'Amazon', role: 'Surveillance and monitoring of workers\\', status: 'charged', notes: 'NLRB found illegal surveillance at multiple facilities; insufficient remedies under current law' },
   { name: 'Amazon/Andy Jassy', role: 'Coercive anti-union statements by CEO', status: 'charged', notes: 'NLRB Administrative Law Judge found Jassy\\' },
 ],
  },
};
