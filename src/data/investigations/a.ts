...
const investigations_a: Record<string, InvestigationData> = {
 ...
 { id: '2', name: 'ExxonMobil', type: 'corporation', relationship: 'Funded climate denial front organizations for decades', href: '/entities/corporations/exxonmobil' },
  ...
  'auto-industry-theft-to-export-rings': {
    ...
    subtitle: 'Organized criminal networks stealing vehicles in the US and shipping them to West Africa, Eastern Europe, and the Middle East',
    severity: 'high',
 ...
 { id: '2', name: 'CBP', type: 'agency', relationship: 'Port-based vehicle export interdiction', href: '/entities/agencies/cbp' },
  ...
  'agricultural-runoff-dead-zone-creation': {
    ...
    subtitle: 'How industrial farming is poisoning waterways and creating ocean dead zones spanning thousands of square miles',
    severity: 'high',
 ...
 { id: '3', name: 'TSA', type: 'agency', relationship: 'Expanding domestic facial recognition to 400+ airports', href: '/entities/agencies/tsa' },
  ...
  'agency-regulatory-capture-new-evidence': {
    ...
    subtitle: 'Documenting how regulated industries systematically seize control of the agencies meant to oversee them',
    severity: 'critical',
    category: 'Institutional Accountability',
    date: 'July 23, 2012',
 ...
 { id: '2', name: 'FinCEN', type: 'agency', relationship: '2025 antiquities AML rule leaving contemporary art unregulated', href: '/entities/agencies/fincen' },
  ...
  'agricultural-worker-exploitation-mapping': {
    ...
    subtitle: 'Systematic forced labor, wage theft, and abuse of migrant farmworkers across the American food supply chain',
    severity: 'critical',
