...
const investigations_h: Record<string, InvestigationData> = {
 ...
 subtitle: 'From Colonial Debt Slavery to Clinton Foundation Disaster Capitalism, America\\',
 severity: 'critical',
 category: 'Government Accountability',
 date: '1804-01-01',
 lastUpdated: '2026-03-28',
 summary: 'Haiti has been systematically exploited by the United States for over two centuries. After becoming the first free Black republic in 1804, Haiti was punished by Western powers, forced to pay France $21 billion (in today\\',
 content: [
 ...
 affiliations: [
   ...
   { id: 'jean-claude-baby-doc-duvalier', name: 'Jean-Claude "Baby Doc "Duvalier', type: 'individual', relationship: 'Dictator (1971-1986) who continued father\\', href: '/entities/individuals/jean-claude-duvalier' },
   ...
   { id: 'gilbert-bigio', name: 'Gilbert Bigio', type: 'individual', relationship: 'Haiti\\', href: '/entities/individuals/gilbert-bigio' },
 ...
 timeline: [
   ...
   { date: '1915-1934', event: 'US occupation imposes forced labor (corvée), rewrites Haiti\\' },
   ...
   { date: '1990', event: 'Jean-Bertrand Aristide wins Haiti\\' },
   ...
   { date: '2011', event: 'WikiLeaks cables reveal Clinton State Department pressured Haiti to keep minimum wage at $0.31/hour for US garment companies Hanes and Levi\\' },
 ...
 statutes: [
   ...
   { code: 'Negligent Homicide, Cholera Introduction', description: 'UN peacekeepers dumped raw sewage containing cholera into Haiti\\' },
   ...
   { code: 'Economic Coercion, Odious Debt', description: 'France\\' },
 ...
 defendants: [
   ...
   { name: 'US Government', role: 'Forced labor during 1915-1934 occupation; supporting Duvalier dictatorships', status: 'charged', notes: 'No accountability; Haiti\\' },
   ...
   { name: 'Hanes / Levi\\', role: 'Lobbying through State Department to suppress Haitian minimum wage', status: 'charged', notes: 'No legal consequences; WikiLeaks cables documented State Department intervention on their behalf' },
 ],
  },
 ...
 affiliations: [
   { id: 'andrew-witty', name: 'Andrew Witty', type: 'individual', relationship: 'CEO of UnitedHealth Group, the largest health insurance company in the world with $371.6B in revenue (2023). UnitedHealth\\', href: '/entities/individuals/andrew-witty' },
   { id: 'david-cordani', name: 'David Cordani', type: 'individual', relationship: 'CEO of Cigna Group (2009-2023). Under his leadership, Cigna expanded its denial rates and prior authorization requirements while posting record profits. Cigna\\', href: '/entities/individuals/david-cordani' },
   { id: 'martin-shkreli', name: 'Martin Shkreli', type: 'individual', relationship: '"Pharma Bro."As CEO of Turing Pharmaceuticals, raised the price of Daraprim, a life-saving anti-parasitic drug, from $13.50 to $750 per pill overnight (a 5,455% increase). Became the public face of ph', href: '/entities/individuals/martin-shkreli' },
   { id: 'heather-bresch', name: 'Heather Bresch', type: 'individual', relationship: 'CEO of Mylan (2012-2020). Presided over the EpiPen price increase from $100 to $608; a 500%+ increase for a life-saving allergy medication that costs approximately $1 to manufacture. Simultaneously lo', href: '/entities/individuals/heather-bresch' },
   { id: 'albert-bourla', name: 'Albert Bourla', type: 'individual', relationship: 'CEO of Pfizer. Quadrupled the price of the COVID-19 vaccine from $19.50 to $110-$130 per dose after the pandemic, a product developed with $2.5B in taxpayer funding. Pfizer\\', href: '/entities/individuals/albert-bourla' },
   { id: 'rick-scott', name: 'Rick Scott', type: 'individual', relationship: 'Former CEO of Columbia/HCA, the largest for-profit hospital chain. Under his leadership, HCA committed the largest Medicare fraud in history, settling for $1.7B. Scott was never charged personally. La', href: '/entities/individuals/rick-scott' },
   { id: 'mitch-mcconnell', name: 'Mitch McConnell', type: 'individual', relationship: 'Senate Minority/Majority Leader. Has received over $4 million in healthcare industry campaign contributions. Led opposition to the Affordable Care Act and every subsequent reform effort, including dru', href: '/entities/individuals/mitch-mcconnell' },
   { id: 'joe-manchin', name: 'Joe Manchin', type: 'individual', relationship: 'U.S. Senator (D-WV). His daughter Heather Bresch was the Mylan CEO who raised EpiPen prices 500%+. Manchin blocked the Build Back Better Act\\', href: '/entities/individuals/joe-manchin' },
   { id: 'donald-trump', name: 'Donald Trump', type: 'individual', relationship: 'Promised to replace the ACA with"something terrific"and to lower drug prices. Instead, his administration expanded short-term junk insurance plans, attempted to eliminate ACA protections, and abandone', href: '/entities/individuals/donald-trump' },
   { id: 'richard-sackler', name: 'Richard Sackler', type: 'individual', relationship: 'Former Chairman of Purdue Pharma. Oversaw the aggressive marketing of OxyContin that fueled the opioid crisis, killing over 500,000 Americans. The Sackler family extracted $10.7B from Purdue while the', href: '/entities/individuals/richard-sackler' },
   { id: 'john-kapoor', name: 'John Kapoor', type: 'individual', relationship: 'Founder and former Chairman of Insys Therapeutics. Convicted of racketeering for bribing doctors to prescribe a powerful fentanyl spray to patients who did not need it, including cancer patients, cont', href: '/entities/individuals/john-kapoor' },
   { id: 'alex-gorsky', name: 'Alex Gorsky', type: 'individual', relationship: 'Former CEO of Johnson & Johnson (2012-2022). J&J knew for decades that its talc-based baby powder contained asbestos and caused cancer. The company used a "Texas two-step"bankruptcy maneuver to limit', href: '/entities/individuals/alex-gorsky' },
   { id: 'stephen-hemsley', name: 'Stephen Hemsley', type: 'individual', relationship: 'Former CEO of UnitedHealth Group (2006-2017). Oversaw UnitedHealth\\', href: '/entities/individuals/stephen-hemsley' },
   { id: 'karen-lynch', name: 'Karen Lynch', type: 'individual', relationship: 'CEO of CVS Health (which acquired Aetna). CVS/Aetna controls insurance, pharmacy benefits, and retail pharmacy, a vertical monopoly that profits at every stage of healthcare delivery while patients pa', href: '/entities/individuals/karen-lynch' },
 ],
 timeline: [
   ...
   { date: '1945', event: 'President Truman proposes a national health insurance program. The AMA brands it"socialized medicine"and spends $1.5 million (equivalent to $23M today) to defeat it, the insurance industry\\' },
   ...
   { date: '1973', event: 'Nixon signs the HMO Act, encouraging the growth of for-profit Health Maintenance Organizations. His advisor John Ehrlichman\\' },
   ...
   { date: '2003', event: 'Medicare Part D prescription drug benefit signed by Bush. The law explicitly prohibits Medicare from negotiating drug prices, a provision written by pharmaceutical industry lobbyist Billy Tauzin, who then became PhRMA\\' },
   { date: '2007', event: 'CIGNA denies a liver transplant to 17-year-old Nataline Sarkisyan, overruling her doctors\\' },
   ...
   { date: '2023', event: 'ProPublica investigation reveals Cigna\\' },
   ...
   { date: 'December 4, 2024', event: 'UnitedHealthcare CEO Brian Thompson shot and killed in Manhattan. The suspect\\' },
 ],
 statutes: [
