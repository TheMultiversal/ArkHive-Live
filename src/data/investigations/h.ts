...
const investigations_h: Record<string, InvestigationData> = {
 ...
 { id: '1', name: 'SEC', type: 'agency', relationship: 'Brings fewer than 50 market manipulation cases annually; "neither admit nor deny" settlements prevent public accountability', href: '/entities/agencies/sec' },
   ...
   timeline: [
     ...
     { date: '2023', event: 'A 2023 Bloomberg investigation found that several prominent hedge fund managers shared identical short positions and traded in lockstep; but proving coordination requires evidence of explicit agree...', type: 'default' },
   ],
  },
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Secures ~500 federal trafficking convictions annually; prosecuted Backpage founders', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '2022', event: 'The International Labour Organization (ILO) estimated in 2022 that 27.6 million people are in forced labor globally; 17.3 million in private sector exploitation (including domestic work, constructi...', type: 'financial' },
     ...
     { date: '2022', event: 'Large-scale trafficking in Gulf states (UAE, Saudi Arabia, Qatar) uses workers from South and Southeast Asia in forced labor conditions; the 2022 Qatar World Cup construction was associated with an...', type: 'default' },
 ...
 { id: '2', name: 'FDA', type: 'agency', relationship: 'Federal public health regulatory authority', href: '/entities/agencies/fda' },
   ...
   timeline: [
     ...
     { date: '2023', event: 'The maximum annual penalty ($2 million for hospitals with 500+ beds, scaled down for smaller hospitals) is meaningless for institutions generating hundreds of millions in revenue; HCA Healthcare (t...', type: 'financial' },
 ...
 { id: '2', name: 'FTC', type: 'agency', relationship: 'Federal Trade Commission consumer protection and antitrust enforcement', href: '/entities/agencies/ftc' },
   ...
   timeline: [
     ...
     { date: '2018', event: 'Law enforcement agencies have used genetic genealogy databases (including GEDmatch and FamilyTreeDNA) to identify suspects through their relatives; the technique was first used publicly in the Gold...', type: 'political' },
     ...
     { date: '2023', event: 'In 2023, the FTC fined BetterHelp $7.8 million for sharing therapy patient data with Facebook, Snapchat, and Criteo for advertising purposes; BetterHelp had promised users their data would remain p...', type: 'financial' },
  ...
  'halliburton-military-contractor-fraud': {
    slug: 'halliburton-military-contractor-fraud',
   ...
   timeline: [
     ...
     { date: '2003', event: 'Halliburton, through its subsidiary Kellogg Brown and Root (KBR), became the largest private military contractor in Iraq and Afghanistan, receiving over $39.5 billion in federal contracts between 2...', type: 'political' },
  ...
  'healthcare-industry-price-gouging': {
   ...
   timeline: [
     ...
     { date: '2023', event: 'The American healthcare system is the most expensive in the world by a massive margin — $4.3 trillion in 2023, representing 17.3% of GDP, compared to 10-12% in other developed nations that achieve ...', type: 'default' },
