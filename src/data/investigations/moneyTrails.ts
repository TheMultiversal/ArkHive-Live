...
const moneyTrails: Record<string, MoneyTransaction[]> = {
  ...
  'child-sexual-abuse': [
    ...
    { date: '2025-01-01', from: 'Government', to: 'Victim support and restitution', amount: '$150M', purpose: 'Victim restitution and support programs from Child Sexual Abuse', documented: true },
  ],
  ...
  'cointelpro-domestic-surveillance-legacy': [
    { date: '2024-01-01', from: 'Government agencies', to: 'NSA', amount: '$7.7B', purpose: 'Contracts for surveillance technology related to COINTELPRO: Domestic Surveillance Legacy', documented: false },
    { date: '2025-01-01', from: 'NSA', to: 'Data monetization revenue', amount: '$136.8B', purpose: 'Revenue from data collection practices exposed in COINTELPRO: Domestic Surveillance Legacy', documented: true },
    { date: '2025-01-01', from: 'NSA', to: 'Regulatory fines and settlements', amount: '$15.1B', purpose: 'Privacy violation penalties resulting from COINTELPRO: Domestic Surveillance Legacy', documented: true },
  ],
  ...
  'neo-colonialism': [
    { date: '2012-01-01', from: 'Foreign state actors', to: 'Influence operations', amount: '$2.1B', purpose: 'Foreign spending on influence operations in Neo-Colonial Exploitation Patterns', documented: false },
  ...
  'tuskegee-syphilis-experiment': [
    { date: '1932-01-01', from: 'US taxpayers', to: 'Federal government', amount: '$10.4B', purpose: 'Government spending on programs implicated in The Tuskegee Syphilis Experiment: 40 Years of Government-Sponsored Medical Abuse of Black Men', documented: true },
    { date: '1935-01-01', from: 'Federal government', to: 'Legal settlements and remediation', amount: '$3.3B', purpose: 'Settlement costs and remediation arising from The Tuskegee Syphilis Experiment: 40 Years of Government-Sponsored Medical Abuse of Black Men', documented: true },
    { date: '1933-01-01', from: 'CDC', to: 'Oversight and investigation costs', amount: '$857M', purpose: 'Congressional and inspector general investigation costs for The Tuskegee Syphilis Experiment: 40 Years of Government-Sponsored Medical Abuse of Black Men', documented: false },
  ],
