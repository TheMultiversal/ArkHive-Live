...
const investigations_d: Record<string, InvestigationData> = {
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Federal human rights enforcement authority', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '1927', event: 'Bell (1927), in which Justice Oliver Wendell Holmes wrote that "three generations of imbeciles are enough." Carrie Buck, the plaintiff, was neither intellectually disabled nor promiscuous; she had ...', type: 'default' },
     ...
     { date: '1979', event: 'Senator James Abourezk held hearings, and the resulting Guidelines for Sterilization (1979) established informed consent protections; but no IHS official was ever prosecuted, and no reparations wer...', type: 'default' },
 ...
 { id: '2', name: 'CIA', type: 'agency', relationship: 'Intelligence assessments of DU health effects in Iraq remain classified', href: '/entities/agencies/cia' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1990', event: 'Studies conducted by Iraqi physicians and international researchers in Basra; where some of the heaviest DU bombardment occurred; documented a 7-fold increase in childhood leukemia rates between 19...', type: 'critical' },
     ...
     { date: '2010', event: 'A 2010 study published in the International Journal of Environmental Research and Public Health found that Fallujah; a city subjected to two major US assaults in 2004; had cancer rates higher than ...', type: 'default' },
 ...
 { id: '2', name: 'Pentagon', type: 'agency', relationship: 'Undercounted civilian deaths by 5-10x according to independent investigations; failed to conduct post-strike assessments', href: '/entities/agencies/pentagon' },
   ...
   timeline: [
     ...
     { date: '2009', event: 'The US armed drone program expanded dramatically under President Obama, who authorized over 540 drone strikes in Pakistan, Yemen, and Somalia between 2009 and 2017; compared to approximately 57 und...', type: 'political' },
 ...
 { id: '2', name: 'EPA', type: 'agency', relationship: 'Environmental regulation and enforcement authority', href: '/entities/agencies/epa' },
   ...
   timeline: [
     ...
     { date: '2019', event: 'Between 2019 and 2022, during the Bolsonaro administration, Amazon deforestation surged 75% compared to the previous four-year period, reaching 13,000 square kilometers in 2021; the highest rate in...', type: 'default' },
     ...
     { date: '2023', event: 'Carbon credit schemes and REDD+ programs (paying forest communities not to deforest) have been undermined by fraudulent credits; a 2023 investigation by The Guardian, Die Zeit, and SourceMaterial f...', type: 'financial' },
 ...
 { id: '1', name: 'FTC', type: 'agency', relationship: 'Issued three reports calling for data broker regulation; enforcement actions criticized as insufficient deterrents', href: '/entities/agencies/federal-trade-commission' },
   ...
   timeline: [
     ...
     { date: '2018', event: 'United States (2018), the Supreme Court ruled that the government needs a warrant to access historical cell phone location data from carriers; but the ruling does not clearly apply to commercially ...', type: 'legal' },
 ...
 { id: '1', name: 'DOJ', type: 'agency', relationship: 'Federal death penalty prosecutions; AEDPA restrictions on habeas corpus have prevented correction of wrongful convictions', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '2011', event: 'The combination of appointed defense counsel with inadequate resources; Alabama had no public defender system at all until 2011; prosecutorial discretion, and all-white jury selection in cases with...', type: 'legal' },
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Federal authority for war crimes prosecution and investigation', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '2016', event: 'A 2016 study by Mark Skidmore and Catherine Austin Fitts at Michigan State University found $21 trillion in unsupported journal voucher adjustments in Army and HUD accounts between 1998 and 2015; a...', type: 'default' },
     ...
     { date: '2021', event: 'A 2021 study by the Project on Government Oversight (POGO) found that 672 former senior government officials; including generals, admirals, senior procurement officials, and members of Congress; mo...', type: 'political' },
 ...
 { id: '2', name: 'DEA', type: 'agency', relationship: 'Enforcement patterns show consistent racial targeting; higher arrest rates in Black communities despite equal drug use rates', href: '/entities/agencies/dea' },
   ...
   timeline: [
     ...
     { date: '2018', event: 'The First Step Act of 2018 reduced some mandatory minimums and made the Fair Sentencing Act retroactive, benefiting approximately 3,500 federal inmates; but it does not apply to state prisons, wher...', type: 'legal' },
 ...
 { id: '1', name: 'FDA', type: 'agency', relationship: 'Generic drug approval process exploited through citizen petitions and 30-month stays; found 81% of blocking petitions filed in bad faith', href: '/entities/agencies/fda' },
   ...
   timeline: [
     ...
     { date: '2023', event: 'A 2023 I-MAK analysis found that the top 12 best-selling drugs in the US were protected by an average of 74 patents each, with expected monopoly periods averaging 38 years from FDA approval; nearly...', type: 'default' },
 ...
 { id: '1', name: 'FDA', type: 'agency', relationship: 'Initially dismissed NDMA contamination findings; inspects foreign drug facilities once every 11 years vs 2.7 years for domestic', href: '/entities/agencies/fda' },
   ...
   timeline: [
     ...
     { date: '2019-09-01', event: 'In September 2019, Valisure, an independent pharmacy, detected the carcinogen NDMA (N-Nitrosodimethylamine) in ranitidine tablets at levels exceeding 3 million nanograms per tablet; over 36,000 tim...', type: 'financial' },
 ...
 { id: '1', name: 'FDA', type: 'agency', relationship: 'Inspects foreign drug facilities once every 11 years; unable to identify all foreign establishments in the drug supply chain', href: '/entities/agencies/fda' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2008', event: 'The 2008 heparin contamination crisis; in which adulterated heparin from Chinese manufacturer Changzhou SPL caused 81 deaths in the United States; demonstrated the dangers of concentrated foreign s...', type: 'critical' },
     ...
     { date: '2018', event: 'Civica Rx, a nonprofit generic pharmaceutical company founded in 2018, has invested in domestic manufacturing of essential generics and biosimilars; but its production capacity covers only a fracti...', type: 'financial' },
     ...
     { date: '2020', event: 'In 2020, early in the COVID-19 pandemic, China temporarily restricted exports of personal protective equipment and placed export controls on APIs; a demonstration of the leverage that supply chain ...', type: 'default' },
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Federal prosecution and oversight authority', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '2010', event: 'The DISCLOSE Act; which would require disclosure of donors contributing over $10,000 to organizations engaging in election spending; has been introduced in Congress repeatedly since 2010 but has ne...', type: 'political' },
 ...
 { id: '2', name: 'DOJ', type: 'agency', relationship: 'Federal human rights enforcement authority', href: '/entities/agencies/doj' },
  ...
  'des-diethylstilbestrol-pharmaceutical-disaster': {
    slug: 'des-diethylstilbestrol-pharmaceutical-disaster',
   ...
   timeline: [
     ...
     { date: '1953', event: 'The legal and regulatory failures include: the FDAs failure to withdraw approval for DES in pregnancy after the 1953 Dieckmann study proved it ineffective; the failure of all 200+ manufacturers to ...', type: 'default' },
