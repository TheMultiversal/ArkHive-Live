...
const investigations_k: Record<string, InvestigationData> = {
 ...
 { id: '4', name: 'CIA', type: 'agency', relationship: 'Expressed concerns about Kushner', href: '/entities/agencies/cia' }
   ...
   timeline: [
     { date: '2017-01', event: 'Kushner submits SF-86 security clearance form with over 100 foreign contacts omitted; form requires multiple amendments as omissions are discovered', type: 'default' },
     { date: '2017-12', event: 'Reports emerge that Kushner discussed establishing a secret back-channel to Moscow using Russian diplomatic facilities during the presidential transition', type: 'critical' },
     { date: '2018-02', event: 'Career White House security officials deny Kushner\'s clearance application; CIA separately expresses concerns and rejects him for access to highly sensitive information', type: 'critical' },
