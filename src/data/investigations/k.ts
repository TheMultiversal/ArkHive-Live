...
const investigations_k: Record<string, InvestigationData> = {
 ...
 date: '1977-01-01',
 lastUpdated: '2026-03-28',
 summary: 'Charles and David Koch built the most powerful private political network in American history, spending over $400 million annually to reshape government policy in their favor. Through a labyrinth of dark money groups, think tanks, and astroturf organizations, the Kochs systematically dismantled environmental regulations, crushed labor unions, slashed taxes for the ultra-wealthy, and funded climate change denial, all while maintaining the fiction that their network represented grassroots American values. The Koch network\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Inside the Koch Brothers\\', url: 'https://www.rollingstone.com/politics/politics-news/inside-the-koch-brothers-toxic-empire-164403/', type: 'Article' },
   ...
   { title: 'Senate Report on Koch Industries\\', url: 'https://www.indian.senate.gov/hearings/oil-theft-indian-lands', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'marc-short', name: 'Marc Short', type: 'individual', relationship: 'Former president of Freedom Partners, later Trump\\', href: '/entities/individuals/marc-short' },
