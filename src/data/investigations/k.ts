...
const investigations_k: Record<string, InvestigationData> = {
 ...
 { id: '2', name: 'Donald Trump', type: 'individual', relationship: 'Ordered clearance for son-in-law', href: '/entities/individuals/donald-trump' },
   ...
   timeline: [
     ...
     { date: '1990', event: 'The Armed Forces Special Powers Act (AFSPA), in effect since 1990, grants the military sweeping powers including the authority to shoot to kill, arrest without warrant, and search any premises; all...', type: 'default' },
 ...
 { id: '1', name: 'Supreme Court', type: 'agency', relationship: 'Upheld Japanese internment', href: '/entities/agencies/supreme-court' },
   ...
   timeline: [
     ...
     { date: '1944', event: 'His case reached the Supreme Court, which ruled 6-3 in 1944 that the internment was constitutional based on "military necessity." Justice Hugo Black wrote that the order was justified by wartime se...', type: 'legal' },
 ...
 { id: '1', name: 'Jared Kushner', type: 'individual', relationship: 'Key figure in investigation', href: '/entities/individuals/jared-kushner' },
  ...
  'kissinger-foreign-policy-war-crimes': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1971', event: 'In 1971, when West Pakistan launched a military campaign against East Pakistan (now Bangladesh) that included systematic mass murder, rape, and displacement of millions, Kissinger and Nixon support...', type: 'critical' },
     { date: '1973', event: 'Kissinger personally directed CIA involvement in the 1973 Chilean coup that overthrew democratically elected President Salvador Allende and installed General Augusto Pinochet', type: 'political' },
     { date: '1973', event: 'He received the Nobel Peace Prize in 1973 (his co-recipient, Le Duc Tho, refused the award)', type: 'default' },
     { date: '1975', event: 'The campaign destabilized rural Cambodia and drove desperate populations toward the Khmer Rouge, which seized power in 1975 and committed genocide killing 1.5-2 million people', type: 'political' },
     { date: '1975-12-01', event: 'In December 1975, Indonesian dictator Suharto informed President Ford and Kissinger of his plan to invade East Timor', type: 'political' },
     { date: '2023-11-29', event: 'He died on November 29, 2023, at age 100, eulogized by world leaders', type: 'critical' },
   ],
  },
  ...
  'kissinger-foreign-policy-war-crimes': {
   ...
   timeline: [
     ...
     { date: '1969-03-01', event: 'Beginning in March 1969 with Operation Menu and expanding into Operation Freedom Deal, the United States dropped over 2.7 million tons of ordnance on Cambodia between 1965 and 1973, more tonnage th...', type: 'financial' },
