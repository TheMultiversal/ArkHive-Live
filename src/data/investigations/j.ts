...
const investigations_j: Record<string, InvestigationData> = {
 ...
 sources: [
   ...
   { title: 'ProPublica, How Jackson\\', url: 'https://www.propublica.org/article/jackson-mississippi-water-crisis', type: 'Article' },
   ...
   { title: 'Catherine Flowers, Waste: One Woman\\', url: 'https://www.thenewpress.com/books/waste', type: 'Article' },
 ...
 date: '2020-01-01',
 lastUpdated: '2026-03-28',
 summary: 'On January 6, 2021, following a rally where President Trump urged supporters to march on the Capitol, thousands stormed the U.S. Capitol building in a violent attempt to stop the certification of Joe Biden\\',
 content: [
 ...
 timeline: [
   ...
   { date: 'Jan 6, 12:00 PM', event: 'Trump speaks:"If you don\\' },
   ...
   { date: 'Jan 6, 1:10 PM', event: 'Trump:"Mike Pence didn\\' },
   ...
   { date: 'Jan 6, 2:38 PM', event: 'Ashli Babbitt shot while breaching Speaker\\' },
 ...
 affiliations: [
   ...
   { id: 'john-l-dewitt', name: 'John L. DeWitt', type: 'individual', relationship: 'Lieutenant General, Commanding General of Western Defense Command, primary architect and advocate of mass removal, made explicitly racist statements including \\', href: '/entities/individuals/john-l-dewitt' },
   { id: 'dillon-s-myer', name: 'Dillon S. Myer', type: 'individual', relationship: 'Director of the War Relocation Authority (WRA); oversaw the administration of ten internment camps housing 120,000+ Japanese Americans, later headed the Bureau of Indian Affairs where he applied simil', href: '/entities/individuals/dillon-s-myer' },
   ...
   { id: 'milton-eisenhower', name: 'Milton Eisenhower', type: 'individual', relationship: 'First Director of the War Relocation Authority, initially oversaw camp operations before resigning after three months, later expressing deep regret and calling internment \\', href: '/entities/individuals/milton-eisenhower' },
   { id: 'fred-korematsu', name: 'Fred Korematsu', type: 'individual', relationship: 'Japanese American civil rights activist, defied internment orders and was convicted in 1942; his case reached the Supreme Court in Korematsu v. United States (1944); conviction vacated in 1983 when go', href: '/entities/individuals/fred-korematsu' },
   ...
   { id: 'norman-mineta', name: 'Norman Mineta', type: 'individual', relationship: 'Japanese American politician, interned at Heart Mountain as a child at age 10; later served as U.S. Secretary of Transportation and U.S. Secretary of Commerce; key advocate for the Civil Liberties Act', href: '/entities/individuals/norman-mineta' },
   { id: 'mike-masaoka', name: 'Mike Masaoka', type: 'individual', relationship: 'National Secretary of the Japanese American Citizens League (JACL); controversial figure who advocated cooperation with the government and promoted the loyalty questionnaire, drawing criticism from wi', href: '/entities/individuals/mike-masaoka' },
 ...
 timeline: [
   ...
   { date: 'February 1943', event: 'The War Department introduces the controversial \\' },
   ...
   { date: 'June 1944', event: 'The 442nd Regimental Combat Team enters combat in Italy, beginning a campaign that will make it the most decorated unit for its size and length of service in U.S. military history, while the soldiers\\' },
   { date: 'December 18, 1944', event: 'The Supreme Court rules 6-3 in Korematsu v. United States that the exclusion order is constitutional, one of the most reviled decisions in Supreme Court history; Justice Frank Murphy dissents, calling it the \\' },
   ...
   { date: '1980-1983', event: 'The Commission on Wartime Relocation and Internment of Civilians (CWRIC) holds hearings across the country; over 750 witnesses testify; the Commission concludes internment was driven by \\' },
   { date: 'November 10, 1983', event: 'Federal judge Marilyn Hall Patel vacates Fred Korematsu\\' },
   ...
   { date: 'October 9, 1990', event: 'The first reparations payments are distributed, accompanied by a signed letter of apology from President George H.W. Bush acknowledging that the internment was \\' },
   ...
   { date: 'June 26, 2018', event: 'In Trump v. Hawaii, the Supreme Court formally repudiates Korematsu v. United States, with Chief Justice Roberts writing that \\' },
 ],
 statutes: [
 ...
 date: '1959-01-01',
 lastUpdated: '2026-03-28',
 summary: 'On November 22, 1963, President John F. Kennedy was assassinated in Dallas, Texas. The Warren Commission concluded that Lee Harvey Oswald acted alone, but decades of evidence, including CIA involvement with anti-Castro operations, Oswald\\',
 content: [
 ...
 sources: [
   ...
   { title: 'JFK Files: What the CIA Didn\\', url: 'https://www.nytimes.com/2017/10/26/us/politics/jfk-files.html', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'j-edgar-hoover', name: 'J. Edgar Hoover', type: 'individual', relationship: 'FBI Director who directed Bureau\\', href: '/entities/individuals/j-edgar-hoover' },
   { id: 'david-atlee-phillips', name: 'David Atlee Phillips', type: 'individual', relationship: 'CIA officer who ran anti-Castro operations; linked to Oswald\\', href: '/entities/individuals/david-atlee-phillips' },
   { id: 'george-de-mohrenschildt', name: 'George de Mohrenschildt', type: 'individual', relationship: 'Oswald\\', href: '/entities/individuals/george-de-mohrenschildt' },
   ...
   { id: 'james-jesus-angleton', name: 'James Jesus Angleton', type: 'individual', relationship: 'CIA Counterintelligence Chief who controlled Oswald\\', href: '/entities/individuals/james-angleton' },
 ...
 timeline: [
   ...
   { date: '1963-09-27', event: 'Oswald visits Soviet and Cuban embassies in Mexico City; CIA surveillance photographs don\\' },
 ...
 defendants: [
   ...
   { name: 'Warren Commission', role: 'Inadequate investigation', status: 'charged', notes: 'HSCA concluded the Commission\\' },
