...
const investigations_j: Record<string, InvestigationData> = {
 ...
 { id: '2', name: 'Department of Justice', type: 'agency', relationship: 'Prosecuted 1,400+ defendants in the largest federal criminal investigation in history', href: '/entities/agencies/doj' }
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2021-01-06T12:00', event: 'Trump addresses supporters at the Ellipse rally for over an hour, telling them "If you don\'t fight like hell, you\'re not going to have a country anymore" and directing them to march to the Capitol', type: 'critical' },
     { date: '2021-01-06T13:10', event: 'First barriers breached at the Capitol; by 2:13 PM rioters break through windows. Senate evacuated at 2:15 PM. House locked down at 2:18 PM', type: 'critical' },
     { date: '2021-01-06T14:24', event: 'Ashli Babbitt shot by Capitol Police while climbing through a broken window toward the House chamber. Officer Brian Sicknick sprayed with chemical irritants; dies the following day', type: 'critical' },
     { date: '2021-01-06T17:20', event: 'National Guard troops finally arrive at the Capitol; over three hours after the initial breach. Capitol Police Chief Sund had requested aid at 1:49 PM; Pentagon delayed approval until 5:08 PM', type: 'political' },
