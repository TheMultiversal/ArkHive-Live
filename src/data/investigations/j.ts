...
const investigations_j: Record<string, InvestigationData> = {
 ...
 { id: '1', name: 'DOJ', type: 'agency', relationship: 'Secretly subpoenaed phone and email records of reporters at NYT, Washington Post, AP, and CNN; prosecuted 8 leakers under Espionage Act during Obama era', href: '/entities/agencies/doj' },
   ...
   timeline: [
     ...
     { date: '2015', event: 'The DOJ adopted internal guidelines in 2015 (revised in 2022) restricting when prosecutors can seek journalist records, but these guidelines are policy; not law; and can be waived or changed by any...', type: 'legal' },
     ...
     { date: '2020', event: 'In the case of the New York Times, the DOJ obtained a court order in 2020 compelling Google to provide email records of four reporters; the order included a gag provision preventing Google from not...', type: 'legal' },
 ...
 { id: '1', name: 'DOJ', type: 'agency', relationship: 'Civil Rights Division investigates unconstitutional conditions in juvenile facilities; has found violations in virtually every state examined', href: '/entities/agencies/doj' },
  ...
  'jackson-mississippi-water-crisis': {
    slug: 'jackson-mississippi-water-crisis',
  ...
  'johnson-and-johnson-talc-cancer': {
   ...
   timeline: [
     ...
     { date: '2018', event: 'Johnson & Johnson marketed its iconic baby powder as the epitome of purity and safety for over a century, targeting mothers and babies with the tagline "Best for Baby, Best for You." Internal compa...', type: 'default' },
  ...
  'judicial-corruption-cash-for-kids': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2000', event: 'Since 2000, judges across the country have been convicted of or removed for: accepting bribes to fix cases (Judge Thomas Porteous, Louisiana, impeached 2010); sexual misconduct toward litigants and...', type: 'legal' },
  ...
  'japanese-american-internment': {
   ...
   timeline: [
     ...
     { date: '1988', event: 'The broad historical causes which shaped these decisions were race prejudice, war hysteria, and a failure of political leadership." Based on these findings, Congress passed the Civil Liberties Act ...', type: 'political' },
