...
const investigations_n: Record<string, InvestigationData> = {
 ...
 { id: '1', name: 'DOJ', type: 'agency', relationship: 'Stop-and-frisk consent decree', href: '/entities/agencies/doj' },
  ...
  'narrative-control-through-search-algorithms': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2019', event: 'A 2019 study by researchers at the American Institute for Behavioral Research and Technology found that biased search results could shift voting preferences by 20% or more among undecided voters; a...', type: 'political' },
  ...
  'nsa-warrantless-wiretapping': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1978', event: 'THE FISA COURT: RUBBER STAMP OF SURVEILLANCE: The Foreign Intelligence Surveillance Court (FISC), established in 1978 as a check on government surveillance, approved 99.97% of the surveillance requ...', type: 'legal' },
