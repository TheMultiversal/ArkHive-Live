...
const investigations_i: Record<string, InvestigationData> = {
 ...
 sources: [
   ...
   { title: 'Inside ICE\\', url: 'https://www.nytimes.com/2018/12/05/us/politics/border-migrants-detained-children.html', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'kevin-mcaleenan', name: 'Kevin McAleenan', type: 'individual', relationship: 'CBP Commissioner who oversaw conditions leading to children\\', href: '/entities/individuals/kevin-mcaleenan' },
 ...
 sources: [
   ...
   { title: 'PBS: Unspoken: America\\', url: 'https://www.pbs.org/video/unspoken-americas-native-american-boarding-schools-preview-xtlsaj/', type: 'Article' },
 ],
 affiliations: [
   ...
   { id: 'dillon-myer', name: 'Dillon Myer', type: 'individual', relationship: 'Commissioner of the Bureau of Indian Affairs (1950-1953). Previously directed Japanese American internment camps. Accelerated termination and relocation policies that continued the boarding school leg', href: '/entities/individuals/dillon-myer' },
   { id: 'bryan-newland', name: 'Bryan Newland', type: 'individual', relationship: 'Assistant Secretary for Indian Affairs. Led the Federal Indian Boarding School Initiative investigation and authored the landmark 2022 and 2024 investigative reports documenting deaths and burial site', href: '/entities/individuals/bryan-newland' },
   ...
   { id: 'carl-schurz', name: 'Carl Schurz', type: 'individual', relationship: 'U.S. Secretary of the Interior (1877-1881). Approved and funded Pratt\\', href: '/entities/individuals/carl-schurz' },
   ...
   { id: 'milton-eisenhower', name: 'Milton Eisenhower', type: 'individual', relationship: 'Brother of Dwight D. Eisenhower. Oversaw relocations of Native Americans and Japanese Americans. His brother\\', href: '/entities/individuals/milton-eisenhower' },
   { id: 'john-collier', name: 'John Collier', type: 'individual', relationship: 'Commissioner of Indian Affairs (1933-1945). Implemented the Indian Reorganization Act of 1934, which slowed but did not end boarding schools. Credited with modest reforms while schools continued opera', href: '/entities/individuals/john-collier' },
 ...
 timeline: [
   ...
   { date: '1869', event: 'President Grant\\' },
 ...
 statutes: [
   { code: '18 U.S.C. § 1091: Genocide', description: 'The systematic destruction of Native American cultures, languages, and identities through forced child removal meets the UN Genocide Convention\\' },
 ...
 sources: [
   { title: 'The Jakarta Method: Washington\\', url: 'https://www.vincentbevins.com/book', type: 'Article' },
   ...
   { title: 'International People\\', url: 'http://www.tribunal1965.org/en/final-report-of-the-ipt-1965/', type: 'Article' },
   { title: 'Indonesia\\', url: 'https://apnews.com/article/indonesia-us-declassified-1965-killings-b63b7f8b9c7845c3b4d51e0acb7f3fd9', type: 'Article' },
 ...
 timeline: [
   ...
   { date: '1965-10-01', event: 'Suharto takes control of the army and launches propaganda campaign blaming PKI for the generals\\' },
   ...
   { date: '1965-12', event: 'State Department cables express satisfaction with the"army\\' },
   ...
   { date: '2017', event: 'International People\\' },
 ],
 statutes: [
   ...
   { code: 'UN Charter, Article 2(4)', description: 'US interference in Indonesia\\' },
 ...
 defendants: [
   { name: 'Indonesian Government', role: 'Genocide and crimes against humanity', status: 'charged', notes: 'International People\\' },
 ...
 date: '1901-01-01',
 lastUpdated: '2026-03-28',
 summary: 'In August 1953, the CIA and British MI6 orchestrated a coup d\\',
 content: [
 ...
 sources: [
   ...
   { title: 'All the Shah\\', url: 'https://www.wiley.com/en-us/All+the+Shah%27s+Men-p-9780470185490', type: 'Article' },
 ...
 affiliations: [
   { id: 'mohammad-mosaddegh', name: 'Mohammad Mosaddegh', type: 'individual', relationship: 'Democratically elected Prime Minister of Iran (1951-1953). TIME Magazine\\', href: '/entities/individuals/mohammad-mosaddegh' },
   { id: 'shah-mohammad-reza-pahlavi', name: 'Shah Mohammad Reza Pahlavi', type: 'individual', relationship: 'Shah of Iran who was reinstalled by the CIA coup. Ruled as autocrat for 25 years with U.S. military and intelligence support. His regime\\', href: '/entities/individuals/shah-pahlavi' },
   { id: 'kermit-roosevelt-jr', name: 'Kermit Roosevelt Jr.', type: 'individual', relationship: 'CIA officer who directed Operation Ajax from inside Tehran. Grandson of President Theodore Roosevelt. Bribed military officers, organized street mobs, planted anti-Mosaddegh propaganda, and orchestrat', href: '/entities/individuals/kermit-roosevelt' },
   { id: 'allen-dulles', name: 'Allen Dulles', type: 'individual', relationship: 'CIA Director who authorized and oversaw Operation Ajax. Brother of Secretary of State John Foster Dulles. Both Dulles brothers had personal financial ties to companies with interests in Iranian oil th', href: '/entities/individuals/allen-dulles' },
   ...
   { id: 'henry-kissinger', name: 'Henry Kissinger', type: 'individual', relationship: 'Later Secretary of State who maintained close relationship with the Shah, sold massive quantities of U.S. weapons to Iran, and encouraged the Shah\\', href: '/entities/individuals/henry-kissinger' },
   { id: 'richard-nixon', name: 'Richard Nixon', type: 'individual', relationship: 'As Vice President, visited Tehran after the coup to congratulate the Shah. Later as President, the "Nixon Doctrine"made Iran a key U.S. proxy, providing blank-check weapons sales that fueled the Shah\\', href: '/entities/individuals/richard-nixon' },
   { id: 'winston-churchill', name: 'Winston Churchill', type: 'individual', relationship: 'British Prime Minister who pressured the Eisenhower administration to support the coup after the Truman administration refused. Framed the oil nationalization as a communist threat to secure American', href: '/entities/individuals/winston-churchill' },
   { id: 'fazlollah-zahedi', name: 'Fazlollah Zahedi', type: 'individual', relationship: 'Iranian general handpicked by MI6 and CIA to replace Mosaddegh. Installed as Prime Minister after the coup. Had been arrested by the British during WWII for pro-Nazi sympathies, yet was chosen to lead', href: '/entities/individuals/fazlollah-zahedi' },
   { id: 'dwight-d-eisenhower', name: 'Dwight D. Eisenhower', type: 'individual', relationship: 'U.S. President who authorized Operation Ajax after being persuaded by the Dulles brothers that Mosaddegh would allow Iran to fall to communism. The Truman administration had rejected British requests', href: '/entities/individuals/dwight-eisenhower' },
   { id: 'donald-wilber', name: 'Donald Wilber', type: 'individual', relationship: 'CIA operative who wrote the classified after-action report on Operation Ajax ("Overthrow of Premier Mossadeq of Iran") - the detailed blueprint that was leaked to the New York Times in 2000, providing', href: '/entities/individuals/donald-wilber' },
   { id: 'nematollah-nassiri', name: 'Nematollah Nassiri', type: 'individual', relationship: 'Iranian colonel who delivered the Shah\\', href: '/entities/individuals/nematollah-nassiri' },
 ],
 timeline: [
   { date: '1901', event: 'William Knox D\\' },
   ...
   { date: '1949-1950', event: 'Iranian public outrage over the lopsided AIOC deal intensifies. Iran receives only 16% of oil profits. AIOC has never allowed Iran to audit its books. Saudi Arabia negotiates a 50/50 deal with ARAMCO, making Iran\\' },
   { date: 'March 15, 1951', event: 'Iranian parliament (Majlis) votes unanimously to nationalize the oil industry. Mosaddegh becomes Prime Minister with a mandate to reclaim Iran\\' },
   ...
   { date: 'October 1951', event: 'Mosaddegh named TIME Magazine "Man of the Year"for 1951. Addresses the UN Security Council and the International Court of Justice, arguing Iran\\' },
   ...
   { date: 'August 15, 1953', event: 'First coup attempt fails. Colonel Nassiri delivers the Shah\\' },
   ...
   { date: 'August 19, 1953', event: 'Second coup succeeds. CIA-paid mobs flood Tehran streets, creating appearance of popular uprising. Bribed military units seize key buildings. Tank columns roll through the capital. Mosaddegh\\' },
   { date: 'August 22, 1953', event: 'The Shah returns triumphantly from Rome to Tehran. Mosaddegh imprisoned. General Zahedi installed as Prime Minister. Iran\\' },
   { date: '1954', event: 'New oil consortium agreement: Iran gets 50% of profits but AIOC (renamed BP) retains 40% ownership alongside American companies who now get a 40% share. The coup\\' },
   { date: '1957', event: 'CIA and Mossad help establish SAVAK (Sazeman-e Ettela\\' },
   { date: '1963-1979', event: 'Shah\\' },
 ...
 statutes: [
   { code: 'UN Charter Article 2(4): Prohibition on Use of Force Against Territorial Integrity', description: 'The covert overthrow of a sovereign nation\\' },
   { code: 'OAS/UN Charter, Prohibition on Intervention in Internal Affairs', description: 'The United States and United Kingdom illegally intervened in Iran\\' },
   ...
   { code: 'Convention Against Torture (CAT)', description: 'The Shah\\' },
   { code: 'Geneva Conventions, Collective Punishment', description: 'Britain\\' },
   { code: 'Rome Statute, Crimes Against Humanity (Article 7)', description: 'The Shah\\' },
 ...
 defendants: [
   { name: 'Mohammad Mosaddegh', role: 'Charged with "treason" by the Shah\\', status: 'incarcerated', notes: '3 years in prison followed by lifetime house arrest until death in 1967. The victim of the crime was the one punished' },
   ...
   { name: 'U.S. Government', role: 'Overthrowing a democratic government, supporting a dictatorship for 25 years, creating conditions for regional instability', status: 'charged', notes: 'CIA admitted role in 2013. Obama referenced the coup in his 2009 Cairo speech. No formal apology, no reparations, no accountability for 25 years of supporting Shah\\' },
 ],
  },
  'iraq-war-lies': {
 title: 'Iraq War Lies',
 ...
 sources: [
   ...
   { title: 'The New York Times -"The Times and Iraq: A Look at Coverage"(Editors\\', url: 'https://www.nytimes.com/2004/05/26/world/from-the-editors-the-times-and-iraq.html', type: 'Article' },
   { title: 'Richard Clarke -"Against All Enemies: Inside America\\', url: 'https://web.archive.org/web/2023/https://www.simonandschuster.com/books/Against-All-Enemies/Richard-A-Clarke/9780743260244', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'dick-cheney', name: 'Dick Cheney', type: 'individual', relationship: 'Vice President and primary architect of the Iraq War; repeatedly claimed Iraq had"reconstituted nuclear weapons"despite CIA assessments to the contrary; created pressure campaign on intelligence agenc', href: '/entities/individuals/dick-cheney' },
   ...
   { id: 'george-tenet', name: 'George Tenet', type: 'individual', relationship: 'CIA Director who told Bush the WMD case was a"slam dunk"and later oversaw the fabrication of Colin Powell\\', href: '/entities/individuals/george-tenet' },
   ...
   { id: 'scooter-libby', name: 'Scooter Libby', type: 'individual', relationship: 'Cheney\\', href: '/entities/individuals/scooter-libby' },
 ...
 timeline: [
   ...
   { date: '2001-01-30', event: 'First National Security Council meeting of Bush presidency discusses Iraq invasion; Treasury Secretary O\\' },
   ...
   { date: '2002-09-08', event: 'Condoleezza Rice warns on CNN that"we don\\' },
   { date: '2002-10-01', event: 'National Intelligence Estimate on Iraqi WMD is produced in just three weeks, normally takes months; State Department\\' },
   ...
   { date: '2002-10-11', event: 'Congress authorizes the use of military force against Iraq based on the administration\\' },
   { date: '2003-01-28', event: 'Bush\\' },
   ...
   { date: '2003-07-06', event: 'Ambassador Joseph Wilson publishes NYT op-ed revealing the Niger yellowcake uranium claim was baseless, his wife Valerie Plame\\' },
   ...
   { date: '2005-11-09', event: 'Curveball\\' },
   { date: '2006-02-09', event: 'Scooter Libby indicted for perjury and obstruction related to the leak of Valerie Plame\\' },
 ...
 statutes: [
   { code: '18 U.S.C. § 1001: False Statements to Congress', description: 'Bush, Cheney, Rice, Rumsfeld, and others made at least 935 false statements about Iraq\\' },
   ...
   { code: '50 U.S.C. § 421: Intelligence Identities Protection Act', description: 'Deliberate disclosure of CIA officer Valerie Plame\\' },
 ...
 defendants: [
   ...
   { name: 'Curveball (Rafid al-Janabi)', role: 'Fabricated the mobile bioweapons lab claims that became the centerpiece of the WMD case and Powell\\', status: 'charged', notes: 'Admitted in 2011 the claims were entirely fabricated; never prosecuted; lives in Germany' },
   { name: 'Judith Miller', role: 'Published fabricated WMD stories in the New York Times based on administration sources, manufacturing public consent for war', status: 'charged', notes: 'NYT published editors\\' },
   ...
   { name: 'International Criminal Court', role: 'Iraq War found to constitute a war of aggression under international law, the"supreme international crime"', status: 'charged', notes: 'The U.S. does not recognize ICC jurisdiction; no international prosecution; American Service-Members\\' },
 ],
  },
};
