...
const investigations_i: Record<string, InvestigationData> = {
 ...
 { id: '2', name: 'SEC', type: 'agency', relationship: 'Securities regulation and financial crime enforcement', href: '/entities/agencies/sec' }
  ...
  'iran-contra-scandal': {
    ...
    content: [
      'ARMS SALES TO IRAN: Senior Reagan administration officials secretly sold over 2,000 TOW missiles and HAWK missile parts to Iran in violation of the U.S. arms embargo, ostensibly to secure release of American hostages held in Lebanon. National Security Advisor Robert McFarlane and his successor John Poindexter authorized the sales with Oliver North coordinating logistics.',
      'CONTRA FUNDING: Proceeds from the Iranian arms sales were diverted to fund the Contras, a rebel group fighting the Sandinista government in Nicaragua. This violated the Boland Amendment, which explicitly prohibited U.S. government funding of the Contras. The diversion was managed through Swiss bank accounts and shell companies.',
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1985-08', event: 'First secret shipment of 96 TOW missiles to Iran via Israel; Reagan administration circumvents arms embargo to pursue hostage negotiations', type: 'default' },
     { date: '1986-11-03', event: 'Lebanese magazine Al-Shiraa exposes the secret arms sales; scandal breaks into public view', type: 'default' },
     { date: '1986-11-25', event: 'Attorney General Meese announces discovery of funds diversion to Contras; Oliver North fired, John Poindexter resigns', type: 'political' },
