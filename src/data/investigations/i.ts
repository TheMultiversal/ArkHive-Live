...
const investigations_i: Record<string, InvestigationData> = {
 ...
 { id: '4', name: 'UN Security Council', type: 'organization', relationship: 'Imposed and maintained sanctions', href: '/entities/organizations/un-security-council' },
   ...
   timeline: [
     ...
     { date: '1998', event: 'RESIGNATION OF UN OFFICIALS: Denis Halliday (UN Humanitarian Coordinator) resigned in 1998, calling sanctions a "violation of human rights."His successor, Hans von Sponeck, also resigned in 2000 fo...', type: 'political' },
 ...
 { id: '2', name: 'SEC', type: 'agency', relationship: 'Has never brought an enforcement action against a sitting member of Congress for insider trading despite documented violations', href: '/entities/agencies/sec' },
   ...
   timeline: [
     ...
     { date: '2022', event: 'In 2022, House Speaker Nancy Pelosi initially opposed a stock trading ban, stating that members should be free to participate in the economy; she later reversed her position under public pressure b...', type: 'political' },
   ],
  },
  'italian-american-mafia-modern-operations': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1953', event: 'The Waterfront Commission of New York Harbor, created in 1953 specifically to combat mob control of the ports, has faced repeated political attempts to defund or disband it; including a 2018 New Je...', type: 'default' },
     ...
     { date: '2020', event: 'In 2020, eight members and associates of the Genovese family were convicted for controlling the International Longshoremen Association Local 1235; extorting payments from shipping companies at port...', type: 'legal' },
 ...
 { id: '3', name: 'Ronald Reagan', type: 'individual', relationship: 'President who authorized arms sales to Iran and claimed inability to recall key decisions; administration solicited foreign governments to circumvent Boland Amendment', href: '/entities/individuals/ronald-reagan' },
   ...
   timeline: [
     ...
     { date: '1984', event: 'Saudi Ambassador Prince Bandar bin Sultan facilitated contributions totaling $32 million to Contra bank accounts between 1984 and 1986; arranged through conversations with National Security Advisor...', type: 'financial' },
 ...
 { id: '1', name: 'EPA', type: 'agency', relationship: 'Enforces Clean Water Act but enforcement actions declined 50%+ since 2006; regulates only 90 of 86,000 commercial chemicals in drinking water', href: '/entities/agencies/epa' },
   ...
   timeline: [
     ...
     { date: '2008', event: 'Industrial contamination from specific sectors is catastrophic: coal ash ponds (containing arsenic, mercury, lead, and selenium) exist at over 500 power plant sites; the 2008 Kingston Fossil Plant ...', type: 'legal' },
     { date: '2019', event: 'A 2019 study published in PNAS found that Black and Hispanic communities are exposed to 56% and 63% more particulate matter pollution than they produce through consumption; while white communities ...', type: 'default' },
 ...
 { id: '1', name: 'Pentagon', type: 'agency', relationship: 'Operated undisclosed fake social media accounts promoting pro-U.S. narratives; removed by Meta and Twitter as coordinated inauthentic behavior', href: '/entities/agencies/pentagon' },
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '1975', event: 'The CIA has historically conducted influence operations through media outlets, cultural organizations, and planted stories; the Church Committee (1975) revealed that the CIA had relationships with ...', type: 'default' },
     ...
     { date: '2018', event: 'Cambridge Analytica (shut down in 2018) harvested Facebook data on 87 million users to build psychographic profiles for targeted political manipulation; the firm worked for the Trump 2016 campaign ...', type: 'political' },
 ...
 { id: '1', name: 'FBI', type: 'agency', relationship: 'Primary federal agency investigating organized insurance fraud networks; limited capacity relative to $308B annual fraud losses', href: '/entities/agencies/fbi' },
  ...
  'indonesian-mass-killings-1965': {
   ...
   timeline: [
     ...
     { date: '1966-04-01', event: 'A CIA cable from April 1966 stated: "In terms of the numbers killed, the anti-PKI massacres in Indonesia rank as one of the worst mass murders of the 20th century." Despite this acknowledgment, US ...', type: 'critical' },
  ...
  'immigration-detention-abuse': {
   ...
   pageUpdatedDate: '2026-03-18',
   timeline: [
     { date: '2010', event: 'Between 2010 and 2017, the DHS OIG received over 33,000 complaints of sexual assault and abuse in ICE facilities', type: 'default' },
     { date: '2016', event: 'GEO Group and CoreCivic together spent $25 million lobbying Congress between 2016 and 2024 and contributed millions to political campaigns', type: 'political' },
     { date: '2018', event: 'Scott Allen, a medical advisor to DHS, submitted a whistleblower complaint in 2018 describing "ichemic conditions" at multiple facilities', type: 'default' },
     { date: '2019', event: 'A 2019 investigation by the House Oversight Committee found that ICE\'s own medical experts recommended hospitalization in cases where detainees were denied care and subsequently died', type: 'critical' },
   ],
  },
  'iraq-war-false-intelligence': {
   ...
   timeline: [
     ...
     { date: '2004', event: 'Former UN Secretary-General Kofi Annan stated in 2004 that the war was "not in conformity with the UN Charter" and was "illegal." No official has ever been held accountable for what Annan character...', type: 'default' },
