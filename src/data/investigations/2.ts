...
const investigations_2: Record<string, InvestigationData> = {
 ...
 summary: 'The 2008 financial crisis was the most devastating economic catastrophe since the Great Depression, triggered by Wall Street\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Bloomberg: The Fed\\', url: 'https://www.bloomberg.com/news/articles/2011-11-28/secret-fed-loans-undisclosed-to-congress-gave-banks-13-billion-in-income', type: 'Article' },
 ...
 affiliations: [
   { id: 'hank-paulson', name: 'Hank Paulson', type: 'individual', relationship: 'U.S. Treasury Secretary (2006-2009). Former Goldman Sachs CEO. Designed and implemented the $700B TARP bailout that rescued his former firm and Wall Street peers. His $700M Goldman holdings were liqui', href: '/entities/individuals/hank-paulson' },
   { id: 'lloyd-blankfein', name: 'Lloyd Blankfein', type: 'individual', relationship: 'Goldman Sachs CEO (2006-2018). Oversaw Goldman\\', href: '/entities/individuals/lloyd-blankfein' },
   { id: 'jamie-dimon', name: 'Jamie Dimon', type: 'individual', relationship: 'JPMorgan Chase CEO (2005-present). JPMorgan sold billions in toxic mortgage securities while internal reports warned they were junk. Received $13B bailout. Paid $13B settlement in 2013; no admission o', href: '/entities/individuals/jamie-dimon' },
   { id: 'dick-fuld', name: 'Dick Fuld', type: 'individual', relationship: 'Lehman Brothers CEO. Oversaw Lehman\\', href: '/entities/individuals/dick-fuld' },
   { id: 'angelo-mozilo', name: 'Angelo Mozilo', type: 'individual', relationship: 'Countrywide Financial CEO. Pioneered predatory subprime lending, specifically targeting Black and Latino borrowers with exploitative adjustable-rate mortgages. While publicly promoting loans, he priva', href: '/entities/individuals/angelo-mozilo' },
   { id: 'ben-bernanke', name: 'Ben Bernanke', type: 'individual', relationship: 'Federal Reserve Chairman (2006-2014). Failed to regulate the shadow banking system and dismissed warnings about the housing bubble. Later orchestrated massive emergency lending (over $16T) to rescue f', href: '/entities/individuals/ben-bernanke' },
   { id: 'alan-greenspan', name: 'Alan Greenspan', type: 'individual', relationship: 'Federal Reserve Chairman (1987-2006). Ardent opponent of financial regulation who championed deregulation of derivatives and blocked efforts to regulate credit default swaps. Later admitted his ideolo', href: '/entities/individuals/alan-greenspan' },
   { id: 'janet-yellen', name: 'Janet Yellen', type: 'individual', relationship: 'President of the San Francisco Fed (2004-2010). Oversaw the district that included Countrywide Financial and Washington Mutual (two of the worst predatory lenders) but took no meaningful regulatory ac', href: '/entities/individuals/janet-yellen' },
   { id: 'tim-geithner', name: 'Tim Geithner', type: 'individual', relationship: 'President of the New York Fed (2003-2009), then Treasury Secretary (2009-2013). Oversaw the bailouts and opposed holding executives accountable. His"foam the runway"approach prioritized bank survival', href: '/entities/individuals/tim-geithner' },
   { id: 'david-solomon', name: 'David Solomon', type: 'individual', relationship: 'Goldman Sachs executive during the crisis era, later CEO (2018-present). Goldman\\', href: '/entities/individuals/david-solomon' },
   { id: 'brian-moynihan', name: 'Brian Moynihan', type: 'individual', relationship: 'Bank of America executive. BofA acquired Countrywide Financial in 2008, inheriting its predatory lending portfolio. BofA paid $16.65B in the largest settlement in American corporate history, no execut', href: '/entities/individuals/brian-moynihan' },
   { id: 'larry-fink', name: 'Larry Fink', type: 'individual', relationship: 'BlackRock CEO. BlackRock was hired by the Federal Reserve to manage the government\\', href: '/entities/individuals/larry-fink' },
   { id: 'steve-mnuchin', name: 'Steve Mnuchin', type: 'individual', relationship: 'Goldman Sachs partner who purchased IndyMac bank in 2009, renamed it OneWest, and aggressively foreclosed on thousands of homeowners (including elderly and minority borrowers) earning the nickname "Fo', href: '/entities/individuals/steve-mnuchin' },
   { id: 'warren-buffett', name: 'Warren Buffett', type: 'individual', relationship: 'Berkshire Hathaway CEO. Invested $5B in Goldman Sachs at the height of the crisis, earning $3.7B in profits. Called derivatives"financial weapons of mass destruction"while profiting from the system th', href: '/entities/individuals/warren-buffett' },
   { id: 'barack-obama', name: 'Barack Obama', type: 'individual', relationship: '44th President. Received more Wall Street campaign donations than any previous candidate. His administration chose to bail out banks rather than homeowners, prosecuting zero top executives despite evi', href: '/entities/individuals/barack-obama' },
   { id: 'george-w-bush', name: 'George W. Bush', type: 'individual', relationship: '43rd President. Signed the Emergency Economic Stabilization Act creating TARP. His administration\\', href: '/entities/individuals/george-w-bush' },
   { id: 'eric-holder', name: 'Eric Holder', type: 'individual', relationship: 'Attorney General (2009-2015). Coined the doctrine that banks were"too big to jail."Former Covington & Burling partner who returned to the firm after DOJ, representing the same banks he declined to pro', href: '/entities/individuals/eric-holder' },
 ],
 timeline: [
   ...
   { date: '2005', event: 'Federal regulators receive warnings about Countrywide\\' },
   ...
   { date: 'March 2008', event: 'Bear Stearns collapses and is acquired by JPMorgan for $2/share (later raised to $10); a 98% loss. The Federal Reserve absorbs $30B in Bear Stearns\\' },
   ...
   { date: 'September 16, 2008', event: 'AIG receives an $85B federal bailout (eventually totaling $182B). AIG had written $440B in credit default swaps insuring Wall Street\\' },
   ...
   { date: 'January 2010', event: 'Financial Crisis Inquiry Commission holds public hearings. Former Citigroup CEO Chuck Prince\\' },
   ...
   { date: '2013', event: 'Attorney General Eric Holder tells Congress some banks are"too big to jail"- admitting the DOJ\\' },
 ],
 statutes: [
 ...
 defendants: [
   ...
   { name: 'S&P / Moody\\', role: 'Issuing fraudulent AAA ratings on securities they knew were toxic', status: 'charged', notes: 'S&P paid $1.5B to settle government and state lawsuits. Moody\\' },
