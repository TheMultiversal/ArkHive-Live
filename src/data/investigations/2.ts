...
const investigations_2: Record<string, InvestigationData> = {
 ...
 content: [
   'The Department of Justice under Attorney General Eric Holder adopted a de facto policy of "too big to jail," declining to prosecute any top Wall Street executive despite overwhelming evidence of fraud documented in the Financial Crisis Inquiry Commission report and internal bank communications. Lanny Breuer, head of the DOJ Criminal Division, later admitted on PBS Frontline that he considered whether prosecutions might destabilize financial markets, an admission that the DOJ had placed Wall Street\'s interests above the rule of law.',
   'Hank Paulson (former Goldman Sachs CEO) served as Treasury Secretary during the bailout, directing billions to his former firm. Goldman received $12.9 billion through the AIG backdoor bailout, paid at 100 cents on the dollar while ordinary creditors received fractions. Paulson had liquidated his $700 million Goldman Sachs stake tax-free upon entering government under a provision designed to prevent conflicts of interest, the same provision that created one, as his personal fortune depended on Goldman\'s survival.',
   'The Federal Reserve conducted trillions of dollars in emergency lending through secret facilities, refusing to disclose the recipients until forced by court order and Freedom of Information Act litigation years later. Bloomberg News revealed $7.77 trillion in undisclosed Fed commitments to Wall Street. Banks borrowed at near-zero rates from the Fed and simultaneously lent back to the government at higher rates, pocketing risk-free profits while ordinary Americans lost their homes.',
   'Rating agencies (S&P, Moody\'s, Fitch) gave AAA ratings to securities they privately described as "ridiculous" and "monstrous" because they were paid by the banks issuing the securities, a structural conflict of interest called the "issuer-pays" model that was never criminally prosecuted. From 2000 to 2007, Moody\'s alone rated nearly 45,000 mortgage-related securities, more than half as triple-A. By the end of 2008, 80% of CDOs rated AAA were downgraded to junk.',
   'Goldman Sachs\'s ABACUS deal, designed with hedge fund manager John Paulson (no relation to Hank) to fail, was marketed to investors as a legitimate product. Goldman secretly shorted the same securities. The SEC charged Goldman with fraud, resulting in a $550 million settlement. Only one junior trader, Fabrice Tourre, was charged. No Goldman executive faced prosecution despite emails showing they knew the products were, in their own words, "one shitty deal."',
   'The housing bubble was inflated by the deliberate destruction of lending standards. Mortgage originators issued "NINJA loans" (No Income, No Job, No Assets) and adjustable-rate mortgages with teaser rates designed to reset at unaffordable levels. Countrywide Financial originated $500 billion in loans annually at its peak, routinely approving borrowers who could never repay. As one Countrywide employee later testified: "If you had a pulse, we gave you a loan." Internal audits at Citigroup found that by 2007, over 80% of purchased mortgages were "defective."',
   'The 2004 SEC decision to relax the net capital rule for the five largest investment banks, Goldman Sachs, Morgan Stanley, Merrill Lynch, Lehman Brothers, and Bear Stearns, allowed their leverage ratios to soar from 12:1 to as high as 40:1. This meant that a mere 3% decline in asset value could wipe out a firm entirely. All five firms subsequently failed, were acquired, or converted to bank holding companies. SEC Chairman Christopher Cox later called the voluntary regulation program "fundamentally flawed."',
   'The subprime crisis disproportionately devastated Black and Latino communities through deliberate racial targeting. Wells Fargo loan officers referred to Black borrowers as "mud people" and called subprime products aimed at them "ghetto loans." Countrywide steered qualified minority borrowers into higher-cost subprime mortgages at rates 2-3 times those offered to similarly situated white borrowers. Between 2005 and 2009, Black families lost 53% of their wealth and Latino families lost 66%, the largest destruction of minority wealth in American history.',
   'The government\'s Home Affordable Modification Program (HAMP), ostensibly designed to help homeowners, was privately described by Treasury Secretary Tim Geithner as a way to "foam the runway" for banks by spreading out foreclosures rather than preventing them. Of 4 million homeowners approved for trial modifications, banks permanently modified fewer than 1.8 million. Banks collected fees from homeowners during trial periods, then foreclosed anyway.',
   'Banks systematically engaged in "robo-signing", executing thousands of fraudulent foreclosure documents daily without review, using fabricated signatures and backdated notarizations to accelerate the seizure of homes. When exposed in 2010, the government negotiated the $25 billion National Mortgage Settlement, which allowed banks to credit phantom "relief" toward their obligations while continuing to foreclose.',
   'The Commodity Futures Modernization Act of 2000, championed by Federal Reserve Chairman Alan Greenspan, Treasury Secretary Robert Rubin, and SEC Chairman Arthur Levitt, exempted over-the-counter derivatives from all regulation. When Brooksley Born, chair of the Commodity Futures Trading Commission, attempted to regulate credit default swaps in 1998, Greenspan, Rubin, and Levitt blocked her proposal and persuaded Congress to strip the CFTC of jurisdiction. The unregulated CDS market grew from $900 billion in 2000 to $62 trillion by 2007.',
   'When Lehman Brothers collapsed on September 15, 2008, filing the largest bankruptcy in history at $639 billion, it triggered a global panic. CEO Dick Fuld had used Repo 105 transactions, short-term accounting maneuvers, to temporarily move $50 billion in liabilities off the balance sheet before quarterly reporting, misleading investors about Lehman\'s actual financial condition. The bankruptcy examiner found "colorable claims" of fraud, but no criminal charges were ever brought.',
   'Eric Holder returned to his former law firm Covington & Burling (which represents most major Wall Street banks) after leaving the DOJ in 2015, becoming a partner earning millions representing the same institutions he declined to prosecute. His deputy, Lanny Breuer, returned to Covington before Holder even departed. This revolving door between Wall Street\'s law firms and the DOJ\'s leadership ensured that the prosecutors and the defense attorneys were, functionally, the same people.',
   'The Dodd-Frank Wall Street Reform and Consumer Protection Act of 2010 was systematically weakened by an army of 2,000+ financial industry lobbyists before passage, weakened further through regulatory implementation, and then partially repealed by the Economic Growth, Regulatory Relief, and Consumer Protection Act of 2018, which exempted banks with under $250 billion in assets from enhanced oversight. The banks that emerged from the crisis were larger, more concentrated, and more powerful than before it.',
   'Internal bank emails and documents revealed in civil litigation showed executives knew their products were toxic: Goldman traders called them "one shitty deal," Citigroup\'s chief risk officer warned of a "nuclear holocaust" scenario, S&P analysts privately called securities they rated AAA "total crap" and joked about the Frankenstein products they were creating. Yet between these documented admissions and $150 billion in settlements, not a single top executive at any major bank was criminally charged.',
   'In total, 47 bankers worldwide served jail time for crisis-related offenses, over half from Iceland, where the crisis was most severe. In the United States, only one Wall Street executive was imprisoned: Kareem Serageldin of Credit Suisse, sentenced to 30 months for concealing $100 million in losses. By contrast, after the much smaller savings and loan crisis of the 1980s, the DOJ secured over 1,000 felony convictions of banking executives, including top officers at major institutions.',
   'The $700 billion TARP bailout was initially presented to Congress in a three-page proposal from Paulson demanding unlimited authority with no judicial review. When Congress balked, Paulson reportedly got on one knee before Speaker Nancy Pelosi, begging for passage. The final Emergency Economic Stabilization Act created TARP with limited oversight. The nine largest banks were summoned to a meeting and told they would each accept TARP funds, whether they wanted them or not, including $25 billion each to JPMorgan Chase and Citigroup, $10 billion each to Goldman Sachs and Morgan Stanley.',
 ],
 tags: ['financial-crime', 'fraud', 'wall-street', 'bailout', 'TARP', 'subprime-mortgage', 'CDO', 'mortgage-backed-securities', 'credit-default-swap', 'too-big-to-fail', 'goldman-sachs', 'lehman-brothers', 'bear-stearns', 'AIG', 'countrywide', 'predatory-lending', 'deregulation', 'dodd-frank', 'revolving-door', 'robo-signing', 'foreclosure-crisis', 'securities-fraud', 'rating-agencies', 'systemic-risk', 'Glass-Steagall', 'derivatives'],
 sources: [
 ...
 timeline: [
   { date: '1998', event: 'Brooksley Born, chair of the CFTC, attempts to regulate over-the-counter derivatives. Greenspan, Rubin, and Levitt block her proposal and persuade Congress to strip the CFTC of jurisdiction.' },
   ...
   { date: 'April 28, 2004', event: 'SEC relaxes net capital rules for the five largest investment banks (Goldman, Merrill, Morgan Stanley, Lehman, Bear Stearns), allowing leverage ratios to soar from 12:1 to 40:1. All five would later collapse or require rescue.', type: 'critical' },
   ...
   { date: '2005', event: 'Michael Burry closes the first credit default swap against subprime mortgage bonds with Deutsche Bank, valued at $60 million, betting the housing market will collapse within two years.', type: 'financial' },
   { date: '2006', event: 'Housing prices peak. Goldman Sachs begins secretly building massive short positions against the mortgage market while continuing to sell CDOs to clients.', type: 'financial' },
   { date: '2006', event: 'Wall Street executives take home $23.9 billion in bonuses. CDO issuance peaks at over $180 billion per quarter. Subprime and non-prime mortgage debt rises to 36% of CDO assets.', type: 'financial' },
   { date: 'February 2007', event: 'HSBC announces $10.5 billion in bad debt charges, 20% higher than expected, driven by U.S. mortgage portfolio losses, the first major subprime loss reported.', type: 'financial' },
   ...
   { date: 'June-August 2007', event: 'Two Bear Stearns hedge funds that invested heavily in subprime mortgages collapse, losing $1.6 billion. Rating agencies begin mass downgrades of mortgage securities.', type: 'critical' },
   { date: 'August 9, 2007', event: 'BNP Paribas freezes withdrawals from three investment funds, citing inability to value subprime mortgage assets. The interbank lending market seizes up. The European Central Bank injects 95 billion euros.', type: 'critical' },
   { date: 'September 14, 2007', event: 'Northern Rock, a major UK bank, suffers the first British bank run in 150 years after it can no longer fund its mortgage operations in the frozen credit markets.', type: 'financial' },
   { date: 'January 2008', event: 'Bank of America acquires Countrywide Financial, the nation\'s largest mortgage lender, inheriting its massive portfolio of toxic subprime loans and predatory lending liability.', type: 'financial' },
   { date: 'March 16, 2008', event: 'Bear Stearns collapses and is acquired by JPMorgan Chase for $2/share (later raised to $10/share), a 98% loss. The Federal Reserve absorbs $30 billion in Bear Stearns\' toxic assets to facilitate the deal.', type: 'critical' },
   { date: 'July 11, 2008', event: 'IndyMac Bancorp fails, the largest thrift failure in U.S. history at the time. FDIC seizes the bank after a bank run triggered by Sen. Chuck Schumer\'s letter about its viability.', type: 'financial' },
   { date: 'September 7, 2008', event: 'Federal government seizes Fannie Mae and Freddie Mac, placing them in conservatorship. Combined exposure: $5.3 trillion in mortgage guarantees.', type: 'critical' },
   { date: 'September 15, 2008', event: 'Lehman Brothers files for bankruptcy, the largest in American history at $639 billion in assets. Global financial markets panic. Merrill Lynch is sold to Bank of America the same day.', type: 'critical' },
   { date: 'September 16, 2008', event: 'AIG receives an $85 billion federal bailout (eventually totaling $182 billion). AIG had written $440 billion in credit default swaps insuring Wall Street\'s toxic products, including $12.9 billion owed to Goldman Sachs, paid at 100 cents on the dollar.', type: 'critical' },
   { date: 'September 19, 2008', event: 'Paulson and Bernanke present Congress with a 3-page proposal demanding $700 billion with no oversight or judicial review. Paulson reportedly gets on one knee before Nancy Pelosi to beg for the bailout.', type: 'critical' },
   { date: 'September 25, 2008', event: 'Washington Mutual is seized by the FDIC, the largest bank failure in U.S. history at $307 billion in assets. JPMorgan Chase acquires its banking operations for $1.9 billion.', type: 'critical' },
   { date: 'October 3, 2008', event: 'Emergency Economic Stabilization Act signed, creating the $700 billion Troubled Asset Relief Program (TARP). Money flows to Wall Street banks, not homeowners.', type: 'critical' },
   { date: 'October 14, 2008', event: 'Treasury Secretary Paulson summons CEOs of nine largest banks to a mandatory meeting, telling them each will accept TARP funds. $125 billion distributed in a single day.', type: 'financial' },
   { date: 'October-December 2008', event: 'Citigroup receives $45 billion in TARP funds plus $306 billion in government guarantees on toxic assets. Bank of America receives $45 billion. Goldman Sachs and Morgan Stanley each receive $10 billion.', type: 'financial' },
   { date: 'December 16, 2008', event: 'Federal Reserve cuts the federal funds rate to effectively 0%, the first time in history, and launches unprecedented quantitative easing programs.', type: 'financial' },
   { date: '2008-2012', event: '10 million American families lose their homes to foreclosure. Black and Latino families lose 53% and 66% of their wealth respectively. 8.7 million jobs are destroyed. Household wealth declines by $13 trillion.', type: 'critical' },
   { date: 'January 2010', event: 'Financial Crisis Inquiry Commission holds public hearings. Former Citigroup CEO Chuck Prince testifies with his infamous quote: "As long as the music is playing, you\'ve got to get up and dance."' },
   { date: 'April 2010', event: 'SEC charges Goldman Sachs with fraud over the ABACUS CDO deal, alleging Goldman let hedge fund Paulson & Co. select toxic assets then sold them to investors without disclosure. Goldman settles for $550 million.', type: 'legal' },
   { date: 'July 21, 2010', event: 'Dodd-Frank Wall Street Reform and Consumer Protection Act signed into law. Critics call it inadequate, it does not break up "too big to fail" banks, which emerge larger and more concentrated than before.', type: 'legal' },
   { date: 'January 2011', event: 'FCIC releases its final 633-page report concluding the crisis was "avoidable" and caused by "widespread failures in financial regulation" and "dramatic breakdowns in corporate governance."', type: 'legal' },
   { date: '2010-2013', event: 'Robo-signing scandal exposed. Banks had forged signatures on millions of foreclosure documents. The $25 billion National Mortgage Settlement is announced, widely criticized as inadequate.', type: 'legal' },
   { date: '2012-2016', event: 'Major banks pay $150+ billion in combined settlements. Goldman: $5.06 billion. JPMorgan: $13 billion. Bank of America: $16.65 billion. Citigroup: $7 billion. Morgan Stanley: $3.2 billion. No top executives criminally charged.', type: 'legal' },
   { date: '2013', event: 'Attorney General Eric Holder tells Congress some banks are "too big to jail", publicly admitting the DOJ\'s policy of protecting Wall Street executives from criminal prosecution.', type: 'critical' },
   { date: '2014', event: 'Kareem Serageldin of Credit Suisse sentenced to 30 months in prison for hiding $100 million in losses on mortgage-backed securities, the only Wall Street banker imprisoned for crisis-related fraud in the United States.', type: 'legal' },
   { date: '2015', event: 'Eric Holder returns to Covington & Burling, the law firm that represents most major Wall Street banks, as a partner earning millions. His deputy Lanny Breuer had already returned to the firm.', type: 'critical' },
   { date: '2018', event: 'Economic Growth, Regulatory Relief, and Consumer Protection Act rolls back key Dodd-Frank protections, exempting banks with under $250 billion in assets from enhanced oversight requirements.', type: 'legal' },
 ],
 statutes: [
   { code: '18 U.S.C. SS 1348: Securities Fraud', description: 'Wall Street banks knowingly packaged defective mortgages into securities, secured fraudulent ratings, and sold them to investors as safe investments while simultaneously betting against them.' },
   { code: '18 U.S.C. SS 1341 (Mail Fraud) / 18 U.S.C. SS 1343 (Wire Fraud)', description: 'The systematic use of mail and electronic communications to execute schemes to defraud investors, including prospectuses containing material misrepresentations about the quality of mortgage-backed securities.' },
   { code: '18 U.S.C. SS 1962: RICO (Racketeer Influenced and Corrupt Organizations)', description: 'The coordinated, cross-institutional pattern of fraud (involving mortgage originators, investment banks, rating agencies, and servicers) constituted an ongoing criminal enterprise.' },
   { code: '18 U.S.C. SS 1014: False Statements to Financial Institutions', description: 'Mortgage originators systematically fabricated borrower income, assets, and employment on loan applications. Internal audits at multiple banks revealed fraud rates exceeding 80% in loan samples.' },
   { code: '18 U.S.C. SS 1956: Money Laundering', description: 'The laundering of fraud proceeds through complex financial instruments designed to obscure the toxic nature of underlying mortgage assets and distribute fraud losses to unwitting investors.' },
   { code: '18 U.S.C. SS 371: Conspiracy to Defraud the United States', description: 'The coordinated effort by Wall Street executives at multiple institutions to circumvent financial regulations, mislead regulators, and conceal the true risk of their activities from government oversight.' },
   { code: '15 U.S.C. SS 78j(b): SEC Rule 10b-5 Violations', description: 'Material misrepresentations and omissions in the sale of securities, including the failure to disclose adverse selection of mortgage pools, inflated appraisals, and internal risk assessments.' },
   { code: '12 U.S.C. SS 1833a: FIRREA (Financial Institutions Reform)', description: 'Fraud affecting federally insured financial institutions. The DOJ used this statute for civil settlements but declined to pursue criminal charges against individuals under the same statute.' },
   { code: '18 U.S.C. SS 1519: Destruction of Records (Sarbanes-Oxley)', description: 'Banks destroyed and altered internal documents, communications, and risk assessments that would have demonstrated knowledge of fraud in mortgage-backed securities.' },
   { code: '18 U.S.C. SS 1005: False Bank Entries', description: 'Executives at Lehman Brothers, Bear Stearns, and other firms made false entries in bank records, including Repo 105 transactions that removed $50 billion from Lehman\'s balance sheet to deceive investors and regulators.' },
   { code: '15 U.S.C. SS 78ff: Willful Violations of Securities Exchange Act', description: 'Senior executives at major banks willfully certified financial statements they knew to be misleading, concealing the true extent of toxic asset exposure from shareholders and regulators.' },
   { code: '18 U.S.C. SS 1344: Bank Fraud', description: 'Mortgage originators defrauded federally insured banks by submitting loan applications with fabricated documentation, and investment banks defrauded counterparties by misrepresenting the quality of securities.' },
 ],
 moneyTrail: [
   { date: 'October 2008', from: 'U.S. Treasury (TARP)', to: 'Citigroup', amount: '$45 billion', purpose: 'Two tranches of TARP preferred stock purchases ($25 billion in October, $20 billion in January 2009) plus $306 billion in government guarantees on toxic assets', documented: true },
   { date: 'October 2008', from: 'U.S. Treasury (TARP)', to: 'Bank of America', amount: '$45 billion', purpose: 'Two tranches of TARP preferred stock purchases ($25 billion in October, $20 billion in January 2009) to stabilize BofA after Merrill Lynch acquisition', documented: true },
   { date: 'October 2008', from: 'U.S. Treasury (TARP)', to: 'JPMorgan Chase', amount: '$25 billion', purpose: 'TARP Capital Purchase Program preferred stock. JPMorgan also received $30 billion in Fed guarantees to acquire Bear Stearns', documented: true },
   { date: 'October 2008', from: 'U.S. Treasury (TARP)', to: 'Goldman Sachs', amount: '$10 billion', purpose: 'TARP Capital Purchase Program preferred stock. Goldman also received $12.9 billion through AIG backdoor bailout at 100 cents on the dollar', documented: true },
   { date: 'October 2008', from: 'U.S. Treasury (TARP)', to: 'Morgan Stanley', amount: '$10 billion', purpose: 'TARP Capital Purchase Program preferred stock. Morgan Stanley also received $9.7 billion through AIG backdoor payments', documented: true },
   { date: 'September 2008 - March 2009', from: 'Federal Reserve / U.S. Treasury', to: 'AIG', amount: '$182 billion', purpose: 'Largest single-entity bailout in history. $85 billion initial loan, expanded to $182 billion. AIG used funds to pay Goldman Sachs, Societe Generale, Deutsche Bank, and other counterparties at 100 cents on the dollar', documented: true },
   { date: '2007-2008', from: 'Federal Reserve (Secret Lending Programs)', to: 'Major Banks', amount: '$7.77 trillion', purpose: 'Undisclosed Fed emergency lending commitments through Term Auction Facility, Primary Dealer Credit Facility, and other programs. Not disclosed to Congress until forced by court order', documented: true },
   { date: '2006-2008', from: 'Public Investors / Pension Funds', to: 'Wall Street Banks', amount: '$2+ trillion', purpose: 'Investment banks sold toxic CDOs and MBS to public pension funds, municipalities, and retail investors. Banks earned billions in fees while investors lost their principal', documented: true },
   { date: '2001-2008', from: 'Homeowners (Mortgage Payments)', to: 'Mortgage Originators / Securitizers', amount: '$10+ trillion', purpose: 'Total outstanding U.S. mortgage debt at peak. Predatory lending practices generated massive fees for originators who had no skin in the game due to securitization', documented: true },
   { date: '2006', from: 'Wall Street Firms', to: 'Executives (Annual Bonuses)', amount: '$23.9 billion', purpose: 'Record Wall Street bonuses paid for 2006 performance, the peak year of toxic CDO production. New York State Comptroller data. Bonuses tied to short-term fee generation from products that later proved worthless', documented: true },
   { date: '2008', from: 'Merrill Lynch', to: 'Merrill Executives (Accelerated Bonuses)', amount: '$3.6 billion', purpose: 'Merrill Lynch accelerated $3.6 billion in bonus payments to executives just days before the Bank of America merger closed, while reporting $27 billion in losses', documented: true },
   { date: '2004-2008', from: 'Countrywide Financial', to: 'Angelo Mozilo (CEO Compensation)', amount: '$521 million', purpose: 'Total compensation for Countrywide CEO Angelo Mozilo from 2000-2008 while company originated billions in toxic subprime mortgages. Mozilo sold $140 million in stock using pre-arranged trading plans', documented: true },
   { date: '2012-2016', from: 'Banks (Settlement Payments)', to: 'DOJ / State AGs / Investors', amount: '$150+ billion', purpose: 'Combined civil settlements: Goldman $5.06 billion, JPMorgan $13 billion, BofA $16.65 billion, Citigroup $7 billion, Morgan Stanley $3.2 billion, Credit Suisse $5.28 billion, S&P $1.5 billion, Moody\'s $864 million. All settlements included no admission of wrongdoing', documented: true },
   { date: '2007-2010', from: 'American Households', to: 'Wall Street / Market Losses', amount: '$13 trillion', purpose: 'Total decline in U.S. household wealth. One in four households lost 75% or more of net worth. Black families lost 53% of wealth. Latino families lost 66%', documented: true },
 ],
 defendants: [
