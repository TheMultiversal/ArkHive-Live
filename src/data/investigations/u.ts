...
const investigations_u: Record<string, InvestigationData> = {
 ...
 summary: 'President Trump withheld $391 million in congressionally-approved military aid to Ukraine and a White House meeting to pressure Ukrainian President Zelensky into announcing investigations into Joe Biden and the 2016 election. The scheme was exposed by a whistleblower and led to Trump\\',
 content: [
 ...
 date: '1892-01-01',
 lastUpdated: '2026-03-28',
 summary: 'The history of American labor is a history of corporate and government violence against workers. From the Pinkerton detective agency\\',
 content: [
 ...
 sources: [
   ...
   { title: 'Amazon\\', url: 'https://www.dol.gov/agencies/olms/public-disclosure-room', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'robert-taft', name: 'Robert Taft', type: 'individual', relationship: 'Senator who co-authored Taft-Hartley Act of 1947 restricting workers\\', href: '/entities/individuals/robert-taft' },
 ...
 timeline: [
   ...
   { date: '1947', event: 'Taft-Hartley Act passed over Truman\\' },
   ...
   { date: '1981-2000', event: 'Private sector permanently replaces striking workers at unprecedented rates following Reagan\\' },
 ...
 statutes: [
   { code: 'National Labor Relations Act § 8(a)(1): Interference with Rights', description: 'Employers systematically interfere with workers\\' },
 ...
 defendants: [
   ...
   { name: 'Tesla', role: 'Illegally firing union supporter; Musk\\', status: 'charged', notes: 'NLRB ordered reinstatement and Musk to delete tweet; Tesla appealed' },
   { name: 'Walmart', role: 'Retaliation against workers who participated in OUR Walmart protests', status: 'charged', notes: 'NLRB found Walmart violated workers\\' },
 ...
 subtitle: 'How America Propped Up South Africa\\',
 severity: 'critical',
 category: 'Government Accountability',
 date: '1948-01-01',
 lastUpdated: '2026-03-28',
 summary: 'For decades, the United States actively supported South Africa\\',
 content: [
 ...
 sources: [
   { title: 'CIA Role in Mandela\\', url: 'https://www.theguardian.com/world/2016/may/15/cia-agent-nelson-mandela-arrest-1962', type: 'Article' },
   ...
   { title: 'South Africa\\', url: 'https://www.nti.org/learn/countries/south-africa/', type: 'Article' },
 ...
 affiliations: [
   ...
   { id: 'dick-cheney', name: 'Dick Cheney', type: 'individual', relationship: 'Congressman who voted against Mandela\\', href: '/entities/individuals/dick-cheney' },
   ...
   { id: 'donald-rickard', name: 'Donald Rickard', type: 'individual', relationship: 'CIA agent who confirmed in 2016 interview that CIA tipped off South Africa about Mandela\\', href: '/entities/individuals/donald-rickard' },
 ],
 timeline: [
   ...
   { date: '1962', event: 'CIA agent Donald Rickard tips off South African intelligence about Mandela\\' },
   ...
   { date: '1986', event: 'Congress overrides Reagan\\' },
   { date: '1986', event: 'Dick Cheney votes against resolution calling for Mandela\\' },
   ...
   { date: '2016', event: 'CIA operative Donald Rickard confirms on film that he provided the tip that led to Mandela\\' },
 ],
 statutes: [
 ...
 defendants: [
   { name: 'United States Government', role: 'Complicity in apartheid through diplomatic support, intelligence cooperation, and obstruction of sanctions', status: 'charged', notes: 'No accountability; constructive engagement policy formally ended only after Congress overrode Reagan\\' },
   { name: 'CIA', role: 'Providing intelligence leading to Nelson Mandela\\', status: 'charged', notes: 'Confirmed by CIA agent Donald Rickard in 2016; no official accountability' },
