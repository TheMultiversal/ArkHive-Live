...
const investigations_q: Record<string, InvestigationData> = {
 ...
 { id: '6', name: 'Kushner Companies', type: 'corporation', relationship: 'Benefited from resolution', href: '/entities/corporations/kushner-companies' },
  ...
  'qualified-immunity-police-accountability-gap': {
    ...
    summary: 'ArkHive\'s automated investigative intelligence has flagged Qualified Immunity Police Accountability Gap for documentation and expanded analysis. This investigation was generated based on cross-references and network analysis of related entities in the accountability database.',
    content: [
      'Qualified Immunity Police Accountability Gap has been identified through ArkHive\'s systematic analysis of institutional power structures, corporate networks, and government accountability gaps.',
