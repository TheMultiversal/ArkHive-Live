...
const investigations_q: Record<string, InvestigationData> = {
 ...
 { id: '6', name: 'Kushner Companies', type: 'corporation', relationship: 'Benefited from resolution', href: '/entities/corporations/kushner-companies' },
  ...
  'qualified-immunity-police-accountability-gap': {
    ...
    subtitle: 'Documenting accountability failures related to Qualified Immunity Police Accountability Gap',
    severity: 'low',
    category: 'Civil Rights',
    date: 'January 31, 2024',
    lastUpdated: 'March 1, 2024',
    summary: 'Investigation into Qualified Immunity Police Accountability Gap. Case file developed through years of public records analysis, FOIA requests, and source-based investigative reporting documenting institutional failures requiring accountability.',
    content: [
    ...
    tags: ['Human Rights', 'Civil Rights', 'Reform', 'Justice'],
    sources: [
