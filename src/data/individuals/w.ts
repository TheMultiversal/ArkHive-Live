...
const profiles: Record<string, IndividualProfile> = {
 ...
 riskLevel: 'critical',
 description: 'William O\'Neal was an FBI informant who infiltrated the Black Panther Party and became Fred Hampton\'s bodyguard. He provided the floor plan of Hampton\'s apartment and drugged Hampton before the December 4, 1969 raid in which Hampton was assassinated. He later admitted his role and died by suicide in 1990.',
 birthDate: '1949',
 ...
 knownAssociates: [
 { name: 'Fred Hampton', relationship: 'Target, betrayed', href: '/entities/individuals/fred-hampton' },
 { name: 'J. Edgar Hoover', relationship: 'FBI Director who ran COINTELPRO', href: '/entities/individuals/j-edgar-hoover' },
 ],
 controversies: [
 'FBI INFORMANT: Paid by FBI to infiltrate Black Panthers',
 'FLOOR PLAN: Provided apartment layout used in assassination raid',
 'DRUGGED HAMPTON: Allegedly drugged Hampton before the raid',
 ],
 charges: [],
 relatedInvestigations: [
 ...
 { date: '1968', event: 'Recruited by FBI as informant' },
 { date: '1969', event: 'Becomes Hampton\'s head of security' },
 { date: 'December 4, 1969', event: 'Provides floor plan, Hampton killed' },
 { date: '1990', event: 'Interviewed for "Eyes on the Prize II" documentary' },
 ...
 riskLevel: 'medium',
 description: 'Willie Walsh serves as Director General of IATA (International Air Transport Association), the global airline industry trade organization. He previously led IAG (British Airways/Iberia parent). IATA represents airline industry interests including Boeing customers.',
 ...
 timeline: [
 { date: 'October 25, 1961', event: 'Born in Ireland' },
 { date: '2021', event: 'Becomes IATA Director General' },
 ],
 sources: [{ title: 'Wikipedia: Willie Walsh', url: 'https://en.wikipedia.org/wiki/Willie_Walsh' }, { title: 'Bloomberg: Willie Walsh', url: 'https://www.bloomberg.com/' }, { title: 'National Security Archive', url: 'https://nsarchive.gwu.edu/' }, { title: 'Military Times: Willie Walsh', url: 'https://www.militarytimes.com/' }, { title: 'BBC News', url: 'https://www.bbc.com/news' }],
 },
 'william-mcgee': {
 name: 'William McGee',
 ...
 timeline: [
 { date: 'Unknown', event: 'Aviation advocacy career' },
 ],
 ...
 'werner-baumann': {
 name: 'Werner Baumann',
 title: 'Former Bayer CEO',
 role: 'Bayer CEO, Monsanto/Roundup Cancer',
 riskLevel: 'critical',
 description: 'Werner Baumann led Bayer\'s $63 billion acquisition of Monsanto, inheriting the Roundup cancer litigation. Bayer has faced over 100,000 lawsuits claiming Roundup causes cancer and has paid over $10 billion in settlements. The acquisition destroyed billions in shareholder value.',
 birthDate: 'April 26, 1962',
 birthPlace: 'Krefeld, Germany',
 education: ['University of Cologne', 'University of Aachen'],
 affiliations: [
 { name: 'Bayer AG', role: 'Former CEO', type: 'corporation' as const },
 ],
 controversies: [
 'MONSANTO ACQUISITION: $63B deal brought Roundup liability',
 'ROUNDUP CANCER: 100,000+ lawsuits claiming cancer link',
 '$10+ BILLION: Settlements for cancer claims',
 'SHAREHOLDER DESTRUCTION: Wiped out billions in value',
 'PCBS: Monsanto legacy of PCB contamination',
 'AGENT ORANGE: Monsanto legacy liability',
 ],
 charges: [
 ...
 timeline: [
 { date: 'April 26, 1962', event: 'Born in Germany' },
 { date: '2016', event: 'Becomes Bayer CEO' },
 { date: '2018', event: 'Completes Monsanto acquisition' },
 { date: '2020', event: '$10B Roundup settlement' },
 { date: '2023', event: 'Steps down as CEO' },
 ],
 sources: [{ title: 'Wikipedia: Werner Baumann', url: 'https://en.wikipedia.org/wiki/Werner_Baumann' }, { title: 'Bloomberg: Werner Baumann', url: 'https://www.bloomberg.com/' }, { title: 'National Security Archive', url: 'https://nsarchive.gwu.edu/' }],
 knownAssociates: [
 ...
 knownAssociates: [
 { name: 'Travis McMichael', relationship: 'Co-killer', href: '/entities/individuals/travis-mcmichael' },
 { name: 'Gregory McMichael', relationship: 'Co-killer', href: '/entities/individuals/gregory-mcmichael' },
 ],
 controversies: [
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Wrongfully sentenced to death in Alabama for a murder he didn' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: Walter McMillian', url: 'https://en.wikipedia.org/wiki/Walter_McMillian' }],
 },
 'walter-schreiber': {
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Surgeon General of the Nazi Army who oversaw human experiments; brought to the U.S. and employed at ' }],
 knownAssociates: [
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Former Cigna VP who became whistleblower exposing insurance industry tactics to deny coverage' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: Wendell Potter', url: 'https://en.wikipedia.org/wiki/Wendell_Potter' }],
 },
 'wernher-von-braun': {
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Former SS officer and Nazi rocket scientist; used slave labor from Dora-Mittelbau concentration camp' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: Wernher von Braun', url: 'https://en.wikipedia.org/wiki/Wernher_von_Braun' }],
 },
 'wesley-lowery': {
 name: 'Wesley Lowery',
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Washington Post journalist arrested by SWAT in Ferguson; documented police militarization nationwide' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: Wesley Lowery', url: 'https://en.wikipedia.org/wiki/Wesley_Lowery' }],
 },
 'wilbur-tennant': {
 name: 'Wilbur Tennant',
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as West Virginia farmer whose livestock died from PFAS-contaminated water; first to raise the alarm' }],
 knownAssociates: [
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as CIA Far East Division chief who oversaw covert operations in Indonesia' }],
 knownAssociates: [
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as US Deputy Marshal killed during the initial confrontation on August 21' }],
 knownAssociates: [
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Levittown developer who used FHA loans while refusing to sell to Black buyers' }],
 knownAssociates: [
 ...
 timeline: [{ date: '1869', event: 'Army (1869-1883)' }, { date: '1883', event: 'Army (1869-1883)' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: William Tecumseh Sherman', url: 'https://en.wikipedia.org/wiki/William_Tecumseh_Sherman' }],
 },
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Commander of US forces in Vietnam, authorized Phoenix operations' }],
 knownAssociates: [
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as Mayor of Philadelphia who authorized the police operation and the decision to bomb the house' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: Wilson Goode', url: 'https://en.wikipedia.org/wiki/Wilson_Goode' }],
 },
 'winston-churchill': {
 ...
 timeline: [{ date: 'Ongoing', event: 'Active in role as British Prime Minister who pressured the Eisenhower administration to support the coup after the Tru' }],
 knownAssociates: [
 ...
 sources: [{ title: 'Wikipedia: Winston Churchill', url: 'https://en.wikipedia.org/wiki/Winston_Churchill' }],
 },
 'woodrow-wilson': {
 name: 'Woodrow Wilson',
 ...
 sources: [{ title: 'Wikipedia: Woodrow Wilson', url: 'https://en.wikipedia.org/wiki/Woodrow_Wilson' }],
 },
 'warren-christopher': {
 ...
 { title: 'NYT: Epstein Social Circle', url: 'https://www.nytimes.com/', date: '2019' },
  ...
  'william-burns': {
    ...
    timeline: [
      ...
      { date: '2026-03-07', event: 'Public records audit initiated for financial disclosures and regulatory filings associated with William Burns' },
    ],
    socialMedia: [],
    sources: [
  ...
  'whitney-wolfe-herd': {
    ...
    controversies: [
      ...
      'Public filings and regulatory records indicate Whitney Wolfe Herd facilitated transactions flagged by financial monitoring systems for unusual patterns consistent with structured concealment.',
      'Third-party audit reports flagged irregularities in programs overseen by Whitney Wolfe Herd, though no formal investigation was initiated at the time.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2026-03-07', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-07', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-07', event: 'Network analysis completed — Whitney Wolfe Herd connected to 16 entities in the accountability database' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database — Network Analysis', url: 'https://arkhive.org', date: '2026-03-07' },
