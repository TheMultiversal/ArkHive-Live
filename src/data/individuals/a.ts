...
const profiles: Record<string, IndividualProfile> = {
 ...
 { name: 'David Cordani', relationship: 'Fellow healthcare industry CEO', href: '/entities/individuals/david-cordani' }
  ...
  'andrew-fastow': {
    ...
    charges: [
      { charge: 'Wire Fraud (18 U.S.C. 1343)', status: 'convicted', date: '2004-01-14' },
      { charge: 'Securities Fraud (15 U.S.C. 78j(b))', status: 'convicted', date: '2004-01-14' },
    ],
    relatedInvestigations: [
      { title: 'Enron Corporate Fraud Scandal', slug: 'enron-corporate-fraud-scandal', severity: 'critical' },
    ],
    timeline: [
      { date: '1961-12-22', event: 'Born in Washington, D.C.' },
      { date: '1983', event: 'Graduated from Tufts University with BA in Economics and Chinese' },
      { date: '1984', event: 'Married Lea Weingarten (from the prominent Houston Weingarten supermarket family)' },
      { date: '1986', event: 'Graduated from Northwestern University Kellogg School of Management with MBA' },
      { date: '1990', event: 'Hired by Jeffrey Skilling to join Enron from Continental Illinois National Bank and Trust Company' },
      { date: '1997', event: 'Created Chewco SPE to buy out CalPERS stake in JEDI partnership, beginning the off-balance-sheet fraud architecture' },
      { date: '1998', event: 'Named Chief Financial Officer of Enron Corporation. Begins designing hundreds of off-balance-sheet entities to conceal debt.' },
      { date: '1999', event: 'Created LJM1 and LJM2 partnerships with Enron board approval (ethics code waived twice). Personally manages and profits from entities designed to hide Enron losses.' },
      { date: '2001-10-24', event: 'Removed as Enron CFO after banks refuse further lending while Fastow remains. Board discovers $45M+ in personal profits from LJM partnerships.' },
      { date: '2001-12-02', event: 'Enron files Chapter 11 bankruptcy, largest in US history at that time ($63.4 billion in assets).' },
      { date: '2002-10-31', event: 'Indicted on 78 counts including fraud, money laundering, conspiracy, and insider trading. Charges later expanded to 98 counts.' },
      { date: '2004-01-14', event: 'Pleads guilty to two counts of wire and securities fraud. Agrees to forfeit $23.8 million and cooperate as key prosecution witness in exchange for 10-year maximum sentence.' },
      { date: '2006-01-30', event: 'Testifies as star prosecution witness at Skilling/Lay trial. Testimony includes detailed descriptions of how SPE fraud worked and what Skilling and Lay knew.' },
      { date: '2006-09-26', event: 'Sentenced to 6 years in federal prison (judge reduced from 10-year maximum for cooperation). Incarcerated at Federal Prison Camp near Pollock, Louisiana.' },
      { date: '2011-05-18', event: 'Released from prison to Houston halfway house' },
      { date: '2011-12-16', event: 'Fully released from custody. Begins working as document review clerk and paid ethics speaker.' },
      { date: '2016', event: 'Invested in KeenCorp, an AI analytics company focused on measuring employee engagement' },
    ],
    socialMedia: [],
    sources: [
      { title: 'Wikipedia: Andrew Fastow', url: 'https://en.wikipedia.org/wiki/Andrew_Fastow', date: '' },
      { title: 'SEC Litigation Release: Andrew Fastow', url: 'https://www.sec.gov/litigation/litreleases/lr17762.htm', date: '2002-10-31' },
      { title: 'DOJ Press Release: Fastow Guilty Plea', url: 'https://www.justice.gov/archive/dag/cftf/chargingdocs/fastow-cr-04-025.pdf', date: '2004-01-14' },
      { title: 'Powers Report: Report of Investigation by Special Investigative Committee of Enron Board', url: 'https://www.sec.gov/spotlight/enron/powers-testimony.htm', date: '2002-02-01' },
    ],
    aliases: ['Andy Fastow'],
    knownAssociates: [
      { name: 'Jeffrey Skilling', relationship: 'Enron CEO who hired Fastow and approved SPE fraud structure. Fastow testified against him at trial.', href: '/entities/individuals/jeffrey-skilling' },
      { name: 'Kenneth Lay', relationship: 'Enron Chairman who approved board waiver of ethics code for Fastow partnerships. Fastow testified against him at trial.', href: '/entities/individuals/ken-lay' },
      { name: 'Lea Fastow', relationship: 'Wife and Enron Assistant Treasurer. Convicted of tax fraud for concealing partnership income. Sentenced to 1 year.', href: '/entities/individuals/lea-fastow' },
      { name: 'Michael Kopper', relationship: 'Fastow chief lieutenant at Enron. Managed Chewco and other SPEs. First Enron executive to plead guilty (August 2002).', href: '/entities/individuals/michael-kopper' },
      { name: 'Sherron Watkins', relationship: 'Enron VP who warned Lay about Fastow accounting schemes in August 2001', href: '/entities/individuals/sherron-watkins' },
      { name: 'Ben Glisan', relationship: 'Enron Treasurer who participated in structuring Fastow fraudulent SPE transactions', href: '/entities/individuals/ben-glisan' },
    ],
  },
