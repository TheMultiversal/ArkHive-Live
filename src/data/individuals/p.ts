...
const profiles: Record<string, IndividualProfile> = {
 ...
 knownAssociates: [
  ...
  'augusto-pinochet': {
    ...
    title: 'Former Military Dictator of Chile',
    role: 'Dictator',
    riskLevel: 'critical' as const,
    description: 'Military general who seized power in a CIA-backed coup on September 11, 1973, overthrowing democratically elected President Salvador Allende. Ruled Chile as dictator for 17 years, during which his regime killed over 3,200 people, tortured 40,000, and forcibly disappeared thousands more. A key architect of Operation Condor, the coordinated campaign of political repression and state terror across South American dictatorships that killed an estimated 60,000-80,000 people.',
    birthDate: '1915-11-25',
    birthPlace: 'Valparaíso, Chile',
    education: ['Military Science, Chilean War Academy (1951)'],
    affiliations: [
      { name: 'Chilean Military Junta', role: 'Commander-in-Chief and President (1973-1990)', type: 'agency' as const },
      { name: 'Operation Condor', role: 'Key Participant and Co-Architect', type: 'organization' as const },
    ],
    controversies: [
      'CIA-backed coup overthrew democratically elected government on September 11, 1973; President Allende died during the assault',
      'Regime killed over 3,200 people and tortured approximately 40,000 during 17-year military rule',
      'Key participant in Operation Condor coordinating assassination and repression across six South American countries',
      'Established DINA secret police that operated torture centers including Villa Grimaldi and Colonia Dignidad',
      'Ordered the car bombing assassination of former Chilean ambassador Orlando Letelier in Washington D.C. in 1976',
      'Amassed secret fortune of $28 million hidden in Riggs Bank and offshore accounts while claiming military salary',
      'Evaded prosecution for decades through self-granted amnesty decree, claimed immunity, and alleged poor health',
      'Caravan of Death: Military execution squad killed 97 political prisoners in October 1973 under his direct orders',
    ],
    charges: [
      {
        statute: 'International Criminal Law - Crimes Against Humanity',
        description: 'Systematic murder, torture, forced disappearance of over 40,000 political opponents during 17-year military dictatorship',
        category: 'human-rights',
      },
      {
        statute: 'International Criminal Law - State Terrorism',
        description: 'Operation Condor: coordinated cross-border assassination and disappearance campaigns across South America killing 60,000-80,000',
        category: 'human-rights',
      },
      {
        statute: 'Chilean Criminal Code - Homicide and Torture',
        description: 'Indicted on charges related to Caravan of Death, Villa Grimaldi torture center, and Operation Colombo disappearances',
        category: 'violent',
      },
      {
        statute: '26 U.S.C. § 7201 - Tax Evasion (Chilean equivalent)',
        description: 'Hidden $28 million in Riggs Bank and offshore accounts; charged with tax evasion and passport fraud in Chile',
        category: 'financial',
      },
    ],
    relatedInvestigations: [
    ...
    timeline: [
      { date: '1915-11-25', event: 'Born in Valparaíso, Chile' },
      { date: '1973-09-11', event: 'Led CIA-backed military coup overthrowing President Salvador Allende' },
      { date: '1973-10', event: 'Orders Caravan of Death; military execution squad kills 97 political prisoners across Chile' },
      { date: '1974', event: 'Creates DINA secret police; establishes network of torture and detention centers' },
      { date: '1975', event: 'Joins Operation Condor coordinating state terror with Argentina, Brazil, Uruguay, Paraguay, Bolivia' },
      { date: '1976-09-21', event: 'DINA agents assassinate Orlando Letelier and Ronni Moffitt via car bomb in Washington D.C.' },
      { date: '1988', event: 'Loses national plebiscite vote; transition to democracy begins' },
      { date: '1990', event: 'Steps down as president; retains military commander role and self-appointed Senator-for-Life status' },
      { date: '1998-10-16', event: 'Arrested in London on Spanish extradition warrant for human rights crimes' },
      { date: '2000', event: 'Released from UK on medical grounds; returns to Chile' },
      { date: '2004', event: 'Riggs Bank investigation reveals $28 million in hidden accounts; stripped of immunity' },
      { date: '2006-12-10', event: 'Dies in Santiago at age 91; never convicted despite 300+ criminal charges' },
    ],
    sources: [
      { title: 'National Security Archive: Chile Documentation Project', url: 'https://nsarchive.gwu.edu/project/chile-documentation-project', date: '2023' },
      { title: 'Chilean National Commission on Truth and Reconciliation (Rettig Report)', date: '1991' },
      { title: 'National Commission on Political Imprisonment and Torture (Valech Report)', date: '2004' },
    ],
    aliases: ['El General', 'The Dictator of Chile'],
    knownAssociates: [
      { name: 'Henry Kissinger', relationship: 'U.S. Secretary of State who supported the 1973 coup and maintained close relations with the regime', href: '/entities/individuals/henry-kissinger' },
      { name: 'Manuel Contreras', relationship: 'Head of DINA secret police who carried out campaign of political murder, torture, and international assassinations' },
      { name: 'Salvador Allende', relationship: 'Democratically elected president overthrown and killed during the September 11, 1973 coup' },
    ],
  },
  'peter-thiel': {
    name: 'Peter Thiel',
