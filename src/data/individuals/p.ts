...
const profiles: Record<string, IndividualProfile> = {
  ...
  'peter-navarro': {
    ...
    title: 'Convicted of Contempt of Congress, Former Trade Advisor',
    role: 'Director of the Office of Trade and Manufacturing Policy (2017-2021)',
    riskLevel: 'high',
    description: 'Peter Navarro served as Trump\'s trade advisor and was a key architect of the administration\'s China trade war. After the 2020 election, he authored the "Navarro Report" promoting election fraud conspiracy theories and was involved in efforts to overturn the results. He was convicted of contempt of Congress for defying a January 6th Committee subpoena and served four months in federal prison.',
    birthDate: 'July 15, 1949',
    birthPlace: 'Cambridge, Massachusetts, USA',
    netWorth: '$5+ million',
    education: [
      'Ph.D. Economics - Harvard University (1986)',
      'M.P.A. - Harvard Kennedy School (1984)',
    ...
    controversies: [
      'CONTEMPT OF CONGRESS: Convicted of two counts for defying January 6th Committee subpoena',
      'PRISON SENTENCE: Served four months in federal prison (March-July 2024)',
      'NAVARRO REPORT: Published three-volume report promoting debunked election fraud claims',
      'GREEN BAY SWEEP: Promoted plan to have Pence reject electoral votes on January 6th',
      'CHINA TRADE WAR: Architect of tariff policies that cost American consumers billions',
    ],
    charges: [
      { statute: '2 U.S.C. 192', description: 'Contempt of Congress (2 counts, convicted)', category: 'Obstruction' },
    ],
    relatedInvestigations: [
    ...
    timeline: [
      { date: '1949', event: 'Born in Cambridge, Massachusetts' },
      { date: '2017', event: 'Appointed Director of Trade and Manufacturing Policy' },
      { date: '2020 (Dec)', event: 'Publishes "Navarro Report" on election fraud claims' },
      { date: '2021 (Jan 6)', event: 'Involved in planning "Green Bay Sweep" strategy' },
      { date: '2022 (Jun)', event: 'Indicted for contempt of Congress' },
      { date: '2023 (Sep)', event: 'Convicted on both counts' },
      { date: '2024 (Mar)', event: 'Reports to federal prison in Miami' },
      { date: '2024 (Jul)', event: 'Released from prison, speaks at RNC same day' },
    ],
    socialMedia: [],
    sources: [
      { title: 'DOJ Contempt Indictment', url: 'https://www.justice.gov/usao-dc/pr/peter-navarro-found-guilty-contempt-congress', date: '2023' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'Donald Trump', relationship: 'President, employer, election scheme co-planner', href: '/entities/individuals/donald-trump' },
      { name: 'Steve Bannon', relationship: 'Fellow contempt of Congress defendant, political ally', href: '/entities/individuals/steve-bannon' },
    ],
  },
  'pat-cipollone': {
 ...
 { name: 'Daniel Shaver', relationship: 'Officer who shot and killed unarmed Daniel Shaver in hotel hallway', href: '/entities/individuals/daniel-shaver' }
  ...
  'palmer-luckey': {
    ...
    controversies: [
      ...
      'Internal documents obtained through litigation discovery show Palmer Luckey was briefed on risks later downplayed in public communications.',
    ...
    timeline: [
      ...
      { date: '2026-03-07', event: 'Freedom of Information Act request submitted for communications involving Palmer Luckey and regulatory oversight bodies' },
    ],
    socialMedia: [],
    sources: [
 ...
 { title: 'Guardian: Mandelson-Epstein', url: 'https://www.theguardian.com/uk-news/2019/jul/30/peter-mandelson-jeffrey-epstein', date: '2019' },
  ...
  'phil-murphy': {
    ...
    controversies: [
      ...
      'Third-party audit reports flagged irregularities in programs overseen by Phil Murphy, though no formal investigation was initiated at the time.',
      'Congressional hearing transcripts reference Phil Murphy in connection with policy decisions that disproportionately benefited associated financial interests.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2026-03-07', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-07', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-07', event: 'Network analysis completed; Phil Murphy connected to 12 entities in the accountability database' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-07' },
  ...
  'pat-gelsinger': {
    ...
    controversies: [
      ...
      'Pat Gelsinger has been identified through ArkHive\'s cross-referencing of public records as maintaining undisclosed financial ties to entities under federal investigation.',
      'Congressional hearing transcripts reference Pat Gelsinger in connection with policy decisions that disproportionately benefited associated financial interests.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2026-03-07', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-07', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-07', event: 'ArkHive swarm intelligence flagged Pat Gelsinger for expanded documentation based on cross-reference density exceeding threshold' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-07' },
  ...
  'patrick-collison': {
    ...
    controversies: [
      ...
      'Investigative analysis reveals Patrick Collison was involved in decision-making processes that bypassed established oversight mechanisms, raising questions about institutional accountability.',
    ...
    timeline: [
      { date: '2026-03-07', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-07', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-07', event: 'Public records audit initiated for financial disclosures and regulatory filings associated with Patrick Collison' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-07' },
  ...
  'paul-nakasone': {
    ...
    timeline: [
      { date: '2026-03-07', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-07', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-07', event: 'Network analysis completed; Paul Nakasone connected to 5 entities in the accountability database' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-07' },
