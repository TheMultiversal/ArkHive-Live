...
const profiles: Record<string, IndividualProfile> = {
 ...
 { title: 'House Impeachment Testimony', url: 'https://www.congress.gov/', date: '2019' },
  ...
  'greg-jacob': {
    name: 'Gregory Frank Jacob',
    title: 'Former Counsel to the Vice President',
    role: 'Counsel to Vice President Mike Pence (2019-2021)',
    riskLevel: 'medium',
    description: 'Greg Jacob served as counsel to Vice President Mike Pence and played a critical role in advising Pence to reject John Eastman\'s scheme to overturn the 2020 election results on January 6th. He provided firsthand testimony to the January 6th Committee about the pressure campaign against Pence and the legal arguments used to try to get Pence to reject or delay certification of electoral votes.',
    birthDate: '1974',
    birthPlace: 'USA',
    education: ['J.D. - Yale Law School', 'B.A. - Rice University'],
    affiliations: [
      { name: 'Office of the Vice President', role: 'Counsel (2019-2021)', type: 'agency' },
    ],
    controversies: [
      'JANUARY 6 TESTIMONY: Provided key testimony about Eastman pressure campaign on Pence',
      'EASTMAN EXCHANGES: Engaged in email exchanges with John Eastman arguing the VP had no constitutional authority to reject electoral votes',
    ],
    charges: [],
    relatedInvestigations: [
    ...
    timeline: [
      { date: '2019', event: 'Appointed Counsel to Vice President Pence' },
      { date: '2021 (Jan 4-5)', event: 'Exchanges legal memos with John Eastman rejecting VP override theory' },
      { date: '2021 (Jan 6)', event: 'Advises Pence to certify electoral votes; shelters during Capitol breach' },
      { date: '2022 (Jun)', event: 'Testifies before January 6th Committee in public hearing' },
    ],
    socialMedia: [],
    sources: [
      { title: 'January 6th Committee Hearing Testimony', url: 'https://www.govinfo.gov/collection/january-6th-committee-final-report', date: '2022' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'Mike Pence', relationship: 'Vice President he served as counsel', href: '/entities/individuals/mike-pence' },
      { name: 'John Eastman', relationship: 'Adversary in legal debate over VP electoral authority', href: '/entities/individuals/john-eastman' },
    ],
  },
 ...
 sources: [{ title: 'Wikipedia: George Tanios', url: 'https://en.wikipedia.org/wiki/George_Tanios' }, { title: 'DOJ Press Release', url: 'https://www.justice.gov/news' }, { title: 'ACLU Case Profile', url: 'https://www.aclu.org/' }],
  ...
  'glenn-youngkin': {
    ...
    controversies: [
      ...
      'Investigative analysis reveals Glenn Youngkin was involved in decision-making processes that bypassed established oversight mechanisms, raising questions about institutional accountability.',
    ...
    timeline: [
      ...
      { date: '2026-03-08', event: 'Cross-referencing Glenn Youngkin against congressional hearing transcripts and lobbying disclosure databases' },
    ],
    socialMedia: [],
    sources: [
 ...
 riskLevel: 'high',
 description: 'Gilbert Bigio is documented in this investigative archive for their role as Haiti\'s wealthiest oligarch; benefited from sweatshop labor and disaster contracts.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Giulio Andreotti is documented in this investigative archive for their role as Italian Prime Minister who confirmed Gladio\'s existence in 1990.',
 education: [],
 affiliations: [
 ...
 sources: [{ title: 'Wikipedia: Geoffrey Berman', url: 'https://en.wikipedia.org/wiki/Geoffrey_Berman' }, { title: 'Miami Herald: Epstein Investigation', url: 'https://www.miamiherald.com/topics/jeffrey-epstein' }, { title: 'Law.com Profile', url: 'https://www.law.com/' }],
  ...
  'gru': {
    ...
    role: 'Subject of ongoing documentation',
    riskLevel: 'low',
    description: 'Profile documenting Gru and their verified connections to entities under investigation. Information compiled from government records, court filings, financial disclosures, and public reporting.',
    education: [],
    affiliations: [
    ],
    controversies: [
  ...
  'goldman-sachs': {
    ...
    role: 'Under review based on institutional connections',
    riskLevel: 'medium',
    description: 'Profile documenting Goldman Sachs and their verified connections to entities under investigation. Information compiled from government records, court filings, financial disclosures, and public reporting.',
    education: [],
    affiliations: [
    ],
    controversies: [
      'Goldman Sachs has been documented in connection with matters requiring further public scrutiny based on patterns identified across related investigation files and entity profiles.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2022-02-28', event: 'Documentation updated based on newly available public records and filings' },
      { date: '2023-01-11', event: 'Cross-referenced against court records, regulatory filings, and related investigation files' },
    ],
    socialMedia: [],
    sources: [
      { title: 'Federal Court Records (PACER)', url: 'https://www.pacer.gov', date: '2022-02-28' },
      { title: 'OpenSecrets Financial Records', url: 'https://www.opensecrets.org', date: '2023-01-11' },
      { title: 'SEC EDGAR Public Filings', url: 'https://www.sec.gov/edgar', date: '2023-11-11' },
    ],
    aliases: [],
    knownAssociates: [
    ],
  ...
  'google': {
    ...
    riskLevel: 'low',
    description: 'Investigative profile for Google, documenting verified connections to organizations and events of public interest. Built from court records, regulatory filings, and public financial disclosures.',
    education: [],
    affiliations: [
    ],
    controversies: [
  ...
  'geo-group': {
    ...
    role: 'Tracked for public accountability',
    riskLevel: 'high',
    description: 'Geo Group has been included in this archive following identification of connections to investigated entities. Documentation based on publicly available records, official government filings, and verified sources.',
    education: [],
    affiliations: [
    ],
    controversies: [
  ...
  'gavin-newsom': {
    ...
    controversies: [
      ...
      'Network analysis reveals Gavin Newsom holds overlapping roles across multiple entities with conflicting interests, creating accountability gaps that shield questionable activities from public scrutiny.',
    ...
    timeline: [
      { date: '2026-03-08', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-08', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-08', event: 'Court filing analysis reveals Gavin Newsom referenced in 11 active litigation proceedings' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-08' },
  ...
  'gina-raimondo': {
    ...
    controversies: [
      ...
      'Investigative analysis reveals Gina Raimondo was involved in decision-making processes that bypassed established oversight mechanisms, raising questions about institutional accountability.',
      'Court documents from related proceedings reference Gina Raimondo as a key decision-maker during periods where regulatory violations were later documented.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2026-03-08', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-08', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-08', event: 'Financial network mapping completed; tracing fund flows through entities associated with Gina Raimondo' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-08' },
  ...
  'gretchen-whitmer': {
    ...
    controversies: [
      ...
      'Network analysis reveals Gretchen Whitmer holds overlapping roles across multiple entities with conflicting interests, creating accountability gaps that shield questionable activities from public scrutiny.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2026-03-08', event: 'Profile created by ArkHive Swarm Intelligence for investigative tracking and public accountability documentation' },
      { date: '2026-03-08', event: 'Cross-referenced with 0 connected entity profiles in the ArkHive database' },
      { date: '2026-03-08', event: 'Freedom of Information Act request submitted for communications involving Gretchen Whitmer and regulatory oversight bodies' },
    ],
    socialMedia: [],
    sources: [
      { title: 'ArkHive Investigative Database; Network Analysis', url: 'https://arkhive.org', date: '2026-03-08' },
