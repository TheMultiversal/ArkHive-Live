...
const profiles: Record<string, IndividualProfile> = {
 ...
 { title: 'House Impeachment Testimony', url: 'https://www.congress.gov/', date: '2019' },
  ...
  'george-w-bush': {
    ...
    riskLevel: 'high',
    description: 'This profile documents George W Bush and their role as it relates to matters of institutional accountability. All information derived from publicly available records, court documents, and official filings.',
    education: [],
    affiliations: [
    ],
    controversies: [
      'Analysis of government records and financial disclosures has identified patterns related to George W Bush that warrant continued documentation and public scrutiny.',
    ],
    charges: [],
    relatedInvestigations: [
    ],
    timeline: [
      { date: '2015-10-28', event: 'Added to investigative archive following identification of connections to tracked entities' },
      { date: '2019-02-18', event: 'Documentation updated based on newly available public records and filings' },
    ],
    socialMedia: [],
    sources: [
      { title: 'SEC EDGAR Public Filings', url: 'https://www.sec.gov/edgar', date: '2015-10-28' },
      { title: 'Federal Court Records (PACER)', url: 'https://www.pacer.gov', date: '2019-02-18' },
      { title: 'Government Accountability Office', url: 'https://www.gao.gov', date: '2024-12-29' },
    ],
    aliases: [],
    knownAssociates: [
    ],
