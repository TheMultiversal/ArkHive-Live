...
const profiles: Record<string, IndividualProfile> = {
 ...
 { title: 'George Floyd Murder & Racial Justice Uprising', slug: 'george-floyd', severity: 'critical' },
 ],
 timeline: [
 { date: 'October 14, 1973', event: 'Born George Perry Floyd Jr. in Fayetteville, North Carolina' },
 { date: 'Childhood', event: 'Grows up in Houston\'s Third Ward; becomes a community figure known as "Big Floyd"' },
 { date: '1990s', event: 'Stars in high school basketball and football at Jack Yates High School' },
 { date: '2014', event: 'Moves to Minneapolis seeking a fresh start; works as truck driver and bouncer' },
 { date: 'May 25, 2020', event: 'Murdered by Derek Chauvin who knelt on his neck for 9 minutes 29 seconds outside Cup Foods at 38th and Chicago Avenue in Minneapolis' },
 { date: 'May 26, 2020', event: 'Darnella Frazier\'s bystander video goes viral; all four officers fired by MPD; protests begin in Minneapolis and spread nationwide' },
 { date: 'June 4, 2020', event: 'Public memorial at North Central University in Minneapolis; Al Sharpton delivers eulogy' },
 { date: 'June 9, 2020', event: 'Funeral and burial in Pearland, Texas next to his mother; Floyd Mayweather pays for funeral services' },
 { date: 'March 12, 2021', event: 'City of Minneapolis approves record $27 million wrongful death settlement with Floyd family' },
 { date: 'April 20, 2021', event: 'Derek Chauvin convicted of second-degree unintentional murder, third-degree murder, and second-degree manslaughter, first white MN officer convicted of murdering a Black person' },
 { date: 'June 25, 2021', event: 'Chauvin sentenced to 22.5 years; judge finds he treated Floyd "with particular cruelty"' },
 { date: 'February 24, 2022', event: 'Kueng, Lane, and Thao convicted of federal civil rights violations related to Floyd murder' },
 { date: 'May 2, 2023', event: 'Tou Thao found guilty at state trial, final conviction in all George Floyd cases' },
 ],
 socialMedia: [],
 sources: [
 { title: 'Minnesota v. Chauvin, Complete Trial Record and Evidence', url: 'https://mncourts.gov/state-v-chauvin/', date: '2021' },
 { title: 'New York Times: Comprehensive George Floyd Investigation', url: 'https://www.nytimes.com/', date: '2020' },
 { title: 'Star Tribune: Pulitzer Prize-Winning George Floyd Coverage', url: 'https://www.startribune.com/', date: '2020-2021' },
 { title: 'DOJ Press Release: Federal Civil Rights Convictions', url: 'https://www.justice.gov/opa/pr/three-former-minneapolis-police-officers-convicted-federal-civil-rights-violations-death', date: '2022' },
 ],
 aliases: [],
 knownAssociates: [
 { name: 'Derek Chauvin', relationship: 'His murderer, knelt on Floyd neck for 9 minutes 29 seconds; convicted and sentenced to 22.5 years state, 21 years federal', href: '/entities/individuals/derek-chauvin' },
 { name: 'Tou Thao', relationship: 'Officer who blocked bystanders during murder; convicted of federal civil rights violations and state manslaughter', href: '/entities/individuals/tou-thao' },
 { name: 'Darnella Frazier', relationship: '17-year-old bystander who recorded the murder; her video contradicted MPD cover-up and was decisive evidence; Pulitzer Prize recipient', href: '/entities/individuals/darnella-frazier' },
 ],
 },
...
'guy-reffitt': {
 ...
 'glenn-andreotta': {
 name: 'Glenn Andreotta',
 title: 'My Lai Helicopter Crew Hero',
 role: 'Specialist 4, Crew Chief, OH-23 Observation Helicopter, 123rd Aviation Battalion',
 riskLevel: 'low',
 description: 'Specialist Glenn Andreotta was the crew chief aboard the OH-23 Raven observation helicopter piloted by Warrant Officer Hugh Thompson during the My Lai massacre on March 16, 1968. Together with Thompson and door gunner Lawrence Colburn, Andreotta witnessed the massacre from the air and took extraordinary action to stop it. Andreotta personally waded into a drainage ditch filled with dead and dying Vietnamese civilians and pulled out a still-living child, carrying the young boy to safety. This act of moral courage under impossible circumstances stands as one of the most remarkable individual acts of the Vietnam War. When Thompson landed his helicopter between American soldiers and a group of Vietnamese civilians to prevent further killings, Andreotta manned the helicopter\'s weapons systems, prepared to fire on fellow American soldiers if necessary to protect the civilians. Tragically, Andreotta was killed in action on April 8, 1968, just three weeks after My Lai, when his helicopter was shot down during a mission near Chu Lai. He was only 20 years old. Andreotta was posthumously awarded the Soldier\'s Medal in 1998, thirty years after My Lai, when the Army finally recognized the heroism of Thompson\'s crew. His courage in pulling a living child from among the dead at the ditch remains one of the most powerful acts of individual moral resistance in American military history.',
 birthDate: 'October 15, 1947',
 birthPlace: 'San Jose, California',
 deathDate: 'April 8, 1968',
 deathCause: 'Killed in action when his helicopter was shot down near Chu Lai, Vietnam',
 education: [],
 affiliations: [
 { name: 'United States Army', relationship: 'Specialist 4, Crew Chief in the 123rd Aviation Battalion, Americal Division', href: '/entities/agencies/us-army' },
 { name: 'Task Force Barker', relationship: 'Helicopter crew member who witnessed and intervened to stop the My Lai massacre', href: '/investigations/my-lai-massacre' },
 ],
 controversies: [
 {
 title: 'Rescue of Living Child from the Ditch',
 description: 'During the My Lai massacre, Andreotta spotted movement among the bodies piled in the drainage ditch where Charlie Company soldiers had executed dozens of civilians. He waded into the ditch, stepping over the dead and dying, and pulled out a small child who was still alive, clinging to a dead woman believed to be the child\'s mother. Andreotta carried the boy to the helicopter for evacuation.',
 date: 'March 16, 1968',
 impact: 'Andreotta\'s rescue of the child from among the dead became one of the most powerful individual acts of the entire Vietnam War and symbolized the possibility of moral courage amid atrocity.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Confrontation with American Ground Forces',
 description: 'When pilot Hugh Thompson landed the helicopter between advancing American soldiers and a group of cowering Vietnamese civilians, Andreotta trained the helicopter\'s weapons on the U.S. soldiers and was prepared to fire if they attempted to harm the civilians. This extraordinary act of threatening to fire on fellow Americans to protect Vietnamese civilians represented the ultimate act of moral courage.',
 date: 'March 16, 1968',
 impact: 'The willingness of Thompson\'s crew to risk killing fellow soldiers to protect civilians set a powerful precedent for the duty to prevent war crimes, regardless of who is committing them.',
 sources: ['https://www.pbs.org/wgbh/americanexperience/films/mylai/'],
 },
 {
 title: 'Witnessing the Massacre from the Air',
 description: 'From the helicopter, Andreotta witnessed the systematic killing of unarmed Vietnamese civilians by Charlie Company soldiers. He saw bodies scattered throughout the hamlet, soldiers firing into groups of civilians, and the mass execution at the drainage ditch. His aerial perspective gave him an unobstructed view of the full scope of the atrocity.',
 date: 'March 16, 1968',
 impact: 'The helicopter crew\'s aerial witness provided crucial testimony to the scale and deliberateness of the massacre.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Killed in Action Three Weeks After My Lai',
 description: 'Andreotta was killed on April 8, 1968, just 23 days after My Lai, when his helicopter was shot down during a mission near Chu Lai. He was 20 years old. His death meant he was unable to testify during subsequent investigations, though Thompson and Colburn provided detailed accounts of his actions.',
 date: 'April 8, 1968',
 impact: 'His death at age 20, so soon after committing one of the war\'s most courageous acts, added a tragic dimension to the My Lai story.',
 sources: ['https://www.pbs.org/wgbh/americanexperience/films/mylai/'],
 },
 {
 title: 'Posthumous Soldier\'s Medal - 30 Year Delay',
 description: 'Andreotta, along with Thompson and Colburn, was not recognized for his heroism at My Lai until 1998, thirty years after the events. The Army initially tried to bury the story and punished Thompson for his intervention. It took three decades for the military to posthumously award Andreotta the Soldier\'s Medal for heroism not involving conflict with the enemy.',
 date: 'March 6, 1998',
 impact: 'The 30-year delay in recognition demonstrated how deeply the military establishment resisted acknowledging what actually happened at My Lai and the heroism of those who tried to stop it.',
 sources: ['https://www.army.mil/article/19780/my_lai_heroes_three_decades_later'],
 },
 {
 title: 'Legacy as Military Ethics Example',
 description: 'Andreotta\'s actions at My Lai, particularly pulling the living child from the ditch, are now taught at military academies worldwide as an example of moral courage and the duty to disobey unlawful orders. His willingness to risk his own life and career to save Vietnamese civilians represents the standard expected of soldiers confronting war crimes.',
 date: 'Ongoing',
 impact: 'Andreotta\'s example is used to teach military personnel that the duty to protect civilians overrides orders, unit loyalty, and personal safety.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 ],
 timeline: [
 { date: 'October 15, 1947', event: 'Born in San Jose, California' },
 { date: '1967', event: 'Deployed to Vietnam as helicopter crew chief with the 123rd Aviation Battalion, Americal Division' },
 { date: 'March 16, 1968', event: 'Witnessed the My Lai massacre from helicopter, rescued a living child from the drainage ditch filled with bodies' },
 { date: 'March 16, 1968', event: 'Manned helicopter weapons aimed at American soldiers while Thompson evacuated Vietnamese civilians to safety' },
 { date: 'April 8, 1968', event: 'Killed in action at age 20 when his helicopter was shot down near Chu Lai, Vietnam' },
 { date: 'March 6, 1998', event: 'Posthumously awarded the Soldier\'s Medal for heroism at My Lai, thirty years after the event' },
 ],
 keyPositions: [
 ...
 { name: 'Lawrence Colburn', relationship: 'Door gunner who aimed weapons at American soldiers to protect Vietnamese civilians', href: '/entities/individuals/lawrence-colburn' },
 { name: 'William Calley', relationship: 'Platoon leader ordering the killings that Thompson\'s crew tried to stop', href: '/entities/individuals/william-calley' },
 { name: 'Ernest Medina', relationship: 'Charlie Company commander whose troops committed the massacre', href: '/entities/individuals/ernest-medina' },
 ],
 charges: [],
 ...
 { name: 'Gina Haspel', relationship: 'CIA officer at black site where Rahman died from hypothermia', href: '/entities/individuals/gina-haspel' },
   ...
   'g-gordon-liddy': {
    name: 'G. Gordon Liddy',
    title: 'Former FBI Agent, CRP Counsel, and Watergate Mastermind',
    role: 'Watergate Planner, White House Plumber, Intelligence Operative',
    riskLevel: 'critical',
    ...
    deathDate: 'March 30, 2021',
    birthPlace: 'Brooklyn, New York, USA',
    education: ['B.S., Fordham University (1952)', 'LL.B., Fordham University School of Law (1957)'],
    affiliations: [
      { name: 'Federal Bureau of Investigation', role: 'Special Agent (1957-1962)', type: 'agency' },
      { name: 'Committee to Re-elect the President', role: 'Counsel and Intelligence Director (1971-1972)', type: 'organization' },
      { name: 'White House Special Investigations Unit', role: 'Co-Director, "Plumbers" (1971)', type: 'agency' },
      { name: 'Dutchess County District Attorney', role: 'Assistant DA, New York (1966-1968)', type: 'agency' },
      { name: 'U.S. Department of the Treasury', role: 'Special Assistant (1969-1971)', type: 'agency' },
    ],
    controversies: [
    ...
    charges: [
      { statute: '18 U.S.C. 371', description: 'Conspiracy to Commit Burglary and Wiretapping; Co-planned Watergate break-in operation', category: 'Federal' },
      { statute: '22 D.C. Code 1801(b)', description: 'Burglary; Participated in planning unlawful entry into DNC headquarters', category: 'Federal' },
      { statute: '18 U.S.C. 2511', description: 'Interception of Wire Communications; Directed placement of wiretaps on DNC telephones', category: 'Federal' },
      { statute: '18 U.S.C. 371', description: 'Conspiracy (Fielding Break-in); Co-directed burglary of Ellsberg\'s psychiatrist\'s office', category: 'Federal' },
      { statute: '18 U.S.C. 241', description: 'Conspiracy Against Rights; Violated civil rights through Fielding burglary', category: 'Federal' },
    ],
    relatedInvestigations: [
    ...
    timeline: [
      { date: 'November 30, 1930', event: 'Born in Brooklyn, New York' },
      { date: '1952', event: 'Graduates from Fordham University' },
      { date: '1957', event: 'Earns law degree from Fordham; joins FBI as special agent' },
      { date: '1957-1962', event: 'Serves as FBI special agent in Indianapolis and Denver field offices' },
      { date: '1962', event: 'Leaves FBI; enters private law practice' },
      { date: '1966', event: 'Becomes assistant district attorney in Dutchess County, New York; known for aggressive drug raids' },
      { date: '1968', event: 'Runs unsuccessfully for Congress in New York' },
      { date: '1969', event: 'Joins Nixon Treasury Department as special assistant for organized crime' },
      { date: '1971', event: 'Transferred to White House Domestic Council, then recruited for "Plumbers" unit' },
      { date: 'September 3, 1971', event: 'Co-directs break-in of Daniel Ellsberg\'s psychiatrist Dr. Lewis Fielding\'s office' },
      { date: 'November 1971', event: 'Moves to CRP as counsel and intelligence director' },
      { date: 'January 27, 1972', event: 'Presents $1 million "Gemstone" intelligence plan to Mitchell, Dean, and Magruder in AG\'s office' },
      { date: 'February 4, 1972', event: 'Presents revised $500,000 Gemstone plan; Mitchell tells him to scale down further' },
      { date: 'March 30, 1972', event: 'Scaled-down $250,000 plan reportedly approved at meeting with Mitchell in Key Biscayne' },
      { date: 'May 26-28, 1972', event: 'First Watergate break-in: team plants bugs on two phones and attempts to photograph documents' },
      { date: 'June 17, 1972', event: 'Second break-in: five burglars arrested inside DNC; Liddy supervises from Watergate Hotel' },
      { date: 'June 19, 1972', event: 'Shreds Gemstone files and $100 bills at CRP offices' },
      { date: 'September 15, 1972', event: 'Indicted by federal grand jury as one of seven Watergate defendants' },
      { date: 'January 30, 1973', event: 'Convicted at trial along with McCord; maintains silence throughout' },
      { date: 'March 23, 1973', event: 'Sentenced to 6 years 8 months to 20 years by Judge Sirica, plus $40,000 fine' },
      { date: '1973-1977', event: 'Serves 52 months in federal prison, longest of any Watergate defendant' },
      { date: 'April 12, 1977', event: 'President Carter commutes sentence to 8 years total; released from prison' },
      { date: '1980', event: 'Publishes autobiography "Will," which becomes a bestseller' },
      { date: '1992-2012', event: 'Hosts nationally syndicated conservative radio talk show' },
      { date: 'March 30, 2021', event: 'Dies in Mount Vernon, Virginia at age 90' },
    ],
    socialMedia: [],
    sources: [
      ...
      { title: 'National Archives: Watergate Investigation Records', url: 'https://www.archives.gov/research/investigations/watergate', date: '1972-1974' },
      { title: 'G. Gordon Liddy, "Will" (Autobiography)', url: 'https://scholar.google.com/scholar?q=G+Gordon+Liddy+Will+autobiography', date: '1980' },
      { title: 'New York Times Obituary: G. Gordon Liddy', url: 'https://www.nytimes.com/2021/03/30/us/politics/g-gordon-liddy-dead.html', date: '2021' },
      { title: 'House Judiciary Committee Impeachment Evidence', url: 'https://www.congress.gov/bill/93rd-congress/house-resolution/803', date: '1974' },
    ],
    aliases: ['The G-Man', 'The Prince of Darkness'],
    knownAssociates: [
      { name: 'E. Howard Hunt', relationship: 'Co-planner of Watergate break-in and White House Plumber partner', href: '/entities/individuals/e-howard-hunt' },
      { name: 'John Mitchell', relationship: 'Attorney General and CRP director who approved Gemstone plan', href: '/entities/individuals/john-mitchell' },
      { name: 'Jeb Stuart Magruder', relationship: 'CRP deputy director who approved Watergate operation', href: '/entities/individuals/jeb-stuart-magruder' },
      { name: 'John Dean', relationship: 'White House counsel who attended Gemstone presentations', href: '/entities/individuals/john-dean' },
      { name: 'Richard Nixon', relationship: 'President whose re-election campaign authorized the operation', href: '/entities/individuals/richard-nixon' },
      { name: 'James McCord', relationship: 'Fellow Watergate burglar and ex-CIA officer', href: '/entities/individuals/james-mccord' },
      { name: 'Egil Krogh', relationship: 'Fellow White House Plumber who co-directed illegal operations', href: '/entities/individuals/egil-krogh' },
    ],
  },
 ...
 knownAssociates: [
  ...
  'gary-thomas-rowe': {
    ...
    charges: [
      { statute: '18 U.S.C. 1111', description: 'Murder: Present in vehicle during shooting of Viola Liuzzo; indicted for first-degree murder by Alabama grand jury (1978); charges dismissed', category: 'Violent Crimes' },
      { statute: '18 U.S.C. 245', description: 'Federally Protected Activities: Participated in violent attacks on Freedom Riders exercising federally protected right to interstate travel', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 241', description: 'Conspiracy Against Rights: Participated in KKK conspiracies to violate civil rights of African Americans and civil rights workers', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 844', description: 'Arson/Explosives: Had foreknowledge of and possible participation in church bombings and other explosive attacks', category: 'Federal Crimes' },
    ],
    relatedInvestigations: [
      { title: 'COINTELPRO: Domestic Surveillance Legacy', slug: 'cointelpro-domestic-surveillance-legacy', severity: 'critical' },
    ],
    timeline: [
      { date: 'August 13, 1933', event: 'Born in Savannah, Georgia' },
      { date: '1960', event: 'Recruited by FBI to infiltrate the Eastview Klavern 13 of the United Ku Klux Klans of America in Birmingham, Alabama' },
      { date: '1961-05-14', event: 'Present during Klan attack on Freedom Riders at Birmingham Trailways bus station; FBI had advance knowledge but failed to prevent attack' },
      { date: '1963-09-15', event: 'Had advance knowledge of Klan activity related to the 16th Street Baptist Church bombing that killed four girls; FBI failed to prevent it' },
      { date: '1965-03-25', event: 'In car when Klansmen shoot and kill civil rights worker Viola Liuzzo on Alabama Route 80 after Selma-to-Montgomery marches' },
      { date: '1965', event: 'Testifies against fellow Klansmen in Liuzzo murder trial; given immunity from prosecution' },
      { date: '1965', event: 'Placed in federal witness protection program under name "Thomas Neil Moore"' },
      { date: '1975-1976', event: 'Church Committee investigation reveals extent of FBI informant operations and Rowe\'s dual role' },
      { date: '1978', event: 'Indicted for first-degree murder in Liuzzo killing by Lowndes County, Alabama grand jury' },
      { date: '1980', event: 'Murder charges dismissed on jurisdictional and double jeopardy grounds' },
      { date: '1982', event: 'Writes memoir "My Undercover Years with the Ku Klux Klan" describing his time as FBI informant' },
      { date: 'May 25, 1998', event: 'Dies in Savannah, Georgia at age 64' },
    ],
    socialMedia: [],
    sources: [
      ...
      { title: 'Gary Thomas Rowe - "My Undercover Years with the Ku Klux Klan"', url: 'https://scholar.google.com/scholar?q=Gary+Thomas+Rowe+Undercover+Years+Ku+Klux+Klan', date: '1976' },
      { title: 'Mary Stanton - "From Selma to Sorrow: The Life and Death of Viola Liuzzo"', url: 'https://scholar.google.com/scholar?q=Mary+Stanton+Selma+Sorrow+Viola+Liuzzo', date: '1998' },
      { title: 'DOJ Investigation of FBI Handling of Rowe Informant File', url: 'https://scholar.google.com/scholar?q=DOJ+investigation+FBI+Gary+Rowe+informant', date: '1979' },
    ],
    aliases: ['Thomas Neil Moore'],
    knownAssociates: [
      { name: 'J. Edgar Hoover', relationship: 'FBI Director who directed the cover-up of Rowe\'s involvement in violence and the smear campaign against Viola Liuzzo', href: '/entities/individuals/j-edgar-hoover' },
      { name: 'Cartha "Deke" DeLoach', relationship: 'FBI Associate Deputy Director involved in Bureau management of the Rowe informant operation', href: '/entities/individuals/cartha-deke-deloach' },
      { name: 'William C. Sullivan', relationship: 'FBI domestic intelligence chief who oversaw COINTELPRO operations during Rowe\'s informant service', href: '/entities/individuals/william-c-sullivan' },
    ],
  },
  'george-c-moore': {
    name: 'George C. Moore',
    title: 'FBI Section Chief, Racial Intelligence Section',
    role: 'FBI official who directed COINTELPRO operations specifically targeting Black civil rights organizations and leaders',
    riskLevel: 'critical',
    description: 'George C. Moore served as Section Chief of the FBI\'s Racial Intelligence Section within the Domestic Intelligence Division, making him the day-to-day operational director of COINTELPRO-BLACK HATE (later renamed COINTELPRO-BLACK NATIONALIST HATE GROUPS) from its expansion in 1967 until the program\'s termination in 1971. Moore reported directly to FBI Assistant Director William C. Sullivan and was responsible for planning and implementing specific COINTELPRO operations against the Black Panther Party, the Southern Christian Leadership Conference, the Nation of Islam, the Student Nonviolent Coordinating Committee, and dozens of other Black civil rights and nationalist organizations. Under Moore\'s direction, the Racial Intelligence Section developed and executed operations designed to create violent confrontations between organizations, destroy leaders\' personal relationships, undermine organizations\' financial support, and "prevent the rise of a Black messiah." Moore personally approved memoranda proposing specific disruptive actions against Martin Luther King Jr., Stokely Carmichael, Elijah Muhammad, and other leaders. The Church Committee\'s investigation revealed that Moore\'s section was responsible for some of the most egregious civil rights violations in COINTELPRO, including operations that contributed directly to violence and death within targeted communities.',
    birthDate: '',
    deathDate: '',
    education: [],
    affiliations: [
      { name: 'Federal Bureau of Investigation', role: 'Section Chief, Racial Intelligence Section, Domestic Intelligence Division', type: 'agency' },
    ],
    controversies: [
    ...
    charges: [
      { statute: 'Rome Statute Article 7(1)(h)', description: 'Crimes Against Humanity; Persecution: Directed systematic persecution of Black civil rights leaders and organizations through COINTELPRO operations', category: 'International Criminal Law' },
      { statute: '18 U.S.C. 241', description: 'Conspiracy Against Rights: Directed FBI operations that systematically violated First Amendment, Fourth Amendment, and equal protection rights of Black Americans', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 242', description: 'Deprivation of Rights Under Color of Law: Used official FBI position to target Black organizations and leaders for political persecution', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 1111', description: 'Murder (accessory): COINTELPRO operations under Moore\'s direction contributed directly to violent deaths, including the Carter/Huggins murders at UCLA', category: 'Violent Crimes' },
      { statute: '18 U.S.C. 1001', description: 'False Statements: Directed creation and distribution of fabricated documents and forged letters as part of COINTELPRO operations', category: 'Federal Crimes' },
    ],
    relatedInvestigations: [
      { title: 'COINTELPRO: Domestic Surveillance Legacy', slug: 'cointelpro-domestic-surveillance-legacy', severity: 'critical' },
    ...
    timeline: [
      { date: '1960s', event: 'Rises through FBI ranks in domestic intelligence operations' },
      { date: '1967-08-25', event: 'COINTELPRO-BLACK NATIONALIST HATE GROUPS expanded under Moore\'s direction from 23 to 41 field offices' },
      { date: '1968-03-04', event: 'Moore\'s section issues directive to "prevent the rise of a Black messiah" targeting King, Carmichael, and Elijah Muhammad' },
      { date: '1968-04-04', event: 'Martin Luther King Jr. assassinated; FBI COINTELPRO operations had worked to isolate and destabilize King for years' },
      { date: '1969-01-17', event: 'Black Panthers Bunchy Carter and John Huggins killed at UCLA in conflict with US Organization that FBI operations had provoked' },
      { date: '1969-12-04', event: 'Fred Hampton assassination facilitated by COINTELPRO intelligence operations under Moore\'s program umbrella' },
      { date: '1969-1971', event: 'Directs escalation of operations to "destroy the Black Panther Party from the inside"' },
      { date: '1971-04-28', event: 'COINTELPRO officially terminated by FBI after exposure through Media, PA break-in revelations' },
      { date: '1975-1976', event: 'Church Committee investigation exposes Moore\'s role as operational director of COINTELPRO-BLACK HATE; Moore\'s memoranda and directives made public' },
    ],
    socialMedia: [],
    sources: [
      { title: 'Senate Church Committee: Final Report - Book III, "COINTELPRO: The FBI\'s Covert Action Programs Against American Citizens"', url: 'https://www.intelligence.senate.gov/sites/default/files/94755_III.pdf', date: '1976' },
      { title: 'Ward Churchill and Jim Vander Wall - "The COINTELPRO Papers"', url: 'https://scholar.google.com/scholar?q=Churchill+Vander+Wall+COINTELPRO+Papers', date: '1990' },
      { title: 'Senate Select Committee: "The FBI\'s Covert Action Program to Destroy the Black Panther Party"', url: 'https://www.intelligence.senate.gov/sites/default/files/94755_II.pdf', date: '1976' },
      { title: 'Kenneth O\'Reilly - "Racial Matters: The FBI\'s Secret File on Black America"', url: 'https://scholar.google.com/scholar?q=Kenneth+OReilly+Racial+Matters+FBI+Secret+File+Black+America', date: '1989' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'William C. Sullivan', relationship: 'Direct superior; Sullivan headed the Domestic Intelligence Division under which Moore\'s Racial Intelligence Section operated', href: '/entities/individuals/william-c-sullivan' },
      { name: 'J. Edgar Hoover', relationship: 'FBI Director who authorized and oversaw COINTELPRO operations Moore implemented', href: '/entities/individuals/j-edgar-hoover' },
      { name: 'Fred Hampton', relationship: 'Black Panther leader killed through intelligence operations conducted under Moore\'s COINTELPRO program', href: '/entities/individuals/fred-hampton' },
      { name: 'Martin Luther King Jr.', relationship: 'Primary target of COINTELPRO operations Moore directed', href: '/entities/individuals/martin-luther-king-jr' },
    ],
  },
};
