...
const profiles: Record<string, IndividualProfile> = {
 ...
 'ed-pierson': {
    ...
    affiliations: [
      { name: 'Boeing', role: 'Senior Manager, 737 Program, Renton Factory (retired)', type: 'corporation' as const },
      { name: 'United States Navy', role: 'Commander (retired), 30+ years of service', type: 'agency' as const },
      { name: 'Foundation for Aviation Safety', role: 'Founder and Executive Director', type: 'organization' as const },
    ],
    controversies: [
    ...
    timeline: [
      { date: '1980s', event: 'Graduates from United States Naval Academy; begins 30+ year career in the U.S. Navy reaching rank of Commander' },
      ...
      { date: '2024-01', event: 'After Alaska Airlines door plug blowout, publicly states Boeing\'s production culture remains unchanged from the conditions he warned about in 2018' },
    ],
    socialMedia: [],
    sources: [
      ...
      { title: 'Foundation for Aviation Safety', url: 'https://www.foundationforaviationsafety.org/', date: '2024' },
      { title: 'Ed Pierson Congressional Testimony (PBS Frontline)', url: 'https://www.pbs.org/wgbh/frontline/article/what-has-happened-to-boeing-since-the-737-max-crashes/', date: '2019' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'Scott Campbell', relationship: 'Boeing SVP to whom Pierson directed his June 2018 production safety warnings' },
      { name: 'John Barnett', relationship: 'Fellow Boeing whistleblower who reported quality defects at South Carolina plant; found dead March 2024' },
      { name: 'Peter DeFazio', relationship: 'House Transportation Committee Chair who received Pierson\'s testimony during Congressional investigation' },
      { name: 'Sam Salehpour', relationship: 'Boeing quality engineer who raised similar concerns about 787 Dreamliner production shortcuts' },
    ],
  },
 ...
 charges: [
 { statute: '720 ILCS 5/31-4', description: 'Obstruction of Justice: Indicted by special grand jury for obstructing the investigation into the Hampton raid; acquitted at trial', category: 'State Criminal Law' },
 { statute: '720 ILCS 5/8-2', description: 'Conspiracy: Indicted for conspiring to obstruct the criminal prosecution of officers involved in the Hampton raid; acquitted at trial', category: 'State Criminal Law' },
 { statute: '42 U.S.C. 1983', description: 'Civil Rights Violation: $1.85 million settlement in Hampton v. Hanrahan civil rights lawsuit acknowledging violations in the raid and cover-up', category: 'Civil Rights' },
 { statute: '18 U.S.C. 241', description: 'Conspiracy Against Rights: Coordinated with FBI COINTELPRO to execute raid targeting Black Panther leadership', category: 'Civil Rights Violations' },
 { statute: '18 U.S.C. 242', description: 'Deprivation of Rights Under Color of Law: Used prosecutorial authority to authorize a raid that violated Fourth Amendment protections', category: 'Civil Rights Violations' },
 ],
 relatedInvestigations: [
 ...
 timeline: [
 { date: 'March 11, 1921', event: 'Born in Coconut Grove, Florida' },
 { date: '1943', event: 'Graduates from University of Notre Dame' },
 { date: '1948', event: 'Graduates from Harvard Law School' },
 { date: '1964', event: 'Appointed U.S. Attorney for the Northern District of Illinois by President Lyndon Johnson' },
 { date: '1968', event: 'Elected Cook County State\'s Attorney as part of the Daley political machine' },
 { date: '1969-12-04', event: 'Authorizes pre-dawn raid on Fred Hampton\'s apartment; 14 officers kill Hampton and Mark Clark' },
 { date: '1969-12-04', event: 'Holds press conference claiming officers acted in self-defense in a "fierce gun battle"' },
 { date: '1970', event: 'Independent forensic investigation demolishes self-defense narrative; community outrage intensifies' },
 { date: '1971', event: 'Indicted by special Cook County grand jury for conspiracy and obstruction of justice' },
 { date: '1972', event: 'Acquitted at trial on obstruction charges' },
 { date: '1972', event: 'Loses Democratic primary for State\'s Attorney; unprecedented African American voter turnout drives defeat' },
 { date: '1982', event: '$1.85 million civil rights settlement in Hampton v. Hanrahan paid by City of Chicago, Cook County, and federal government' },
 { date: 'June 9, 2009', event: 'Dies in Chicago, Illinois at age 88' },
 ],
 socialMedia: [],
 sources: [
 ...
 { title: 'Commission of Inquiry into the Black Panthers and the Police (1970)', url: 'https://scholar.google.com/scholar?q=Commission+Inquiry+Black+Panthers+Police+Hampton+1970', date: '1970' },
 ],
 aliases: [],
 knownAssociates: [
 { name: 'Fred Hampton', relationship: 'Black Panther chairman killed in raid Hanrahan authorized', href: '/entities/individuals/fred-hampton' },
 { name: 'J. Edgar Hoover', relationship: 'FBI Director whose COINTELPRO program coordinated with Hanrahan\'s office on the Hampton raid', href: '/entities/individuals/j-edgar-hoover' },
 { name: 'William O\'Neal', relationship: 'FBI informant who provided the apartment floor plan used to plan the raid', href: '/entities/individuals/william-o-neal' },
 { name: 'Richard J. Daley', relationship: 'Chicago Mayor and head of the political machine that appointed Hanrahan', href: '/entities/individuals/richard-j-daley' },
 ],
 },
 ...
 timeline: [
 { date: 'November 12, 1899', event: 'Born in Early County, Georgia' },
 { date: '1922', event: 'Graduates from Tuskegee Institute nursing program' },
 { date: '1932', event: 'Assigned as nurse for the new PHS syphilis study in Macon County; begins building relationships with the 600 enrolled men' },
 { date: '1930s-1940s', event: 'Maintains continuous contact with study subjects, driving them to appointments, arranging follow-ups, and managing logistics as the men are denied treatment' },
 { date: '1947', event: 'Penicillin becomes the standard cure for syphilis; Rivers continues her role as study liaison as subjects remain untreated' },
 { date: '1958', event: 'Receives the Oveta Culp Hobby Award from the Department of Health, Education, and Welfare for her Tuskegee study work' },
 { date: '1972', event: 'The Tuskegee study is publicly exposed by AP journalist Jean Heller; Rivers\'s role comes under scrutiny' },
 { date: '1973', event: 'Congressional hearings examine the study; Rivers is not called to testify' },
 { date: 'August 28, 1986', event: 'Dies in Tuskegee, Alabama; never faced criminal charges or official sanction for her role' },
 ],
 sources: [
 ...
 { title: 'Eunice Rivers et al., "Twenty Years of Follow-up Experience in a Long-Range Medical Study," Public Health Reports 68(4), 1953', date: '1953' },
 { title: 'CDC, "The Tuskegee Timeline"', url: 'https://www.cdc.gov/tuskegee/timeline.htm', date: '2024' },
 { title: 'Fred Gray, The Tuskegee Syphilis Study (NewSouth Books, 1998)', date: '1998' },
 ],
 knownAssociates: [
 { name: 'Raymond Vonderlehr', relationship: 'PHS physician who designed the study and relied on Rivers to maintain subject participation', href: '/entities/individuals/raymond-vonderlehr' },
 { name: 'Taliaferro Clark', relationship: 'PHS officer who originated the study; Rivers was assigned as nurse from the beginning', href: '/entities/individuals/taliaferro-clark' },
 { name: 'John R. Heller Jr.', relationship: 'PHS Division Director who oversaw the study during the penicillin era while Rivers maintained daily contact', href: '/entities/individuals/john-r-heller-jr' },
 { name: 'Fred Gray', relationship: 'Civil rights attorney who filed the class action lawsuit on behalf of the subjects Rivers had worked with', href: '/entities/individuals/fred-gray' },
 { name: 'Thomas Parran', relationship: 'Surgeon General who presided over PHS during Rivers\'s early decades with the study', href: '/entities/individuals/thomas-parran' },
 ],
 },
 ...
 'NSA REPORTING: Published multiple stories revealing British GCHQ surveillance programs including Tempora',
  ...
  'edward-s-miller': {
    ...
    charges: [
      { statute: '18 U.S.C. 241', description: 'Conspiracy Against Rights: Convicted of conspiring to violate constitutional rights through warrantless break-ins of private homes; fined $3,500; pardoned by Reagan', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 242', description: 'Deprivation of Rights Under Color of Law: Used FBI authority to authorize warrantless searches of private residences without judicial authorization', category: 'Civil Rights Violations' },
      { statute: 'Fourth Amendment', description: 'Unreasonable Search and Seizure: Directed break-ins of homes without warrants or probable cause, targeting individuals not suspected of criminal activity', category: 'Constitutional Violations' },
    ],
    relatedInvestigations: [
      { title: 'COINTELPRO: Domestic Surveillance Legacy', slug: 'cointelpro-domestic-surveillance-legacy', severity: 'critical' },
    ...
    timeline: [
      { date: '1924', event: 'Born' },
      { date: '1940s', event: 'Joins the FBI as a special agent' },
      { date: '1971', event: 'Appointed Assistant Director heading the FBI Intelligence Division after William C. Sullivan\'s removal' },
      { date: '1972-1973', event: 'Authorizes warrantless break-ins against Weather Underground associates alongside Mark Felt' },
      { date: '1973', event: 'Retires from the FBI after Bureau leadership changes' },
      { date: '1976', event: 'Church Committee investigation exposes scope of FBI domestic surveillance operations' },
      { date: '1978', event: 'Indicted along with Mark Felt for ordering warrantless break-ins' },
      { date: '1980-11', event: 'Convicted in United States v. Felt; fined $3,500' },
      { date: '1981-03-26', event: 'Pardoned by President Ronald Reagan alongside Mark Felt' },
      { date: '2006', event: 'Dies' },
    ],
    socialMedia: [],
    sources: [
      ...
      { title: 'Reagan Pardon Proclamation for Felt and Miller', url: 'https://scholar.google.com/scholar?q=Reagan+pardon+Felt+Miller+1981', date: '1981' },
    ...
    aliases: [],
    knownAssociates: [
      { name: 'Mark Felt', relationship: 'Co-defendant; FBI Associate Director who was convicted alongside Miller and also pardoned by Reagan', href: '/entities/individuals/mark-felt' },
      { name: 'J. Edgar Hoover', relationship: 'FBI Director who established the illegal surveillance framework Miller continued to implement', href: '/entities/individuals/j-edgar-hoover' },
      { name: 'William C. Sullivan', relationship: 'Predecessor as head of domestic intelligence; Miller took over the division after Sullivan\'s removal', href: '/entities/individuals/william-c-sullivan' },
      { name: 'Richard Nixon', relationship: 'Former President who publicly supported Felt and Miller\'s defense after conviction', href: '/entities/individuals/richard-nixon' },
    ],
  },
};
