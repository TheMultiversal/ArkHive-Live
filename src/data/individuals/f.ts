...
const profiles: Record<string, IndividualProfile> = {
 ...
 role: '',
 riskLevel: 'low',
 description: 'Franklin Graham. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Felix Sater. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Fred Trump. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Francis Collins. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Fawn Hall. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 riskLevel: 'high',
 description: 'Felice Casson. Profile pending review.',
 education: [],
 affiliations: [
 { name: 'Legal Profession', role: 'Legal Professional', type: 'organization' },
 ],
 ...
 riskLevel: 'high',
 description: 'Felix Wormser. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Fidel Castro. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Five Omar Mualimm-ak. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Flint Taylor. Profile pending review.',
 education: [],
 affiliations: [
 ...
 'frank-barker': {
 name: 'Frank Barker',
 title: 'Task Force Commander - My Lai',
 role: 'Lieutenant Colonel, Commander of Task Force Barker, Americal Division',
 riskLevel: 'critical',
 description: 'Lieutenant Colonel Frank Barker was the commanding officer of Task Force Barker, the unit responsible for the My Lai massacre on March 16, 1968. Barker planned and ordered Operation Muscatine, the search-and-destroy mission that resulted in the deaths of between 347 and 504 unarmed Vietnamese civilians in the Son My village area. He briefed his company commanders, including Captain Ernest Medina of Charlie Company, on the operation, and witnesses testified that his orders emphasized aggressive action and the destruction of the village. Barker was killed in a helicopter crash on June 13, 1968, just three months after the massacre, which meant he was never investigated, charged, or tried for his role in planning and ordering the operation. His death before the massacre was exposed effectively shielded the most senior tactical commander from accountability. The Peers Commission later concluded that Barker bore significant responsibility for the operation\'s planning and execution, but his death made prosecution impossible. The task force bearing his name became synonymous with one of the worst war crimes committed by American forces.',
 birthDate: '',
 birthPlace: '',
 deathDate: 'June 13, 1968',
 deathCause: 'Killed in helicopter crash during combat operations in Vietnam',
 education: [],
 affiliations: [
 { name: 'United States Army', relationship: 'Lieutenant Colonel commanding Task Force Barker, 11th Infantry Brigade, Americal Division', href: '/entities/agencies/us-army' },
 { name: 'Task Force Barker', relationship: 'Namesake commander who planned and ordered the March 16, 1968 operation against Son My village', href: '/investigations/my-lai-massacre' },
 ],
 controversies: [
 {
 title: 'Planning and Ordering the My Lai Operation',
 description: 'Barker planned Operation Muscatine, the search-and-destroy mission targeting the Son My village area on March 16, 1968. He ordered his company commanders to engage what intelligence had identified as the 48th Local Force Battalion of the Viet Cong. His operational orders set the stage for the massacre by emphasizing the destruction of the village and aggressive engagement.',
 date: 'March 15-16, 1968',
 impact: 'The operation he planned and ordered resulted in the deaths of between 347 and 504 unarmed civilians, including women, children, and elderly villagers.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Responsibility for Rules of Engagement',
 description: 'As task force commander, Barker established the rules of engagement for the My Lai operation. Witnesses testified that the briefings conveyed the message that soldiers were to destroy the village and its inhabitants, with some interpreting this as authorization to kill everyone encountered.',
 date: 'March 15, 1968',
 impact: 'The ambiguous or explicitly murderous rules of engagement created the conditions where soldiers felt authorized to kill unarmed civilians.',
 sources: ['https://www.pbs.org/wgbh/americanexperience/films/mylai/'],
 },
 {
 title: 'Falsified After-Action Reports',
 description: 'After the operation, Task Force Barker\'s after-action report claimed 128 enemy killed in action against only 3 weapons recovered. Barker either authored, approved, or allowed these grossly falsified reports that characterized a civilian massacre as a successful combat operation.',
 date: 'March 1968',
 impact: 'The falsified reports enabled the cover-up to persist for over 18 months, preventing accountability for the massacre.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Death Before Investigation',
 ...
 date: 'June 13, 1968',
 impact: 'His death created a permanent gap in accountability, as the officer most directly responsible for ordering the operation could never be tried.',
 sources: ['https://www.loc.gov/item/2018690253/'],
 },
 {
 title: 'Peers Commission Findings',
 description: 'The Peers Commission, investigating the massacre in 1970, concluded that Barker bore significant command responsibility for the operation. The commission found that his planning, orders, and failure to control the operation made him one of the most culpable individuals, but noted his death made prosecution impossible.',
 date: '1970',
 impact: 'The commission\'s findings established Barker\'s central role in the massacre even though he could not be tried posthumously.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Failure to Respond to Hugh Thompson Reports',
 description: 'During the operation, helicopter pilot Hugh Thompson reported the massacre in progress to his superiors, who relayed concerns up the chain. Barker, as the operational commander, received reports of civilian casualties but took no action to halt the killing or investigate the reports.',
 date: 'March 16, 1968',
 impact: 'His failure to act on real-time reports of the massacre while it was occurring allowed the killing to continue throughout the morning.',
 sources: ['https://www.pbs.org/wgbh/americanexperience/films/mylai/'],
 },
 {
 title: 'Command Climate Under Barker',
 description: 'Task Force Barker operated in an environment where body counts were the primary measure of success and civilian casualties were routinely underreported or misclassified. Barker\'s command culture prioritized kill statistics over the protection of civilians and the laws of war.',
 date: '1968',
 impact: 'The toxic command climate encouraged soldiers to view Vietnamese civilians as legitimate targets, creating conditions for atrocity.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 ],
 timeline: [
 { date: 'March 15, 1968', event: 'Briefed company commanders on Operation Muscatine targeting Son My village area' },
 { date: 'March 16, 1968', event: 'Task Force Barker under his command launched the assault on My Lai hamlet, resulting in the massacre of 347-504 civilians' },
 { date: 'March 16, 1968', event: 'Received reports from helicopter pilot Hugh Thompson about civilian casualties but took no action to stop the killing' },
 { date: 'March 1968', event: 'After-action reports under his authority falsely claimed 128 enemy killed against 3 weapons recovered' },
 { date: 'June 13, 1968', event: 'Killed in helicopter crash during combat operations in Vietnam, three months after the massacre' },
 { date: 'November 1969', event: 'My Lai massacre exposed by journalist Seymour Hersh, but Barker already dead' },
 { date: '1970', event: 'Peers Commission concluded Barker bore significant command responsibility but could not be tried posthumously' },
 ],
 keyPositions: [
 'Lieutenant Colonel, Commander of Task Force Barker, 11th Infantry Brigade, Americal Division',
 ],
 knownAssociates: [
 { name: 'Ernest Medina', relationship: 'Charlie Company commander who received Barker\'s operational briefing', href: '/entities/individuals/ernest-medina' },
 { name: 'William Calley', relationship: 'Platoon leader who carried out the massacre under Barker\'s operational command', href: '/entities/individuals/william-calley' },
 { name: 'Oran Henderson', relationship: '11th Brigade commander who was Barker\'s superior officer', href: '/entities/individuals/oran-henderson' },
 { name: 'Samuel Koster', relationship: 'Americal Division commander in Barker\'s chain of command', href: '/entities/individuals/samuel-koster' },
 { name: 'Eugene Kotouc', relationship: 'Intelligence officer who served under Barker', href: '/entities/individuals/eugene-kotouc' },
 ],
 charges: [],
 status: 'deceased before investigation',
 sources: [
 ...
 riskLevel: 'high',
 description: 'Frank DiPascali. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Frank Powell. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Fred Branfman. Profile pending review.',
 education: [],
 affiliations: [
 ...
 timeline: [
 { date: 'December 14, 1930', event: 'Born in Montgomery, Alabama' },
 { date: '1954', event: 'Graduates from Case Western Reserve University School of Law; returns to Alabama to practice civil rights law' },
 { date: 'December 1, 1955', event: 'Becomes the attorney for Rosa Parks after her arrest; helps organize the legal challenge to bus segregation' },
 { date: '1956', event: 'Files Browder v. Gayle; the U.S. Supreme Court rules Alabama bus segregation unconstitutional' },
 { date: '1955-1960s', event: 'Serves as legal advisor to Dr. Martin Luther King Jr. and fights dozens of civil rights cases across Alabama' },
 { date: '1972', event: 'The Tuskegee syphilis study is exposed by AP reporter Jean Heller; Gray begins legal action on behalf of the surviving subjects' },
 { date: '1973', event: 'Files Pollard v. United States, the class action lawsuit on behalf of the Tuskegee study victims' },
 { date: '1974', event: 'The case results in a $10 million out-of-court settlement providing lifetime medical benefits for participants and their families' },
 { date: '1998', event: 'Publishes "The Tuskegee Syphilis Study," the definitive legal account of the case from the attorney\'s perspective' },
 { date: '2002', event: 'Inducted into the Alabama Lawyers Hall of Fame' },
 ],
 sources: [
 { title: 'Fred Gray, The Tuskegee Syphilis Study (NewSouth Books, 1998)', date: '1998' },
 { title: 'Fred Gray, Bus Ride to Justice: The Life and Works of Fred Gray (NewSouth Books, 1995; revised 2013)', date: '2013' },
 { title: 'James H. Jones, Bad Blood: The Tuskegee Syphilis Experiment (Free Press, 1981; expanded 1993)', date: '1981' },
 { title: 'Bryan Stevenson, "Fred Gray: Alabama\'s Civil Rights Attorney," Equal Justice Initiative', date: '2020' },
 ],
 knownAssociates: [
 { name: 'Rosa Parks', relationship: 'Represented Parks after her 1955 arrest; his legal work helped end bus segregation', href: '/entities/individuals/rosa-parks' },
 { name: 'Martin Luther King Jr.', relationship: 'Served as one of King\'s primary legal advisors during the Montgomery Bus Boycott', href: '/entities/individuals/martin-luther-king-jr' },
 { name: 'Eunice Rivers', relationship: 'Tuskegee study nurse whose role Gray examined as he built the case for the study subjects', href: '/entities/individuals/eunice-rivers' },
 { name: 'Peter Buxtun', relationship: 'Whistleblower whose exposure of the study created the conditions for Gray\'s lawsuit', href: '/entities/individuals/peter-buxtun' },
 { name: 'Charlie Pollard', relationship: 'Named plaintiff in Pollard v. United States, the Tuskegee class action', href: '/entities/individuals/charlie-pollard' },
 ],
 },
 ...
 riskLevel: 'high',
 description: 'Fred Guttenberg. Profile pending review.',
 education: [],
 affiliations: [
 { name: 'Victim/Deceased', role: 'Victim', type: 'organization' },
 ],
 ...
 riskLevel: 'high',
 description: 'Fred Hampton Jr.. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Frederick Babcock. Profile pending review.',
 education: [],
 affiliations: [
 { name: 'Law Enforcement', role: 'Law Enforcement Officer', type: 'agency' },
 ],
 ...
 riskLevel: 'high',
 description: 'Frederick Douglass. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Frederick Hitz. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Frederik Obermaier. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'critical',
 description: 'Fazlollah Zahedi. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'medium',
 description: 'Francis Biddle. Profile pending review.',
 ...
 riskLevel: 'critical',
 description: 'François Duvalier. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Freeway Ricky Ross. Profile pending review.',
 education: [],
 affiliations: [
 { name: 'Central Intelligence Agency', role: 'CIA Official', type: 'agency' },
 ],
 ...
 riskLevel: 'medium',
 description: 'Fox News. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 riskLevel: 'medium',
 description: 'Facebook. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 riskLevel: 'medium',
 description: 'Free Speech Systems. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 riskLevel: 'medium',
 description: 'Fsb. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: 'Documented for accountability tracking',
 riskLevel: 'low',
 description: 'Fisa Court. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: 'Documented based on entity connections',
 riskLevel: 'medium',
 description: 'Fcc. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: 'Tracked for public accountability',
 riskLevel: 'critical',
 description: 'Federal Reserve. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: 'Subject of ongoing documentation',
 riskLevel: 'medium',
 description: 'Ftx. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
