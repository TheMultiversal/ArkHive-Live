...
const profiles: Record<string, IndividualProfile> = {
 ...
 education: [],
 affiliations: [
  { name: 'Purdue Pharma', role: 'Board of Directors; oversaw OxyContin marketing during opioid crisis; one of eight family defendants', type: 'corporation' as const },
  { name: 'Sackler Family', role: 'Daughter of Mortimer Sackler; member of family that owned Purdue Pharma and extracted $10.7 billion', type: 'organization' as const },
 ],
 controversies: [
 ...
 timeline: [
  { date: '1948', event: 'Born as daughter of Mortimer Sackler, one of three physician brothers who owned Purdue Frederick/Purdue Pharma' },
  { date: '1996', event: 'Purdue Pharma launches OxyContin; begins aggressive marketing to doctors claiming low addiction risk' },
  { date: '2007', event: 'Purdue Pharma pleads guilty to misbranding OxyContin; pays $634.5 million; three executives plead guilty but no Sackler charged' },
  { date: '2008-2018', event: 'Sackler family extracts approximately $10.7 billion from Purdue Pharma; at least $1 billion wired to offshore accounts including Swiss banks' },
  { date: '2018', event: 'Named as one of eight Sackler family defendants in Massachusetts AG lawsuit and other state lawsuits' },
 ...
 aliases: [],
 knownAssociates: [
  { name: 'Richard Sackler', relationship: 'Half-brother (son of Raymond Sackler); former Purdue Pharma president and co-chairman who directed aggressive OxyContin marketing', href: '/entities/individuals/richard-sackler' },
  { name: 'David Sackler', relationship: 'Nephew (Richard\'s son); third-generation Sackler; fellow Purdue board member and co-defendant', href: '/entities/individuals/david-sackler' },
  ...
  { name: 'Jonathan Sackler', relationship: 'Brother (son of Mortimer); Purdue board member; died 2020 before lawsuit resolution' },
 ],
 },
