...
const profiles: Record<string, IndividualProfile> = {
 ...
 { title: 'NYC Settlement Documents', url: 'https://www.courtlistener.com/', date: '2014' },
  ...
  'katherine-harris': {
    ...
    title: 'Former Florida Secretary of State, 2000 Election Controversy',
    role: 'Florida Secretary of State (1999-2003)',
    riskLevel: 'high',
    description: 'Katherine Harris served as Florida\'s Secretary of State during the contested 2000 presidential election and was co-chair of George W. Bush\'s Florida campaign while simultaneously overseeing the election. She certified Bush\'s 537-vote victory after halting recounts, a decision upheld by the Supreme Court in Bush v. Gore. Her dual role as campaign co-chair and election overseer represented one of the most significant conflicts of interest in American electoral history.',
    birthDate: 'April 5, 1957',
    birthPlace: 'Key West, Florida, USA',
    education: [
      'J.D. (incomplete) - Stetson University College of Law',
      'M.A. - Harvard Kennedy School',
    ...
    controversies: [
      '2000 ELECTION: Certified Bush\'s 537-vote Florida victory while serving as co-chair of his Florida campaign',
      'HALTED RECOUNTS: Used strict interpretation of deadlines to stop manual recounts',
      'VOTER PURGE: Oversaw purge of "felons" from voter rolls that incorrectly removed thousands of eligible Black voters',
      'CONFLICT OF INTEREST: Served simultaneously as election overseer and Bush campaign co-chair',
    ],
    charges: [],
    relatedInvestigations: [
    ...
    timeline: [
      { date: '1957', event: 'Born in Key West, Florida' },
      { date: '1998', event: 'Elected Florida Secretary of State' },
      { date: '2000 (Nov)', event: 'Certifies Bush victory in Florida despite ongoing recount disputes' },
      { date: '2000 (Dec)', event: 'Supreme Court rules in Bush v. Gore, ending recounts' },
      { date: '2002', event: 'Elected to US House of Representatives' },
      { date: '2006', event: 'Loses Senate campaign by wide margin' },
    ],
    socialMedia: [],
    sources: [
      { title: 'Bush v. Gore Supreme Court Decision', url: 'https://supreme.justia.com/cases/federal/us/531/98/', date: '2000' },
      { title: 'US Commission on Civil Rights - FL Election Report', url: 'https://www.usccr.gov/pubs/vote2000/report/main.htm', date: '2001' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'George W. Bush', relationship: 'Presidential candidate she was campaign co-chair for while overseeing his election', href: '/entities/individuals/george-w-bush' },
      { name: 'Jeb Bush', relationship: 'Florida Governor during 2000 election, his brother won', href: '/entities/individuals/jeb-bush' },
    ],
  },
