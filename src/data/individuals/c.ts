...
const profiles: Record<string, IndividualProfile> = {
 ...
 { name: 'Gary Gensler', relationship: 'SEC chair who pursued crypto enforcement against CZ', href: '/entities/individuals/gary-gensler' },
   ...
   'charles-calhoun': {
    ...
    charges: [
      { statute: 'UCMJ Article 92', description: 'Dereliction of Duty; Failed to properly oversee and report on combat operation at My Lai', category: 'Military' },
      { statute: 'UCMJ Article 134', description: 'Failure to Report a Known War Crime; Did not report the massacre through proper channels', category: 'Military' },
    ],
    relatedInvestigations: [
      { title: 'The My Lai Massacre', slug: 'my-lai-massacre', severity: 'critical' },
    ],
    timeline: [
      { date: '1968', event: 'Serving as Major and S-3 Operations Officer for Task Force Barker, 11th Infantry Brigade' },
      { date: 'March 15, 1968', event: 'Participates in operational planning and briefing for the My Lai assault' },
      { date: 'March 16, 1968', event: 'My Lai massacre occurs; Calhoun in position to receive real-time operational reports' },
      { date: 'March 1968', event: 'After-action reports filed with grossly inflated enemy casualty figures and no mention of civilian deaths' },
      { date: 'March 1969', event: 'Ronald Ridenhour sends letters to 30 members of Congress exposing the massacre' },
      { date: 'November 1969', event: 'Seymour Hersh publishes investigation revealing the massacre to the American public' },
      { date: '1970', event: 'Peers Commission identifies Calhoun as one of officers involved in the operation and cover-up' },
      { date: '1970', event: 'Charged with failure to report a war crime and dereliction of duty' },
      { date: '1971', event: 'All charges dropped before trial' },
    ],
    socialMedia: [],
    sources: [
      { title: 'Peers Commission Report (Peers Inquiry)', url: 'https://www.loc.gov/rr/frd/Military_Law/Peers_Inquiry.html', date: '1970' },
      { title: 'National Archives: Records of the My Lai Massacre', url: 'https://www.archives.gov/research/vietnam-war/my-lai-massacre', date: '1970' },
      { title: 'Seymour Hersh, "My Lai 4: A Report on the Massacre and Its Aftermath"', url: 'https://scholar.google.com/scholar?q=Hersh+My+Lai+4+Report+Massacre', date: '1970' },
      { title: 'Department of the Army: My Lai Courts-Martial Records', url: 'https://www.loc.gov/rr/frd/Military_Law/ML_court-martials.html', date: '1970-1971' },
      { title: 'Michael Bilton and Kevin Sim, "Four Hours in My Lai"', url: 'https://scholar.google.com/scholar?q=Bilton+Sim+Four+Hours+My+Lai', date: '1992' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'William Calley', relationship: 'Platoon leader convicted of murder at My Lai', href: '/entities/individuals/william-calley' },
      { name: 'Ernest Medina', relationship: 'Charlie Company commander at My Lai, acquitted', href: '/entities/individuals/ernest-medina' },
      { name: 'Samuel Koster', relationship: 'Americal Division commander who covered up the massacre', href: '/entities/individuals/samuel-koster' },
      { name: 'Oran Henderson', relationship: 'Colonel, 11th Brigade commander, acquitted', href: '/entities/individuals/oran-henderson' },
    ],
  },
 ...
 { name: 'Rob Bilott', relationship: 'Attorney who sued DuPont over PFAS during Holliday\'s tenure', href: '/entities/individuals/rob-bilott' },
   ...
   'charles-hutto': {
    ...
    charges: [
      { statute: 'UCMJ Article 118', description: 'Murder; Killing of unarmed Vietnamese civilians at My Lai', category: 'Military' },
      { statute: 'UCMJ Article 134', description: 'Assault with Intent to Murder; Shooting at unarmed civilians', category: 'Military' },
    ],
    relatedInvestigations: [
      { title: 'The My Lai Massacre', slug: 'my-lai-massacre', severity: 'critical' },
    ],
    timeline: [
      ...
      { date: 'Early 1968', event: 'Charlie Company suffers casualties from mines and booby traps in Quang Ngai Province' },
      { date: 'March 15, 1968', event: 'Briefed that My Lai area is a Viet Cong stronghold; told all civilians would have left for market' },
      { date: 'March 16, 1968', event: 'Participates in assault on My Lai; kills unarmed Vietnamese civilians during the operation' },
      { date: '1969', event: 'Massacre exposed by Ronald Ridenhour\'s letters and Seymour Hersh\'s reporting' },
      { date: '1970', event: 'Charged with murder and assault with intent to murder by U.S. Army' },
      { date: '1971', event: 'Tried by court-martial; acquitted of all charges' },
      { date: 'Post-trial', event: 'Appears on CBS 60 Minutes, states he was "just following orders"' },
    ],
    socialMedia: [],
    sources: [
      { title: 'CBS News 60 Minutes: My Lai Interviews', url: 'https://scholar.google.com/scholar?q=Charles+Hutto+My+Lai+60+Minutes+interview', date: '1970s' },
      { title: 'Peers Commission Report', url: 'https://www.loc.gov/rr/frd/Military_Law/Peers_Inquiry.html', date: '1970' },
      { title: 'National Archives: My Lai Courts-Martial Records', url: 'https://www.archives.gov/research/vietnam-war/my-lai-massacre', date: '1970-1971' },
      { title: 'Seymour Hersh, "My Lai 4"', url: 'https://scholar.google.com/scholar?q=Hersh+My+Lai+4+Report+Massacre', date: '1970' },
      { title: 'Michael Bilton and Kevin Sim, "Four Hours in My Lai"', url: 'https://scholar.google.com/scholar?q=Bilton+Sim+Four+Hours+My+Lai', date: '1992' },
    ],
    aliases: [],
    knownAssociates: [
      { name: 'William Calley', relationship: 'Platoon leader, only person convicted of My Lai murders', href: '/entities/individuals/william-calley' },
      { name: 'Ernest Medina', relationship: 'Charlie Company commander who gave orders for the operation', href: '/entities/individuals/ernest-medina' },
 ...
 'charles-zarzecki': {
  ...
  'cartha-deke-deloach': {
    ...
    title: 'FBI Associate Deputy Director (1965-1970)',
    role: 'Third-ranking FBI official who served as Hoover\'s political liaison and directed FBI surveillance and manipulation of civil rights leaders and political figures',
    riskLevel: 'critical',
    description: 'Cartha Dillon "Deke" DeLoach served as the FBI\'s Associate Deputy Director from 1965 to 1970, making him the third most powerful official in the Bureau under J. Edgar Hoover. DeLoach functioned as Hoover\'s primary liaison to the White House, Congress, and the media, serving under Presidents Kennedy, Johnson, and Nixon. He was deeply involved in COINTELPRO operations, playing a central role in the FBI\'s campaign against Martin Luther King Jr. and performing political intelligence work for President Lyndon Johnson, including surveillance of political opponents at the 1964 Democratic National Convention. DeLoach personally managed the distribution of surveillance recordings and derogatory information about civil rights leaders to friendly journalists and politicians. He was accused of attempting to use FBI files to blackmail public officials and of directing intelligence operations designed to undermine political movements. After retiring from the FBI in 1970, DeLoach became vice president of PepsiCo, where he leveraged his extensive network of political and law enforcement contacts. He vigorously defended Hoover\'s legacy until his death in 2013, publishing a memoir that disputed Church Committee findings about COINTELPRO abuses.',
    birthDate: 'July 20, 1920',
    birthPlace: 'Claxton, Georgia',
    deathDate: 'March 13, 2013',
    education: ['Stetson University, BA'],
    affiliations: [
      { name: 'Federal Bureau of Investigation', role: 'Associate Deputy Director (1965-1970)', type: 'agency' },
      { name: 'PepsiCo', role: 'Vice President, Corporate Affairs (1970-1985)', type: 'corporation' },
    ],
    controversies: [
      'COINTELPRO LEADERSHIP: As Associate Deputy Director, was directly involved in COINTELPRO operations targeting civil rights organizations, antiwar groups, and the New Left. Served on the FBI\'s executive committee that approved disruptive and illegal operations against American citizens.',
      'MLK SURVEILLANCE AND BLACKMAIL: Personally managed the distribution of FBI surveillance recordings and derogatory dossiers about Martin Luther King Jr. to sympathetic journalists, politicians, and religious leaders. Oversaw efforts to diminish King\'s influence before the 1964 Nobel Peace Prize ceremony.',
      '1964 DNC SURVEILLANCE: Directed a team of approximately 30 FBI agents who conducted surveillance operations at the 1964 Democratic National Convention in Atlantic City at the request of President Lyndon Johnson. The operation targeted civil rights groups, particularly the Mississippi Freedom Democratic Party, and political opponents of the Johnson administration.',
      'POLITICAL INTELLIGENCE FOR LBJ: Served as Hoover\'s primary liaison to President Johnson, providing the White House with political intelligence gathered through FBI surveillance. This included derogatory information about senators, congressmen, and public figures that could be used for political leverage.',
      'BLACKMAIL ALLEGATIONS: Accused of using FBI files containing compromising information to intimidate and manipulate public officials. The Church Committee documented that FBI leadership, including DeLoach, used their intelligence files as instruments of political power.',
      'MEDIA MANIPULATION: Cultivated relationships with sympathetic journalists and media figures, providing them with FBI-sourced derogatory information about surveillance targets. This included planting disinformation about civil rights leaders in mainstream publications.',
      'DEFENSE OF COINTELPRO: Published memoir "Hoover\'s FBI" (1995) that defended FBI operations and disputed Church Committee findings about COINTELPRO abuses. Continued to deny or minimize the severity of FBI civil rights violations until his death.',
      'CORPORATE INTELLIGENCE: After retiring from FBI at age 50, joined PepsiCo as VP of corporate affairs, leveraging his FBI network and intelligence contacts for corporate advantage, raising questions about the revolving door between government surveillance agencies and corporate America.',
    ],
    charges: [
      { statute: '18 U.S.C. 241', description: 'Conspiracy Against Rights: Participated in COINTELPRO operations that systematically violated First and Fourth Amendment rights of American citizens', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 242', description: 'Deprivation of Rights Under Color of Law: Used FBI authority to conduct politically motivated surveillance and distribute derogatory information about civil rights leaders', category: 'Civil Rights Violations' },
      { statute: '18 U.S.C. 2511', description: 'Illegal Wiretapping: Participated in warrantless electronic surveillance of civil rights leaders, political figures, and organizations', category: 'Surveillance Crimes' },
      { statute: '18 U.S.C. 873', description: 'Blackmail: Accusations of using FBI surveillance files to intimidate and manipulate public officials', category: 'Coercion' },
      { statute: 'Rome Statute Article 7(1)(h)', description: 'Crimes Against Humanity; Persecution: Participated in systematic targeting of civil rights movement as part of FBI leadership', category: 'International Criminal Law' },
    ],
    relatedInvestigations: [
    ...
    timeline: [
      { date: 'July 20, 1920', event: 'Born in Claxton, Georgia' },
      { date: '1942', event: 'Graduates from Stetson University; joins the FBI as a special agent' },
      { date: '1959', event: 'Promoted to Assistant Director, serving in Crime Records Division handling media and congressional liaison' },
      { date: '1964-08', event: 'Directs FBI surveillance team of approximately 30 agents at the Democratic National Convention in Atlantic City at LBJ\'s request' },
      { date: '1964-11', event: 'Manages distribution of MLK surveillance materials and derogatory dossiers to journalists and politicians before Nobel Prize ceremony' },
      { date: '1965', event: 'Promoted to Associate Deputy Director (No. 3 position); becomes Hoover\'s primary White House and congressional liaison' },
      { date: '1965-1970', event: 'Oversees COINTELPRO operations as member of FBI executive leadership under Hoover' },
      { date: '1965-1968', event: 'Provides regular political intelligence briefings to President Johnson using FBI surveillance materials' },
      { date: '1970', event: 'Retires from FBI at age 50; joins PepsiCo as Vice President of Corporate Affairs' },
      { date: '1976', event: 'Church Committee exposes COINTELPRO abuses; DeLoach\'s role in MLK operations and political surveillance documented' },
      { date: '1995', event: 'Publishes memoir "Hoover\'s FBI: The Inside Story by Hoover\'s Trusted Lieutenant" defending Bureau operations' },
      { date: 'March 13, 2013', event: 'Dies in Hilton Head, South Carolina at age 92' },
    ],
    socialMedia: [],
    sources: [
      ...
      { title: 'Cartha DeLoach - "Hoover\'s FBI: The Inside Story"', url: 'https://scholar.google.com/scholar?q=DeLoach+Hoover+FBI+Inside+Story', date: '1995' },
    ],
    aliases: ['Deke DeLoach', 'C.D. DeLoach'],
    knownAssociates: [
      { name: 'J. Edgar Hoover', relationship: 'FBI Director and superior; DeLoach served as Hoover\'s most trusted political operative', href: '/entities/individuals/j-edgar-hoover' },
      { name: 'William C. Sullivan', relationship: 'FBI colleague; Sullivan headed domestic intelligence while DeLoach handled political liaison', href: '/entities/individuals/william-c-sullivan' },
      { name: 'Mark Felt', relationship: 'FBI colleague; Felt served as Deputy Director during transition period', href: '/entities/individuals/mark-felt' },
      { name: 'Martin Luther King Jr.', relationship: 'Primary target of FBI surveillance and derogatory information campaigns DeLoach managed', href: '/entities/individuals/martin-luther-king-jr' },
    ],
  },
};
