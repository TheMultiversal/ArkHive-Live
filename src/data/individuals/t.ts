...
const profiles: Record<string, IndividualProfile> = {
 ...
 role: 'Officer who blocked bystanders during George Floyd murder; convicted of aiding and abetting manslaughter and federal civil rights violations',
 riskLevel: 'critical',
 description: 'Tou Thao was a Minneapolis police officer who stood guard and physically blocked concerned bystanders from intervening while Derek Chauvin murdered George Floyd on May 25, 2020. As bystanders begged him to check Floyd pulse and pleaded for Chauvin to stop, Thao told them to get back on the sidewalk. He was the most experienced officer on scene besides Chauvin, with approximately 8 years on the force. Thao had 6 prior complaints filed against him, including a 2017 excessive force lawsuit that the City of Minneapolis settled for $25,000. He was convicted of federal civil rights violations in February 2022 and found guilty of state aiding and abetting second-degree manslaughter in May 2023 after rejecting a plea deal and choosing an evidentiary trial before Judge Peter Cahill. He was the last of the four officers to be convicted, receiving the maximum state sentence of 4.75 years.',
 birthDate: '1985',
 birthPlace: 'Minnesota',
 education: [],
 affiliations: [
 { name: 'Minneapolis Police Department', role: 'Former Officer (approximately 2012-2020)', type: 'agency' },
 { name: 'Minneapolis Police Federation', role: 'Union member', type: 'organization' },
 ],
 knownAssociates: [
 { name: 'Derek Chauvin', relationship: 'Senior officer who murdered George Floyd; Thao blocked bystanders while Chauvin knelt on Floyd neck for 9 minutes 29 seconds', href: '/entities/individuals/derek-chauvin' },
 { name: 'J. Alexander Kueng', relationship: 'Fellow officer at scene who knelt on Floyd back; both convicted federally and in state court', href: '/entities/individuals/j-alexander-kueng' },
 { name: 'Thomas Lane', relationship: 'Fellow officer at scene who held Floyd legs; both convicted federally and in state court', href: '/entities/individuals/thomas-lane' },
 ],
 controversies: [
 ...
 charges: [
 { statute: 'Minn. Stat. SS 609.205 / 609.05', description: 'Aiding and Abetting Second-Degree Manslaughter, found guilty in evidentiary trial before Judge Peter Cahill on May 2, 2023; sentenced to maximum 4.75 years', category: 'Violent Crime' },
 { statute: '18 U.S.C. SS 242', description: 'Deprivation of Rights Under Color of Law, Failure to Intervene: convicted by federal jury February 24, 2022 for failing to stop Chauvin unreasonable force; sentenced to 3.5 years', category: 'Federal Crime' },
 { statute: '18 U.S.C. SS 242', description: 'Deprivation of Rights Under Color of Law, Failure to Provide Medical Care: convicted by federal jury February 24, 2022 for failing to render medical aid to Floyd; sentenced concurrently', category: 'Federal Crime' },
 ],
 relatedInvestigations: [
 ...
 timeline: [
 { date: '2012', event: 'Joins Minneapolis Police Department as patrol officer' },
 { date: '2017', event: 'Lamar Ferguson sues Thao and another officer for excessive force during a traffic stop; City of Minneapolis settles for $25,000' },
 { date: 'May 25, 2020', event: 'Present at George Floyd murder; blocks bystanders from intervening while Chauvin kneels on Floyd neck for 9 minutes 29 seconds' },
 { date: 'May 26, 2020', event: 'Fired by Minneapolis Police Department along with Chauvin, Kueng, and Lane' },
 { date: 'June 3, 2020', event: 'Charged with aiding and abetting second-degree murder and second-degree manslaughter by Minnesota Attorney General Keith Ellison' },
 { date: 'May 7, 2021', event: 'Federal grand jury indicts Thao, Kueng, and Lane on civil rights violations; charged with failing to intervene and failing to provide medical care' },
 { date: 'January 20, 2022', event: 'Federal civil rights trial begins in Saint Paul, Minnesota' },
 { date: 'February 24, 2022', event: 'Federal jury convicts Thao on all counts, failure to intervene and failure to provide medical care during Floyd murder' },
 { date: 'July 2022', event: 'Sentenced to 3.5 years in federal prison for civil rights violations' },
 { date: 'October 2022', event: 'Rejects state plea deal accepted by Kueng; chooses evidentiary trial before Judge Cahill' },
 { date: 'May 2, 2023', event: 'Found guilty of aiding and abetting second-degree manslaughter in state evidentiary trial; sentenced to maximum 4.75 years' },
 { date: 'August 2023', event: 'Federal appeal denied by 8th Circuit Court of Appeals' },
 { date: 'November 2025', event: 'Released from prison after serving sentence; last of four officers to be freed' },
 ],
 sources: [
 { title: 'Minnesota v. Thao, State Evidentiary Trial Records', url: 'https://mncourts.gov/', date: '2023' },
 { title: 'United States v. Thao, Kueng, and Lane, Federal Civil Rights Trial', url: 'https://www.justice.gov/opa/pr/three-former-minneapolis-police-officers-convicted-federal-civil-rights-violations-death', date: '2022' },
 { title: 'DOJ Press Release: Federal Sentencing of Former Minneapolis Officers', url: 'https://www.justice.gov/opa', date: '2022' },
 { title: 'Star Tribune: Tou Thao Found Guilty in George Floyd Murder', url: 'https://www.startribune.com/', date: '2023' },
 ],
 },
 'tina-peters': {
 name: 'Tina Peters',
 ...
 charges: [
 { charge: 'No criminal charges were ever filed', status: 'pending', date: 'N/A', source: 'Parran died in 1968, four years before the Tuskegee study was publicly exposed. The Guatemala experiments were not discovered until 2010.' },
 ],
 relatedInvestigations: [
 ...
 timeline: [
 { date: 'September 28, 1892', event: 'Born in St. Leonard, Maryland' },
 { date: '1917', event: 'Joins the United States Public Health Service after completing medical training at Georgetown University' },
 { date: '1930', event: 'Appointed Commissioner of the New York State Department of Health; begins public campaign against venereal disease' },
 { date: 'April 6, 1936', event: 'Appointed sixth Surgeon General of the United States by President Franklin D. Roosevelt' },
 { date: '1937', event: 'Publishes "Shadow on the Land: Syphilis," a landmark book credited with destigmatizing syphilis as a public health issue' },
 { date: '1936-1948', event: 'Tuskegee syphilis study continues and expands under his twelve-year tenure as Surgeon General' },
 { date: '1946-1948', event: 'Guatemala syphilis experiments conducted by John Charles Cutler under Parran\'s PHS authority; experiments deliberately infect vulnerable populations with STDs' },
 { date: '1947', event: 'Penicillin becomes widely available as standard treatment for syphilis; Tuskegee subjects continue to be denied treatment under Parran\'s PHS' },
 { date: '1948', event: 'Leaves office as Surgeon General; appointed first dean of the University of Pittsburgh Graduate School of Public Health' },
 { date: 'February 16, 1968', event: 'Dies in Pittsburgh, four years before the Tuskegee study is publicly exposed' },
 ],
 sources: [
 ...
 { title: 'Susan M. Reverby, "Normal Exposure" and Inoculation Syphilis: A PHS "Tuskegee" Doctor in Guatemala, 1946-1948', date: '2011' },
 { title: 'Presidential Commission for the Study of Bioethical Issues, "Ethically Impossible" (September 2011)', date: '2011' },
 { title: 'Thomas Parran, Shadow on the Land: Syphilis (Reynal & Hitchcock, 1937)', date: '1937' },
 ],
 knownAssociates: [
 { name: 'John Charles Cutler', relationship: 'PHS physician who conducted the Guatemala syphilis experiments under Parran\'s authority and later served as advisor to the Tuskegee study', href: '/entities/individuals/john-charles-cutler' },
 { name: 'Raymond Vonderlehr', relationship: 'PHS physician who designed and directed the early Tuskegee study under Parran\'s Surgeon General tenure', href: '/entities/individuals/raymond-vonderlehr' },
 { name: 'Eunice Rivers', relationship: 'Tuskegee study nurse who maintained subject contact throughout Parran\'s PHS tenure', href: '/entities/individuals/eunice-rivers' },
 { name: 'Susan Reverby', relationship: 'Historian who discovered the Guatemala experiments in Cutler\'s papers decades after Parran\'s death', href: '/entities/individuals/susan-reverby' },
 { name: 'Taliaferro Clark', relationship: 'PHS officer who originated the Tuskegee study before Parran became Surgeon General', href: '/entities/individuals/taliaferro-clark' },
 ],
 },
 ...
 timeline: [
 { date: 'August 18, 1961', event: 'Born in Brooklyn, New York. Father worked for USAID; family lived in Zimbabwe, India, Thailand, and China during childhood' },
 { date: '1988', event: 'Joins the Treasury Department; works under Robert Rubin and Lawrence Summers on international financial crises' },
 { date: '2001-2003', event: 'Serves as Director of Policy Development and Review at the International Monetary Fund' },
 { date: 'November 2003', event: 'Becomes President of the Federal Reserve Bank of New York at age 42, the youngest person in the role. Assumes primary regulatory authority over the largest Wall Street banks' },
 { date: '2003-2007', event: 'As NY Fed President, oversees Wall Street during the buildup of catastrophic leverage and subprime exposure. Takes no meaningful action to restrain the risks' },
 { date: 'March 2008', event: 'Orchestrates the emergency sale of Bear Stearns to JPMorgan Chase with $29 billion in Fed guarantees' },
 { date: 'September 12-14, 2008', event: 'Hosts emergency weekend negotiations at the NY Fed attempting to find a buyer for Lehman Brothers. No rescue materializes' },
 { date: 'September 16, 2008', event: 'Approves $85 billion emergency loan to AIG. AIG uses funds to pay Goldman Sachs $12.9 billion at 100 cents on the dollar' },
 { date: 'January 26, 2009', event: 'Confirmed as 75th Secretary of the Treasury despite controversy over unpaid personal taxes' },
 { date: '2009-2010', event: 'Oversees TARP implementation. Privately describes HAMP as a way to "foam the runway" for banks. Opposes breaking up too-big-to-fail banks' },
 { date: 'January 2013', event: 'Leaves Treasury. No top Wall Street executive has been prosecuted during his tenure' },
 { date: 'March 2014', event: 'Becomes President of Warburg Pincus, a $73 billion private equity firm, fully transitioning to the financial industry he previously regulated' },
 ],
 socialMedia: [],
 sources: [
 { title: 'Wikipedia: Timothy Geithner', url: 'https://en.wikipedia.org/wiki/Timothy_Geithner', date: '' },
 { title: 'Neil Barofsky, "Bailout: An Inside Account of How Washington Abandoned Main Street While Rescuing Wall Street"', url: 'https://www.simonandschuster.com/books/Bailout/Neil-Barofsky/', date: '2012' },
 { title: 'FCIC Report: Financial Crisis Inquiry Commission', url: 'https://fcic.law.stanford.edu/', date: 'January 2011' },
 { title: 'PBS Frontline: The Untouchables', url: 'https://www.pbs.org/wgbh/frontline/documentary/untouchables/', date: '2013' },
 ],
 aliases: [],
 knownAssociates: [
 { name: 'Henry Paulson', relationship: 'Treasury predecessor during financial crisis; coordinated bailout strategy', href: '/entities/individuals/henry-paulson' },
 { name: 'Ben Bernanke', relationship: 'Fed Chair during crisis; Geithner reported to Bernanke as NY Fed President', href: '/entities/individuals/ben-bernanke' },
 { name: 'Robert Rubin', relationship: 'Mentor and predecessor who shaped Wall Street-friendly policy; Geithner worked under Rubin at Treasury in the 1990s', href: '/entities/individuals/robert-rubin' },
 { name: 'Barack Obama', relationship: 'President who appointed Geithner Treasury Secretary; Geithner\'s approach shaped Obama administration\'s crisis response', href: '/entities/individuals/barack-obama' },
 { name: 'Larry Summers', relationship: 'Fellow Treasury veteran and Obama economic advisor; Summers mentored Geithner in the 1990s', href: '/entities/individuals/larry-summers' },
 ],
 },
 ...
 knownAssociates: [
  ...
  'taliaferro-clark': {
    ...
    charges: [
    { charge: 'No criminal charges were ever filed', status: 'pending', date: 'N/A', source: 'Clark died in 1948, 24 years before the study was publicly exposed.' },
    ],
    relatedInvestigations: [
    { title: 'Tuskegee Syphilis Study: 40 Years of Medical Genocide', slug: 'tuskegee-experiment', severity: 'critical' },
    ],
    timeline: [
    { date: '1867', event: 'Born in the United States' },
    { date: '1920s', event: 'Works with the Rosenwald Fund on syphilis treatment demonstration programs for Black communities in the rural South' },
    { date: '1932-06', event: 'Proposes a six-to-eight month observational study of untreated syphilis among Black men in Macon County, Alabama after Rosenwald Fund treatment program ends' },
    { date: '1932-09', event: 'Recruits cooperation of Tuskegee Institute president Robert Moton and Macon County health officials using deceptive framing' },
    { date: '1932-10', event: 'Study begins enrolling subjects under Clark\'s direction; 399 men with syphilis and 201 controls recruited with false promises of treatment' },
    { date: '1932-12', event: 'Raymond Vonderlehr takes increasing control of the study, pushing to make it long-term and non-therapeutic' },
    { date: '1933', event: 'Clark retires from USPHS; the study continues under Vonderlehr\'s direction, expanding into a decades-long experiment' },
    { date: '1948-06-28', event: 'Dies, 24 years before the study he created would be publicly exposed by Jean Heller of the Associated Press' },
    ],
    sources: [
    { title: 'James H. Jones, Bad Blood: The Tuskegee Syphilis Experiment (Free Press, 1981; expanded 1993)', date: '1981' },
    { title: 'Susan M. Reverby, Examining Tuskegee: The Infamous Syphilis Study and Its Legacy (UNC Press, 2009)', date: '2009' },
    ...
    knownAssociates: [
    { name: 'Raymond Vonderlehr', relationship: 'USPHS colleague who took over the Tuskegee study from Clark and transformed it into a permanent non-treatment experiment', href: '/entities/individuals/raymond-vonderlehr' },
    { name: 'Eunice Rivers', relationship: 'Nurse recruited to maintain subject compliance; carried out Clark\'s and Vonderlehr\'s protocols for 40 years', href: '/entities/individuals/eunice-rivers' },
    { name: 'Oliver C. Wenger', relationship: 'PHS officer who advised on the study design and helped prevent subjects from receiving treatment', href: '/entities/individuals/oliver-c-wenger' },
    { name: 'Robert Russa Moton', relationship: 'President of Tuskegee Institute who agreed to institutional cooperation, lending credibility to the study', href: '/entities/individuals/robert-russa-moton' },
    ],
  },
