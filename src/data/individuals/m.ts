...
const profiles: Record<string, IndividualProfile> = {
 ...
 { title: 'A Sacred Oath (memoir)', url: 'https://www.goodreads.com/', date: '2022' },
  ...
  'manuel-contreras': {
    ...
    title: 'DINA Director, Chilean Secret Police Chief',
    role: 'Director of DINA (Chilean Secret Police) (1973-1977)',
    riskLevel: 'critical',
    description: 'Manuel Contreras was the head of Chile\'s secret police (DINA) under Augusto Pinochet. He directed the systematic torture, assassination, and disappearance of thousands of political opponents. He orchestrated the car bombing assassination of former Chilean ambassador Orlando Letelier in Washington D.C. in 1976, and coordinated with other South American dictatorships in Operation Condor\'s transnational assassination program. He was convicted of multiple human rights crimes and died in prison.',
    birthDate: 'May 4, 1929',
    birthPlace: 'Santiago, Chile',
    education: ['Chilean Military Academy', 'School of the Americas (US-trained)'],
    affiliations: [
      { name: 'DINA', role: 'Founder and Director (1973-1977)', type: 'agency' },
      { name: 'Operation Condor', role: 'Key coordinator', type: 'organization' },
    ],
    controversies: [
      'TORTURE AND MURDER: Directed systematic torture and killing of thousands of Chilean political opponents',
      'LETELIER ASSASSINATION: Ordered car bombing of Orlando Letelier in Washington D.C., killing him and American Ronni Moffitt',
      'OPERATION CONDOR: Key coordinator of transnational assassination program among South American dictatorships',
      'US TRAINED: Received training at School of the Americas, maintained CIA contacts',
    ],
    charges: [
      { statute: 'Chilean Criminal Code', description: 'Multiple convictions for murder, kidnapping, torture (500+ years total sentences)', category: 'Crimes Against Humanity' },
    ],
    relatedInvestigations: [
    ...
    timeline: [
      { date: '1929', event: 'Born in Santiago, Chile' },
      { date: '1973 (Sep)', event: 'Pinochet coup; Contreras appointed to lead intelligence' },
      { date: '1974', event: 'Formally creates DINA, begins systematic repression' },
      { date: '1975', event: 'Joins Operation Condor coordination' },
      { date: '1976 (Sep)', event: 'Orders assassination of Orlando Letelier in Washington D.C.' },
      { date: '1977', event: 'Removed as DINA director after international pressure' },
      { date: '1993', event: 'Convicted of Letelier assassination' },
      { date: '2015', event: 'Dies in prison serving 500+ years of sentences' },
    ],
    socialMedia: [],
    sources: [
    ...
    aliases: ['El Mamo'],
    knownAssociates: [
      { name: 'Augusto Pinochet', relationship: 'Dictator who appointed him to lead secret police', href: '/entities/individuals/augusto-pinochet' },
      { name: 'Henry Kissinger', relationship: 'US Secretary of State who supported the Pinochet regime', href: '/entities/individuals/henry-kissinger' },
    ],
  },
