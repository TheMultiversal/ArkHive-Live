...
const profiles: Record<string, IndividualProfile> = {
 ...
 role: '',
 riskLevel: 'high',
 description: 'Oleg Deripaska. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Omarosa Manigault Newman. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Oscar Munoz. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Omar Al Bashir. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 riskLevel: 'high',
 description: 'Oliver Schmidt. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Oliver Wendell Holmes Jr.. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Orlando Letelier. Profile pending review.',
 education: ['MBA'],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Orval Faubus. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Orville Kelly. Profile pending review.',
 education: [],
 affiliations: [
 ...
 riskLevel: 'high',
 description: 'Oscar Danilo Blandón. Profile pending review.',
 education: [],
 affiliations: [
 ...
 timeline: [
 { date: 'Ongoing', event: 'Active in role as Nicaraguan drug trafficker who sold tons of cocaine in LA to fund the Contras; became DEA informant' },
 ],
 socialMedia: [],
 sources: [
 ...
 riskLevel: 'high',
 description: 'Óscar Romero. Profile pending review.',
 education: [],
 affiliations: [
 ...
 timeline: [
 { date: 'Ongoing', event: 'Active in role as Archbishop of San Salvador assassinated while saying Mass for criticizing military violence' },
 ],
 socialMedia: [],
 sources: [
 ...
 riskLevel: 'high',
 description: 'Otto Pérez Molina. Profile pending review.',
 education: [],
 affiliations: [
 { name: 'Department of Defense', role: 'Defense Official', type: 'agency' },
 ],
 ...
 timeline: [
 { date: 'Ongoing', event: 'Active in role as Military commander in Ixil Triangle during genocide; later President of Guatemala' },
 ],
 socialMedia: [],
 sources: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Oath Keepers. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
 ...
 role: '',
 riskLevel: 'low',
 description: 'Oprah Winfrey. Profile pending review.',
 education: [],
 affiliations: [
 ],
 controversies: [
