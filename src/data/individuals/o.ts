...
const profiles: Record<string, IndividualProfile> = {
 ...
 'oran-henderson': {
 name: 'Oran Henderson',
 title: 'Highest-Ranking Officer Tried for My Lai',
 role: 'Colonel, Commander of 11th Infantry Brigade, Americal Division',
 riskLevel: 'critical',
 description: 'Colonel Oran Henderson was the commander of the 11th Infantry Brigade, Americal Division, making him the highest-ranking officer to be tried in connection with the My Lai massacre and its cover-up. Task Force Barker, which carried out the massacre on March 16, 1968, operated under Henderson\'s brigade command. On the day of the massacre, Henderson received reports from helicopter pilot Hugh Thompson about American soldiers killing civilians, and Henderson personally flew over the area. Despite witnessing evidence of the massacre from the air and receiving Thompson\'s urgent reports, Henderson took no meaningful action to stop the killing or investigate the reports. Instead, he conducted a cursory "investigation" that concluded no civilians had been killed, effectively authoring the official cover-up. Henderson was charged with dereliction of duty and cover-up of the My Lai massacre. He was the only high-ranking officer to face trial, but was acquitted by a military jury in December 1971. His acquittal ensured that the command structure that enabled, permitted, and concealed the massacre faced no accountability, leaving Lieutenant William Calley as the sole scapegoat. Henderson\'s case demonstrated the military justice system\'s unwillingness to hold senior officers accountable for the actions of their subordinates or for their failures to prevent and report war crimes.',
 birthDate: '',
 birthPlace: '',
 education: [],
 affiliations: [
 { name: 'United States Army', relationship: 'Colonel, Commander of 11th Infantry Brigade, Americal Division, the brigade under which Task Force Barker operated', href: '/entities/agencies/us-army' },
 { name: 'Task Force Barker', relationship: 'Brigade commander with direct authority over the task force that conducted the My Lai massacre', href: '/investigations/my-lai-massacre' },
 ],
 controversies: [
 {
 title: 'Direct Knowledge of the Massacre',
 description: 'Henderson received urgent reports from helicopter pilot Hugh Thompson on the day of the massacre, indicating that American soldiers were killing unarmed civilians. Henderson personally flew over My Lai in a command helicopter and would have seen evidence of the killing. Despite this direct knowledge, he took no action to halt the operation or rescue civilians.',
 date: 'March 16, 1968',
 impact: 'Henderson\'s failure to act despite real-time knowledge allowed the massacre to continue throughout the morning, resulting in the deaths of 347-504 civilians.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Fraudulent Investigation and Cover-Up',
 description: 'After receiving Thompson\'s reports, Henderson conducted a sham investigation that concluded no massacre had occurred and that civilian casualties were the result of normal combat operations. This fraudulent investigation became the foundation of the official cover-up that concealed the massacre for over 18 months.',
 date: 'March-April 1968',
 impact: 'Henderson\'s cover-up prevented accountability for the massacre for nearly two years and enabled the military to continue denying the atrocity.',
 sources: ['https://www.pbs.org/wgbh/americanexperience/films/mylai/'],
 },
 {
 title: 'Highest-Ranking Officer Tried',
 description: 'Henderson was charged with dereliction of duty and cover-up and became the highest-ranking officer to face trial in connection with My Lai. The Peers Commission had recommended charges against more senior officers including Major General Samuel Koster, but Henderson bore the burden of representing command accountability at trial.',
 date: '1971',
 impact: 'His trial represented the military justice system\'s attempt to address command responsibility, but even this limited effort ended in acquittal.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Acquittal by Military Jury',
 description: 'Henderson was acquitted by a military jury in December 1971. His defense argued that he had reasonably relied on the reports of subordinates and that the fog of war prevented him from fully understanding what had occurred. The jury\'s acceptance of this defense effectively established that no commander bore responsibility for the massacre.',
 date: 'December 1971',
 impact: 'The acquittal of the highest-ranking officer tried ensured that the entire command structure escaped accountability, leaving only a single lieutenant convicted.',
 sources: ['https://www.loc.gov/item/2018690253/'],
 },
 {
 title: 'Suppression of Thompson\'s Reports',
 description: 'When Hugh Thompson reported the massacre through his chain of command, Henderson was positioned to receive and act on those reports. Instead of ordering a cease-fire and investigation, Henderson allowed the official after-action report to characterize the operation as a successful engagement against 128 enemy fighters, despite knowing this was false.',
 date: 'March 1968',
 impact: 'Henderson\'s suppression of Thompson\'s truthful reports and endorsement of false official reports constituted the most consequential act of the cover-up.',
 sources: ['https://www.pbs.org/wgbh/americanexperience/films/mylai/'],
 },
 {
 title: 'Command Responsibility Failure',
 description: 'Henderson had both the authority and the responsibility to prevent, halt, and investigate the massacre. As the brigade commander, he had the power to order a cease-fire, deploy forces to protect civilians, and launch an immediate investigation. His failure to exercise any of these powers constituted a catastrophic failure of command responsibility.',
 date: 'March 16, 1968',
 impact: 'Henderson\'s command failure became a landmark case in discussions of military command responsibility and the duty to prevent war crimes.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 {
 title: 'Peers Commission Findings',
 description: 'The Peers Commission found that Henderson bore significant responsibility for both the failure to prevent the massacre and the active cover-up afterward. The commission documented how Henderson\'s cursory investigation was designed to reach a predetermined conclusion that no wrongdoing had occurred.',
 date: '1970',
 impact: 'Despite the Peers Commission\'s thorough findings, the military justice system failed to hold Henderson accountable.',
 sources: ['https://www.archives.gov/research/military/vietnam-war/my-lai-massacre'],
 },
 ],
 timeline: [
 { date: 'March 16, 1968', event: 'Task Force Barker, under Henderson\'s brigade command, conducted the My Lai massacre killing 347-504 civilians' },
 { date: 'March 16, 1968', event: 'Received reports from Hugh Thompson about American soldiers killing civilians; flew over the area in command helicopter' },
 { date: 'March 16, 1968', event: 'Failed to order cease-fire or launch investigation despite direct knowledge of the massacre' },
 { date: 'March-April 1968', event: 'Conducted sham investigation concluding no massacre occurred, establishing the official cover-up' },
 { date: 'March 1968 - November 1969', event: 'Cover-up concealed the massacre for over 18 months' },
 { date: 'November 1969', event: 'My Lai massacre publicly exposed by journalist Seymour Hersh' },
 { date: '1970', event: 'Peers Commission identified Henderson as bearing significant responsibility for the massacre and cover-up' },
 { date: '1971', event: 'Charged with dereliction of duty and cover-up' },
 { date: 'December 1971', event: 'Acquitted by military court-martial jury, the highest-ranking officer to escape conviction' },
 ],
 keyPositions: [
 'Colonel, Commander of 11th Infantry Brigade, Americal Division',
 ],
 knownAssociates: [
 { name: 'Frank Barker', relationship: 'Task Force Barker commander who planned and ordered the My Lai operation under Henderson\'s authority', href: '/entities/individuals/frank-barker' },
 { name: 'Samuel Koster', relationship: 'Americal Division commander and Henderson\'s superior officer, also implicated in cover-up', href: '/entities/individuals/samuel-koster' },
 { name: 'Hugh Thompson Jr.', relationship: 'Helicopter pilot who reported the massacre to Henderson\'s chain of command', href: '/entities/individuals/hugh-thompson-jr' },
 { name: 'William Calley', relationship: 'Platoon leader and only person convicted, serving under Henderson\'s brigade', href: '/entities/individuals/william-calley' },
 { name: 'Ernest Medina', relationship: 'Charlie Company commander under Henderson\'s brigade', href: '/entities/individuals/ernest-medina' },
 ],
 charges: [
 { statute: 'UCMJ - Dereliction of Duty', description: 'Charged with dereliction of duty for failing to properly investigate reports of the massacre', category: 'Military Misconduct' },
 { statute: 'UCMJ - Cover-Up of War Crimes', description: 'Charged with participating in the cover-up of the My Lai massacre through false investigation and reports', category: 'Obstruction' },
 ],
 status: 'acquitted',
 sources: [
