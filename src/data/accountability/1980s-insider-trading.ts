...
export const insiderTradingAccountability: AccountabilityData = {
  ...
  primaryTargets: [
    ...
    },
    {
      ...
      obstacles: [
        ...
        'Most direct evidence was provided by Siegel himself as cooperator',
      ],
    },
    {
      name: 'Robert Freeman',
      role: 'Head of Arbitrage at Goldman Sachs. Convicted of insider trading based on tips from Martin Siegel and others.',
      currentStatus: 'Pleaded guilty in 1989 to one count of insider trading. Sentenced to 4 months in prison, served the full sentence. Fined $1.1 million. Goldman Sachs paid $2 million civil penalty. Freeman quietly retired from Goldman and Wall Street.',
      accountabilityPath: 'Freeman represented the direct link between the insider trading conspiracy and Goldman Sachs, one of the most powerful financial institutions in the world. Goldman Sachs benefited from the insider information traded by Freeman and paid a minimal $2 million penalty. Investigation into whether Goldman\'s arbitrage profits during Freeman\'s tenure were properly disgorged. Shareholder derivative actions against Goldman for inadequate oversight.',
      obstacles: [
        'Goldman Sachs\'s institutional power and legal resources',
        'Criminal sentence already served',
        'One-count plea deal limited the scope of admitted conduct',
        'Goldman\'s penalty was minimal relative to profits earned',
      ],
    },
    {
      name: 'John Mulheren',
      role: 'Head of Jamie Securities. Convicted of conspiracy and securities fraud for illegal stock manipulation coordinated with Ivan Boesky.',
      currentStatus: 'Convicted in 1990, sentenced to 1 year and 1 day plus a $1.68 million fine. Conviction partially reversed on appeal in 1991 (conspiracy and securities fraud counts upheld, manipulation counts reversed). Mulheren died in 2003.',
      accountabilityPath: 'Mulheren\'s case demonstrated the breadth of Boesky\'s network of co-conspirators in stock manipulation. His estate and any trusts funded during the period of criminal activity remain subject to constructive trust claims. Investigation into whether profits from the securities fraud were fully disgorged before his death.',
      obstacles: [
        'Mulheren deceased (2003)',
        'Partial reversal on appeal complicates claims',
        'Assets dispersed through estate',
      ],
    },
  ],
  ...
  legalMechanisms: [
    ...
    },
    {
      ...
      statute: '18 U.S.C. § 3512; Bilateral MLAT Agreements',
      description: 'The United States has mutual legal assistance treaties with over 70 countries, including Switzerland, the Cayman Islands, the United Kingdom, and most major financial centers. These treaties allow U.S. authorities to request foreign governments to freeze assets, compel disclosure of bank records, and enforce U.S. court orders in foreign jurisdictions.',
      hasStatuteOfLimitations: false,
      reachesHeirs: true,
      authorizedActors: ['U.S. Department of Justice (Office of International Affairs)', 'FBI', 'SEC'],
      applicability: 'potentially_applicable',
      notes: 'Dennis Levine maintained secret accounts at Bank Leu in the Bahamas. Ivan Boesky was known to have offshore financial structures. Switzerland reformed its banking secrecy laws and now cooperates with U.S. enforcement for fraud cases. Any assets moved offshore during the conspiracy period can potentially be recovered through MLAT channels.',
    },
    {
      ...
      description: 'The DOJ\'s Kleptocracy Asset Recovery Initiative targets the proceeds of foreign corruption that have been laundered into or through the United States. While originally focused on foreign officials, its framework and expertise apply to any large-scale financial crime asset recovery, including domestic cases where assets cross borders.',
      hasStatuteOfLimitations: false,
      reachesHeirs: true,
      authorizedActors: ['DOJ Money Laundering and Asset Recovery Section', 'FBI International Corruption Unit'],
      applicability: 'requires_new_action',
      notes: 'The expertise and infrastructure built for kleptocracy cases is directly applicable to recovering assets from the 1980s insider trading conspiracy that may have been moved to foreign jurisdictions.',
    },
    {
      ...
      applicability: 'directly_applicable',
      notes: 'Paul Bilzerian\'s $62 million restitution order is a federal lien that has NEVER been satisfied. Under 18 U.S.C. § 3613(b), this lien attaches to all property and rights to property of the defendant, and it survives his bankruptcy filing. The government has both the authority and the duty to enforce this order. The failure to do so for over 35 years is itself an accountability scandal.',
    },
  ],
  ...
  wealthTrace: [
    {
      ...
      transferMethod: 'Original criminal earnings to family trusts, investment vehicles, Milken Institute, Milken Family Foundation, private equity stakes',
    ...
    {
      name: 'Kidder, Peabody & Co. / GE Capital (successor)',
      relationship: 'Investment bank where Martin Siegel ran M&A and received cash bribes from Boesky',
      transferMethod: 'Kidder Peabody was acquired by General Electric in 1986. The firm\'s M&A department under Siegel generated fees based on insider information. GE sold Kidder\'s operations to PaineWebber in 1994, which was later acquired by UBS. The criminal profits flowed through multiple corporate successors.',
      estimatedValue: 'GE\'s purchase price and subsequent sale price reflected value built in part on insider-trading-enhanced advisory business',
      legalEntities: ['General Electric (historical)', 'UBS Group AG (ultimate successor)'],
      recoveryMechanisms: ['Constructive Trust', 'Unjust Enrichment'],
    },
    {
      name: 'Drexel Burnham Lambert Liquidation Trust',
      relationship: 'Bankruptcy estate of the firm at the center of the conspiracy',
      transferMethod: 'Drexel pleaded guilty to six felony counts in 1989 and paid $650 million in fines and restitution. The firm filed for bankruptcy in February 1990. A liquidation trust was established to distribute remaining assets to creditors. The trust has made periodic distributions over decades.',
      estimatedValue: 'Original assets: billions. Distributions to creditors: partial. Final distributions may still be pending.',
      legalEntities: ['Drexel Burnham Lambert Group Inc. Liquidating Trust'],
      recoveryMechanisms: ['Estate Claims', 'Constructive Trust'],
    },
    {
      name: 'SEC Disgorgement / Victim Restitution Funds',
      relationship: 'Government-collected penalties from the insider trading cases',
      transferMethod: 'The SEC collected hundreds of millions in disgorgement and penalties from Milken ($600M), Boesky ($100M), Drexel ($650M), and others. These funds were supposed to be distributed to harmed investors through Fair Funds and disgorgement funds. The full accounting of whether all collected funds reached victims has never been publicly verified.',
      estimatedValue: 'Total collected: $1.4+ billion in penalties and disgorgement. Amount actually distributed to victims: not fully transparent.',
      legalEntities: ['SEC Fair Fund', 'Various court-supervised distribution funds'],
      recoveryMechanisms: ['Congressional Investigation & Legislative Action', 'FOIA Requests for Fund Accounting'],
    },
  ],
