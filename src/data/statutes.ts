...
export const STATUTE_CATEGORIES: Record<StatuteCategory, { name: string; color: string }> = {
  ...
  'obstruction': { name: 'Obstruction', color: 'text-red-500' },
  'corruption': { name: 'Corruption', color: 'text-red-400' },
  'campaign-finance': { name: 'Campaign Finance', color: 'text-red-300' },
  'foreign-influence': { name: 'Foreign Influence', color: 'text-red-400' },
  'tax': { name: 'Tax', color: 'text-red-300' },
  'securities': { name: 'Securities', color: 'text-red-400' },
  'antitrust': { name: 'Antitrust', color: 'text-red-300' },
  'environmental': { name: 'Environmental', color: 'text-red-400' },
  'civil-rights': { name: 'Civil Rights', color: 'text-red-500' },
  'healthcare': { name: 'Healthcare Fraud', color: 'text-red-400' },
  'national-security': { name: 'National Security', color: 'text-red-500' },
  'perjury': { name: 'Perjury', color: 'text-red-300' },
  'racketeering': { name: 'Racketeering', color: 'text-red-500' },
  'money-laundering': { name: 'Money Laundering', color: 'text-red-400' },
  'public-integrity': { name: 'Public Integrity', color: 'text-red-400' },
  'records': { name: 'Records', color: 'text-red-300/70' },
  'conspiracy': { name: 'Conspiracy', color: 'text-red-400' },
};
